...
- Use el centro Microsoft 365 administración para crear un buzón de usuario. Se recomienda una directiva de retención de 30 días. 
...
Después de crear un buzón único para El programador de Cortana, debe designar el buzón para que Microsoft 365 formalmente. Después de designar el buzón programador de Cortana, estará disponible para programar reuniones en nombre de los usuarios.

Para designar el buzón del Programador de Cortana, un administrador autorizado debe ejecutar un comando de PowerShell de una línea. 
...
Para descubrir qué buzón de correo de la organización está establecido actualmente como asistente programador de Cortana, ejecute la función get:
