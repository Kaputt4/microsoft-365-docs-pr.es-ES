...
Para obtener información general sobre los modelos agregados al sitio del centro de contenido SharePoint Syntex, use el cmdlet [Get-PnPSyntexModel](https://pnp.github.io/powershell/cmdlets/Get-PnPSyntexModel.html):
