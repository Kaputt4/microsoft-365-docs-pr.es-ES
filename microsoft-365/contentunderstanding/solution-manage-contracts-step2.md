...
Después de adjuntar la biblioteca de documentos de SharePoint, podrá ver los contratos clasificados a través de una vista de lista predeterminada.
   ...
   ![Vista de lista de la biblioteca de SharePoint.](../media/content-understanding/list-view.png)
...
Si desea ver o realizar cambios en el código JSON de la vista en el canal de Teams, en el canal de Teams, seleccione el menú desplegable vista y, a continuación, seleccione **Dar formato a la vista actual**.

   ![Captura de pantalla del formato json en el canal de Teams.](../media/content-understanding/jason-format.png)
