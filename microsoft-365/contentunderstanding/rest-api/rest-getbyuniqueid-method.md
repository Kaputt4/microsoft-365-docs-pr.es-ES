...
Obtiene o actualiza información acerca de un modelo de comprensión mediante documentos de SharePoint Syntex (vea [ejemplo](rest-getbyuniqueid-method.md#examples)).
...
|-----|---|--------|----|-----------|
|modelUniqueId|consulta|True|string|Id. del archivo del modelo de Syntex.|
...
### <a name="get-the-contoso-contract-model-by-id"></a>Obtener el modelo del contrato de Contoso por Id.
...
### <a name="get-and-delete-the-contoso-contract-model-by-id"></a>Obtener y eliminar el modelo de contrato de Contoso por Id.
