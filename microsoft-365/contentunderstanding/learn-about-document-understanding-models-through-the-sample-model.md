...
Microsoft SharePoint Syntex proporciona un modelo de ejemplo que puede examinar, lo que le ayuda a comprender mejor cómo crear sus propios modelos. El modelo de ejemplo también le permite examinar los componentes del modelo, como su clasificador, extractores y explicaciones. Además, puede usar los archivos de ejemplo para entrenar el modelo.
