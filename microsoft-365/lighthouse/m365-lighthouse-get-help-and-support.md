...
- Para crear y administrar solicitudes de servicio, debe tener asignado al menos un rol de Azure Active Directory (Azure AD) con el siguiente conjunto de propiedades: **microsoft.office365.supportTickets/allEntities/allTasks**. Para obtener una lista de los roles de Azure AD, vea [Roles integrados de Azure AD](/azure/active-directory/roles/permissions-reference). Para obtener información sobre cómo asignar roles, vea [Asignar roles de Azure AD a los usuarios.](/azure/active-directory/roles/manage-roles-portal)
