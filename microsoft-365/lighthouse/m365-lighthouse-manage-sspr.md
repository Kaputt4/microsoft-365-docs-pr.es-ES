...
- El inquilino del cliente debe tener una Azure AD Premium licencia para cada usuario. Para obtener más información sobre las licencias compatibles con SSPR, consulte [Licensing requirements for Azure Active Directory self-service password reset](/azure/active-directory/authentication/concept-sspr-licensing).

- El inquilino del cliente debe estar activo en Lighthouse. Para obtener información sobre cómo determinar si un espacio empresarial está activo, consulte [Microsoft 365 Lighthouse de la página Inquilinos](m365-lighthouse-tenants-page-overview.md).
...
5. En Azure AD, habilite SSPR para todos o usuarios seleccionados. Para obtener más información, vea Tutorial: Permitir a los usuarios desbloquear su cuenta o restablecer contraseñas [Azure Active Directory restablecimiento de contraseñas de autoservicio](/azure/active-directory/authentication/tutorial-enable-sspr).
...
[Planear una implementación Azure Active Directory de restablecimiento de contraseñas de autoservicio](/azure/active-directory/authentication/howto-sspr-deployment) (artículo)\
[Tutorial: permitir que los usuarios desbloqueen su cuenta o restablezcan las contraseñas Azure Active Directory restablecimiento de contraseñas](/azure/active-directory/authentication/tutorial-enable-sspr) de autoservicio (artículo)\
