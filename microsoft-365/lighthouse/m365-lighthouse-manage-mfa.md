...
- El inquilino del cliente debe tener una Azure AD Premium licencia para cada usuario. Para obtener más información sobre las licencias compatibles con MFA, consulte Características y licencias [para Azure AD multifactor authentication](/azure/active-directory/authentication/concept-mfa-licensing).

- El inquilino del cliente debe estar activo en Microsoft 365 Lighthouse. Para obtener información sobre cómo determinar si un inquilino está activo, [consulte Microsoft 365 Lighthouse de lista de inquilinos](/microsoft-365/lighthouse/m365-lighthouse-tenant-list-overview).
...
Para habilitar MFA a través del acceso condicional, vea Tutorial: Proteger los eventos de inicio de sesión de usuario [Azure AD autenticación multifactor](/azure/active-directory/authentication/tutorial-enable-azure-mfa).
