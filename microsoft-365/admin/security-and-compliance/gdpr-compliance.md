...
### <a name="im-a-sole-proprietor---do-i-really-have-to-worry-about-the-gdpr"></a>Soy el único propietario, ¿de verdad tengo que preocuparme del RGPD?
...
### <a name="how-can-i-tell-if-our-company-website-is-gdpr-compliant"></a>¿Cómo saber si nuestro sitio web de la compañía está en cumplimiento con el RGPD?
...
- Una organización benéfica internacional recopila datos sobre donadores y los usa para enviar actualizaciones y solicitudes de donaciones. El RGPD indica: "... el procesamiento de datos personales con fines de marketing directos puede considerarse realizado con un interés legítimo". Sin embargo, la organización tiene la responsabilidad de demostrar que sus intereses prevalecen sobre los del interesado. La empresa (o, en este caso, la organización benéfica) siempre debe obtener un consentimiento informado, explícito y voluntario.
...
### <a name="sure-i-collect-data-but-some-other-company-stores-it-does-that-get-me-off-the-hook"></a>Por supuesto, recopilo datos, pero otra empresa los almacena. ¿Eso me libera del anzuelo?
...
## <a name="satisfy-privacy-concerns-using-microsoft-365-for-business"></a>Satisfaga los problemas de privacidad con Microsoft 365 para empresas
...
[Información general del Centro de confianza de Microsoft del RGPD](https://www.microsoft.com/trust-center/privacy/gdpr-overview
)
...
- [Normas de protección de datos de la UE de 2018](https://ec.europa.eu/commission/priorities/justice-and-fundamental-rights/data-protection/2018-reform-eu-data-protection-rules)
