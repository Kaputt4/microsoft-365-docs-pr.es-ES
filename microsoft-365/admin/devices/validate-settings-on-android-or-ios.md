...
![Asegúrese de que requerir un PIN o una huella digital para acceder a Office aplicaciones esté establecido en Activado.](../../media/f37eb5b2-7e26-49fb-9bd6-d955d196bacf.png)
...
En el panel **Editar directiva**, elija **Editar** junto a **Office control de acceso de documentos**, expanda **Administrar cómo acceden los usuarios a los archivos Office en dispositivos móviles** y asegúrese **de que Restablecer PIN después del número de intentos erróneos** esté establecido en algún número. Esto es 5 de forma predeterminada. 
...
2. Escriba un PIN incorrecto tantas veces como haya especificado en la directiva. Verá un mensaje que indica Límite de **intento de PIN alcanzado** para restablecer el PIN. 
    ...
    ![Captura de pantalla que indica que después de demasiados intentos de PIN incorrectos, debe restablecer el PIN.](../../media/fca6fcb4-bb5c-477f-af5e-5dc937e8b835.png)
...
En el panel **Editar directiva**, elija **Editar** junto a **Office control de acceso a documentos**, expanda **Administrar cómo acceden los usuarios a los archivos Office en dispositivos móviles** y asegúrese de que **Requerir que los usuarios inicien sesión de nuevo después de que Office aplicaciones hayan estado inactivas durante** algún número de minutos. Esto es 30 minutos de forma predeterminada. 
...
3. Vuelva a acceder a Outlook en el dispositivo Android.
...
2. Abra un correo electrónico que contenga algunos datos adjuntos de archivos de imagen.
...
2. Elija **Directiva de aplicación para iOS** para la configuración que creó durante la instalación u otra directiva que creó y compruebe que se aplica para Outlook, por ejemplo. 
...
2. Escriba un PIN incorrecto tantas veces como haya especificado en la directiva. Verá un mensaje que indica Límite de **intento de PIN alcanzado** para restablecer el PIN. 
    ...
    ![Captura de pantalla en la que se advierte el restablecimiento del PIN después de demasiados intentos incorrectos.](../../media/fab5c089-a4a5-4e8d-8c95-b8eed1dfa262.png)
...
3. Solo debería ver una opción para OneDrive para la Empresa. Si no es así, pulse **Agregar cuenta** y seleccione **OneDrive para la Empresa** en la pantalla **Agregar cuenta de Storage**. Proporcione la Microsoft 365 Empresa Premium del usuario final para iniciar sesión cuando se le solicite. 
...
3. Vuelva a acceder a Outlook en el dispositivo iOS.
