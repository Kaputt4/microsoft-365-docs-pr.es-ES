...
---
# <a name="create-dns-records-at-crazy-domains-for-office-365"></a>Crear registros DNS en Crazy Domains para Office 365
...
Después de agregar estos registros a Crazy Domains, su dominio estará configurado para trabajar con los servicios de Office 365.
...
8. En los cuadros para el nuevo registro, escriba o copie y pegue los valores de la tabla siguiente.
    ...
    |:-----|:-----|
    |(Leave this field empty.)  <br/> |MS=ms *XXXXXXXX*  <br/> **Nota:** Este es un ejemplo. Utilice aquí su valor de **Dirección o puntos de destino**, de la tabla de Office 365.           [¿Cómo puedo encontrarlo?](../get-help-with-domains/information-for-dns-records.md)          |
...
8. En los cuadros para el nuevo registro, escriba o pegue los valores de la tabla siguiente.
    ...
    |**Subdominio**|**Registro de texto**|
    |:-----|:-----|
    |(Deje este campo en blanco).  <br/> |v=spf1 include:spf.protection.outlook.com -all  <br/> **Nota:** Se recomienda copiar y pegar esta entrada para que todo el espaciado sea correcto.           |
...
8. Agregue el primero de los dos registros SRV.
    ...
    |**Tipo de registro**|**Subdominio**|**Prioridad**|**Peso**|**Puerto**|**Destino**|
    |:-----|:-----|:-----|:-----|:-----|:-----|
