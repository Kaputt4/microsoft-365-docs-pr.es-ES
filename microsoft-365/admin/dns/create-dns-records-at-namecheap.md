...
Si Namecheap es su proveedor de host DNS, siga los pasos de este artículo para comprobar su dominio y configurar los registros DNS para el correo electrónico, Skype Empresarial Online, entre otros.
  
Después de agregar estos registros a Namecheap, el dominio estará configurado para funcionar con los servicios Microsoft.
...
7. En los cuadros para el nuevo registro, escriba o copie y pegue los valores de la tabla siguiente.
    ...
    (El **cuadro** Prioridad es el cuadro sin nombre a la derecha del **cuadro** Valor. Elija el **valor TTL** en la lista desplegable). 
...
9. Mediante los cuatro pasos anteriores y los valores de las otras cinco filas de la tabla, agregue cada uno de los otros cinco registros CNAME.
...
7. En los cuadros para el nuevo registro, escriba o copie y pegue los siguientes valores de la tabla siguiente.
...
9. Mediante los cuatro pasos anteriores y los valores de la segunda fila de la tabla, agregue el otro registro SRV.
