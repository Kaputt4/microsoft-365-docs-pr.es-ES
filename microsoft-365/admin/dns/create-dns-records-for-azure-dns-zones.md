...
Si Azure es su proveedor de hospedaje DNS, siga los pasos descritos en este artículo para comprobar su dominio y configurar registros DNS para correo electrónico, Skype Empresarial Online, entre otros.
...
Después de agregar estos registros en Azure, el dominio se configurará para que funcione con los servicios de Microsoft.
...
Cuando se inscribió en Azure, creó un grupo de recursos dentro de una zona DNS y, a continuación, asignó el nombre de dominio a ese grupo de recursos. Ese nombre de dominio está registrado en un registrador de dominio externo; Azure no ofrece servicios de registro de dominios.
  
Para comprobar y crear registros DNS para su dominio en Microsoft, primero debe cambiar los servidores de nombres en el registrador de dominios para que usen los servidores de nombres de Azure asignados al grupo de recursos.
...
2. Cree dos registros de servidor de nombres mediante los valores de la tabla siguiente o edite los registros existentes del servidor de nombres para que coincidan con estos valores. A continuación se muestra un ejemplo de servidores de nombres asignados de Azure.
...
1. Para empezar, vaya a la página dominios de Azure mediante [este vínculo](https://portal.azure.com ). Se le pedirá que inicie sesión primero .
    
    ![Azure-BP-Configure-1-1](../../media/ed377cad-0c47-4f9f-b322-c3e06b309b1f.png)
  
2. Con la **barra de búsqueda de** la página **Panel,** escriba zonas **DNS**. En la presentación de resultados, seleccione **zonas DNS en** la **parte** Servicios. Una vez que te redirijan, selecciona el dominio que quieres actualizar.
    
    ![Azure-BP-Configure-1-2](../../media/eb4baad2-92d7-49c9-95e5-1dd8510d5ec9.png)
  
3. En la **página Configuración** del dominio, en el área **zona DNS,** seleccione **+ Conjunto de registros**.
    
    ![Azure-BP-Configure-1-3](../../media/b04db89a-3dbc-4cd2-aaca-af17fda53a60.png)
  
4. En el **área Agregar conjunto de** registros, en los cuadros del nuevo conjunto de registros, seleccione los valores de la tabla siguiente. 
    
    (Elija los **valores de unidad Type** y **TTL** de las listas desplegables). 
...
4. En el **área Agregar conjunto de** registros, en los cuadros del nuevo conjunto de registros, seleccione los valores de la tabla siguiente. 
    ...
    |:-----|:-----|:-----|:-----|:-----|:-----|
    |@  <br/> |MX  <br/> |1  <br/> |Horas  <br/> |10    <br/> Para obtener más información sobre la prioridad, consulte [¿Qué es una prioridad de MX?](../setup/domains-faq.yml) <br/> | *\<domain-key\>*  .mail.protection.outlook.com  <br/> **Nota:** Obtener el  *\<domain-key\>*  de su cuenta de Microsoft.   [¿Cómo puedo encontrar esto?](../get-help-with-domains/information-for-dns-records.md)  
...
4. Agregue el primero de los cuatro registros CNAME.
    ...
    En el **área Agregar conjunto de** registros, en los cuadros del nuevo conjunto de registros, escriba o copie y pegue los valores de la primera fila de la tabla siguiente. 
...
6. Agregue cada uno de los otros tres registros CNAME.
    ...
    En el **área zona DNS,** seleccione **+ Conjunto de registros**. A continuación, en el conjunto de registros vacío, cree un registro mediante los valores de la siguiente fila de la tabla y, de nuevo, seleccione **Aceptar** para completar dicho registro. 
    
    Repita este proceso hasta que haya creado los cuatro registros CNAME.
    
7.  (Opcional) Agrega 2 registros CNAME para MDM.
...
4. En el **área Propiedades del conjunto de** registros, en los cuadros del nuevo conjunto de registros, seleccione los valores de la tabla siguiente. 
...
4. Agregue el primero de los dos registros SRV.
    ...
    En el **área Agregar conjunto de** registros, en los cuadros del nuevo conjunto de registros, seleccione los valores de la primera fila de la tabla siguiente. 
...
6. Agregue el otro registro SRV.
    ...
    En los cuadros del nuevo registro, escriba o copie y pegue los valores de la segunda fila de la tabla.
