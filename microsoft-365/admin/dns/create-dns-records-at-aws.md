...
1. En los cuadros para el nuevo registro, escriba o copie y pegue los valores de la tabla siguiente. 
    ...
    ||||||
    |:-----|:-----|:-----|:-----|:-----|
    |**Nombre del registro** <br/> |**Tipo de registro** <br/> |**Valor** <br/> |**TTL (segundos)** <br/> |**Directiva de enrutamiento** <br/> |
    |(Leave this field empty.)  <br/> |TXT: se usa para comprobar remitentes de correo electrónico  <br/> |MS=ms *XXXXXXXX*  <br/>**Nota:** esto es un ejemplo. Use su valor **Dirección de destino** específico aquí, de la tabla de Microsoft 365. [¿Cómo puedo encontrar esto?](../get-help-with-domains/information-for-dns-records.md) |300  <br/> |Simple  <br/> |
...
1. En el Centro de administración de Microsoft, vaya **al** Configuración \> <a href="https://go.microsoft.com/fwlink/p/?linkid=834818" target="_blank">**Domains**</a>.
...
## <a name="add-an-mx-record-so-email-for-your-domain-will-come-to-microsoft-365"></a>Agregue un registro MX para que el correo electrónico de su dominio se Microsoft 365
...
1. En los cuadros para el nuevo registro, escriba o copie y pegue los valores de la tabla siguiente. 
    ...
    |**Nombre del registro**|**Tipo de registro**|**Valor**|**TTL (segundos)**|**Directiva de enrutamiento**|
    |:-----|:-----|:-----|:-----|:-----|
    |(Deje este campo en blanco).  <br/> |MX - Registro de intercambio de correo  <br/> |0  *\<domain-key\>*  .mail.protection.outlook.com.  <br/> El 0 es el valor de prioridad MX. Agréguelo al principio del valor MX, separado del resto del valor por un espacio.  <br/> **Este valor DEBE terminar en punto (.).** <br/> **Nota:** Obtenga el \<*domain-key*\> de su cuenta Microsoft 365 usuario. [¿Cómo puedo encontrar esto?](../get-help-with-domains/information-for-dns-records.md) | 300  <br/> | Enrutamiento simple <br/> |
  
1. Seleccione **Crear registros**.
  
1. Si hay otros registros MX, quítelos seleccionando el registro y seleccionando **Eliminar**.
...
1. En los cuadros para el nuevo registro, escriba o copie y pegue los valores de la tabla siguiente. 
    ...
    |:-----|:-----|:-----|:-----|:-----|
    |autodescubrir  <br/> |CNAME: enruta el tráfico a otro nombre de dominio  <br/> | autodiscover.outlook.com.  <br/> **Este valor DEBE terminar en punto (.)** <br/> | 300  <br/> |Simple  <br/> |
  
6. Seleccione **Crear registros**.
...
1. En los cuadros para el nuevo registro, escriba o copie y pegue los valores de la tabla siguiente. 
    ...
    |**Nombre del registro**|**Tipo de registro**|**Valor**|**TTL (segundos)**|**Directiva de enrutamiento**|
    |:-----|:-----|:-----|:-----|:-----|
    |_sip._tls|SRV - Localizador de servicio|100 1 443 sipdir.online.lync.com. **Este valor DEBE terminar con un punto (.)**><br> **Nota:** recomendamos copiar y pegar esta entrada, para que todo el espacio sea correcto. | 300 |Simple|
    |_sipfederationtls._tcp|SRV - Localizador de servicio|100 1 5061 sipfed.online.lync.com. **Este valor DEBE terminar en punto (.)**<br> **Nota:** recomendamos copiar y pegar esta entrada, para que todo el espacio sea correcto.    | 300 |Simple|
  
7. Para agregar el otro registro SRV, seleccione Agregar otro **registro,** cree un registro con los valores de la siguiente fila de la tabla y, a continuación, vuelva a seleccionar **Crear registros**. 
...
1. En los cuadros para el nuevo registro, escriba o copie y pegue los valores de la tabla siguiente. 
    ...
    |**Nombre del registro**|**Tipo de registro**|**Valor**| **TTL** |**Directiva de enrutamiento**|
    |:-----|:-----|:-----|:-----|:-----|
    |sip  <br/> |CNAME - nombre canónico  <br/> |sipdir.online.lync.com.  <br/> **Este valor DEBE terminar en punto (.)** <br/> |300  <br/> |Simple  <br/> |
    |lyncdiscover  <br/> |CNAME - nombre canónico  <br/> |webdir.online.lync.com.  <br/> **Este valor DEBE terminar en punto (.)** <br/>  |300  <br/> ||Simple  <br/> |
...
1. En los cuadros para el nuevo registro, escriba o copie y pegue los valores de la tabla siguiente. 
    ...
    |**Nombre del registro**|**Tipo de registro**|**Valor**| **TTL** |**Directiva de enrutamiento**|
    |:-----|:-----|:-----|:-----|:-----|
    |enterpriseregistration  <br/> |CNAME - nombre canónico  <br/> |enterpriseregistration.windows.net.  <br/> **Este valor DEBE terminar en punto (.)** <br/> |300  <br/> |Simple  <br/> |
    |EnterpriseEnrollment  <br/> |CNAME - nombre canónico  <br/> | enterpriseenrollment-s.manage.microsoft.com.  <br/> **Este valor DEBE terminar en punto (.).** <br/>|300  <br/> | |Simple  <br/> |
