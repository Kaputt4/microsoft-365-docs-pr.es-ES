...
---
# <a name="create-dns-records-at-amazon-web-services-aws-for-office-365"></a>Crear registros DNS en Amazon Web Services (AWS) para Office 365
...
Después de agregar estos registros a AWS, su dominio estará configurado para trabajar con los servicios de Office 365.
...
5. In the **Create Record Set** area, in the boxes for the new record, type or copy and paste the values from the following table. 
    ...
    |(Leave this field empty.)  <br/> |TXT - Text  <br/> |No  <br/> |300  <br/> |MS=ms *XXXXXXXX*  <br/>**Nota:** Este es un ejemplo. Utilice aquí su valor de **Dirección o puntos de destino**, de la tabla de Office 365. [¿Cómo puedo encontrarlo?](../get-help-with-domains/information-for-dns-records.md)          |Simple  <br/> |
...
5. In the **Create Record Set** area, in the boxes for the new record, type or copy and paste the values from the following table. 
    ...
    |:-----|:-----|:-----|:-----|:-----|:-----|
    |(Deje este campo en blanco).  <br/> |MX - Registro de intercambio de correo  <br/> |No  <br/> |300  <br/> |0  *\<clave-de-dominio\>*  .mail.protection.outlook.com.  <br/> El 0 es el valor de prioridad MX. Agréguelo al principio del valor MX, separado del resto del valor por un espacio.  <br/> **Este valor DEBE terminar en punto (.).** <br/> **Nota:** Obtenga la \< *clave* \> de dominio de su cuenta de Office 365. [¿Cómo puedo encontrarla?](../get-help-with-domains/information-for-dns-records.md)          |Simple  <br/> |
...
5. En el área **Editar conjunto de registros**, al final de la entrada actual del cuadro **Valor:** del registro existente, presione ENTRAR en el teclado para crear una línea; luego, en esa línea (en el valor existente), escriba o copie y pegue el valor de la tabla siguiente (puede ver un ejemplo en la ilustración que aparece debajo de la tabla). 
    ...
    |**Valor:**|
    |:-----|
    |v=spf1 include:spf.protection.outlook.com -all  <br/> (Las comillas necesarias por las instrucciones en pantalla aparecen automáticamente. No es necesario escribirlas manualmente).  <br/> **Nota:** Se recomienda copiar y pegar esta entrada para que todo el espaciado sea correcto.           |
...
5. Agregue el primer registro SRV.
    ...
    |**Name**|**Type**|**Alias**|**TTL (segundos)**|**Valor**|**Directiva de enrutamiento**|
    |:-----|:-----|:-----|:-----|:-----|:-----|
    |_sip. _tls|SRV - Localizador de servicio|No|300|100 1 443 sipdir.online.lync.com. **Este valor debe terminar con un punto (.).**><br> **Nota:** Se recomienda copiar y pegar esta entrada para que todo el espaciado sea correcto.           |Simple|
    |_sipfederationtls. _tcp|SRV - Localizador de servicio|No|300|100 1 5061 sipfed.online.lync.com. **This value MUST end with a period (.)**<br> **Nota:** Se recomienda copiar y pegar esta entrada para que todo el espaciado sea correcto.           |Simple|
