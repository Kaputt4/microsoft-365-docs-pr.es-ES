...
3. En la **página DNS** del dominio, seleccione **Preferencias**.
...
5. In the **Add DNS Record** section, in the boxes for the new record, type or copy and paste the values from the following table. 
    ...
    |**Host**|**TTL**|**Tipo**|**Datos**|
    |:-----|:-----|:-----|:-----|
    |(Leave this field empty.)  <br/> |600  <br/> |MX  <br/> |10  *\<domain-key\>*  .mail.protection.outlook.com.  <br/> **Este valor DEBE terminar en punto (.).** <br/> El valor de **10** se corresponde con la prioridad MX. Agréguelo al principio del valor MX, separado del resto del valor por un espacio.  <br/> **Nota:** Obtener el  *\<domain-key\>*  de su cuenta de Microsoft.           [¿Cómo puedo encontrar esto?](../get-help-with-domains/information-for-dns-records.md)      <br>    Para obtener más información sobre la prioridad, consulte [¿Qué es una prioridad de MX?](../setup/domains-faq.yml) <br/> |
...
7. Agregue los otros cinco registros CNAME.
    ...
    En la sección Agregar registro **DNS,** cree un registro con los valores de la siguiente fila de la tabla y, a continuación, vuelva a seleccionar **Crear** registro para completar dicho registro. 
...
7. Agregue el otro registro SRV.
    ...
    En la sección Agregar registro **DNS,** cree un registro mediante los valores de la segunda fila de la tabla y, a continuación, vuelva a seleccionar **Crear** registro para completar dicho registro. 
