...
2. En la **página Servicios de nivel de** zona, seleccione **Dyn Standard DNS Service** para el dominio que desea editar. 
    
3. En la **página DNS** de su dominio, seleccione **Preferencias.**
    
4. Seleccione **Habilitar interfaz experta.**
...
5. In the **Add DNS Record** section, in the boxes for the new record, type or copy and paste the values from the following table. 
    ...
    |**Host**|**TTL**|**Tipo**|**Datos**|
    |:-----|:-----|:-----|:-----|
    |(Leave this field empty.)  <br/> |600  <br/> |TXT  <br/> |MS=ms *XXXXXXXX*  <br/> **Nota:** esto es un ejemplo. Utilice aquí su valor de **Dirección de destino**, desde la tabla.           [¿Cómo puedo encontrar esto?](../get-help-with-domains/information-for-dns-records.md)          |
...
5. In the **Add DNS Record** section, in the boxes for the new record, type or copy and paste the values from the following table. 
    ...
    |**Host**|**TTL**|**Tipo**|**Datos**|
    |:-----|:-----|:-----|:-----|
    |(Leave this field empty.)  <br/> |600  <br/> |MX  <br/> |10  *\<domain-key\>*  .mail.protection.outlook.com.  <br/> **Este valor DEBE terminar en punto (.).** <br/> El valor de **10** se corresponde con la prioridad MX. Agréguelo al principio del valor MX, separado del resto del valor por un espacio.  <br/> **Nota:** Obtenga su  *\<domain-key\>*  cuenta de Microsoft.           [¿Cómo puedo encontrar esto?](../get-help-with-domains/information-for-dns-records.md)      <br>    Para obtener más información sobre la prioridad, consulte [¿Qué es una prioridad de MX?](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq) <br/> |
...
5. Agregue el primero de los seis registros CNAME.
    ...
    |**Host**|**TTL**|**Tipo**|**Datos**|
    |:-----|:-----|:-----|:-----|
    |autodiscover  <br/> |600  <br/> |CNAME  <br/> |autodiscover.outlook.com.  <br/> **Este valor DEBE terminar en punto (.)** <br/> |
    |sip  <br/> |600  <br/> |CNAME  <br/> |sipdir.online.lync.com.  <br/> **Este valor DEBE terminar en punto (.)** <br/> |
    |lyncdiscover  <br/> |600  <br/> |CNAME  <br/> |webdir.online.lync.com.  <br/> **Este valor DEBE terminar en punto (.)** <br/> |
    |enterpriseregistration  <br/> |600  <br/> |CNAME  <br/> |enterpriseregistration.windows.net.  <br/> **Este valor DEBE terminar en punto (.)** <br/> |
...
7. Agregue los otros cinco registros CNAME.
    ...
    En la sección Agregar registro **DNS,** cree un registro con los valores de la siguiente fila de la tabla y, a continuación, vuelva a seleccionar **Crear** registro para completar ese registro. 
...
1. Para empezar, vaya a su página de dominios en Dyn.com a través de [este vínculo](https://account.dyn.com/dns/). You'll be prompted to login first 
...
5. Agregue el primero de los dos registros SRV.
    ...
    |**Host**|**TTL**|**Tipo**|**Datos**|
    |:-----|:-----|:-----|:-----|
    |_sip._tls|600|SRV|100 1 443 sipdir.online.lync.com. **Este valor DEBE terminar en punto (.)**<br>**Nota:** recomendamos copiar y pegar esta entrada, para que todo el espacio sea correcto.           |
    |_sipfederationtls._tcp|600|SRV|100 1 5061 sipfed.online.lync.com. **Este valor DEBE terminar en punto (.)**<br> **Nota:** recomendamos copiar y pegar esta entrada, para que todo el espacio sea correcto.           |
...
7. Agregue el otro registro SRV.
    ...
    En la sección Agregar registro **DNS,** cree un registro con los valores de la segunda fila de la tabla y, a continuación, vuelva a seleccionar **Crear** registro para completar ese registro. 
