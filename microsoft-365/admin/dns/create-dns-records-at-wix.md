...
1. En los cuadros del nuevo registro, escriba o copie y pegue los valores de la primera fila de la tabla:
   ...
   | **Servicio** | **Protocolo** | **Nombre de host** | **Grosor** | **Puerto** | **Destino** | **Prioridad** | **TTL** |
   |:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
