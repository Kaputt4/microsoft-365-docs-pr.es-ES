...
Para probar el nuevo centro de administración, cambie el botón de alternancia para <b>probar la vista previa</b>. El botón de alternancia mostrará <b>vista previa en</b>. La próxima vez que inicie sesión en el centro de administración, recordamos su selección e iniciará sesión en el nuevo centro de administración.

Para volver al uso del centro de administración anterior, active la opción alternar desde la <b>vista previa</b> a la posición desactivada. La próxima vez que inicie sesión en el centro de administración, le iniciaremos sesión en el centro de administración antiguo.
...
¿No ve sus preguntas aquí respondidas? Ve a la sección de **comentarios** en la parte inferior de esta página y formula tu pregunta. 
