---
title: 'Informes de Microsoft 365 en el centro de administración: actividad de usuario de Microsoft Teams: vista previa'
ms.author: sirkkuw
author: Sirkkuw
manager: scotv
audience: Admin
...
## <a name="how-to-get-to-the-preview-microsoft-teams-user-activity-report"></a>Cómo obtener acceso a la vista previa del informe de actividad de usuario de Microsoft Teams

1. En el centro de administración de, vaya a **Informes** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=2074756" target="_blank">página</a> uso.
2. En la lista desplegable **seleccionar un informe** , seleccione **Microsoft Teams**.
  
## <a name="interpret-the-preview-microsoft-teams-user-activity-report"></a>Interpretar la vista previa del informe de actividad de usuario de Microsoft Teams

Puede ver la actividad de usuario en el informe de vista previa de Teams eligiendo la ficha **actividad de usuario** .
