...
|---|---|---|
|Identificador de la aplicación|Identificador de aplicación externo presente en el manifiesto de la aplicación.|Yes|
|Fecha de último uso|Fecha en la que cualquiera de la organización usó esa aplicación por última vez.|Yes|
|Teams que usa esta aplicación|El número de equipos de Teams distintos que tienen al menos un usuario que usa esta aplicación.|Yes|
|Usuarios que usan esta aplicación|Número de usuarios distintos de la organización que usan esta aplicación.|Yes|
|Se usa en Windows| Esto indica si al menos un usuario de la organización ha usado esa aplicación en Windows.|Yes|
|Se usa en dispositivos móviles|Esto indica si al menos un usuario de la organización ha usado esa aplicación en mobile.|Yes|
|Se usa en la web| Esto indica si al menos un usuario de la organización ha usado esa aplicación en web.|Sí|
|Se usa en Mac|Número de reuniones ad hoc organizadas por un usuario durante el período de tiempo especificado.|No|
|Nombre de la aplicación|Nombre de esta aplicación como presente en el manifiesto de la aplicación.|No|
|Publisher|Publicador de esta aplicación como presente en el manifiesto de la aplicación. Esto solo está disponible para las aplicaciones publicadas en la Tienda global.|No|
...
Para ver la **actividad del usuario** en el informe de uso de aplicaciones de Teams, elija la pestaña **Actividad de usuario** .
...
|Métrica|Definición|¿Se incluye de forma predeterminada?|
|---|---|---|
|Nombre de usuario|Nombre de usuario de un usuario único. El valor está oculto de forma predeterminada.|Yes|
|Aplicaciones instaladas|Número de aplicaciones únicas (en la Tienda y personalizadas) que el usuario ha instalado.|Yes|
|Aplicaciones usadas|Número de aplicaciones únicas (en la Tienda y personalizadas) que el usuario ha abierto o usado.|Yes|
|Aplicaciones usadas en un equipo|Número de aplicaciones únicas (en la Tienda y personalizadas) que el usuario ha abierto o usado en un equipo de Teams.|Sí|
|Se usa en Windows| Esto indica si ese usuario ha usado alguna aplicación en Windows.|Yes|
|Se usa en dispositivos móviles|Esto indica si ese usuario ha usado alguna aplicación en Móvil (iOS o Android).|Yes|
|Se usa en la web| Esto indica si ese usuario ha usado alguna aplicación en web.|Yes|
|Se usa en Mac|Esto indica si ese usuario ha usado alguna aplicación en Mac.|No|
