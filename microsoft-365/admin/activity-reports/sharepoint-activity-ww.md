---
title: Centro de administración de Microsoft 365 SharePoint de actividad
f1.keywords:
- NOCSH
ms.author: kwekua
author: kwekua
...
Puede ver las actividades en el informe SharePoint seleccionando la **pestaña** Actividad.<br/>![Microsoft 365: informe de actividad SharePoint Microsoft.](../../media/5a0a96f-0e4f-4fb9-8baa-3262275b3d1f.png)
...
|:-----|:-----|
|**Métrica**|**Definición**|
|Nombre de usuario  <br/> |La dirección de correo electrónico del usuario que realizó la actividad en el SharePoint web.  <br/> |
