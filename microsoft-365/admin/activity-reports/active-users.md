...
|4.  <br/> | En el gráfico **usuarios activos** , el eje x muestra el período de informe seleccionado y el eje y muestra los usuarios activos diarios separados y codificados por colores por tipo de licencia.  <br/>  En el gráfico de actividad **Servicios**, en el eje X se muestran los servicios individuales habilitados para los usuarios en el período especificado y en el eje Y se muestra el número de usuarios por estado de actividad, codificados por colores según el estado de la actividad.  <br/> |
