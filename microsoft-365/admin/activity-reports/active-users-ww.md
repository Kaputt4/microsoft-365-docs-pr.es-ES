...
2. En la Página principal del panel, haga clic en el botón **Ver más** de la tarjeta usuarios activos-Microsoft 365 Services.

## <a name="interpret-the-active-users-report"></a>Interpretar el informe Usuarios activos

Puede ver los usuarios activos en el informe de Office 365 eligiendo la pestaña **usuarios activos** .<br/>![Microsoft 365 Reports: usuarios activos de Microsoft Office 365.](../../media/56fe2e54-76ad-49e5-886f-1344c2697258.png)

|||
|:-----|:-----|
|1.  <br/> |El informe **Usuarios activos** permite ver las tendencias de los últimos 7 días, 30 días, 90 días o 180 días. Sin embargo, si ve un día concreto en el informe, la tabla (7) mostrará los datos de hasta 28 días a partir de la fecha actual (no la fecha en que se generó el informe).  <br/> |
|2.  <br/> |Los datos de cada informe normalmente cubren hasta las últimas 24 a 48 horas.  <br/> |
|3.  <br/> |El gráfico **usuarios** muestra los usuarios activos diarios en el período de informes separados por producto.  <br/> El gráfico **actividad** muestra el recuento de actividades diarias en el período de informe separado por producto. <br/> El gráfico **Servicios** se muestra el número de usuarios por tipo de actividad y servicio.  <br/> |
|4.  <br/> | En el gráfico **usuarios** , el eje x muestra el período de informe seleccionado y el eje y muestra los usuarios activos diarios separados y codificados por colores por tipo de licencia.  <br/>  En el gráfico **actividad**   , el eje x muestra el período de informe seleccionado y el eje y muestra el número de actividades diarias separados y codificado con color por tipo de licencia. <br/> En el gráfico de actividad **Servicios**, en el eje X se muestran los servicios individuales habilitados para los usuarios en el período especificado y en el eje Y se muestra el número de usuarios por estado de actividad, codificados por colores según el estado de la actividad.  <br/> |
