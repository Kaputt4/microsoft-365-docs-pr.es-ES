...
|Fecha de última actividad (UTC)  <br/> | La última fecha en la que se realizó una actividad de archivo en OneDrive. Si la OneDrive no ha tenido actividad de archivos, el valor se mostrará en blanco.  <br/> |
|Archivos  <br/> |El número de archivos de OneDrive. <br/>|
...
|Almacenamiento usado (MB)  <br/> |La cantidad de almacenamiento que OneDrive usa en MB. |
|||