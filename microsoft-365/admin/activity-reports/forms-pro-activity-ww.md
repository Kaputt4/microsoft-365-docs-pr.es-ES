...
|Fecha de la última actividad (UTC)  |La fecha más reciente en la que el usuario realizó una actividad de formulario para el intervalo de fechas seleccionado. Para ver las actividades realizadas en una fecha específica, seleccione la fecha directamente en el gráfico.<br/>Esto filtrará la tabla para mostrar los datos de actividad de archivo solo para los usuarios que realizaron la actividad en ese día específico.  |
|Número de encuestas creadas  |Número de encuestas que creó el usuario.   |
|Número de respuestas a encuestas  |El número de respuestas de los respondedores a los que se distribuyó la encuesta.|
