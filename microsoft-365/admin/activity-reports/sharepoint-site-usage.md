...
1. En el centro de administración, vaya a uso de **informes** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=2074756" target="_blank"></a>.
    
2. En **archivos de SharePoint** , haga clic en **Ver más**. 

3. Junto a **actividad de SharePoint**, haga clic en la flecha hacia abajo para abrir el menú.
