...
## <a name="how-do-i-get-to-the-yammer-groups-activity-report"></a>¿Cómo se obtiene acceso al informe de actividad de grupos de Yammer?
...
Puede ver las actividades de grupos en el informe de Yammer eligiendo la pestaña **actividad de grupos** .<br/>![Microsoft 365 Reports: informe de actividad de grupos de Microsoft Yammer.](../../media/3afdafe5-9269-402e-8264-c7695ceb227d.png)

Seleccione **elegir columnas** para agregar o quitar columnas del informe.  <br/> ![Informe de actividad de grupos de Yammer: elegir columnas](../../media/54744932-34fe-48c3-9779-1d10c3f05be1.png)
...
|Administrador del grupo  <br/> |El nombre del administrador o propietario del grupo.  <br/> |
...
|Tipo  <br/> |El tipo de grupo, público o privado. <br/> |
|Conectado a Office 365  <br/> |Indica si el grupo de Yammer es también un grupo de Microsoft 365. <br/> |
|Fecha de la última actividad (UTC)  <br/> | La última fecha en la que el grupo leyó, contabilizó o gustó un mensaje.  <br/> |
|Members  <br/> | El número de miembros del grupo.  <br/> |
|Publicado  <br/> |El número de mensajes publicados en el grupo de Yammer durante el período de notificación. <br/>|
|Lectura  <br/> |El número de conversaciones leídas en el grupo de Yammer durante el período de notificación.  <br/> |
|Etiquetado como “Me gusta”  <br/> |El número de mensajes que me gusta en el grupo de Yammer durante el período de notificación. <br/>|
|Nombre de red  <br/> |El nombre completo de la red a la que pertenece el grupo. |
|||