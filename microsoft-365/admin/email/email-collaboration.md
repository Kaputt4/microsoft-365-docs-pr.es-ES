---
title: Colaboración por correo electrónico en Office 365
f1.keywords:
- NOCSH
ms.author: kwekua
author: kwekua
...
En esta tabla se explican las diversas opciones de colaboración disponibles para el usuario.
  


|**Herramienta de colaboración**|**Descripción**|
|:-----|:-----|
|Grupos en Outlook  <br/> |Un área de trabajo compartida que funciona en todas las aplicaciones de Office 365. Incluye una bandeja de entrada compartida, un calendario y un sitio de OneDrive para la Empresa para almacenar los archivos. Los usuarios pueden crear, buscar y unirse a grupos en Outlook directamente desde su correo electrónico o calendario. Los usuarios nuevos y existentes con una suscripción de Exchange Online u Office 365 pueden usar grupos en Outlook.  <br/> |
...
[Administrar grupos de distribución](https://technet.microsoft.com/library/bb124513%28v=exchg.150%29.aspx)
    
[Uso de grupos de Office 365 en lugar de buzones de sitio](https://support.office.com/article/737d6b1f-67cc-41fe-8db8-f2d09dd1673b.aspx)
    
[Crear buzones de correo compartidos en Office 365](create-a-shared-mailbox.md)
    
[Carpetas públicas en Office 365 y Exchange Online](https://technet.microsoft.com/library/jj200758%28v=exchg.150%29.aspx)
