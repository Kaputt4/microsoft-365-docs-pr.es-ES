---
title: Adición de un usuario o contacto a un grupo de distribución
f1.keywords:
- NOCSH
ms.author: kwekua
author: kwekua
...
## <a name="watch-add-a-user-to-a-distribution-list"></a>Inspección: Adición de un usuario a una lista de distribución
