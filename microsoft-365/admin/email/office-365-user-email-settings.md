...
Esta tabla explica las distintas opciones de configuración del correo electrónico que puede modificar para un usuario de Microsoft 365.


|Configuración de correo|Descripción  |
|---------|---------|
|Permisos de buzones de correo| **Leer y administrar** le permite determinar si los usuarios pueden leer y administrar buzones de correo de otras personas. También puede establecer los permisos **Enviar como** y **Enviar en nombre de** para un usuario. Para obtener más información, consulte [Conceder permisos de buzón a otro usuario en Microsoft 365: Ayuda para administradores](../add-users/give-mailbox-permissions-to-another-user.md). |
|Aplicaciones de correo electrónico| Las aplicaciones de correo electrónico le permiten elegir las aplicaciones que el usuario puede emplear para acceder a su correo de Microsoft. |
