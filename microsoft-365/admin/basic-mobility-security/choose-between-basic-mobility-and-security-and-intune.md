...
search.appverid:
- MET150
description: La movilidad básica y la seguridad forman parte de los Microsoft 365 planes.
ms.openlocfilehash: 79e5a641ad4c7c1966d1014376c9f1698caeff16
ms.sourcegitcommit: cdb90f28e59f36966f8751fa8ba352d233317fc1
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 03/09/2022
ms.locfileid: "63400383"
---
...
|Enterprise Mobility & Seguridad E3 |No|Sí|
...
|Cumplimiento de dispositivos|Establece y administra directivas de seguridad, como bloqueo de PIN de nivel de dispositivo y detección de jailbreak. |Limitaciones en dispositivos Android. Vea [los detalles](capabilities.md). |Sí|
...
|Protección de aplicaciones móviles  |Permitir que los usuarios accedan de forma segura a la información corporativa mediante las aplicaciones móviles y de línea de negocio de Office que conocen, al tiempo que garantizan la seguridad de los datos al ayudar a restringir acciones como copiar, cortar, pegar y guardar como, solo a aquellas aplicaciones administradas aprobadas para datos corporativos. Funciona incluso si los dispositivos no están inscritos en Movilidad y seguridad básicas. Consulta Proteger los datos de la aplicación mediante directivas mam. |No|Sí|
...
Las acciones remotas básicas de movilidad y seguridad incluyen retirar, borrar y borrar completamente. Para obtener más información acerca de las acciones básicas de movilidad y seguridad, consulte [Capabilities of Basic Mobility and Security](capabilities.md).
...
- [Modo perdido](/mem/intune/remote-actions/device-lost-mode)  (solo iOS)- [Examen rápido](/mem/intune/configuration/device-restrictions-windows-10#microsoft-defender-antivirus)(Windows 10 solo)
...
-  [Restablecer código de](/mem/intune/remote-actions/device-passcode-reset) [acceso Restart](/mem/intune/remote-actions/device-restart) (Windows solamente)
-  Actualizar Windows Defender inteligencia de seguridad (Windows solo)
-  Windows 10 restablecimiento de PIN (solo Windows pin)
