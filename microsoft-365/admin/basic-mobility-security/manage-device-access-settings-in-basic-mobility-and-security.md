...
Para obtener información sobre los dispositivos compatibles con la movilidad y la seguridad básica, consulte [capacidades básicas de movilidad y seguridad](capabilities-of-basic-mobility-and-secruity.md).