...
|Configurar directivas de dispositivo, como la configuración de seguridad y los requisitos de contraseña |En el panel de administración de dispositivos, seleccione **directivas de seguridad de dispositivos**   >  **Add +**. Para obtener más información, vea [crear directivas de seguridad de dispositivos en Basic Mobility and Security](create-device-security-policies.md).|
