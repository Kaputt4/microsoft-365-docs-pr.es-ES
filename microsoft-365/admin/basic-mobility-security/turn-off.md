...
## <a name="remove-user-security-groups-from-basic-mobility-and-security-device-policies"></a>Quitar grupos de seguridad de usuario de directivas de dispositivos de movilidad y seguridad básicas
