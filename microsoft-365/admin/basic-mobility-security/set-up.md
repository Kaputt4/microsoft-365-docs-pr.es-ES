...
Si no tiene un dominio personalizado asociado a Microsoft 365 o si no está administrando Windows dispositivos, puede omitir esta sección. De lo contrario, deberá agregar registros DNS para el dominio en el host DNS. Si ya ha agregado los registros, como parte de la configuración del dominio con Microsoft 365, ya está todo establecido. Después de agregar los registros, Microsoft 365 usuarios de la organización que inician sesión en su dispositivo Windows con una dirección de correo electrónico que usa el dominio personalizado se redirigen para inscribirse en Basic Mobility and Security.
...
6. En la página Crear un certificado APNs:
   ...
   - Vaya a la solicitud de firma de certificados que descargó en el equipo desde Microsoft 365 y seleccioneUpload (Cargar).
   - Download the APN certificate created by the Apple Push Certificate Portal to your computer.

     > [!TIP]
     > If you're having trouble downloading the certificate, refresh your browser.

7. Volver para Microsoft 365 y seleccione **Siguiente**.
