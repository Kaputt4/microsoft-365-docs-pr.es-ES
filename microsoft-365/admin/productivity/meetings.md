...
Para empezar con la información de reuniones, los usuarios de su organización deben tener una licencia para:
...
Las reuniones, donde las personas exploran ideas, planean, resuelven problemas y toman decisiones, son un pilar fundamental para la productividad de la organización. La investigación indica que cuando las personas usan las herramientas de reunión en línea de forma eficaz, tienden a ahorrar hasta 104 minutos por semana.

## <a name="how-we-calculate-the-meetings-score"></a>Cómo calculamos la puntuación de las reuniones

Proporcionamos una información principal sobre la experiencia que contiene las métricas clave de esta categoría. A continuación, se usa un marco de puntuación, que se detalla a continuación, para que estas métricas calculen la puntuación de la organización.
...
En el siguiente gráfico se muestran las líneas de tendencia del numerador y el denominador de la métrica clave de la información principal. En otras palabras, muestra el número de reuniones de Microsoft Teams en línea con procedimientos recomendados, como el uso compartido de vídeo o pantalla, y el número total de reuniones de Microsoft Teams en línea realizadas en los últimos 180 días. Cada punto de datos del gráfico de líneas es un agregado de actividad durante los últimos 28 días.
...
También le proporcionamos información de soporte técnico para que comprenda cómo las personas de su organización, como agregado, realizan reuniones. Estas métricas adicionales no contribuyen directamente a tu puntuación de productividad, pero pueden ayudarte a crear un plan de acción como parte de la transformación digital.

### <a name="breakdown-of-how-many-meetings-follow-best-practices"></a>Desglose de cuántas reuniones se siguen los procedimientos recomendados
...
### <a name="distribution-of-time-spent-by-people-in-meetings"></a>Distribución del tiempo invertido por las personas en reuniones
...
3. **Visualización:** Proporciona una vista de las personas de la organización en función del tiempo promedio que se pasa por semana en reuniones en los últimos 28 días. Se proporciona la siguiente información para cada categoría:
      ...
      - **Asistentes a reuniones con vídeo:** Para cada categoría, esto muestra cuántas personas de la organización estuvieron en cualquier reunión con vídeo en los últimos 28 días.
      - **Asistentes a reuniones con uso compartido de pantalla:** Para cada categoría, esto muestra cuántas personas estuvieron en una reunión que incluía el uso compartido de pantalla en los últimos 28 días.

### <a name="distribution-of-meeting-length-by-type"></a>Distribución de la longitud de reunión por tipo
...
3. **Visualización:** Muestra el tipo de reuniones a las que asisten las personas que asisten a cualquier reunión en línea Microsoft Teams reuniones. Cada tipo de reunión se representa como una barra horizontal, donde la parte coloreada y la fracción representan lo siguiente:
   ...
   - **Reunión instantánea ahora en canal**:
    ...
    - **Reuniones periódicas programadas:**
        - Numerador: el número de personas que asisten a instancias de reuniones periódicas en su calendario (programado) en los últimos 28 días
        - Denominador: el número de personas que asisten a cualquier reunión Microsoft Teams en línea en los últimos 28 días
