...
Para empezar con la información de comunicación, los usuarios de la organización deben tener una licencia para:
...
Para Comunicación, proporcionamos una información principal, que contiene las métricas clave asociadas con la comunicación en su organización, combinada con un marco de puntuación para usar estas métricas para calcular la puntuación de la organización.

### <a name="primary-insight"></a>Información principal

Microsoft 365 proporciona a los usuarios la flexibilidad para adaptarse al estilo de comunicación de todos ofreciendo varios modos. La información principal proporciona una medida de las personas de la organización que usan varios modos para comunicarse.
...
#### <a name="trend-visualization-of-primary-insight"></a>Visualización de tendencias de información principal
 ...
 Este gráfico proporciona la tendencia del numerador de la métrica clave en la información principal, es decir, el número de personas de la organización que usan más de un modo de comunicación en los últimos 180 días. Aquí que el valor diario es un agregado del número de personas que usan varias formas de comunicación en los últimos 28 días.
...
La puntuación de comunicación de la organización mide en un nivel agregado (organización) si las personas se comunican de forma coherente mediante varios modos entre correo electrónico, chat y publicaciones de la comunidad en una ventana de 28 días.
...
También le proporcionamos información que le ayuda a obtener visibilidad de cómo se comunica su organización. Estas métricas adicionales no influyen directamente en tu puntuación de productividad, pero pueden ayudarte a crear un plan de acción como parte de la transformación digital.
...
3. **Visualización:** Desglosa el uso de la característica preguntas y respuestas en su organización:
