...
2. Busque la factura que desee, seleccione para ver o elija descargar el PDF.
  ...
  - Para solicitar un Fapiao, seleccione **Obtener Fapiaos**.
    ...
    > [!NOTE]
    > Necesita una cuenta registrada para tener acceso al [sistema de administración de fapiao.](https://go.microsoft.com/fwlink/p/?linkid=837465) Si aún no ha configurado una cuenta, vea Solicitar un [Fapiao para Office 365 operado por 21Vianet.](apply-for-a-fapiao.md)