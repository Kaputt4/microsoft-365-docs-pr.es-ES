...
**¿No es una empresa?** [Regístrese para un plan familiar o de hogar](https://go.microsoft.com/fwlink/?linkid=2109398).
...
3. ¿Qué necesita tener en cuenta sobre la propiedad de los datos y los derechos de propiedad intelectual?

Consulte la tabla siguiente para ver las opciones de registro y los servicios que se aplicarán a su selección.
...
Si decide usar un dominio que ya posee, puede usarlo para su dirección de correo electrónico con Microsoft 365. Como parte del proceso de registro, le pedimos que compruebe el dominio por motivos de seguridad y que proteja contra actividades fraudulentas.

### <a name="how-does-recurring-billing-work"></a>¿Cómo funciona la facturación periódica?

Cuando la facturación periódica está activada, la suscripción se seguirá facturando cada mes (o año, en función de su plan de facturación) el día en que se suscribió. Puede desactivar o volver a activar esta opción en el centro de administración mientras su suscripción esté activa. Obtenga más información en [Activar o desactivar la facturación periódica](../../commerce/subscriptions/renew-your-subscription.md#turn-recurring-billing-off-or-on).
