---
title: Adición de un nuevo empleado a Microsoft 365
f1.keywords:
- NOCSH
ms.author: efrene
author: efrene
...
Este artículo le ayuda a incorporar un nuevo empleado a Microsoft 365 para empresas. Suponemos que es un Administración y que ya [ha completado la configuración de Microsoft 365](../setup/setup.md) y ahora tiene alguien nuevo que se une a su empresa.
  
Está en el lugar correcto si el nuevo empleado necesita Microsoft 365 y usa un [plan de Microsoft 365](https://products.office.com/business/compare-office-365-for-business-plans) que le permite instalar aplicaciones de Office como Word y Excel en un equipo. 
...
|[Paso 2: Dar al empleado su id. de usuario y contraseña](#step-2-give-the-employee-their-user-id-and-password) <br/> |Al crear una cuenta, obtendrá un identificador y una contraseña que puede pasar a su empleado para que pueda iniciar sesión.  <br/> |
...
|[Paso 4: Ayudar a su empleado a empezar](#step-4-help-your-employee-get-started) <br/> |Deje que el empleado sepa cómo usar OneDrive o cualquier sitio de equipo de su organización.  <br/> |
...
## <a name="step-2-give-the-employee-their-user-id-and-password"></a>Paso 2: Dar al empleado su id. de usuario y contraseña


A menos que lo envíe a su dirección de correo electrónico personal, imprima el nombre y la contraseña de inicio de sesión del empleado y páselo. O diles la información por teléfono.
...
Al igual que Facebook, Amazon o Gmail, el empleado inicia sesión para usar Microsoft 365. Proporciónele la siguiente información de inicio de sesión:
  
- Inicie sesión en [https://www.office.com](https://www.office.com).
    
- Seleccione **Iniciar sesión** y escriba el identificador de usuario y la contraseña.
    
## <a name="step-4-help-your-employee-get-started"></a>Paso 4: Ayudar a su empleado a empezar


Comparta con ellos la [configuración rápida del empleado para que Microsoft 365](../setup/employee-quick-setup.md) inicie sesión, instale software, configure el correo electrónico y mucho más. 
...
|Complete el aprendizaje sobre SharePoint Online para ayudarle a colaborar con compañeros de trabajo y compartir contenidos.  <br/> |El mejor lugar para guardar los documentos a los que también tendrán acceso sus compañeros de trabajo es SharePoint Online.  <br/> <br/>**Aprendizaje:** [Vídeo: Colaborar con contenidos de equipos con SharePoint Online](https://support.microsoft.com/office/c17b6824-cc22-478f-8757-497cc6b57121) <br/><br/> **Descúbralo:** ¿Cómo usa su organización SharePoint Online y qué tipo de documentos se almacenan allí? Además, qué documentos se almacenan en OneDrive para la Empresa.  <br/> |

## <a name="related-content"></a>Contenido relacionado

[Eliminación de un antiguo empleado de Microsoft 365](remove-former-employee.md) (artículo)\
