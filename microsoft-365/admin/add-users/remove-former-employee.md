...
En una hora, o después de dejar la página de Microsoft 365 actual en la que se encuentra, se le pide que vuelva a iniciar sesión. Un token de acceso es válido durante una hora, por lo que la escala de tiempo depende de la cantidad de tiempo que quede en ese token y de si se desplaza fuera de su página web actual.
  
> [!IMPORTANT]
> Si el usuario está en Outlook en la web, sólo tiene que hacer clic en su buzón de correo, es posible que no se expongan inmediatamente. En cuanto Seleccione un icono diferente, como OneDrive, o actualice el explorador, se iniciará el cierre de sesión.
...
|1. [Guardar el contenido del buzón de un antiguo empleado](#save-the-contents-of-a-former-employees-mailbox) <br/> |Esto es útil para la persona que se va a ocupar del trabajo del empleado o si hay litigios.  <br/> |
...
Si su antiguo empleado tenía un teléfono de la organización, puede usar el centro de administración de Exchange para eliminar y bloquear ese dispositivo de modo que todos los datos de la organización se quiten del dispositivo y ya no puedan conectarse a Office 365.
...
4. En la página **detalles del dispositivo móvil** , en **dispositivos móviles**, seleccione el dispositivo móvil, seleccione barrido de borrado de **datos** ![ y, ](../../media/1c113a36-53cb-4974-884f-3ecd9535506e.png) a continuación, seleccione **bloquear**.
5. Seleccione **Guardar**.
   > [!TIP]
...
3. Desactive las casillas de las licencias que desee quitar y, a continuación, seleccione **Guardar cambios**.
...
::: moniker range="o365-worldwide"
1. En el centro de administración, vaya a la página **facturación** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=842054" target="_blank">de productos</a> y seleccione la pestaña **productos** .
2. Seleccione la suscripción de la que desea quitar licencias.
3. En la página detalles, seleccione **quitar licencias**.
4. En el panel **quitar licencias** , en nueva cantidad, en el cuadro **licencias totales** , escriba el número total de licencias que desea para esta suscripción. Por ejemplo, si tiene 25 licencias y desea quitar una de ellas, escriba 24.
5. Seleccione **Guardar**.
::: moniker-end
...
Al [Agregar a otra persona](add-users.md) a su empresa, se le pedirá que compre una licencia al mismo tiempo, con un solo paso.
...
Para obtener información sobre cómo eliminar y restaurar una cuenta de usuario en Active Directory, consulte [eliminar una cuenta de usuario](https://go.microsoft.com/fwlink/?linkid=841808).
  
Si está usando Azure Active Directory, consulte el cmdlet de PowerShell [Remove-MsolUser](https://go.microsoft.com/fwlink/?linkid=842230) .
...
Las operaciones anteriores pueden realizarse en tres lugares:
