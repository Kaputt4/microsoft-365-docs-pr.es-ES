...
4. Seleccione el nombre del usuario para ir al  panel de propiedades y, en la pestaña Cuenta, seleccione **Iniciar inicio de sesión.**
...
> [!NOTE]
> Debe ser un administrador global para iniciar el inicio de sesión.

En una hora , o después de salir de la página actual de Microsoft 365 en la que están, se les pedirá que vuelvan a iniciar sesión. Un token de acceso es bueno durante una hora, por lo que la escala de tiempo depende de cuánto tiempo queda en ese token y de si sale de su página web actual.
  
> [!IMPORTANT]
> Si el usuario está en Outlook en la Web, simplemente haciendo clic en su buzón, es posible que no se le eche inmediatamente. Tan pronto como seleccionan un icono diferente, como OneDrive, o actualizan su explorador, se inicia la sesión.
...
> [!NOTE]
> Si es un administrador global, puede eliminar al empleado, reenviar su correo electrónico, elegir qué hacer con su contenido de OneDrive con la nueva experiencia guiada. Para obtener más información, [vea Administrador global: Eliminar un usuario.](remove-former-employee.md) Sin embargo, te recomendamos que completes todos los pasos adicionales que se indican aquí para asegurarte de que el empleado no tenga acceso a los datos de tu empresa. 
...
2. Aplique una retención por juicio o una conservación local al buzón de correo antes de eliminar la cuenta del usuario. Esto es mucho más complicado que la primera opción, pero vale la pena hacerlo si su plan Enterprise incluye archivado y retención legal, si los litigios son una posibilidad o si tiene un departamento informático potente a nivel técnico.
    ...
    Para obtener información sobre cómo colocar una retención en un buzón, consulte Administrar buzones [inactivos en Exchange Online.](https://docs.microsoft.com/microsoft-365/compliance/create-and-manage-inactive-mailboxes)
...
3. Junto al **reenvío de correo electrónico,** **seleccione Editar**.
...
Si su antiguo empleado tenía un teléfono de la organización, puede usar el Centro de administración de Exchange para borrar y bloquear ese dispositivo de modo que todos los datos de la organización se quiten del dispositivo y ya no se puedan conectar a Office 365.
...
## <a name="block-a-former-employees-access-to-microsoft-365-data"></a>Bloquear el acceso de un antiguo empleado a los datos de Microsoft 365
...
1. En el centro de administración, vaya a la página **Usuarios** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=834822" target="_blank">Usuarios activos</a>.
2. Seleccione el nombre del empleado que desea bloquear y, debajo del nombre del usuario, seleccione el símbolo para Bloquear **a este usuario.**
...
Si tiene correo electrónico como parte de su suscripción a Microsoft 365, debe iniciar sesión en el Centro de administración de Exchange para seguir estos pasos para impedir que el antiguo empleado acceda a su correo electrónico.
  
1. Vaya al <a href="https://go.microsoft.com/fwlink/p/?linkid=2059104" target="_blank">Centro de administración de Exchange</a>.
2. En el Centro de administración de Exchange, vaya a **Destinatarios** \> **Buzones**.
3. Haga doble clic en el usuario y vaya a la página **características del buzón.** En **Dispositivos móviles,** seleccione **Deshabilitar Exchange ActiveSync** **OWA** para dispositivos y responda Sí a ambos cuando se le solicite. 
4. En **Conectividad de correo** electrónico, seleccione **Deshabilitar** y responda **Sí** cuando se le pida.
...
**Para reducir el número de licencias por las** que paga hasta que contrate a otra persona, siga estos pasos:
...
## <a name="set-up-call-forwarding-to-people-in-your-organization"></a>Configurar el reenvío de llamadas a personas de su organización

Si necesita configurar el reenvío de llamadas para el número de teléfono del empleado que ha terminado, la configuración de reenvío de llamadas en las directivas de llamada puede configurar el reenvío donde las llamadas entrantes se pueden reenviar a otros usuarios o puede llamar a otra persona al mismo tiempo. Para obtener más información, vea [Directivas de llamadas en Microsoft Teams.](https://docs.microsoft.com/microsoftteams/teams-calling-policy)
...
3. En el nombre del usuario, seleccione el símbolo para **Eliminar usuario**. Elija las opciones que desee para este usuario y, a continuación, **seleccione Eliminar usuario.**
...
Si su organización sincroniza cuentas de usuario con Microsoft 365 desde un entorno local de Active Directory, debe eliminar y restaurar esas cuentas de usuario en el servicio local de Active Directory. No puede suprimirlas ni restaurarlas en Office 365.
  
Para obtener información sobre cómo eliminar y restaurar una cuenta de usuario en Active Directory, vea [Eliminar una cuenta de usuario.](https://go.microsoft.com/fwlink/?linkid=841808)
  
Si usa Azure Active Directory, consulte el cmdlet [remove-MsolUser](https://go.microsoft.com/fwlink/?linkid=842230) de PowerShell.
