...
- Si configura el reenvío de correo electrónico, solo se enviarán nuevos *correos* electrónicos al antiguo empleado.

Siga estos pasos sobre cómo convertir el buzón del usuario [en un buzón compartido.](../email/convert-user-mailbox-to-shared-mailbox.md)
