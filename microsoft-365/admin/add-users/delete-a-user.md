...
## <a name="global-admin-delete-a-user-stop-paying-for-their-license-and-choose-what-to-do-with-their-email-and-onedrive-content"></a>Administrador global: eliminar un usuario, dejar de pagar su licencia y elegir qué hacer con su correo electrónico y contenido de OneDrive
...
Antes de empezar, piense en lo que desea hacer con el correo electrónico del usuario y el contenido de OneDrive, y si desea mantener la licencia o dejar de pagar por ella.
...
|Contenido de OneDrive  <br/> |Si el usuario guardó sus archivos en OneDrive, puede dar a otro usuario acceso a estos archivos.  <br/><br/> Tendrás que mover los archivos que quieras conservar dentro del período de retención establecido para los archivos de OneDrive. **De forma predeterminada, el período de retención es de 30 días.** Si no mueve los archivos dentro del período de retención después de eliminar al usuario, el contenido de OneDrive se eliminará permanentemente. Para aumentar el número de días que conserva archivos de OneDrive para cuentas eliminadas, vea Establecer la retención de [OneDrive para usuarios eliminados.](/onedrive/set-retention)  <br/><br/> **¡Importante!** Si el usuario eliminado usaba un equipo personal para descargar archivos de SharePoint y OneDrive, no hay manera de borrar los archivos que almacenaban en su equipo. Seguirán teniendo acceso a los archivos que se sincronizaron desde OneDrive.           |
...
## <a name="user-management-admin-delete-one-or-more-users-from-office-365"></a>Administrador de administración de usuarios: eliminar uno o varios usuarios de Office 365
...
Consulte el cmdlet [Remove-MsolUser](https://docs.microsoft.com/powershell/module/msonline/remove-msoluser) PowerShell.
...
- **No tiene los permisos adecuados para eliminar un usuario**. Solo las personas que son administradores globales de [Microsoft 365](about-admin-roles.md) o administradores de administración de usuarios pueden eliminar usuarios. Normalmente se trata del soporte técnico de su escuela o empresa.
