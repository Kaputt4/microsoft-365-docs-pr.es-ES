---
title: 'Paso 4: Reenviar el correo electrónico de un antiguo empleado a otro empleado o convertirlo en un buzón compartido'
f1.keywords:
- NOCSH
ms.author: kwekua
author: kwekua
...
En este paso, asignará la dirección de correo electrónico del empleado anterior a otro empleado o convertirá el buzón del usuario en un buzón compartido.

## <a name="convert-former-employees-mailbox-to-a-shared-mailbox"></a>Convertir el buzón de correo de un antiguo empleado en un buzón compartido
...
## <a name="forward-a-former-employees-email-to-another-employee"></a>Reenviar el correo electrónico de un ex empleado a otro empleado

 > [!IMPORTANT]
 > Si va a configurar el reenvío de correo electrónico o un buzón compartido, al final, no elimine la cuenta del empleado anterior. Debe conservar la cuenta, puesto que se usa para anclar el reenvío de correo electrónico o el buzón compartido.
...
Si la persona tenía reuniones que reservaban equipos o salas, no estarán disponibles para reservarse hasta que se cancelen esas reuniones. Lea [Eliminar una cita o una reunión](https://support.microsoft.com/office/delete-an-appointment-or-a-meeting-2703bfdb-9a07-4396-be3b-a9f79438455b) para conocer los pasos.
...
[Administrar los elementos de correo y calendario de otra persona](https://support.microsoft.com/office/manage-another-person-s-mail-and-calendar-items-afb79d6b-2967-43b9-a944-a6b953190af5)
