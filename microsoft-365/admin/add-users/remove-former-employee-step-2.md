---
title: 'Paso 2: Guardar el contenido del buzón de un empleado anterior'
f1.keywords:
- NOCSH
ms.author: kwekua
author: kwekua
...
En este paso, coloque una suspensión por juicio o una suspensión local en el usuario o exporte sus datos de Outlook a un archivo .pst.

## <a name="place-hold-or-export-users-data-to-a-pst-file"></a>Mantener o exportar los datos del usuario a un archivo .pst
