...
ms.locfileid: "62765389"
---
# <a name="let-users-reset-their-own-passwords"></a>Permitir que los usuarios puedan restablecer sus propias contraseñas

Como administrador Microsoft 365, puede permitir que las personas usen la herramienta de restablecimiento [](https://go.microsoft.com/fwlink/p/?LinkId=522677) de contraseñas sin servicio para que no tenga que restablecer contraseñas para ellas. Así no tendrá tanto trabajo.
...
1. En el Centro de administración de Microsoft 365, en el panel de navegación izquierdo,  >  seleccione Configuración **Org y**, a continuación, <a href="https://go.microsoft.com/fwlink/p/?linkid=2072756" target="_blank">**Seguridad & privacidad**</a>.
...
- El restablecimiento de contraseñas autoservicio para los usuarios de  la nube es gratuito Microsoft 365 plan de pago para empresas, educación o organizaciones sin ánimo de lucro. No funciona con la Microsoft 365 prueba.
...
1. En el <a href="https://go.microsoft.com/fwlink/p/?linkid=2024339" target="_blank">Centro de administración</a>, vaya a la **página Configuración** >  **Configuración deorg**.
...
4. En **Autoservicio de restablecimiento de contraseña**, seleccione **Ir a Azure Portal para activar el restablecimiento de contraseñas de autoservicio**.
