...
1. En la navegación izquierda, elija Mostrar **todos** >  **los Configuración** >  <a href="https://go.microsoft.com/fwlink/p/?linkid=834818" target="_blank">**Dominios**</a>.
1. A continuación, elija el dominio predeterminado.
1. Seleccione **Continuar la instalación** y, a continuación, para conectar el dominio, elija  **Continuar**.
