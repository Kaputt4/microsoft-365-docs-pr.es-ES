...
Cuando pases a Microsoft 365 para empresas, querrás migrar los archivos desde Google Drive. Puedes usar la aplicación Mover para mover archivos de unidades personales y compartidas. Para obtener más información, consulte [Mover Cloud Migration](/sharepointmigration/mover-plan-migration).
...
1. Elige **AppsGoogle** >  **Workspace Marketplace appsAdd** >  **app to Domain Install list**.

1. Busque Mover y selecciónelo.

1. Elija **Instalación de dominio** y **, a continuación, Continuar**.

1. Revise los permisos, active la casilla para aceptar los términos, luego seleccione **Permitir**, elija **Siguiente** y, a continuación, **Listo**.

### <a name="create-connectors-and-run-the-migration"></a>Crear conectores y ejecutar la migración

1. Vuelve a las **aplicaciones de Google Workspace Marketplace**.
...
1. Selecciona **Autorizar nuevo conector**, **busca G Suite (administrador)** y elige **Autorizar**.
...
1. Elija **Continuar la configuración de migración**, **Agregar usuarios** y, a continuación, **Detectar y agregar usuarios automáticamente**.
...
1. Una vez que el archivo CSV esté listo, seleccione **Acciones de migración**, **Agregar** a la migración, **Elegir un archivo para cargar**.
