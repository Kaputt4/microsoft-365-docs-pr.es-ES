...
Los usuarios pueden encontrarse por nombre para mostrar, apellidos, nombre, nombre de usuario, dirección de correo electrónico principal o alias de correo electrónico. Seleccione la edición del nombre del usuario para editar los detalles del usuario.
...
Si selecciona el menú "Más acciones" junto a su nombre, puede restablecer su contraseña.
...
**Sugerencias para mejorar los resultados de la búsqueda de usuarios**

- Asegúrese de escribir los nombres de los usuarios correctamente, ya que las búsquedas de usuario coinciden exactamente con las propiedades mencionadas anteriormente. Por ejemplo, en el ejemplo anterior, Jus o Malz funcionarán, pero un error ortográfico como, por ejemplo, Jostin en lugar de Él no encontrará a este usuario.
- Para obtener una coincidencia exacta, busque por dirección de correo electrónico principal o nombre de usuario.

## <a name="groups"></a>Grupos

Puede buscar grupos por nombre de grupo o dirección de correo electrónico del grupo. Puede seleccionar el grupo y editarlo desde cualquier página.
...
**Sugerencias para mejorar los resultados de la búsqueda en grupo**

Asegúrate de escribir el nombre del grupo correctamente.
...
Los resultados proporcionan una forma de navegar rápidamente a una página específica en el centro de administración. Por ejemplo, la búsqueda de RBAC le llevará a la página Roles para los roles de Azure AD.
