...
> [!IMPORTANT]
> Si tiene problemas con el uso de la aplicación móvil de administración en iOS o Android, envíenos un correo electrónico a [feedback365@microsoft.com](mailto:feedback365@microsoft.com) para que podamos saberlo. 
...
Debe tener una suscripción válida de Microsoft 365 apps for Business o Microsoft 365 Business Premium con privilegios de administrador para iniciar sesión y usar la aplicación. La aplicación móvil de administración no es un cliente de correo electrónico. Se trata de una aplicación administrativa enriquecida con más de 80 características que le ayudarán a dar soporte a su organización mientras está de viaje.
  
### <a name="can-i-use-the-app-with-my-microsoft-365-family-subscription"></a>¿Puedo usar la aplicación con mi suscripción a la familia 365 de Microsoft?

No, la aplicación solo funciona con las suscripciones de Microsoft 365 apps for Business y Microsoft 365 Business Premium. 
...
Sí, pero con funcionalidad reducida. Podrá iniciar sesión y ver la información del servicio, pero la mayoría de las funciones de administración de usuarios serán de solo lectura. No podrá agregar, editar o eliminar usuarios. Sin embargo, podrá asignar licencias a los usuarios de su organización y recibir notificaciones.
  
### <a name="what-languages-are-supported-by-the-app"></a>¿Qué idiomas son compatibles con la aplicación?

La aplicación admite todos los idiomas 39 que admite el centro de administración de Microsoft 365 basado en Web. 
...
3. Si esto no funciona, puede enviarnos un correo electrónico a [feedback365@microsoft.com](mailto:feedback365@microsoft.com) para que nos informemos.
