...
La aplicación de administración tiene muchas funcionalidades que te permitirán administrar Microsoft 365 desde tu dispositivo móvil o tableta, cuando no puedas llegar a un equipo. Esta es una lista de algunas de las tareas que puedes hacer desde la aplicación:

- **Administrar usuarios y dispositivos** Agregar o editar un usuario, restablecer la contraseña de un usuario, asignar un rol, bloquear usuario, eliminar usuario, administrar alias, asignar licencias, borrar datos del dispositivo y mucho más.
- **Administrar grupos** Agregar un grupo, agregar o quitar usuarios de grupos.
...
- **Soporte técnico** Cree una nueva solicitud de servicio y realice un seguimiento de todas las actualizaciones relacionadas con las solicitudes de servicio mientras está en marcha.
- **Centro de mensajes** Manténgase al tanto de todos los próximos cambios, el mantenimiento planeado u otros anuncios importantes relacionados con Microsoft 365
...
Sí, pero con funcionalidad reducida. Podrá iniciar sesión y ver la información del servicio, pero la mayoría de las funciones de administración de usuario serán de solo lectura. No podrá agregar, editar ni eliminar usuarios. Sin embargo, podrá asignar licencias a los usuarios de su organización y recibir notificaciones.
...
Si selecciona un incidente de servicio específico o un mensaje, la opción compartir estará en la esquina superior derecha.
...
### <a name="im-unable-to-login-or-my-app-is-acting-funny-what-can-i-do-to-troubleshoot-or-fix-the-issue"></a>No puedo iniciar sesión o mi aplicación actúa de forma divertida. ¿Qué puedo hacer para solucionar el problema o solucionarlo?
...
En el menú de navegación izquierdo, ve **a Configuración**  >  **Notificaciones**. Puedes administrar el estado del servicio, el centro de mensajes y las notificaciones de facturación aquí.
