...
- **Un nombre de inicio de sesión (id. de usuario):** Este identificador de usuario se convierte en la dirección de correo electrónico inicial de Microsoft 365, solo para empezar rápidamente.
