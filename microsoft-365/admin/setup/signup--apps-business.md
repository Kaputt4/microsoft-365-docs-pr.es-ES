...
ms.openlocfilehash: 42becb616353c6d5392f978c255df247f01916cb
ms.sourcegitcommit: 181a0aff54842dcbafd834647c6e9ee47304d10f
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 10/27/2022
ms.locfileid: "68734063"
---
...
¿Desea registrarse para obtener una suscripción Aplicaciones Microsoft 365 para negocios?

Hay un par de maneras de empezar:

- **[Compre](https://go.microsoft.com/fwlink/?linkid=2181424) Aplicaciones Microsoft 365 para negocios y complete su propia configuración**. Para comprar Aplicaciones Microsoft 365 para negocios, [siga estos pasos](#sign-up-steps).
...
- [Regístrese para un plan familiar o de hogar](https://go.microsoft.com/fwlink/?linkid=2109398) si no está comprando para una empresa.
...
2. En la página **Ha seleccionado Aplicaciones Microsoft 365 para negocios**, escriba una dirección de correo electrónico que ya use. Puede ser cualquier dirección que quiera que Microsoft use para comunicarse con usted durante la instalación. También es la dirección donde le enviaremos información sobre la factura y las renovaciones. A continuación, seleccione **Configurar cuenta**.
3. Escriba el nombre, el número de teléfono de la empresa, el tamaño de la empresa, el nombre de la empresa y la ubicación. Seleccione **Siguiente**.
...
5. Decida cómo iniciar sesión en Microsoft 365. Puede [iniciar sesión con su correo electrónico personal actual](#option-1-sign-in-with-your-outlook-hotmail-yahoo-gmail-or-other-email-account) o [crear una nueva cuenta](#option-2-add-a-domain) agregando un dominio.

## <a name="choosing-the-right-business-subscription"></a>Elección de la suscripción empresarial adecuada

Al registrarse para Aplicaciones Microsoft 365 para empresas, tiene dos opciones para empezar. Evalúe tres factores clave para elegir cuál se ajusta mejor a sus necesidades:
...
Esto se aplica a Microsoft 365 Empresa Estándar y Aplicaciones Microsoft 365 para empresas. Iniciará sesión en Microsoft 365 con esta dirección de correo electrónico. Por ejemplo, alliebellew@hotmail.com.
...
2. Seleccione cuántas licencias de Aplicaciones Microsoft 365 para negocios desea para su organización y seleccione **Agregar método de pago** y continuar con la compra en **Realizar pedido**.
...
Recuerde que esta opción no proporciona correo electrónico de marca, control de administración para el uso de los servicios por parte de otros usuarios ni soporte técnico de cumplimiento específico del sector. Los suscriptores no tienen acceso ni control sobre el uso o los documentos de otros usuarios (empleados) bajo esta opción. Los usuarios pueden optar por no transferir los datos creados en el almacenamiento, como OneDrive, a la cuenta de dominio de nivel empresarial actualizada si no elige **la opción 2**.

<!--This option isn't recommended for larger businesses, including specialty industries such as healthcare or legal.-->

Puede agregar un dominio empresarial en cualquier punto para acceder al resto de la funcionalidad de la suscripción de Aplicaciones para empresas, entre las que se incluyen:

- Programación de citas de Bookings y grabaciones de reuniones
- Almacenamiento de documentos compartido con OneDrive

Siga estos pasos para [finalizar la configuración de](setup-apps-for-business.md) la suscripción de Aplicaciones Microsoft 365 para negocios. También puede [agregar un dominio](../setup/add-domain.md) cuando esté listo.
...
Si anteriormente usó el modo de registro simplificado para comprar una suscripción empresarial en octubre de 2021 sin un dominio empresarial, es posible que tenga que aceptar nuevos términos de servicio para el servicio ininterrumpido y el uso de las aplicaciones de Microsoft Office. Es posible que se te envíen correos electrónicos o que veas mensajes desde la aplicación al iniciar sesión en el Centro de administración de Microsoft 365.

Los términos de uso simplificados Sign-Up se han actualizado recientemente y, en particular, aclaran las licencias y la propiedad de los datos para las suscripciones empresariales de varios usuarios. Para continuar con el servicio de su suscripción empresarial, puede visitar el Centro de administración de Microsoft 365 y seguir usando el **registro simplificado** (y aceptar el uso de los términos complementarios actualizados del Contrato de servicios de Microsoft), o bien visitar el Centro de administración y **agregar un dominio** (y usar el Contrato de servicios en línea de Microsoft de nivel empresarial). Para ayudarle a elegir cuál de estos dos modos se adapta mejor a sus necesidades, consulte la tabla de la parte superior de este artículo.
...
- Microsoft 365 Empresa Básico, Aplicaciones Microsoft 365 para negocios, Microsoft 365 Empresa Estándar y Microsoft 365 Empresa Premium  los planes están disponibles para el pago mensual del compromiso o el pago de compromiso anual.
