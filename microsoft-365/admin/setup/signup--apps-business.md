...
4. Ayúdenos a asegurarse de que es usted. Escriba un número que podamos usar para llegar a usted y seleccione **Enviar código de verificación**. Recibirá un texto. Escriba el código y seleccione **Comprobar**.
