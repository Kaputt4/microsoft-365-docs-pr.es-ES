...
¿Es nuevo en Microsoft 365 para empresas? :::image type="icon" source="../../media/video-call-icon.png" border="false":::[Vea este vídeo: ¿Qué es Microsoft 365?](../admin-overview/what-is-microsoft-365.md) para obtener información al respecto. Después, siga estos pasos.
...
## <a name="2-download-and-install-office-apps"></a>2. Descargar e instalar aplicaciones Office
...
## <a name="4-save-or-copy-files-to-onedrive"></a>4. Guarde o copie archivos en OneDrive

- Guarde los documentos para **OneDrive** desde el menú **Guardar como** en Office aplicaciones.
    :::image type="content" source="../../media/save-onedrive.png" alt-text="Imge que quién es cómo guardar como para OneDrive.":::
...
- O copie archivos desde el Escritorio o Documentos a **OneDrive**.
    ...
    > [!TIP]
    > También puede almacenar archivos en [sitios](https://support.microsoft.com/office/d18d21a0-1f9f-4f6c-ac45-d52afa0a4a2e) en Microsoft 365.
...
- Obtén **Outlook** en tu teléfono desde App Store o Google Play Store. Ábralo, elija **Introducción** y agregue su correo electrónico y contraseña.
...
- En un **Windows Phone**, elija **Configuración**, **Correo electrónico y cuentas**, **Agregar una cuenta** y, a continuación, **Exchange**.