...
ms.locfileid: "61521449"
---
# <a name="employee-quick-setup"></a>Configuración rápida para empleados

¿Es nuevo en Microsoft 365 para empresas? :::image type="icon" source="../../media/video-call-icon.png" border="false":::[Vea este vídeo: ¿qué Microsoft 365?](../admin-overview/what-is-microsoft-365.md) para obtener información sobre él. Después, siga estos pasos.
...
1. Escriba su Microsoft 365 correo electrónico y contraseña y, a continuación, **inicie sesión**.

## <a name="2-download-and-install-office-apps"></a>2. Descargar e instalar Office aplicaciones
...
- Guarde documentos para **OneDrive** desde el **menú Guardar como** en Office aplicaciones.
...
- O copie archivos desde el Escritorio o Documentos a **OneDrive**.
    ...
    > [!TIP]
    > También puede almacenar archivos en [sitios en](https://support.microsoft.com/office/d18d21a0-1f9f-4f6c-ac45-d52afa0a4a2e) Microsoft 365.
...
- Obtén **Outlook** en el teléfono desde la Tienda de aplicaciones o la Tienda Google Play. Ábralo y elija **Introducción** y agregue su correo electrónico y contraseña.
