...
Si no completa el asistente para la instalación, puede completar las tareas de configuración en cualquier momento desde [el centro de administraciónSetup](https://go.microsoft.com/fwlink/p/?linkid=2024339) > . Desde aquí puede migrar el correo electrónico y los contactos desde otro servicio de correo electrónico, cambiar el dominio de su cuenta de administrador, administrar la información de facturación, agregar o quitar usuarios, restablecer contraseñas y realizar otras funciones empresariales. Para obtener más información acerca de las diferencias entre el asistente  para la instalación y la página Configuración, vea Diferencias entre el asistente para Microsoft 365 [configuración y la página Configuración](o365-setup-wizard-and-setup-page.md).
...
- **¿Desea pasar a Microsoft 365 gradualmente?** Si desea pasar a Microsoft 365 fases, omita la ejecución del asistente de configuración de Microsoft 365 y considere la posibilidad de adoptar Microsoft 365 características en el siguiente orden:
    ...
    5. Cuando esté listo, en el Centro de [administración, seleccione](https://go.microsoft.com/fwlink/p/?linkid=2024339) Configurar  en el panel de navegación izquierdo y use la página  Configuración para [mover el dominio y el correo electrónico](add-domain.md).
...
- **Si tiene menos de 50 empleados:**
  ...
  - **Llama [Microsoft 365 soporte técnico para empresas](../../business-video/get-help-support.md) con tus preguntas**. ¡Estamos aquí para ayudarle! 
