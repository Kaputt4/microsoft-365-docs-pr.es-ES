...
A veces no puede agregar un dominio a la cuenta de la organización porque otra persona ya se ha registrado para Microsoft 365 una dirección de correo electrónico asociada con ese nombre de dominio. Pero puede quitar el dominio de la otra cuenta no administrada y agregarlo a la cuenta de la organización.
...
1. Vaya a la Centro de administración de Microsoft 365 > **Configuración**  >  **Dominios**  >  **+ Agregar dominio** y agregue el nombre de dominio.
...
1. Vaya a **Usuarios** usuarios activos para la cuenta con la que se unió en el paso 2 y, a continuación, seleccione el nombre para mostrar para el nombre de usuario con el que ha  >   iniciado sesión.

1. En **Nombre de** usuario, seleccione **Administrar** nombre de usuario y mueva el usuario al dominio de onmicrosoft seleccionando el onmicrosoft.com de la lista desplegable.

1. Cerrar sesión de la cuenta y volver a iniciar sesión con el nuevo `username@account.onmicrosoft.com` .

1. Seleccione **Configuración**, busque el dominio que desea agregar a la otra  >  cuenta y seleccione **Quitar dominio**.
...
1. Seleccione **Configuración** Dominios + Agregar dominio y, a continuación, escriba el nombre de dominio para continuar con los pasos del asistente para comprobar la propiedad del dominio en esta cuenta y completar la adición del dominio a su  >    >  cuenta.
