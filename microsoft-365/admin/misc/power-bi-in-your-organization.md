...
> [!IMPORTANT]
> Para obtener más información y orientación sobre la administración de los inquilinos, vea [¿Qué es la administración de Power BI?](https://docs.microsoft.com/power-bi/service-admin-administering-power-bi-in-your-organization).
...
Si un usuario se registró para Power BI, pero ya no desea que tenga acceso a Power BI, puede quitar la licencia de Power BI para ese usuario.
