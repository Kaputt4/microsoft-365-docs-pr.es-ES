...
### <a name="scenario-2-your-organization-has-an-existing-microsoft-365-environment-and-the-user-signing-up-for-power-bi-doesnt-have-a-microsoft-365-account"></a>Escenario 2: Su organización tiene un entorno de Microsoft 365 existente y el usuario que se inscriba en Power BI no tiene una cuenta de Microsoft 365.
...
### <a name="scenario-3-your-organization-does-not-have-a-microsoft-365-environment-connected-to-your-email-domain"></a>Escenario 3: La organización no tiene un entorno de Microsoft 365 conectado al dominio de correo electrónico.

No hay acciones administrativas que su organización necesite para aprovechar Power BI.
...
> [!IMPORTANT]
> Para obtener más información y instrucciones sobre la administración de inquilinos, vea [¿Qué es la administración de Power BI?](/power-bi/service-admin-administering-power-bi-in-your-organization).
...
Para realizar los siguientes pasos, debe instalar la versión más reciente de 64 bits del módulo de PowerShell de [Azure Active Directory V2](https://www.powershellgallery.com/packages/AzureADPreview/2.0.2.5).
...
> [!NOTE]
> La *marca AllowAdHocSubscriptions* se usa para controlar varias funcionalidades de usuario de la organización, incluida la capacidad para que los usuarios se inscriba en el Servicio de Azure Rights Management. El cambio de este indicador afectará a todas estas capacidades.
...
Si un usuario se ha registrado en Power BI, pero ya no desea que tenga acceso a Power BI, puede quitar la licencia de Power BI para ese usuario.
...
4. Desactiva la opción **Microsoft Power BI.**
...
## <a name="why-did-1-million-licenses-for-microsoft-power-bi-show-up-in-my-tenant"></a>¿Por qué 1 millón de licencias de Microsoft Power BI se presentaron en mi inquilino?

Como organización que cumple los requisitos, los usuarios de su organización son aptos para usar el servicio De Microsoft Power BI y estas licencias representan la capacidad disponible para los nuevos usuarios de Power BI en su inquilino. No hay ningún cargo por estas licencias. Si ha elegido permitir que los usuarios se inscriban en Power BI, se les asignará una de estas licencias gratuitas disponibles cuando completen el proceso de registro. También puede elegir asignar estas licencias a los usuarios usted mismo a través del Centro de administración.
