...
3. <span data-ttu-id="46ed7-160">En **Id. de partner**, seleccione **Editar partner de registro**.</span><span class="sxs-lookup"><span data-stu-id="46ed7-160">Under the **Partner ID**, select **Edit partner of record**.</span></span>
