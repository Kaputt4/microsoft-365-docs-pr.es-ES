...
|Nombre|Descripción|
|---|---|
|**Almacenamiento**|Los Datos del cliente se almacenan en servidores de Microsoft dentro de la nube de Office 365. Sus datos forman parte de su espacio empresarial. <br/><br/>No se retienen datos de audio de voz.|
|**Permanece en la ubicación geográfica**|Los Datos del cliente se almacenan en servidores de Microsoft dentro de la nube de Office 365 en la ubicación geográfica. Sus datos forman parte de su espacio empresarial.|
|**Retención**|Los Datos del cliente se eliminan cuando la cuenta es cerrada por el administrador de inquilinos o cuando se realiza una solicitud de Derechos del interesado del RGPD. <br/><br/>No se retienen datos de audio de voz.|
|**Procesamiento y confidencialidad**|El personal encargado del procesamiento de Datos del cliente y de datos personales (i) procesarán dichos datos solo si el Cliente lo solicita y (ii) está obligado a mantener la confidencialidad y la seguridad de los datos, inclusive cuando la interacción finalice.|
|**Uso**|Microsoft usa los Datos del cliente solo para proporcionar los servicios acordados, y con fines compatibles con dichos servicios. Uno de estos fines es el aprendizaje automático para desarrollar y mejorar modelos. El aprendizaje automático se realiza en la nube de Office 365 y ninguna persona puede ver, revisar o etiquetar sus Datos del cliente. <br/><br/>No usamos sus datos para dirigir la publicidad.|
...
### <a name="how-to-opt-out-of-play-my-emails"></a>Cómo no participar en Play My Emails (Reproducir mis correos electrónicos)
...
Para los servicios regidos por el [Contrato de servicios de Microsoft](https://go.microsoft.com/fwlink/p/?LinkId=2109174) y la [Declaración de privacidad de Microsoft](https://privacy.microsoft.com/privacystatement), Microsoft es el controlador de datos. Como responsable de los datos, Microsoft usa los datos para mejorar productos y servicios en conformidad con la [Declaración de privacidad de Microsoft](https://privacy.microsoft.com/privacystatement).
