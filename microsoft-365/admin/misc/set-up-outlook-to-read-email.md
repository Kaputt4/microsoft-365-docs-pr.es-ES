...
La primera vez que abra la aplicación de Outlook, se abrirá el Asistente para configurar mi bandeja de entrada. En el asistente: 
...
Para determinar la suscripción, vea [¿qué suscripción tengo?](../admin-overview/what-subscription-do-i-have.md)
