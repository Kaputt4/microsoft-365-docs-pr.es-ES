...
Si desea comprar un dominio de un registrador de dominio que no sea [GoDaddy,](https://www.godaddy.com)le recomendamos que use uno siguiente que admita la configuración automática (Conexión de dominio). 
...
Para configurar un dominio en Microsoft 365, debe ser propietario de un dominio y cambiar algunos de los registros DNS de su dominio.
...
[Actualice los registros DNS para mantener su sitio web con su proveedor de hospedaje actual.](../dns/update-dns-records-to-retain-current-hosting-provider.md)