...
> [!NOTE]
> Si su organización usa Office 365 operado por 21Vianet en China, vea How [to buy a domain for Office 365 operated by 21Vianet in China](/buy-a-domain-name?view=o365-21vianet#how-to-buy-a-domain-for-office-365-operated-by-21vianet.md).
...
Puede elegir uno de los siguientes dominios de primer nivel para el suyo.
...
> [!NOTE]
> Al seleccionar **Comprar dominio,** es posible que se le redirija al sitio web de su partner de Microsoft si el inquilino se compra o administra a través de un partner de Microsoft.

## <a name="domain-privacy"></a>Privacidad de dominio
Ofrecemos una suscripción de privacidad de dominio gratuita con la compra de un dominio. Esto mantiene la información de contacto adjunta al registro de su dominio con ICANN privada. [Aprende más.](https://whois.icann.org/en/privacy-and-proxy-services)
  
## <a name="buy-a-domain-from-another-domain-registrar"></a>Comprar un dominio a otro registrador de dominios
Si desea comprar un dominio de un registrador de dominios distinto de [GoDaddy,](https://www.godaddy.com)le recomendamos que use uno a continuación que admita la configuración automática (dominio Conectar). 
...
Después de registrar el dominio (en un registrador de dominios), inicia sesión en Microsoft 365 como administrador y configura el dominio para que pueda usarlo con su dirección de correo electrónico y otros servicios.
  
> [!NOTE]
> La SharePoint del sitio web público en línea de este artículo solo se aplica si su organización compró Microsoft 365 antes del 9 de marzo de 2015. 

### <a name="domain-registrars-that-support-all-dns-records-required-for-microsoft-365"></a>Registradores de dominio que admiten todos los registros DNS necesarios para Microsoft 365
...
[Actualizar registros DNS para mantener su sitio web con su proveedor de hospedaje actual](../dns/update-dns-records-to-retain-current-hosting-provider.md) (artículo)