        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Buscar y corregir problemas después de agregar el dominio o los registros DNS</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Información sobre el dominio inicial onmicrosoft</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Comprender los dominios</h3>
                            <p><a href="what-is-a-domain.md">¿Qué es un dominio?</a></p>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Introducción</h3>
                            <p><a href="../setup/add-domain.md">Comprobar el dominio (demostrar que es el propietario del dominio)</a></p>
