...
Uso de un dominio personalizado como *Rob@contoso<span> . com* con Office 365 puede ayudarle a crear credibilidad y reconocimiento para su marca. 
  
## <a name="choose-the-experience-thats-best-for-you"></a>Seleccione la experiencia que se adapte mejor a sus necesidades:

 **Compre un nuevo dominio:**
  
Use Office 365 para comprar un nuevo dominio: configuraremos todo hacia arriba. [Aprende más.](buy-a-domain-name.md)
  
 **Use un dominio de su propiedad:**
  
Si ya tiene un dominio como *You@yourcompany.<span> com* puede agregarlo y empezar a usar las aplicaciones de OneDrive y Office inmediatamente. Necesitará dedicar unos minutos a configurar el correo y Skype Empresarial. 
...
Llame al soporte técnico de Office 365: [obtenga ayuda para configurar un dominio con Office 365](../contact-support-for-business-products.md).
