---
title: Integración de Microsoft OneDrive LTI con Blackboard
ms.author: danismith
author: DaniEASmith
manager: serdars
ms.reviewer: amitman
...
description: Crear y calificar asignaciones, compilar y mantener contenido del curso, y colaborar en archivos en tiempo real con la nueva interoperabilidad de herramientas de Microsoft OneDrive Learning para Blackboard.
ms.openlocfilehash: 7e43ff51a069db55be06236fb0318aa4453d8feb
ms.sourcegitcommit: 195e4734d9a6e8e72bd355ee9f8bca1f18577615
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 04/13/2022
ms.locfileid: "64824660"
---
# <a name="integrate-microsoft-onedrive-lti-with-blackboard"></a>Integración de Microsoft OneDrive LTI con Blackboard

La integración de Microsoft OneDrive LTI con Blackboard es un proceso de dos pasos. El primer paso hace que la Microsoft OneDrive LTI esté disponible en los cursos de Blackboard y el segundo paso activa Microsoft OneDrive para Blackboard.
...
6. En **Directivas de institución**, seleccione las casillas **Rol en** curso y **Nombre** en los campos de usuario que se van a enviar. Todos los demás campos de usuario son opcionales, pero se recomienda dejarlos en para futuras pruebas de la instalación del OneDrive.
