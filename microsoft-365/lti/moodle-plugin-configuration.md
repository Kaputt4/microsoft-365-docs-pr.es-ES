...
### <a name="the-teams-for-moodle-set-up-process"></a>Proceso de configuración de Teams for Moodle

1. Creación de una aplicación de Azure
...
1. Establecimiento de los detalles de la aplicación de Azure en Moodle
...
1. Configuración de la conexión entre los complementos de Microsoft y los servicios de Microsoft
    1. En la página Configuración de integración de Microsoft 365, seleccione la pestaña **Configuración** .
...
1. Configuración de la sincronización de usuarios y cursos
