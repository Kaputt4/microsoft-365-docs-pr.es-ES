...
---
# <a name="configure-sharepoint-as-a-learning-content-source-for-microsoft-viva-learning-preview"></a><span data-ttu-id="cf738-103">Configurar SharePoint como origen de contenido de aprendizaje para Microsoft Viva Learning (versión preliminar)</span><span class="sxs-lookup"><span data-stu-id="cf738-103">Configure SharePoint as a learning content source for Microsoft Viva Learning (Preview)</span></span>

> [!NOTE]
> <span data-ttu-id="cf738-104">Esta característica aún no está disponible en la vista previa del producto.</span><span class="sxs-lookup"><span data-stu-id="cf738-104">This feature is not yet available in product preview.</span></span>
