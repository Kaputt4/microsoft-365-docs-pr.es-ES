...
3. En el panel **Administrador de** conocimientos, seleccione **Administradores asignados** y, a continuación, **seleccione Agregar**.
     ...
     ![Página Roles en la Centro de administración de Microsoft 365 que muestra el panel Administrador de conocimientos para agregar un usuario.](../media/learning/learning-add-knowledge-admin-1.png)
...
2. En la **página Configuración de** la organización, en la pestaña **Servicios,** seleccione **Viva Learning (vista previa).**

     ![Configuración página en el Centro de administración de Microsoft 365 que muestra la Learning lista.](../media/learning/learning-sharepoint-configure1.png)

3. En el **panel Viva Learning (vista** previa), seleccione los orígenes de contenido de aprendizaje que desea configurar para la organización y, a continuación, **seleccione Guardar**.

     ![Learning panel de la Centro de administración de Microsoft 365 muestra las opciones de orígenes de contenido.](../media/learning/learning-sharepoint-configure2.png)
