---
title: Incorporar los dispositivos de la organización a Microsoft Defender para empresas
description: Incorporar los dispositivos de la organización a Microsoft Defender para empresas
...
---
# <a name="onboard-managed-devices-to-microsoft-defender-for-business"></a>Incorporación de dispositivos administrados a Microsoft Defender para empresas

Incorpore dispositivos a Microsoft Defender para empresas para protegerlos con protección de última generación (antivirus, antimalware y protección entregada en la nube), protección de firewall, filtrado de contenido web y mucho más. 
...
> [!IMPORTANT]
> Si algo sale mal y se produce un error en el proceso de incorporación, consulta Solución de problemas de [Microsoft Defender para empresas](../security/defender-business/mdb-troubleshooting.yml).
...
Para obtener más información sobre la incorporación automática, consulta el paso 2 en [Usar el asistente para configurar Microsoft Defender para empresas](../security/defender-business/mdb-use-wizard.md).
...
5. Siga las instrucciones de los artículos siguientes:
   ...
   - dispositivos macOS: [implementación manual para Microsoft Defender para Endpoint en macOS](../security/defender-endpoint/mac-install-manually.md#download-installation-and-onboarding-packages)
...
[Revisar acciones de corrección en Microsoft 365 Empresa Premium](m365bp-review-remediation-actions-devices.md)