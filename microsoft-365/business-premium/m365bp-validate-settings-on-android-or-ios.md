...
![Asegúrese de que requerir un PIN o una huella digital para acceder a Office aplicaciones esté establecido en Activado.](../business-premium/media/f37eb5b2-7e26-49fb-9bd6-d955d196bacf.png)
...
1. Se le pedirá que escriba el PIN para poder acceder a Outlook de nuevo.
...
1. Solo debería ver una opción para OneDrive para la Empresa. Si no es así, pulse **Agregar cuenta** y seleccione **OneDrive para la Empresa** en la pantalla **Agregar cuenta de Storage**. Proporcione la Microsoft 365 Empresa Premium del usuario final para iniciar sesión cuando se le solicite.
...
1. Vuelva a acceder a Outlook en el dispositivo iOS.
