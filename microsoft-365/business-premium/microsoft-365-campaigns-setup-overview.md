...
Para las campañas que califiquen para precios especiales, empieza solicitando una invitación de [Microsoft](https://m365forcampaigns.microsoft.com/) y, a continuación, [insccribiendo Microsoft 365 campañas](m365-campaigns-sign-up.md). Para completar la instalación, [ejecute el Asistente para la](../business/set-up.md?toc=/microsoft-365/campaigns/toc.json) instalación para configurar la configuración principal.

Para todas las demás organizaciones, después de que te hayas registrado en [Microsoft 365 Empresa Premium](../admin/admin-overview/sign-up-for-office-365.md)), completa la configuración ejecutando el [](../business/set-up.md?toc=/microsoft-365/campaigns/toc.json) asistente para configurar la configuración principal.

Para todas las organizaciones, aumente la protección de [seguridad: proteger](m365-campaigns-protect-admin-accounts.md) las cuentas de [administrador, proteger](m365-campaigns-conditional-access.md) el acceso al correo y los datos y aumentar [la protección contra amenazas](m365-campaigns-increase-protection.md).
...
Para el personal clave, se recomienda usar dispositivos [administrados](../business/set-up-windows-devices.md?toc=/microsoft-365/campaigns/toc.json) para una protección aún mejor. Para todos los dispositivos, querrás configurar la autenticación [multifactor](m365-campaigns-multifactor-authentication.md).
