...
El escritorio administrado de Microsoft establece esta directiva para evitar que se instalen extensiones de Chrome en los extremos administrados. Hay riesgos conocidos asociados con el modelo de extensión de cromo, incluida la protección contra la pérdida de datos, la privacidad y otros riesgos que pueden poner en peligro los dispositivos. 
