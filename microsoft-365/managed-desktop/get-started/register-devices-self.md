...
Cuando usas el portal de administración para registrar dispositivos, asignamos automáticamente la etiqueta de grupo Autopilot asociada al perfil de dispositivo que aparece en Registrar dispositivos mediante [el Centro de partners](register-devices-partner.md).
