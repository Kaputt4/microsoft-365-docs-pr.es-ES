...
- Las excepciones de proxy deben limitarse a un máximo de 2064 caracteres. Esto incluye direcciones de Escritorio administrado de Microsoft agregadas.
