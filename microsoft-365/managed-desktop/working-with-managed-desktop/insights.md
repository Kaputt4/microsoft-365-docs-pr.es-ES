...
description: Introducción a la información disponible en el escritorio administrado de Microsoft
...
Para acceder a estas vistas desde el [Administrador de extremos de Microsoft](https://endpoint.microsoft.com/), navegue hasta la ficha escritorio administrado de Microsoft en la página de inicio y seleccione **Ver detalles** en el área de **informes** :
...
Obtenga más información sobre [Usage Insights](usage-insights.md).
