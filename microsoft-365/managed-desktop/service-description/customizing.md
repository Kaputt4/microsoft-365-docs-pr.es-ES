...
---
# <a name="customize-the-service"></a>Personalizar el servicio
...
## <a name="types-of-customizations"></a>Tipos de personalización
Una personalización es cualquier adición o cambio en la configuración de base de escritorio administrada de Microsoft; los ejemplos abarcan desde la configuración de puertos USB hasta la implementación de un nuevo agente de seguridad. Agrupamos varias personalizaciones de la siguiente manera:
...
## <a name="request-a-customization"></a>Solicitar una personalización
...
-   Tipo de personalización: ¿qué categoría de personalización es? (vea la tabla anterior)
-   Requisito: ¿Cuáles son los requisitos empresariales específicos para la personalización?
-   Propuesta: ¿Qué solución es la que solicita la empresa?
-   Escala de tiempo: ¿Cuánto tiempo desea que dure esta personalización? 


## <a name="how-we-assess-a-customization-request"></a>Cómo evaluaremos una solicitud de personalización

Cuando se revisan las solicitudes de personalización, se evalúan estos factores en este orden:
...
3.  Si podemos cumplir sus requisitos con la tecnología de Microsoft, probablemente aprobamos la solicitud de un período de migración de tres a doce meses (según el ámbito del proyecto).
...
Se revisan las personalizaciones para asegurarse de que no infringen ninguna de estas condiciones:

-   Una personalización no debe afectar negativamente A la seguridad del sistema. 
-   El mantenimiento de la personalización no debe suponer un costo significativo para las operaciones de escritorio administradas de Microsoft o el soporte técnico.
-   Una personalización no debe afectar a la estabilidad del sistema, por ejemplo, al hacer que el modo kernel se bloquee o se bloquee.
...
## <a name="revoking-approval-for-a-customization"></a>Revocar la aprobación para una personalización

Después de que se apruebe e implemente una personalización solicitada, es posible que se detecten problemas que infrinjan las condiciones clave que no eran evidentes cuando se aprobó el cambio en primer lugar. En esta situación, es posible que deba revocar la aprobación para la personalización.
 
Si esto ocurre, le enviaremos una notificación mediante el portal de administración de escritorio administrado de Microsoft. Desde la primera vez que le notificamos, tiene 90 días para quitar la personalización antes de que los dispositivos con la personalización ya no estén asociados por los contratos de nivel de servicio de escritorio administrado por Microsoft. Le enviaremos varias notificaciones de acuerdo con una escala de tiempo estricta, pero es posible que un incidente o una amenaza graves deban cambiar la escala de tiempo o nuestras decisiones sobre la personalización. No se *quitará* una personalización sin su consentimiento, pero los dispositivos con una personalización revocada dejarán de estar vinculados por nuestro contrato de nivel de servicio. Esta es la escala de tiempo de las notificaciones que le enviaremos:

- **Primer aviso:** Le proporcionamos el primer aviso de nuestra decisión de revocar la aprobación, que incluye información sobre por qué la revocación, las acciones que le aconsejamos realizar, la fecha límite para esas acciones y los pasos que debe seguir si desea apelar la decisión. Esto es de 90 días antes de que se deba quitar la personalización de todos los dispositivos. 
...
- **90 días después de la primera notificación:** Los contratos de nivel de servicio de escritorio administrados por Microsoft ya no se aplican a los dispositivos que tienen la personalización revocada. En cualquier momento, puede desafiar la decisión y proporcionar información adicional para tener en cuenta, como la actualización, los cambios de configuración o el cambio de software. 
