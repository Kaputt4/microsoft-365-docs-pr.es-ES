...
Cuando ordenes un nuevo dispositivo a un fabricante [aprobado,](device-requirements.md#minimum-requirements)sigue estos pasos para asegurarte de que envían dispositivos con la configuración correcta de software y imagen de Escritorio administrado de Microsoft.
...
### <a name="hp"></a>HP 
Cuando ordene nuevos dispositivos de HP, asegúrese de usar la SKU específica que se muestra en la sección Requisitos adicionales para cada modelo, como se muestra en [Dispositivos de programación.](device-list.md#hp)
...
Estas imágenes usan el entorno de recuperación de Windows (WinRE) y este es un proceso manual (no automatizado). Sigue los pasos de [Crear y usar una unidad de recuperación USB para Surface](https://support.microsoft.com/surface/creating-and-using-a-usb-recovery-drive-for-surface-677852e2-ed34-45cb-40ef-398fc7d62c07).


### <a name="universal-image"></a>Imagen universal
Microsoft Managed Desktop ha creado una imagen que contiene Windows 10 Pro y Aplicaciones de Microsoft 365 para empresas que puedes usar con Microsoft Managed Desktop. Sin embargo, lo mejor es usar las imágenes apropiadas para el Escritorio administrado de Microsoft proporcionadas por el fabricante siempre que sea posible, incluso si eso significa una versión anterior de Windows que, a continuación, debe actualizarse una vez que el usuario inicia sesión. El uso de la imagen universal de Escritorio administrado de Microsoft debe ser una opción final.

- Actualizamos la imagen con las actualizaciones de calidad mensuales más recientes de Windows cada 30-60 días y las actualizaciones de Aplicaciones de Microsoft 365 para empresas al menos dos veces al año.
- La imagen contiene un paquete de aprovisionamiento de recuperación para garantizar que Microsoft 365 Apps for Enterprise se restaure después de los escenarios de recuperación de Windows.
