...
Responsabilidad | Servicio de Escritorio administrado de Microsoft | Microsoft 365 cliente | Clientes y servidores locales | software personalizado y que no es de Microsoft
----- | ----- | ----- | ----- | -----
...
Microsoft Store para Empresas | Configure y mantenga el perfil Windows Autopilot para el servicio de Escritorio administrado de Microsoft. | - Crear una solicitud de soporte técnico que solicite información para un cambio de configuración planeado, incluidos los detalles de configuración, el ámbito, la escala de tiempo y otros detalles pertinentes que Microsoft debe revisar.<br>- Solo aplica un cambio una vez que Las operaciones de escritorio administrado de Microsoft han evaluado y recomendado.<br>- No modificar la configuración del perfil de Microsoft Managed Desktop Windows Autopilot o agregar o quitar dispositivos asignados.
