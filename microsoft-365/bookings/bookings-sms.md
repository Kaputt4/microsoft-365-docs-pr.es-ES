...
Los asistentes, clientes o asociados necesitan un número de teléfono válido de Estados Unidos o Canadá para poder recibir notificaciones POR SMS.
...
- En la aplicación Booking de Teams, vaya a **Configuración** >  **Appointment typeAdd** >  **appointment type (Agregar tipo de cita**) y seleccione **Send them text messages (Enviar mensajes de texto**).

## <a name="tracking-and-metrics-for-sms-notifications"></a>Seguimiento y métricas de notificaciones SMS

> [!NOTE]
> Debe ser administrador de Teams para ver Teams y Bookings datos en el centro de administración de Teams.
...
1. En el centro de administración de Teams, **las notificaciones sms de visitas virtuales**.
