...
### <a name="can-i-use-bookings-even-if-i-dont-have-a-web-page-for-my-business"></a>¿Puedo usar reservas incluso si no tengo una página web para mi empresa?
...
### <a name="is-bookings-customizable"></a>¿Hay reservas personalizables?
...
### <a name="is-all-the-functionality-of-the-original-bookings-web-app-available-in-microsoft-teams"></a>¿Todas las funciones de la aplicación Web de reservas originales están disponibles en Microsoft Teams?
...
### <a name="is-bookings-a-small-business-offering-or-an-enterprise-offering-or-both"></a>¿Tiene reservas una oferta pequeña de negocio o una oferta empresarial o ambas?
...
### <a name="do-i-need-to-migrate-my-email-account-from-my-current-provider-to-microsoft-365"></a>¿Es necesario migrar mi cuenta de correo electrónico de mi proveedor actual a Microsoft 365?
...
### <a name="can-my-employees-use-bookings-without-a-microsoft-365-account"></a>¿Pueden mis empleados usar reservas sin una cuenta de Microsoft 365?
...
### <a name="can-i-create-more-than-one-bookings-calendar-under-the-same-microsoft-365-account-and-switch-between-them"></a>¿Puedo crear más de un calendario de reservas en la misma cuenta de Microsoft 365 y cambiar entre ellos?
...
### <a name="what-if-my-organization-has-mixed-licenses-with-f1f3-e1-and-e3e5"></a>¿Qué sucede si mi organización tiene licencias mixtas con F1/F3, E1 y E3/E5?
...
### <a name="where-do-bookings-calendars-show-up-in-my-microsoft-365-tenant"></a>¿Dónde se muestran los calendarios de reservas en mi inquilino de Microsoft 365? * *
...
### <a name="can-i-delete-a-previously-created-bookings-calendar"></a>¿Puedo eliminar un calendario de reservas creado anteriormente?

Para eliminar un calendario de reservas, debe eliminar el buzón asociado en Exchange.

### <a name="if-i-create-a-calendar-and-someone-else-has-access-to-bookings-would-they-be-able-to-see-my-calendar"></a>Si creo un calendario y alguien más tiene acceso a reservas, ¿podré ver mi calendario?
...
### <a name="are-video-conferencing-meetings-integrated-into-the-bookings-app"></a>¿Las reuniones de videoconferencia están integradas en la aplicación de reservas?
...
### <a name="how-can-bookings-appointments-show-up-on-a-persons-calendar"></a>¿Cómo se pueden mostrar citas de reservas en el calendario de una persona?
...
### <a name="what-triggers-service-provider-or-staff-and-customer-emails"></a>¿Qué desencadena el proveedor de servicios o el personal y los correos electrónicos de clientes?
...
### <a name="can-i-book-classroom-style-appointments-that-are-1many-instead-of-11"></a>¿Puedo reservar citas de tipo aula que sean 1: muchas en lugar de 1:1?
...
### <a name="can-calendars-remain-unpublished-not-public-facing-but-still-accessible-to-designated-users"></a>¿Los calendarios permanecen sin publicar (no accesibles públicamente) pero siguen siendo accesibles para los usuarios designados?
...
### <a name="can-i-turn-off-the-email-notifications-for-time-off"></a>¿Puedo desactivar las notificaciones de correo electrónico para que no se puedan usar?
...
### <a name="is-it-possible-to-share-only-one-service-on-the-self-service-page-at-a-time"></a>¿Es posible compartir un solo servicio en la página de autoservicio al mismo tiempo?
...
### <a name="what-options-are-available-for-embedding-a-consent-form-or-disclosure-for-those-booking-an-appointment"></a>¿Qué opciones hay disponibles para insertar un formulario de consentimiento o revelación para los que están reservando una cita?
...
### <a name="what-changes-can-be-made-to-the-staff-selection-capability-on-the-self-service-booking-page"></a>¿Qué cambios se pueden realizar en la función de selección de personal en la página de reserva de autoservicio?
...
### <a name="can-bookings-support-many-concurrent-booking-requests-and-self-service-page-visits"></a>¿Pueden las reservas admitir muchas solicitudes de reserva simultáneas y visitas de página de autoservicio?
...
### <a name="where-is-bookings-data-stored"></a>¿Dónde se almacenan los datos de las reservas?
...
### <a name="is-there-a-way-to-centrally-manage-bookings-calendars-for-all-users"></a>¿Hay alguna forma de administrar de forma centralizada los calendarios de reservas para todos los usuarios?
...
### <a name="is-there-the-ability-to-customize-email-addresses-for-customer-replies"></a>¿Existe la posibilidad de personalizar las direcciones de correo electrónico para las respuestas de los clientes?
...
### <a name="we-would-like-for-the-customer-to-accept-our-terms-and-conditions-during-the-booking-process-is-that-possible"></a>Nos gustaría que el cliente Acepte nuestros términos y condiciones durante el proceso de reserva. ¿Es posible?
...
### <a name="how-can-bookings-associated-mailboxes-in-exchange-be-identified"></a>¿Cómo pueden identificarse los buzones asociados a la reserva en Exchange?
...
### <a name="how-can-users-opt-out-of-receiving-sms-messages-if-they-have-already-opted-in-previously"></a>¿Cómo pueden los usuarios dejar de recibir mensajes SMS si ya han optado por ellos anteriores?
...
### <a name="the-staff-member-needs-to-change-their-calendar-permissions"></a>El miembro del personal debe cambiar los permisos de calendario
...
### <a name="we-cant-find-a-staff-member-in-our-organization"></a>No encontramos un miembro del personal en nuestra organización
