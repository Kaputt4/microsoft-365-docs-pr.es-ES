...
> [!NOTE]
> Para obtener más información sobre las consideraciones de seguridad y rendimiento de la conectividad directa a puntos de conexión de Office 365, vea [Principios de conectividad de red de Office 365](microsoft-365-network-connectivity-principles.md).
...
|**Instance** <br/> |La instancia de servicio de Office 365, que tiene como valor predeterminado En todo el mundo. Esto también se pasa al servicio web. <br/> |
...
Las configuraciones codificadas de forma rígida o el uso de una lista de permitidos basada en FQDN indirectos de Office 365 no se recomiendan, no son compatibles con Microsoft y se sabe que causan problemas de conectividad del cliente. Las soluciones DNS que se bloquean en el redireccionamiento de CNAME, o que de lo contrario resuelven incorrectamente las entradas DNS de Office 365, se pueden resolver a través de reenviadores DNS con recursividad DNS habilitada o mediante sugerencias de raíz DNS. Muchos productos perimetrales de red de terceros integran de forma nativa el punto de conexión de Office 365 recomendado para incluir una lista de permitidos en su configuración mediante el [servicio web dirección IP y dirección URL de Office 365](microsoft-365-ip-web-service.md).
