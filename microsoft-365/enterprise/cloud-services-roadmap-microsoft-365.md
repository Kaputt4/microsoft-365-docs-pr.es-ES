---
title: Hoja de ruta de servicios en la nube para Microsoft 365
f1.keywords:
- NOCSH
ms.author: kvice
...
- [Migración de los datos locales a Microsoft 365](migrate-data-to-office-365.md)
- Configuración de los servicios en la nube para los usuarios
...
- [Comprobación del estado del servicio](view-service-health.md)
- [Descripción de las opciones de soporte técnico](../admin/get-help-support.md)
- Administración de los servicios en la nube
  - [Exchange Online](/Exchange/exchange-online)
...
Inicie la implementación de los servicios en la nube. Para obtener instrucciones, consulte [Configuración de aplicaciones y servicios de Microsoft 365 Enterprise](configure-services-and-applications.md).
