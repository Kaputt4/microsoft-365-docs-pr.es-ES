...
Los procedimientos de esta sección requieren que use el Shell de administración SharePoint Online para conectarse a SharePoint Online. Para obtener instrucciones, consulte [Connect to SharePoint Online PowerShell](/powershell/sharepoint/sharepoint-online/connect-sharepoint-online?view=sharepoint-ps).
...
> [!NOTE]
> En general, no debe codificar las direcciones URL directamente a los activos de la CDN. Sin embargo, puede crear manualmente direcciones URL para activos en orígenes públicos si es necesario. Para obtener más información, [vea Hardcoding CDN URL for public assets](use-microsoft-365-cdn-with-spo.md).
