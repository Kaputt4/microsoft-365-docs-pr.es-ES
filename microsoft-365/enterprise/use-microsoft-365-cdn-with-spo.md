...
+ [Planeación de la implementación de la red CDN de Office 365](use-microsoft-365-cdn-with-spo.md#plan-for-deployment-of-the-office-365-cdn)

  + [Determine qué activos estáticos desea hospedar en la red CDN](use-microsoft-365-cdn-with-spo.md#CDNAssets).
  + [Determine dónde desea almacenar los activos](use-microsoft-365-cdn-with-spo.md#CDNStoreAssets). Esta ubicación puede ser un sitio de SharePoint, una biblioteca o una carpeta y se denomina _origen_.
...
+ Instalar y configurar la red CDN mediante PowerShell o la CLI de SharePoint Online
  ...
  + [Instalar y configurar la red CDN mediante el shell de administración de SharePoint Online](use-microsoft-365-cdn-with-spo.md#CDNSetupinPShell)
  + [Instalar y configurar la red CDN mediante PnP PowerShell](use-microsoft-365-cdn-with-spo.md#CDNSetupinPnPPosh)
  + [Instalar y configurar la red CDN mediante la CLI de Office 365](use-microsoft-365-cdn-with-spo.md#CDNSetupinCLI)
...
Una vez que haya terminado con el programa de instalación, puede [administrar la red CDN de Office 365](use-microsoft-365-cdn-with-spo.md#CDNManage) con el tiempo:
...
Por último, vea [usar los activos de la red CDN](use-microsoft-365-cdn-with-spo.md#using-your-cdn-assets) para obtener información sobre cómo obtener acceso a los recursos de la red CDN desde orígenes públicos y privados.
...
Antes de implementar la red CDN de Office 365 para su inquilino de Office 365, debe tener en cuenta los siguientes factores como parte del proceso de planeación.
  ...
  + [Determinación de los activos estáticos que desea hospedar en la red CDN](use-microsoft-365-cdn-with-spo.md#CDNAssets)
...
Puede obtener más información sobre cómo el acceso de la red CDN a los activos de un origen privado trabaja en el [uso de activos en orígenes privados](use-microsoft-365-cdn-with-spo.md#using-assets-in-private-origins).
...
Vea [orígenes de la red CDN predeterminados](use-microsoft-365-cdn-with-spo.md#default-cdn-origins) para obtener información sobre los orígenes que se aprovisionan de forma predeterminada al habilitar la red CDN de Office 365 y el impacto potencial de omitir la configuración de orígenes predeterminados.
...
No puede modificar el origen que ha creado. En su lugar, quite el origen y, a continuación, agregue uno nuevo. Para obtener más información, vea [para quitar un origen de la red CDN de Office 365](use-microsoft-365-cdn-with-spo.md#Office365CDNforSPORemoveOriginPosh) y [Agregar un origen a los activos](use-microsoft-365-cdn-with-spo.md#Office365CDNforSPOOriginPosh).
...
Vea [orígenes de la red CDN predeterminados](use-microsoft-365-cdn-with-spo.md#default-cdn-origins) para obtener información sobre los orígenes que se aprovisionan de forma predeterminada al habilitar la red CDN de Office 365.
...
+ [Actualización de vínculos a activos de la red CDN](use-microsoft-365-cdn-with-spo.md#updating-links-to-cdn-assets)
+ [Usar activos en orígenes públicos](use-microsoft-365-cdn-with-spo.md#using-assets-in-public-origins)
