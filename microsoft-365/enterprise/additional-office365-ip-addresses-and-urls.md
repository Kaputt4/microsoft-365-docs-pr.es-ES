...
Algunos puntos de conexión de red se publicaron anteriormente y no se han incluido en el servicio Office 365 dirección IP y [url web](microsoft-365-ip-web-service.md). El ámbito del servicio web son puntos de conexión de red necesarios para la conectividad de un usuario de Office 365 a través de una red perimetral de empresa. Actualmente, este grupo no incluye:
