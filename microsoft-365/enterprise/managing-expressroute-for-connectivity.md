...
ExpressRoute para Office 365 ofrece una ruta de enrutamiento alternativa para llegar a muchos Office 365 sin necesidad de todo el tráfico para salir a Internet. Aunque la conexión a Internet a Office 365 todavía es necesaria, las rutas específicas que Microsoft anuncia a través de BGP a la red hacen que el circuito directo de ExpressRoute prefiera a menos que haya otras configuraciones en la red. Las tres áreas comunes que puede configurar para administrar este enrutamiento incluyen el filtrado de prefijos, la seguridad y el cumplimiento.
  
> [!NOTE]
> Microsoft cambió la forma en que se revisa el dominio de enrutamiento de emparejamiento de Microsoft para Azure ExpressRoute. A partir del 31 de julio de 2017, todos los clientes de Azure ExpressRoute pueden habilitar el emparejamiento de Microsoft directamente desde la consola administrativa de Azure o a través de PowerShell. Después de habilitar Microsoft Peering, cualquier cliente puede crear filtros de ruta para recibir anuncios de ruta BGP para aplicaciones de Dynamics 365 Customer Engagement (anteriormente conocidas como CRM Online). Los clientes que necesitan Azure ExpressRoute para Office 365 deben obtener la opinión de Microsoft antes de poder crear filtros de ruta para Office 365. Póngase en contacto con el equipo de cuenta de Microsoft para obtener información sobre cómo solicitar una revisión para habilitar Office 365 ExpressRoute. Las suscripciones no autorizadas que intentan crear filtros de ruta Office 365 recibirán un [mensaje de error](https://support.microsoft.com/kb/3181709)
...
Existen varias razones para evitar el uso de las direcciones URL de Office 365 e [intervalos](./urls-and-ip-address-ranges.md) de direcciones IP para generar listas de filtros de prefijos. Incluye lo siguiente:
  
- Los Office 365 de IP se someten a muchos cambios con frecuencia.

- Las Office 365 direcciones URL e intervalos de direcciones IP están diseñadas para administrar listas de permitidos de firewall e infraestructura de proxy, no para enrutamiento.

- Las Office 365 direcciones URL e intervalos de direcciones IP no cubren otras servicios Microsoft que puedan estar en el ámbito de las conexiones de ExpressRoute.
...
- Correo de un Exchange Online inquilino a un host local.

- SharePoint Envío de correo en línea SharePoint Online a un host local.
...
Microsoft recomienda aceptar estas conexiones a través del circuito de Internet en lugar del circuito de ExpressRoute para reducir la complejidad. Si sus necesidades de cumplimiento o rendimiento determinan que estas conexiones entrantes deben aceptarse a través de un circuito de ExpressRoute, se recomienda usar un firewall o proxy inverso para establecer el ámbito de las conexiones aceptadas. Puede usar los extremos [Office 365 para](./urls-and-ip-address-ranges.md) averiguar los FQDN y prefijos IP correctos.
  
### <a name="compliance"></a>Cumplimiento

No dependemos de la ruta de enrutamiento que use para ninguno de nuestros controles de cumplimiento. Independientemente de si se conecta a Office 365 servicios a través de ExpressRoute o un circuito de Internet, nuestros controles de cumplimiento no cambiarán. Debe revisar los diferentes niveles de certificación de cumplimiento y seguridad de Office 365 para averiguar la mejor opción para satisfacer las necesidades de su organización.
