...
description: 'Resumen: describe consideraciones sobre la capacidad de red, aceleradores WAN y dispositivos de equilibrio de carga que se usan para conectarse a Office 365.'
...
- [Solución de problemas de errores de inicio de sesión de Skype Empresarial Online para administradores](/skypeforbusiness/set-up-skype-for-business-online/troubleshooting-sign-in-errors-for-admins)

- [No puede conectarse a Skype Empresarial o determinadas características no funcionan, ya que un firewall local bloquea la conexión](https://go.microsoft.com/fwlink/p/?LinkID=243625)
