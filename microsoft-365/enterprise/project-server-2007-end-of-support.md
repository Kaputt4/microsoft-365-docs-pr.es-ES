...
La compatibilidad finalizó para los servidores y aplicaciones de Office 2007 en 2017 y debe tener en cuenta los planes de migración. Si actualmente usa Project Server 2007 y productos relacionados, tenga en cuenta las siguientes fechas de fin de soporte técnico:
...
Para obtener más información acerca de los servidores de Office 2007 que llegan a la retirada, vea [Upgrade from Office 2007 servers and client products](upgrade-from-office-2007-servers-and-products.md).
...
2. En Project Professional 2013, Project Professional 2016 o el cliente de escritorio de Project Online, abra cada archivo .mpp y, a continuación, guárdelo y publirálo en Project Online.
    
Puede crear manualmente la configuración de Microsoft Project Web App (PWA) en Project Online. Por ejemplo, vuelva a crear los campos personalizados o los calendarios de empresa necesarios. Los partners de Microsoft también pueden ayudarle con este proceso.
...
|[Descripciones del servicio de Project Online](/office365/servicedescriptions/project-online-service-description/project-online-service-description) <br/> |Información sobre los diferentes planes de Project Online que están disponibles <br/> |
...
Las diferencias de arquitectura entre Project Server 2007 y Project Server 2016 impiden una ruta de migración directa. Por lo tanto, debe migrar los datos de Project Server 2007 a cada versión sucesiva de Project Server hasta que llegue a Project Server 2016.
...
|**Recurso**|**Descripción**|
|:-----|:-----|
|[Introducción a la actualización de Project Server 2010](/previous-versions/office/project-server-2010/ee662496(v=office.14)) <br/> |Una vista de alto nivel de lo que necesita hacer para actualizar de Project Server 2007 a Project Server 2010 <br/> |
...
|**Recurso**|**Descripción**|
|:-----|:-----|
|[Información general sobre el proceso de actualización de Project Server 2013](/project/upgrade-to-project-server-2016) <br/> |Información general sobre lo que debe hacer para actualizar de Project Server 2010 a Project Server 2013  <br/> |
...
Lo que necesita saber acerca de la actualización de [Project Server 2016](/project/plan-for-upgrade-to-project-server-2016) le indica algunos cambios importantes para la actualización de esta versión, que incluyen:
  
- Al crear el entorno de Project Server 2016 al que migrará los datos de Project Server 2013, los archivos de instalación de Project Server 2016 se incluyen en SharePoint Server 2016. Para obtener más información, vea [Deploy Project Server 2016](/project/deploy-project-server-2016).
...
Project Portfolio Server 2007 se usó con Project Server 2007 para estrategia de cartera, priorización y optimización. No se crearon versiones adicionales de Project Portfolio Server después de esta versión. Sin embargo, las características de administración de carteras están disponibles en Project Server 2016 y en la versión Premium de Project Online. Pero los datos de Project Portfolio Server 2007 no se pueden migrar a ninguno de los dos. Los datos, como los impulsores de negocios, tendrán que volver a crearse.
  
Otros recursos:
  
- [Descripciones del servicio de Project Online:](/office365/servicedescriptions/project-online-service-description/project-online-service-description) Vea las características de administración de carteras que se incluyen con Project Server 2016 y Project Online Premium.
