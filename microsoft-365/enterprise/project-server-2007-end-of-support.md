...
description: El 10 de octubre de 2017, el soporte técnico finalizó para Project Server 2007, Project Portfolio Server y Project 2007. Use este artículo para planear la actualización ahora.
...
El soporte técnico finalizó para los servidores y aplicaciones de Office 2007 en 2017 y debe tener en cuenta los planes de migración. Si actualmente usa Project Server 2007 y productos relacionados, tenga en cuenta las siguientes fechas de fin de soporte técnico:
...
Para obtener más información acerca de los servidores de Office 2007 que están llegando a la retirada, vea Actualizar desde los servidores de [Office 2007 y los productos de cliente.](upgrade-from-office-2007-servers-and-products.md)
  
## <a name="what-does-end-of-support-mean"></a>¿Qué significa *el fin del* soporte técnico?

La mayoría de los productos de Microsoft tienen un ciclo de vida de soporte técnico durante el cual obtienen nuevas características, correcciones de errores, correcciones de seguridad, entre otros. Este ciclo de vida suele durar 10 años desde la versión inicial del producto. El final de este ciclo de vida se conoce como el final del soporte técnico del producto. Dado que Project Server 2007 llegó a su fin de soporte técnico el 10 de octubre de 2017, Microsoft ya no proporciona:
...
La instalación de Project Server 2007 seguirá funcionando después de esta fecha. Pero debido a los cambios enumerados anteriormente, se recomienda encarecidamente migrar desde Project Server 2007 tan pronto como sea práctico.
...
|[Descripciones del servicio Project Online](https://go.microsoft.com/fwlink/p/?linkid=829088) <br/> |Información sobre los diferentes planes de Project Online que están disponibles <br/> |
...
Las diferencias de arquitectura entre Project Server 2007 y Project Server 2016 impiden una ruta de migración directa. Por lo tanto, debe migrar los datos de Project Server 2007 a cada versión sucesiva de Project Server hasta llegar a Project Server 2016.
...
Para obtener una descripción completa de lo que debe hacer para actualizar de Project Server 2007 a Project Server 2010, vea Actualizar a [Project Server 2010](https://go.microsoft.com/fwlink/p/?linkid=841812).
  
Recursos clave:
  
|**Recurso**|**Descripción**|
|:-----|:-----|
|[Introducción a la actualización de Project Server 2010](https://go.microsoft.com/fwlink/p/?linkid=841813) <br/> |Una vista general de lo que debe hacer para actualizar de Project Server 2007 a Project Server 2010 <br/> |
...
- **Actualización de base de datos adjunta:** Este método solo actualiza el contenido del entorno, no las opciones de configuración. Es necesario si va a actualizar desde Office Project Server 2007 implementado en hardware que solo admite un sistema operativo de servidor de 32 bits. Existen dos tipos de métodos de actualización de base de datos adjunta:
...
Después de comprobar que los datos se han migrado correctamente, el siguiente paso es migrar a Project Server 2013.
  
Para obtener una descripción completa de lo que debe hacer para actualizar de Project Server 2010 a Project Server 2013, vea Actualizar a [Project Server 2013.](https://go.microsoft.com/fwlink/p/?linkid=841822) 
  
Recursos clave:
  
|**Recurso**|**Descripción**|
|:-----|:-----|
|[Introducción al proceso de actualización de Project Server 2013](https://go.microsoft.com/fwlink/p/?linkid=841822) <br/> |Información general sobre lo que debe hacer para actualizar de Project Server 2010 a Project Server 2013  <br/> |
...
[Las novedades de la actualización de Project Server 2013](https://go.microsoft.com/fwlink/p/?linkid=841824) describen los cambios importantes para la actualización de esta versión. Los más notables son: 
...
Después de comprobar que los datos se han migrado correctamente, el siguiente paso es migrar a Project Server 2016.
  
Para obtener una descripción completa de lo que debe hacer para actualizar de Project Server 2013 a Project Server 2016, vea Actualizar a [Project Server 2016](https://docs.microsoft.com//project/upgrading-to-project-server-2016).
  
Recursos clave:
  
|**Recurso**|**Descripción**|
|:-----|:-----|
|[Introducción al proceso de actualización a Project Server 2016](https://go.microsoft.com/fwlink/p/?linkid=841260) <br/> |Información general sobre lo que debe hacer para actualizar de Project Server 2013 a Project Server 2016 <br/> |
|[Planeación de la actualización a Project Server 2016](https://go.microsoft.com/fwlink/p/?linkid=841826) <br/> |Consideraciones de planeación que debe actualizar de Project Server 2013 a Project Server 2016 <br/> |
   
#### <a name="things-to-know-about-upgrading-to-this-version"></a>Aspectos que debe saber sobre la actualización a esta versión

Lo que necesita saber sobre la actualización de [Project Server 2016](https://go.microsoft.com/fwlink/p/?linkid=841827) le indica algunos cambios importantes para la actualización de esta versión, entre los que se incluyen:
  
- Al crear el entorno de Project Server 2016 al que migrará los datos de Project Server 2013, los archivos de instalación de Project Server 2016 se incluyen en SharePoint Server 2016. Para obtener más información, vea [Implementar Project Server 2016.](https://go.microsoft.com/fwlink/p/?linkid=841829)
...
Project Portfolio Server 2007 se usó con Project Server 2007 para la estrategia de cartera, la priorización y la optimización. No se crearon versiones adicionales de Project Portfolio Server después de esta versión. Sin embargo, las características de administración de carteras están disponibles en Project Server 2016 y en la versión Premium de Project Online. Pero los datos de Project Portfolio Server 2007 tampoco se pueden migrar. Los datos, como los impulsores de negocios, tendrán que volver a crearse.
  
Otros recursos:
  
- [Descripciones del servicio Descripciones de Project Online:](https://go.microsoft.com/fwlink/p/?linkid=841280) Vea las características de administración de carteras que se incluyen con Project Server 2016 y Project Online Premium.
    
- [Microsoft Office de migración de Project Portfolio Server 2007.](https://go.microsoft.com/fwlink/p/?linkid=841279)
    
## <a name="related-topics"></a>Temas relacionados

[Plan de fin de soporte técnico de SharePoint Server 2007](sharepoint-2007-end-of-support.md)
