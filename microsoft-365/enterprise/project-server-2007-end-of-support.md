...
La compatibilidad finalizó para Office 2007 servidores y aplicaciones en 2017, y debe tener en cuenta los planes de migración. Si actualmente usa Project Server 2007 y productos relacionados, tenga en cuenta las siguientes fechas de finalización de soporte técnico:
...
|Project estándar de 2007  <br/> |10 de octubre de 2017  <br/> |
|Project 2007 Professional  <br/> |10 de octubre de 2017  <br/> |
   
Para obtener más información sobre Office servidores de 2007 que llegan a la retirada, consulte [Actualización desde Office 2007 servidores y productos cliente](upgrade-from-office-2007-servers-and-products.md).
...
La instalación de Project Server 2007 seguirá ejecutándose después de esta fecha. Pero debido a los cambios enumerados anteriormente, se recomienda encarecidamente migrar desde Project Server 2007 tan pronto como sea práctico.
...
> [!NOTE]
> Para obtener más información sobre las opciones para migrar desde los servidores de Office 2007, consulte [Recursos para ayudarle a actualizar desde Office clientes y servidores de 2007](upgrade-from-office-2007-servers-and-products.md). Tenga en cuenta que Project Server no admite una configuración híbrida, ya que Project Server y Project Online no pueden compartir el mismo grupo de recursos. 
...
1. Guarde los planes de proyecto de Project Server 2003 al formato .mpp.
...
- **Actualización de conexión de base de datos:** Este método solo actualiza el contenido de su entorno, no los valores de configuración. Es necesario si va a actualizar desde Office Project Server 2007 implementado en hardware que solo admite un sistema operativo de servidor de 32 bits. Hay dos tipos de métodos de actualización de conexión de base de datos:
  ...
  - ***Actualización completa* de la conexión a la base** de datos: migra los datos del proyecto almacenados en las bases de datos de Office Project Server 2007, además de los datos del sitio de Microsoft Project Web App almacenados en una base de datos de contenido SharePoint.
...
- [SuperFlow para la actualización de Microsoft Project Server 2010](/samples/browse/?redirectedfrom=TechNet-Gallery)
...
[Las novedades de la actualización de Project Server 2013](/project/what-s-new-in-project-server-2013-upgrade) describen los cambios importantes para la actualización de esta versión. Los más notables son: 
...
- El proceso de actualización no solo convertirá los datos de Project Server 2010 al formato Project Server 2013, sino que también consolidará las cuatro bases de datos de Project Server 2010 en una sola base de datos de Project Web App.
...
- [diagrama de procesos de actualización de Microsoft Project Server](https://go.microsoft.com/fwlink/p/?linkid=841270)
    
- [La gran consolidación de bases de datos, Project migración de Server 2010 a 2013 en 8 sencillos pasos](https://go.microsoft.com/fwlink/p/?linkid=841271)
...
- [Microsoft Office Project guía de migración de Portfolio Server 2007.](https://go.microsoft.com/fwlink/p/?linkid=841279)
