...
Como parte de la incorporación a Office 365 DoD, deberá agregar los dominios SMTP y SIP al inquilino de Servicios en línea.  Para ello, usará el cmdlet New-MsolDomain en Azure AD PowerShell o usará [Azure Government Portal](https://portal.azure.us) para iniciar el proceso de agregar el dominio y probar la propiedad.
