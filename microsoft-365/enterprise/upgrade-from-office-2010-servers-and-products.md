...
f1.keywords:
- NOCSH
description: Comience a planear la actualización desde los servidores de Office 2010 y las aplicaciones cliente, ya que la compatibilidad finaliza pronto y los acuerdos de soporte personalizados no están disponibles.
...
- Aplicaciones de Microsoft 365 para empresas (anteriormente denominada *Office 365 ProPlus),* que se incluye con Microsoft 365 E3 y E5, es el conjunto de aplicaciones cliente de Office que se instalan en el dispositivo local. Se actualizan con nuevas características de productividad y seguridad regularmente desde la nube de Microsoft.

Para obtener un resumen visual de las opciones de actualización, migración y traslado a la nube para clientes y servidores de Office 2010 y Windows 7, vea el póster de fin de [soporte](../downloads/Office2010Windows7EndOfSupport.pdf)técnico.
...
En este póster de una página se resumen las distintas rutas de acceso que puede tomar para controlar los productos de cliente y servidor de Office 2010 y Windows 7 desde que llega al final de la compatibilidad. Se resaltan las rutas preferidas y la compatibilidad con opciones en Microsoft 365 Enterprise.
