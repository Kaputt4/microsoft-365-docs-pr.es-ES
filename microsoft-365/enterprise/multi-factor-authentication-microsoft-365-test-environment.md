...
Configurar la autenticación multifactor para una cuenta en el entorno de prueba de Microsoft 365 para empresas implica dos fases y una tercera fase opcional:
...
8. En la pestaña Centro de administración de **Microsoft 365,** seleccione el icono de cuenta de usuario en la parte superior derecha y, a continuación, **seleccione Cerrar sesión.**
...
2. Vaya al Centro [de administración de Microsoft 365](https://admin.microsoft.com) e inicie sesión con el nombre de cuenta y la contraseña del usuario 2.
...
2. Seleccione **Azure Active Directory**  >  **Security** Conditional  >  **Access**.
