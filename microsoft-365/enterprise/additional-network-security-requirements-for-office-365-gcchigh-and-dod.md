...
GCC los clientes de alto nivel y dod que planean usar identidades federadas o coexistencia híbrida pueden requerir que Microsoft permita el acceso entrante o saliente a las implementaciones locales existentes.  Algunos ejemplos de estas actividades son:
...
* **Asunto del correo electrónico**: Office 365 GCC solicitud de alta red: contoso.onmicrosoft.us (reemplace por el nombre del inquilino)
...
* Indique si tiene previsto usar Microsoft Teams coexistencia híbrida con las implementaciones locales.
