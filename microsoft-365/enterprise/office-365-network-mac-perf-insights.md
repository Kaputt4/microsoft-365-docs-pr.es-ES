...
- [<span data-ttu-id="88899-109">Salida de red backhauled</span><span class="sxs-lookup"><span data-stu-id="88899-109">Backhauled network egress</span></span>](#backhauled-network-egress)
...
<span data-ttu-id="88899-123">Esta información se abrevia como "Egress" en algunas vistas de resumen.</span><span class="sxs-lookup"><span data-stu-id="88899-123">This insight is abbreviated as "Egress" in some summary views.</span></span>
...
### <a name="what-should-i-do"></a><span data-ttu-id="88899-131">¿Qué tengo que hacer?</span><span class="sxs-lookup"><span data-stu-id="88899-131">What should I do?</span></span>
...
> [!div class="mx-imgBorder"]
> <span data-ttu-id="88899-147">![Rendimiento relativo de la red](../media/m365-mac-perf/m365-mac-perf-insights-detail-cust-near-you.png)</span><span class="sxs-lookup"><span data-stu-id="88899-147">![Relative network performance](../media/m365-mac-perf/m365-mac-perf-insights-detail-cust-near-you.png)</span></span>

### <a name="what-does-this-mean"></a><span data-ttu-id="88899-148">¿Qué significa esto?</span><span class="sxs-lookup"><span data-stu-id="88899-148">What does this mean?</span></span>

<span data-ttu-id="88899-149">Esta información examina el rendimiento agregado de Microsoft 365 clientes en la misma ciudad que esta ubicación de oficina.</span><span class="sxs-lookup"><span data-stu-id="88899-149">This insight examines the aggregate performance of Microsoft 365 customers in the same city as this office location.</span></span> <span data-ttu-id="88899-150">Esta información se muestra si la latencia media de los usuarios es un 10 % mayor que la latencia media de los inquilinos vecinos.</span><span class="sxs-lookup"><span data-stu-id="88899-150">This insight is displayed if the average latency of your users is 10% greater than the average latency of neighboring tenants.</span></span>

### <a name="what-should-i-do"></a><span data-ttu-id="88899-151">¿Qué tengo que hacer?</span><span class="sxs-lookup"><span data-stu-id="88899-151">What should I do?</span></span>
...
> [!div class="mx-imgBorder"]
> <span data-ttu-id="88899-158">![Puerta frontal exo no óptima](../media/m365-mac-perf/m365-mac-perf-insights-detail-front-door-exo.png)</span><span class="sxs-lookup"><span data-stu-id="88899-158">![Non-optimal EXO front door](../media/m365-mac-perf/m365-mac-perf-insights-detail-front-door-exo.png)</span></span>

### <a name="what-does-this-mean"></a><span data-ttu-id="88899-159">¿Qué significa esto?</span><span class="sxs-lookup"><span data-stu-id="88899-159">What does this mean?</span></span>

<span data-ttu-id="88899-160">Enumeramos Exchange Online puertas frontales de servicio adecuados para su uso desde la ciudad de la ubicación de la oficina con un buen rendimiento.</span><span class="sxs-lookup"><span data-stu-id="88899-160">We list Exchange Online service front doors which are suitable for use from the office location city with good performance.</span></span> <span data-ttu-id="88899-161">Si la prueba actual muestra el uso de una puerta Exchange Online de servicio no en esta lista, llamamos a esta recomendación.</span><span class="sxs-lookup"><span data-stu-id="88899-161">If the current test shows use of an Exchange Online service front door not on this list, then we call out this recommendation.</span></span>

### <a name="what-should-i-do"></a><span data-ttu-id="88899-162">¿Qué tengo que hacer?</span><span class="sxs-lookup"><span data-stu-id="88899-162">What should I do?</span></span>

<span data-ttu-id="88899-163">El uso de una puerta principal de servicio de Exchange Online no óptima podría deberse al backhaul de red antes de la salida de la red corporativa, en cuyo caso se recomienda la salida de red local y directa.</span><span class="sxs-lookup"><span data-stu-id="88899-163">Use of a non-optimal Exchange Online service front door could be caused by network backhaul before the corporate network egress in which case we recommend local and direct network egress.</span></span> <span data-ttu-id="88899-164">También podría deberse al uso de un servidor de resolución recursiva dns remoto, en cuyo caso se recomienda alinear el servidor de resolución recursiva DNS con la salida de red.</span><span class="sxs-lookup"><span data-stu-id="88899-164">It could also be caused by use of a remote DNS Recursive Resolver server in which case we recommend aligning the DNS Recursive Resolver server with the network egress.</span></span>

## <a name="use-of-a-non-optimal-sharepoint-online-service-front-door"></a><span data-ttu-id="88899-165">Uso de una puerta principal de servicio SharePoint en línea no óptima</span><span class="sxs-lookup"><span data-stu-id="88899-165">Use of a non-optimal SharePoint Online service front door</span></span>

<span data-ttu-id="88899-166">Esta información se mostrará si el servicio de información de red detecta que los usuarios de una ubicación específica no se conectan a la puerta principal del servicio en línea SharePoint más cercana.</span><span class="sxs-lookup"><span data-stu-id="88899-166">This insight will be displayed if the network insights service detects that users in a specific location are not connecting to the closest SharePoint Online service front door.</span></span>

<span data-ttu-id="88899-167">Esta información se abrevia como "Afd" en algunas vistas de resumen.</span><span class="sxs-lookup"><span data-stu-id="88899-167">This insight is abbreviated as "Afd" in some summary views.</span></span>

> [!div class="mx-imgBorder"]
> <span data-ttu-id="88899-168">![Puerta principal de SPO no óptima](../media/m365-mac-perf/m365-mac-perf-insights-detail-front-door-spo.png)</span><span class="sxs-lookup"><span data-stu-id="88899-168">![Non-optimal SPO front door](../media/m365-mac-perf/m365-mac-perf-insights-detail-front-door-spo.png)</span></span>

### <a name="what-does-this-mean"></a><span data-ttu-id="88899-169">¿Qué significa esto?</span><span class="sxs-lookup"><span data-stu-id="88899-169">What does this mean?</span></span>
...
## <a name="sharepoint-sampled-connections-impacted-by-connectivity-issues"></a><span data-ttu-id="88899-208">SharePoint conexiones muestreadas afectadas por problemas de conectividad</span><span class="sxs-lookup"><span data-stu-id="88899-208">SharePoint sampled connections impacted by connectivity issues</span></span>
...
[<span data-ttu-id="88899-220">Microsoft 365 de prueba de conectividad de red (versión preliminar)</span><span class="sxs-lookup"><span data-stu-id="88899-220">Microsoft 365 network connectivity test tool (preview)</span></span>](office-365-network-mac-perf-onboarding-tool.md)
