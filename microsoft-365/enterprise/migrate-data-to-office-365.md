...
description: En este artículo, encontrará los recursos que le ayudarán a migrar los datos de su organización a Microsoft 365.
ms.openlocfilehash: 084cd4f6b89cfa1b8c5ad89fade3f01a0bf53dce
ms.sourcegitcommit: 27b2b2e5c41934b918cac2c171556c45e36661bf
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 03/19/2021
ms.locfileid: "50924077"
---
# <a name="migrate-your-organization-data-to-microsoft-365-enterprise"></a>Migrar datos de su organización a Microsoft 365 Enterprise

## <a name="ready-to-migrate-your-data-to-microsoft-365"></a>¿Listo para migrar los datos a Microsoft 365?

Nuestras [instrucciones básicas de configuración](https://support.office.com/article/Set-up-Office-365-for-business-6a3a29a0-e616-4713-99d1-15eda62d04fa) le ayudan a obtener todos los usuarios que usan sus servicios y aplicaciones de Microsoft 365 en el menor tiempo posible. Esto omite los escenarios híbridos y los métodos más avanzados para migrar a Microsoft 365. 
  
Si desea ayuda para configurar Microsoft 365, [FastTrack](https://fasttrack.microsoft.com/office) es la forma más sencilla de implementar Microsoft 365, también puede iniciar sesión y usar las guías de instalación de los servicios [de Microsoft 365](setup-guides-for-microsoft-365.md).

## <a name="migrate-email-to-microsoft-365"></a>Migrar correo electrónico a Microsoft 365
- Migrar con Exchange Hybrid mediante el [Asistente para implementación de Exchange](https://technet.microsoft.com/exdeploy2013). (Administrador)
...
- [Migrar a SharePoint Online y OneDrive](/sharepointmigration/migrate-to-sharepoint-online). (Administrador)
- [Rutas básicas de configuración híbrida de SharePoint Server](/SharePoint/hybrid/configuration-roadmaps). (Administrador)
