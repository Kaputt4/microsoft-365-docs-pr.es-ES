...
---
# <a name="protect-global-administrator-accounts-in-your-microsoft-365-for-enterprise-test-environment"></a>Proteger cuentas de administrador global en el entorno de prueba de Microsoft 365 para empresas
...
En este artículo se describe cómo usar directivas de acceso condicional de Azure Active Directory (Azure AD) para proteger cuentas de administrador global.

Proteger las cuentas de administrador global en el entorno de prueba de Microsoft 365 para empresas implica dos fases:
...
1. En la pestaña Centro de administración de **Microsoft 365,** seleccione **Grupos** en la navegación izquierda y, a continuación, **seleccione Grupos**.
...
2. Haga clic **en Azure Active Directory**  >  **Security**  >  **Conditional Access**.
