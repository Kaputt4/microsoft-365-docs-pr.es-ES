---
title: Protección de cuentas de administrador global en el entorno de prueba de Microsoft 365 para empresas
f1.keywords:
- NOCSH
ms.author: kvice
...
- TLG
- Ent_TLGs
description: Siga estos pasos para proteger las cuentas de administrador globales en el entorno de prueba de Microsoft 365 para empresas.
...
---
# <a name="protect-global-administrator-accounts-in-your-microsoft-365-for-enterprise-test-environment"></a>Protección de cuentas de administrador global en el entorno de prueba de Microsoft 365 para empresas
...
7. En el panel **Configuración opcional**, seleccione **Roles** >  **Administración acceso** >  al centro **Administrador** >  global **Siguiente**.
...
9. En el panel **GlobalAdmins**, seleccione **Agregar miembros**, seleccione la cuenta **DedicatedAdmin** y la cuenta de administrador global y, a continuación, seleccione **Guardar** > **cierre** > .
...
4. En la pestaña **Incluir** del panel **Usuarios y grupos** , seleccione **Seleccionar usuarios y grupos** > **Usuarios y grupos** > **Seleccione**.
5. En el panel **Seleccionar** , seleccione el grupo **GlobalAdmins** y seleccione **Seleccionar** > **listo**.
