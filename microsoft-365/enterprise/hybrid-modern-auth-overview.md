...
Para más información sobre la autenticación moderna en Office 365, vea [Soporte para aplicaciones cliente de Office 365: autenticación moderna](microsoft-365-client-support-modern-authentication.md).
