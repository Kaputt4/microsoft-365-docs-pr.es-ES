...
- **Dynamics 365**, realice [este paso](#dynamics-365).
...
|Garantizar la conectividad de [red a Office 365 direcciones IP y direcciones IP de los servicios.](https://aka.ms/o365urls)|Todos los clientes y servicios hospedados por el cliente que se usan para obtener acceso Office 365 servicio deben poder tener acceso a los puntos de conexión Office 365 servicios globales. <p> En caso de que usted o sus asociados de colaboración tengan reglas de firewall que impidan el acceso a las direcciones URL y direcciones IP enumeradas en las direcciones URL de servicios de Office 365 y las direcciones IP deben cambiar las reglas de firewall para permitir el acceso [a](https://aka.ms/o365urls) los extremos de servicio global de Office 365|Pueden producirse errores en el servicio o el software cliente si no se realiza antes de la fase 4|
...
Durante la migración, mientras la organización está entre la fase 2 y la fase 9, no puede agregar ninguna aplicación multiinquilino (MTA) de terceros a su organización. Cuando la migración finalice la fase 9, puede reanudar la adición o consentimiento de aplicaciones MTA para su organización.
