...
| Revisar y preparar los cambios de DNS relacionados con la migración. | El cliente prepara las entradas DNS para Exchange Online y Exchange Online Protection (registro MX, etc.). | Clientes de Exchange Online | Se trata de una acción recomendada. Ninguna acción significa que el correo electrónico de los clientes migrados puede enrutar a través de Microsoft Cloud Deutschland hasta que los servicios de Microsoft Cloud Deutschland estén deshabilitados. |
