...
En este artículo se proporcionan instrucciones paso a paso para crear un entorno simplificado para Microsoft 365 para empresas que incluya lo siguiente:
...
- El nombre de dominio DNS público de su entorno de prueba (testlab.\<your public domain>). Deberá escribir este nombre en el **campo Nombre de dominio** de la página **Implementación personalizada**.
...
A continuación, configure DC1 como controlador de dominio y servidor DNS para el dominio **testlab.**\<your public domain> . Especifique el nombre de su dominio público, quite los caracteres \< and > y, a continuación, ejecute estos comandos en el símbolo del sistema de Windows PowerShell en el nivel de administrador en DC1.
...
5. En la barra de direcciones, escriba **http<span>://</span>app1.testab.**\<your public domain name>**/** y, luego, presione ENTRAR. Debería ver la página web predeterminada de Internet Information Services para APP1.
...
Consulte las [guías del laboratorio de pruebas de 365 de Microsoft para empresas](m365-enterprise-test-lab-guides.md) para ver las guías del laboratorio de pruebas adicionales que se aplican tanto a Microsoft 365 como a Office 365.
