...
En lugar de intentar cargar pruebas SharePoint como un servicio, en lugar de centrarse en seguir los procedimientos recomendados y seguir las instrucciones para [crear,](/sharepoint/portal-health) iniciar y mantener un portal en buen estado.