...
### <a name="using-an-office-365-devtest-environment"></a>Usar un entorno de desarrollo y pruebas de Office 365

Si solo necesita un entorno de desarrollo y pruebas de Office 365, vea está información. 
