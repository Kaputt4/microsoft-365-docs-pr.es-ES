...
---
# <a name="microsoft-365-client-app-support-single-sign-on"></a>Compatibilidad con aplicaciones cliente de Microsoft 365: Sign-On
...
Las últimas versiones de los siguientes clientes y plataformas admiten el inicio de sesión único. Para obtener más información acerca de la compatibilidad con plataformas en Microsoft 365, consulte Requisitos del sistema [para Microsoft 365.](/microsoft-365/microsoft-365-and-office-resources)
<br>
<br>
...
| Microsoft Edge | ![Compatible](../media/check-mark.png) | Planeado | N/D | N/D | ![Compatible](../media/check-mark.png) |
...
| Kaizala | ![Compatible](../media/check-mark.png) | Planeado | N/D | N/D | N/D |
...
| OneDrive | ![Compatible](../media/check-mark.png) | ![Compatible](../media/check-mark.png) | Planeado | ![Compatible](../media/check-mark.png) | Planeado |
...
| Teams | ![Compatible](../media/check-mark.png) | ![Compatible](../media/check-mark.png) | Planeado | N/D | Planeado |
| Tareas pendientes | ![Compatible](../media/check-mark.png) | ![Compatible](../media/check-mark.png) | No aplicable | ![Compatible.](../media/check-mark.png) | No aplicable |
...
| Yammer | ![Compatible](../media/check-mark.png) | ![Compatible](../media/check-mark.png) | N/D | N/D | Planeado |
