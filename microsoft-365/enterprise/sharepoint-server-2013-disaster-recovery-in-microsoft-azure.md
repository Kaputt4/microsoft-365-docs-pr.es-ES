...
|Escenarios de restauración de búsqueda|Because enterprise search deployments tend to be fairly unique and complex, restoring search from databases requires a greater investment. You can work with a consultant or partner to identify and implement search restore scenarios that your organization might require.|
...
|Fase 7|Validate failover and recovery solutions. This includes the following procedures and technologies: <br/> Detener el trasvase de registros <br/> Restaurar las copias de seguridad <br/> Rastrear el contenido <br/> Recuperar servicios <br/> Administrar los registros DNS|
...
|SP-SQL-HA1, SP-SQL-HA2|Database servers, configured with SQL Server 2012 AlwaysOn availability groups to provide high availability. This configuration uses SP-SQL-HA1 and SP-SQL-HA2 as the primary and secondary replicas.|Cuatro procesadores <br/> De 2 a 16 GB de RAM|
