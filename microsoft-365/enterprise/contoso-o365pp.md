...
- El panel administración de cliente de Office, que facilita la implementación de Office y la supervisión de actualizaciones y proporciona a los administradores acceso a las características de implementación y administración más recientes.
...
Además de Configuration Manager, Contoso usó [Readiness Toolkit para complementos de Office y VBA](/deployoffice/readiness-toolkit-application-compatibility-microsoft-365-apps), una herramienta gratuita de Microsoft, para evaluar los problemas de compatibilidad con sus macros y complementos de Office.
...
- Semi-Annual Canal de empresa para actualizaciones en el grupo amplio
...
1. Antes de la implementación, Contoso usó el kit de herramientas de preparación para complementos de Office y VBA para probar sus aplicaciones y complementos de Office con el fin de evaluar su compatibilidad con Aplicaciones Microsoft 365 para empresas.
...
1. Crearon paquetes de implementación para Office mediante el panel de administración de cliente de Office y el asistente del instalador de Office 365, que forman parte de la consola de Configuration Manager. Crearon dos paquetes de Aplicaciones Microsoft 365 para empresas, uno para el grupo piloto en Semi-Annual Enterprise Channel (versión preliminar) y otro para el grupo amplio en el canal Semi-Annual Enterprise.
2. Cada paquete de Office incluía paquetes de inglés, francés y alemán. Si un dispositivo requiere un idioma que no se incluyó en el paquete de Office, ese paquete de idioma se descargó automáticamente de Office Content Delivery Network (CDN).
