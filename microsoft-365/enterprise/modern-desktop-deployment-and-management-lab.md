...
**Windows 10 y Windows 11 versiones del kit de laboratorio de implementación ya están disponibles para su descarga gratuita en el Centro de evaluación de Microsoft.**

[Descargar Windows 11 con Office 365 de laboratorio de implementación](https://www.microsoft.com/evalcenter/evaluate-windows-11-office-365-lab-kit)<br>
[Descargar Windows 10 con Office 365 de laboratorio de implementación](https://www.microsoft.com/evalcenter/evaluate-lab-kit)
...
|Microsoft Endpoint Configuration Manager, versión 2103     |  Microsoft Endpoint Configuration Manager, versión 2111      | 
...
- Adjunte y co-administración de inquilinos
- Análisis de puntos de conexión
- Optimizar la entrega de actualizaciones

### <a name="deploy-windows"></a>Implementar Windows 

- Secuencias de tareas de implementación del sistema operativo en Configuration Manager
- Windows Autopilot

### <a name="service-windows"></a>Servicio Windows 

- Mantenimiento de Windows con la directiva de grupo
...
- Enterprise administrada con Configuration Manager
...
- Implementar y actualizar edge    
- Modo IE
- Configurar Enterprise nueva pestaña 
