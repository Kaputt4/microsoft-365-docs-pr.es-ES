...
La herramienta de diagnóstico de SharePoint página se puede instalar para:
...
El procedimiento de instalación de esta sección funcionará para los exploradores chrome y Microsoft Edge web.
...
## <a name="what-youll-see-in-the-page-diagnostics-for-sharepoint-tool"></a>Lo que verá en la herramienta Diagnóstico de página para SharePoint página
...
1. Haga clic en los puntos suspensivos (...) en la esquina superior derecha de la herramienta para buscar los vínculos siguientes:
   ...
   1. El **vínculo Enviar comentarios** proporciona un vínculo al sitio SharePoint sitios y el sitio de voz del usuario de _colaboración._
...
>[!NOTE]
>Los sitios de grupo clásicos que no tienen habilitada la característica de publicación no pueden usar cdnes. Al ejecutar la herramienta en estos sitios, se espera que la prueba CDN error y se pueda omitir, pero todas las pruebas restantes son aplicables. La funcionalidad adicional de la característica SharePoint publicación de páginas puede aumentar los tiempos de carga de página, por lo que no debe habilitarse solo para permitir CDN funciones.
...
La **pestaña Seguimiento de** red proporciona información detallada sobre ambas solicitudes para crear la página y las respuestas recibidas de SharePoint.
...
1. Abra la herramienta Diagnóstico de página SharePoint página.
