...
En esta serie de artículos se describe cómo configurar el acceso seguro a los servicios en la nube mediante Microsoft 365 para productos empresariales mediante la implementación de un entorno y una configuración recomendados, incluido un conjunto de directivas de acceso condicional y funcionalidades relacionadas. Puede usar esta guía para proteger el acceso a todos los servicios que se integran con Azure Active Directory (Azure AD), incluidos los servicios de Microsoft 365, otros servicios de SaaS y aplicaciones locales publicadas con el proxy de aplicación de Azure AD.
...
![Miniatura del póster "protección de identidades y dispositivos para Office 365"](../media/microsoft-365-policies-configurations/O365_Identity_device_protection_thumb.png)<br/>
...
| [Inscripción de dispositivos](/azure/active-directory/devices/overview) | Inscriba un dispositivo en Azure AD para crear una identidad para el dispositivo. Esta identidad se usa para autenticar el dispositivo cuando un usuario inicia sesión y aplica reglas de acceso condicional que requieren equipos compatibles o Unidos a un dominio. Para esta guía, usamos la inscripción de dispositivos para inscribir automáticamente equipos con Windows Unidos a un dominio. La inscripción de dispositivos es un requisito previo para administrar dispositivos con Intune. | Microsoft 365 E3 o E5 |
...
- [Configurar su espacio empresarial para aumentar la seguridad](../security/office-365-security/tenant-wide-setup-for-increased-security.md)

  Recomendaciones relativas a la seguridad de línea base de su espacio empresarial.

- [Plan de seguridad: principales prioridades de los primeros 30 días, 90 días y más allá](../security/office-365-security/security-roadmap.md)
