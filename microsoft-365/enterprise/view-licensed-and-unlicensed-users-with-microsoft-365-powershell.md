...
---
# <a name="view-licensed-and-unlicensed-microsoft-365-users-with-powershell"></a>Ver usuarios de Microsoft 365 con licencia y sin licencia con PowerShell

*Este artículo afecta tanto a Office 365 Enterprise como a Microsoft 365 Enterprise*

Las cuentas de usuario de su organización de Microsoft 365 pueden tener algunas, todas o ninguna de las licencias disponibles asignadas desde los planes de licencias disponibles en su organización. Puede usar PowerShell para Microsoft 365 para encontrar rápidamente los usuarios con licencia y sin licencia de su organización.
...
Para ver la lista de todas las cuentas de usuario de la organización que se han asignado a cualquiera de sus planes de licencias (usuarios con licencia), ejecute el siguiente comando:
...
Para ver la lista de todas las cuentas de usuario y su estado de licencia en la organización, ejecute el siguiente comando en PowerShell:
