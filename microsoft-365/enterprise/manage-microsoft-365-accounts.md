---
title: Herramientas para administrar cuentas de usuario de Microsoft 365
ms.author: josephd
...
ms.locfileid: "46694117"
---
# <a name="tools-to-manage-microsoft-365-user-accounts"></a>Herramientas para administrar cuentas de usuario de Microsoft 365
...
- [Proveedores de identidad y autenticación de terceros](about-microsoft-365-identity.md) : los objetos de AD DS se pueden sincronizar con Microsoft 365 y el acceso a recursos de la nube es administrado principalmente por un proveedor de identidades de terceros (IDP). 
