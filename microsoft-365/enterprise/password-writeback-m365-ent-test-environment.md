...
En este artículo se describe cómo configurar el entorno de prueba de Microsoft 365 para la escritura de contraseña.

La configuración del entorno de prueba para la reescribición de contraseñas consta de dos fases:
...
3. En la **página Usuarios activos,** seleccione la **cuenta usuario1,**

4. En el **panel usuario1,** seleccione **Editar** junto a **Roles**.

5. En el **panel Editar roles de** usuario para usuario1, seleccione Administrador **global,** Guardar **y,** a continuación, **seleccione Cerrar**.
...
3. En la barra de menús, seleccione **Ver**. Si **las características avanzadas** no están habilitadas, selecciónelos para habilitarlo.

4. En el panel de árbol, seleccione y mantenga presionado (o haga clic con el botón secundario) el dominio, seleccione Propiedades y, a continuación, seleccione la **pestaña** Seguridad.

5. Seleccione **Opciones avanzadas**.

6. En la **pestaña Permisos,** seleccione **Agregar**.

7. Seleccione **Seleccionar una entidad de** seguridad, escriba **Usuario1** y, a continuación, **seleccione Aceptar**.
...
6. En las **páginas Conectar directorios** y Filtrado de dominios **o unidades** organizativas, seleccione **Siguiente**.
...
9. Cuando vea que finaliza la configuración, seleccione **Salir**.

Ahora está listo para probar la escritura reescribición de contraseñas para los usuarios en equipos que no están conectados a la red virtual de la intranet simulada.
...
- Suscripciones de prueba o de pago de Microsoft 365 E5 con el dominio DNS TESTLAB.\<*your domain name*> registrado.
- Una intranet de organización simplificada conectada a Internet, que consta de las máquinas virtuales DC1, APP1 y CLIENT1 en una subred de una red virtual de Azure.
