...
El siguiente diagrama ilustra el conjunto de directivas recomendadas para la protección de archivos en SharePoint Online y OneDrive para la empresa. Indica qué directivas se actualizará o creadas recientemente para agregar protección para SharePoint Online y OneDrive para la empresa.

![Resumen de directivas para SharePoint Online y OneDrive](../images/identity-access-ruleset-sharepoint.png)

Si ha incluido SharePoint Online cuando crea las políticas comunes, sólo necesita crear el nuevo polcies. Al configurar las reglas de acceso condicional, SharePoint Online incluye OneDrive para la empresa.
...
Las nuevas directivas de implementan la protección de dispositivo contenido confidencial y altamente regulado aplicando los requisitos de acceso específico a los sitios de SharePoint que especifique. 
 ...
 En la siguiente tabla se enumera las directivas que necesite revisar y actualizar o crear nuevos para SharePoint Online. Vinculación las directivas comunes a las instrucciones de configuración asociada en el artículo de [las directivas de acceso de dispositivo e identidad comunes](identity-access-policies.md) (vínculos próximamente).


|Nivel de protección|Policies|Más información|
|:---------------|:-------|:----------------|
|**Línea base**|[Requerir MFA al inicio de sesión de riesgo es *medio* o *alto*](identity-access-policies.md#require-mfa-based-on-sign-in-risk)|Incluir SharePoint Online en las asignaciones de aplicaciones en la nube.|
|        |[Clientes de bloque que no admiten la autenticación moderna](identity-access-policies.md#block-clients-that-dont-support-modern-authentication)|Incluir SharePoint Online en las asignaciones de aplicaciones en la nube.|
...
|**Confidencial**|[Requerir MFA al inicio de sesión de riesgo es *bajo*, *medio* o *alto*](identity-access-policies.md#require-mfa-based-on-sign-in-risk)| Incluir SharePoint Online en las asignaciones de aplicaciones en la nube.|
...
||[Directiva de control de acceso a SharePoint Online](#sharepoint-online-access-control-policies): permitir el acceso de sólo explorador a determinados sitios de SharePoint desde dispositivos no administrados|Esto evita la edición y la descarga de archivos. PowerShell de usuario para especificar los sitios.|
|**Extremadamente regulado**|[*Siempre* requrie MFA](identity-access-policies.md#require-mfa-based-on-sign-in-risk)|Incluir SharePoint Online en las asignaciones de aplicaciones en la nube. |
...
## <a name="use-app-enforced-restrictions-in-sharepoint-online"></a>Aplicación de uso aplica restricciones en SharePoint Online
...
En la ilustración:
- James se asigna a las directivas de acceso condicional asociadas a la protección de línea de base, pero puede tener acceso a sitios de SharePoint asociados a la protección altamente regulada o confidencial. 
