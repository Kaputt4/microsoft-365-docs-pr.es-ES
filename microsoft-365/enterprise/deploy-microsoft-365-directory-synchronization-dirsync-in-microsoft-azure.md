...
Antes de implementar esta solución en producción, puede seguir las instrucciones de [la configuración básica empresarial simulada](simulated-ent-base-configuration-microsoft-365-enterprise.md) para establecer esta configuración como una prueba de concepto, para demostraciones o para experimentación.
