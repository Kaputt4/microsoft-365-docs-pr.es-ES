...
**Resumen**: Cree un sitio de equipo de SharePoint Online o un equipo de Microsoft Teams para almacenar los recursos digitales más valiosos y confidenciales.
...
- Bloquee el sitio o equipo para evitar:
   - El acceso a todos los usuarios excepto a un conjunto específico de cuentas a través de la pertenencia a grupos, lo que incluye aquellas que pueden acceder al sitio de grupo de SharePoint Online y el nivel de permiso con el que cuentan, además de aquellas que pueden administrarlo.
   - Que miembros del sitio concedan acceso a terceros.
   - Que aquellos que no sean miembros del sitio soliciten acceso.
- Configure una etiqueta de Office 365 para los sitios o grupos de SharePoint Online de forma predeterminada para clasificar recursos digitales en el sitio.
- Bloquee la capacidad de los usuarios de enviar archivos fuera de la organización.
...
| Etiquetar los recursos digitales del sitio | Etiquetas de Office 365 |
...
- Su [infraestructura básica](deploy-foundation-infrastructure.md). 
...
- La etiqueta de Office 365 para asignar al sitio y el conjunto de directivas DLP para la etiqueta
...
### <a name="step-2-office-365-labels-and-dlp-policies"></a>Paso 2: Etiquetas de Office 365 y directivas DLP

Cuando se aplican a un sitio de grupo de SharePoint Online, las etiquetas de Office 365 proporcionan un método predeterminado de clasificación para todos los recursos digitales almacenados en el sitio.
 
En los sitios de SharePoint Online para datos altamente regulados, debe determinar qué etiqueta de Office 365 usar.

Para conocer las consideraciones de diseño de las etiquetas de Office 365, consulte [Etiquetas y clasificación de Office 365](https://docs.microsoft.com/office365/enterprise/secure-sharepoint-online-sites-and-files#office-365-classification-and-labels).
...
En los sitios de SharePoint Online con datos altamente regulados, debe configurar una directiva DLP para la etiqueta de Office 365 asignada al sitio; esta directiva deberá bloquear a los usuarios cuando intenten compartir recursos digitales con usuarios externos. 
...
Para conocer las consideraciones sobre el diseño de las etiquetas de Azure Information Protection, consulte [Azure Information Protection](https://docs.microsoft.com/office365/enterprise/secure-sharepoint-online-sites-and-files#azure-information-protection).
...
- La etiqueta adecuada de Office 365 y la directiva DLP que tiene asociada
...
### <a name="step-2-configure-the-site-for-an-office-365-label-dlp-policy"></a>Paso 2: Configurar el sitio para una directiva DLP de etiquetas de Office 365
...
- Identificar o crear la etiqueta de Office 365 y aplicarla a su sitio de SharePoint Online aislado.
...
- Una etiqueta de Office 365 asignada al sitio de SharePoint Online aislado
- Una directiva DLP para la etiqueta de Office 365
