...
La mayoría de las organizaciones empresariales tienen un entorno heterogéneo que incluye varias versiones de sistemas operativos, software cliente y software de servidor. Microsoft 365 para Enterprise incluye las versiones más seguras de los componentes clave de su infraestructura de TI. También incluye características de productividad diseñadas para aprovechar las tecnologías en la nube.

Para maximizar el valor empresarial de la Microsoft 365 para Enterprise conjunto de productos integrados, comience a planear e implementar una estrategia para migrar las versiones de:

- El Office instalado en los equipos para Aplicaciones Microsoft 365 para empresas.
- Los Office instalados en los servidores en sus servicios equivalentes en Microsoft 365.
...
A medida que realiza estas migraciones con el tiempo, su organización se acerca más a la visión del [lugar de trabajo moderno.](https://www.microsoft.com/microsoft-365/blog/2018/04/27/making-it-simpler-with-a-modern-workplace/) Este entorno seguro e integrado puede ayudarle a desbloquear el trabajo en equipo y la creatividad en su organización. Microsoft 365 para Enterprise permite y le habilita en todo el camino.

## <a name="migration-for-office-client-products"></a>Migración para Office cliente

Las organizaciones grandes y pequeñas suelen usar una combinación de versiones anteriores de Office cliente, como Word, Excel y PowerPoint. Estas versiones anteriores:
...
Microsoft 365 para Enterprise incluye Aplicaciones Microsoft 365 para empresas. Esta versión de los Office cliente está disponible con una Microsoft 365 para Enterprise licencia. Se instala y actualiza desde la nube de Microsoft. Aplicaciones de Microsoft 365 para empresas incluye actualizaciones de seguridad y las características más recientes. Para obtener más información, vea [Acerca de Aplicaciones Microsoft 365 para empresas](/deployoffice/about-microsoft-365-apps).

### <a name="office-2007"></a>Office 2007

Para las versiones de Office en la Office 2007, el final de la compatibilidad ya ha pasado. Para obtener más información, vea Office plan de fin de soporte técnico de [2007](/deployoffice/office-2007-end-support-roadmap).

En lugar de actualizar los equipos que ejecutan Office 2007 a Office 2010, Office 2013 o Office 2016, considere la posibilidad de seguir los siguientes pasos:
...
Para las versiones de Office versión Office 2010, la compatibilidad finalizó el 13 de octubre de *2020*. Para obtener más información, vea Office plan de fin de soporte técnico de [2010](/deployoffice/office-2010-end-support-roadmap).

Es posible que considere la posibilidad de actualizar los equipos que ejecutan Office 2010 a Office 2013 o Office 2016. Sin embargo, ambas versiones deben actualizarse manualmente. Por lo tanto, considere la posibilidad de seguir los pasos siguientes en su lugar:

1. Obtener y asignar una Microsoft 365 licencia de usuario para los usuarios.
2. Desinstale Office 2010 en sus equipos.
3. Instale Aplicaciones Microsoft 365 para empresas, ya sea individualmente o durante un lanzamiento de IT. Para más información, consulte la [Guía de implementación para Aplicaciones de Microsoft 365](/deployoffice/deployment-guide-microsoft-365-apps).

Aplicaciones Microsoft 365 para empresas instala automáticamente las actualizaciones de seguridad y las actualizaciones de nuevas características. Puede aprovechar los servicios basados en la nube en Microsoft 365 mejorar la seguridad y la productividad.

### <a name="office-2013-and-office-2016"></a>Office 2013 y Office 2016

Vea la guía básica de fin de [soporte técnico para Office 2013](/lifecycle/products/microsoft-office-2013). El final de la compatibilidad con Office 2016 aún no se ha determinado. En estas versiones, como Office 2010, debe instalar [actualizaciones de seguridad.](https://support.office.com/article/install-office-updates-2ab296f3-7f03-43a2-8e50-46de917611c5) Es posible que esta tarea no se escale bien, según el tamaño de la organización.

En lugar de mantener los equipos actualizados con las actualizaciones de seguridad más recientes para Office 2013 o Office 2016, o actualizar los equipos de Office 2013 Office 2016, considere la posibilidad de seguir los siguientes pasos:

1. Obtener y asignar una Microsoft 365 licencia de usuario para los usuarios.
2. Desinstale Office 2013 o Office 2016 en sus equipos.
3. Instale Aplicaciones Microsoft 365 para empresas, ya sea individualmente o durante un lanzamiento de IT. Para más información, consulte la [Guía de implementación para Aplicaciones de Microsoft 365](/deployoffice/deployment-guide-microsoft-365-apps).

Aplicaciones Microsoft 365 para empresas instala automáticamente las actualizaciones de seguridad y las nuevas características. Puede aprovechar los servicios basados en la nube en Microsoft 365 mejorar la seguridad y la productividad.

## <a name="migration-for-office-server-products"></a>Migración para Office de servidor

Las organizaciones grandes y pequeñas suelen usar una combinación de versiones anteriores de los Office de servidor, como Exchange Server y SharePoint Server. Estas versiones anteriores:
...
- No incluyas las características de seguridad más recientes, como Exchange y Defender para Office 365.

Microsoft 365 para Enterprise incluye versiones basadas en la nube de servicios de servidor de Office que usan algunas de las mismas herramientas que las versiones locales de software de servidor de Office, como exploradores web y el cliente Outlook. Estos servicios se actualizan automáticamente por motivos de seguridad. Por lo tanto, el personal de IT ahorra el tiempo necesario para mantener y actualizar los servidores locales. Estos servicios también ofrecen nuevas mejoras de características que no están presentes en Office software de servidor.
...
### <a name="office-2007-server-products"></a>Office de servidor de 2007

Para los productos de servidor de la Office 2007, el final de la compatibilidad ya ha pasado. Vea estos artículos para obtener más información:

- [Exchange plan de fin de soporte técnico de 2007](exchange-2007-end-of-support.md)
- [SharePoint Guía básica de fin de soporte técnico de Server 2007](sharepoint-2007-end-of-support.md)
- [Project Guía básica de fin de soporte técnico de Server 2007](project-server-2007-end-of-support.md)
- [Office Guía básica de fin de soporte técnico de Communications Server](/skypeforbusiness/plan-your-deployment/upgrade)
- [PerformancePoint Server plan de fin de soporte técnico de 2007](pps-2007-end-of-support.md)

En lugar de actualizar los productos de servidor en la versión de Office 2007 con productos de servidor en las versiones de Office 2010, Office 2013 o Office 2016, considere la posibilidad de seguir los pasos siguientes:

1. Migre los datos de los servidores Office 2007 a Microsoft 365. Para obtener más información o ayuda, contrate a un partner de Microsoft.
2. Roll out the new functionality and work processes to your users.
3. Cuando ya no necesite los servidores locales que se Office productos de servidor de 2007, retirarlos.

### <a name="office-2010-server-products"></a>Office de servidor de 2010
...
### <a name="office-2013-server-products"></a>Office de servidor de 2013
...
### <a name="office-2016-server-products"></a>Office de servidor de 2016
...
La compatibilidad finalizó Windows 7 de enero *de 2020.* Para migrar los dispositivos que se Windows 7 o Windows 8.1, puede realizar una actualización local.
...
## <a name="office-2010-clients-and-servers-and-windows-7"></a>Office clientes y servidores de 2010 y Windows 7
...
[![Imagen que muestra las opciones para el final de la compatibilidad Office clientes y servidores de 2010 y Windows 7.](../media/microsoft-365-overview/office2010-windows7-end-of-support.png)](../downloads/Office2010Windows7EndOfSupport.pdf)

Este póster de una página es una forma rápida de comprender las rutas de acceso que puede tomar para administrar el fin de la compatibilidad con los productos de cliente y servidor de Office 2010 y Windows 7. Las rutas de acceso preferidas se admiten Microsoft 365 para Enterprise.
...
Para obtener una mejor imagen de cómo mover toda la organización a los productos y servicios de Microsoft 365 para Enterprise, descargue este póster de transición:
...
- [Windows 10 implementación: Sugerencias y trucos de Microsoft IT](https://www.microsoft.com/itshowcase/Article/Content/951/Windows-10-deployment-tips-and-tricks-from-Microsoft-IT) (vídeo)