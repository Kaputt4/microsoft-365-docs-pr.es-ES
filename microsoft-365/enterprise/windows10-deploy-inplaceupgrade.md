...
## <a name="the-windows-10-deployment-with-system-center-configuration-manager-poster"></a>El póster para la implementación de Windows 10 con System Center Configuration Manager
