...
¿Está listo para implementar Microsoft 365 Enterprise, integrarla con la infraestructura local y permitir que los empleados aprovechen la productividad y la colaboración basadas en la nube?
...
3. [Implementación de la seguridad](/office365/securitycompliance/security-roadmap)
   ...
   Incluye la configuración y la implementación de protecciones básicas y mejoradas de seguridad, amenazas e información para el inquilino y las identidades en los primeros 30 días, 90 días y posteriores.
...
5. [Configuración de la administración de dispositivos móviles](https://support.office.com/article/set-up-mobile-device-management-mdm-in-office-365-dd892318-bc44-4eb1-af00-9db5430be3cd)
   ...
   Microsoft 365 Enterprise incluye funcionalidades de administración de dispositivos móviles que le ayudan a proteger y administrar los dispositivos móviles de los usuarios.
...
>[!Note]
>Estos pasos también son para empresas y [organizaciones sin ánimo de lucro](https://go.microsoft.com/fwlink/?LinkId=627221) que quieren empezar con una implementación personalizada de Microsoft 365 Enterprise. 
>