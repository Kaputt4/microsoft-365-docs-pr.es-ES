...
Para conocer los pasos para optimizar la red para Microsoft 365 y otras plataformas y servicios en la nube de Microsoft, consulte el póster [Microsoft Cloud Networking for Enterprise Architects](https://aka.ms/cloudarchnetworking) .
...
- [Guías de configuración de servicios de Office 365](setup-guides-for-microsoft-365.md)
