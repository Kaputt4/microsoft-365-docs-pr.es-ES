...
Para conocer los pasos para optimizar la red para Microsoft 365 y otras plataformas y servicios en la nube de Microsoft, consulte el póster [Microsoft Cloud Networking for Enterprise Architects (Redes en la nube de Microsoft para arquitectos de Enterprise](../solutions/cloud-architecture-models.md)).
...
- [Microsoft 365 herramienta de prueba de conectividad de red](/microsoft-365/enterprise/office-365-network-mac-perf-onboarding-tool): prueba Microsoft 365 conectividad de red.
...
6. Algunos clientes encuentran que la configuración de red interna puede afectar al rendimiento. Configuración como el tamaño máximo de la unidad de transmisión (MTU), la negociación automática de la red o la detección automática, y las rutas sub-óptimas a Internet son lugares comunes para buscar.
