...
Al hacer doble clic en la alerta de servicio, se muestra una página desplegable similar a la siguiente.

![Contenido de la alerta de servicio para mensajes pendientes de entrega a destinatarios externos.](../media/microsoft-365-exchange-monitoring/ExternalRecipientsServiceAlerts2.png)

## <a name="what-do-these-service-alerts-indicate"></a>¿Qué indican estas alertas de servicio?

Las alertas de servicio para mensajes pendientes de entrega a destinatarios externos le informan de que los mensajes destinados a destinatarios fuera de Exchange Online pueden retrasarse. La cola de mensajes puede deberse al entorno local o a una solución de mensajería o registro en diario de terceros.

Estos son algunos motivos comunes para poner en cola mensajes a destinatarios externos. Sin embargo, es posible que los problemas que causan estas alertas de servicio no se limite a estos motivos.

- Cambios de DNS

- Tasas de envío excesivas

- Agentes de transferencia de mensajes (MTA) locales o soluciones de registro en diario con poco o ningún espacio libre en disco
...
Para obtener más información para determinar la causa raíz de estas alertas de servicio, vea [Inteligencia de flujo de correo en Exchange Online](../security/office-365-security/mail-flow-intelligence-in-office-365.md). En este artículo también se incluyen acciones sugeridas para corregir la causa raíz.

> [!NOTE]
> Microsoft no puede tener en cuenta todos los códigos de error SMTP proporcionados por proveedores de terceros. Por lo tanto, es posible que los administradores deban investigar códigos de errores específicos de sus soluciones de MTA o de registro en diario usadas por su organización.
...
- [Configurar el flujo de correo mediante conectores en Exchange Online](/exchange/mail-flow-best-practices/use-connectors-to-configure-mail-flow/use-connectors-to-configure-mail-flow)
