...
|---------|---------|---------|---------|
|RED CDN de Office 365     |Download         |Recursos genéricos en orígenes públicos, contenido de usuario de SharePoint en orígenes privados         |[Uso de la red de entrega de contenido de Office 365 con SharePoint Online](use-microsoft-365-cdn-with-spo.md)         |
...
También puede usar la [dirección IP y el servicio Web de office 365](microsoft-365-ip-web-service.md) para solicitar las direcciones URL y los intervalos de direcciones IP de Office 365 actuales con formato CSV o JSON.
