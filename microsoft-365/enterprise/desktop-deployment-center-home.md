        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Actualizar ConfigMgr a la rama actual</h3>
            <p>Parte de la preparación de red y el directorio para las organizaciones que usan el Administrador de configuración</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Validar dispositivos y aplicaciones preparadas</h3>
            <p>Parte de la preparación de dispositivos y aplicaciones; la ayuda está disponible a través de la Asesoría de aplicaciones de escritorio</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Actualizar equipos de Windows 7 a Windows 10</h3>
            <p>Parte de la implementación del SO y actualizaciones de características para los equipos retenidos por el usuario</p>
                    </div>
                </div>
            </div>
        </div>
