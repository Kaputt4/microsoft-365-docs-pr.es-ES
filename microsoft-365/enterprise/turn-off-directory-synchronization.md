...
[Póngase en contacto con](https://support.office.com/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b) el soporte técnico de productos empresariales si es necesario.
...
1. En primer lugar, instale el software necesario y conéctese a su suscripción a Microsoft 365. Para obtener instrucciones, [consulte Conectarse con el módulo microsoft Azure Active Directory para Windows PowerShell](connect-to-microsoft-365-powershell.md#connect-with-the-microsoft-azure-active-directory-module-for-windows-powershell).
    
2. Use [Set-MsolDirSyncEnabled para](https://go.microsoft.com/fwlink/p/?LinkId=821939) deshabilitar la sincronización de directorios: 
...
>[!Note]
>Si usa este comando, debe esperar 72 horas para volver a activar la sincronización de directorios.
>
