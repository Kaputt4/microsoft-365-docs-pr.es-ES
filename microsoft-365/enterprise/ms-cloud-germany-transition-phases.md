...
|Pasos|Duración|Responsable|Description|
|---|---|---|---|
...
|**Tarea de administración** Deshabilitar características|El administrador debe realizar una acción explícita para deshabilitar esas características, si es necesario.|<ul><li>Los usuarios ven nuevos servicios desconocidos en el portal</li><li>La funcionalidad adicional está disponible (por ejemplo, Microsoft Planner y Power Automate), a menos que esté deshabilitada por el administrador del espacio empresarial.</li></ul> <p> Para obtener información sobre cómo deshabilitar los planes de servicio asignados a las licencias de los usuarios, [vea Disable access to Microsoft 365 services while assigning user licenses](disable-access-to-services-while-assigning-user-licenses.md).</li></ul>|
