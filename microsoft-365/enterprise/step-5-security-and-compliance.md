...
[Implementación básica de Bitlocker](https://docs.microsoft.com/windows/security/information-protection/bitlocker/bitlocker-basic-deployment)
...
[Aspectos básicos de la administración de identidades de Azure](https://docs.microsoft.com/azure/active-directory/fundamentals/identity-fundamentals)

[Información acerca de las soluciones de identidad de Azure](https://docs.microsoft.com/azure/active-directory/fundamentals/understand-azure-identity-solutions)

[Acceso condicional de Azure Active Directory](https://docs.microsoft.com/azure/active-directory/conditional-access/overview)
...
[Más información sobre la seguridad basada en la virtualización](https://docs.microsoft.com/windows-hardware/design/device-experiences/oem-vbs)
...
También se ha incluido la protección **[Vínculos seguros](https://docs.microsoft.com/office365/securitycompliance/atp-safe-links)** en las aplicaciones de Office para protegerle de una lista dinámica de sitios web malintencionados conocidos.
