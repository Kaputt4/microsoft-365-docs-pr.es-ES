...
Al crear un inquilino de Microsoft 365, se asigna a una ubicación geográfica específica. También puede tener un inquilino con varias ubicaciones geográficas y mover el espacio empresarial de una ubicación a otra.
...
- [Comprender suscripciones, licencias y inquilinos de Azure Active Directory (Azure AD)](subscriptions-licenses-accounts-and-tenants-for-microsoft-cloud-offerings.md)
- [Comprender cómo usar certificados SSL de terceros](plan-for-third-party-ssl-certificates.md)
- [Comprender las formas en que un inquilino de Microsoft 365 está integrado con los servicios de Azure AD](integrated-apps-and-azure-ads.md)
...
- Use las guías de instalación en el Centro de administración de [Microsoft 365](setup-guides-for-microsoft-365.md).
