...
|Paso 2 |   [Configurar Microsoft 365 para la migración de Google Workspace.](set-up-microsoft-365-forgoogle.md) </br> En este paso, validará el dominio que usa en Google Workspace, agregará usuarios y configurará la seguridad básica para los dispositivos. |
