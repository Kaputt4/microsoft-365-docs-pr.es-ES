...
---
# <a name="manage-safe-attachments"></a>Administrar datos adjuntos seguros
...
Se ha actualizado la regla de datos adjuntos seguros de ATP.

Ahora que la protección está en su lugar, no podrá abrir un archivo malintencionado desde Outlook, OneDrive, SharePoint o Teams. Los archivos afectados tendrán escudos rojos junto a ellos. Si alguien intenta abrir un archivo bloqueado, recibirá un mensaje de advertencia.
