...
1. Elija el usuario y, a continuación, **seleccione Siguiente**.
1. Si lo desea, puede crear un nuevo nombre para mostrar que indique que el buzón perteneció a un antiguo empleado y, a continuación, **seleccione Siguiente**.
1. Activa las respuestas automáticas y cambia el texto de respuesta si quieres.
1. Elija a quién enviar respuestas automáticas, personas dentro o fuera de su empresa y si la misma respuesta va a las personas fuera de su empresa y, a continuación, **seleccione Siguiente**.
