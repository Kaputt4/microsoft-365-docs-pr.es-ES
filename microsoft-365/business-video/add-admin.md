...
Al registrarse en Microsoft 365 Empresa, se convierte automáticamente en administrador global. Para ayudar a administrar la empresa, también puede hacer que otros administradores de personas. 
...
Si hay una persona externa de TI que le ayudará a administrar su empresa, puede agregarla como administrador global.

1. En el Centro de administración de Microsoft 365, seleccione **Usuarios** **,** Usuarios activos y, a continuación, Agregar un **usuario.**
...
1. Active la **casilla Enviar contraseña por correo electrónico** al finalizar para que se le envíe por correo electrónico la contraseña del usuario. Escriba su dirección de correo electrónico. Separe varias direcciones con punto y coma. Seleccione **Siguiente**.
