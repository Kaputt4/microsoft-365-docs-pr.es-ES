...
Puedes habilitar el cifrado BitLocker para ayudar a proteger los datos en caso de que se pierda o robe un dispositivo, y habilitar Windows Exploit Guard para proporcionar protección avanzada contra ransomware.
