...
---
# <a name="configure-microsoft-defender-for-endpoint-for-linux-for-static-proxy-discovery"></a>Configurar Microsoft Defender para endpoint para Linux para la detección de proxy estático
