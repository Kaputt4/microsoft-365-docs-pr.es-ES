...
1. En el portal de Microsoft 365 Defender (<https://security.microsoft.com>), en la página **Configuración**, en **Permisos**, seleccione **Grupos de dispositivos**.
