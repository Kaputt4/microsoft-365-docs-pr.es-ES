...
| ``15``                        |Error de coincidencia del espacio empresarial                        |El dispositivo se incorporó correctamente a Microsoft Defender para Endpoint. Sin embargo, se produjo un error en el flujo de administración de configuración de seguridad porque el identificador de inquilino de Microsoft Defender para extremo no coincide con el identificador de inquilino de Azure Active Directory.Asegúrese de que el identificador de inquilino de Azure Active Directory del inquilino de Defender para el punto de conexión coincide con el identificador de inquilino de la entrada SCP del dominio. Para obtener más información, [solucionar problemas de incorporación relacionados con administración](troubleshoot-security-config-mgt.md)de seguridad para Microsoft Defender para endpoint .|
