...
En el caso de Security Management para Microsoft Defender para punto de conexión en equipos unidos a Windows Server 2012 dominio R2, se necesita una actualización de azure AD Conectar regla de sincronización "In from AD-Computer Join". Esto se puede lograr mediante la clonación y modificación de la regla, que deshabilitará la regla original "In from AD - Computer Join". Azure AD Conectar ofrece esta experiencia de forma predeterminada para realizar cambios en las reglas integradas.
