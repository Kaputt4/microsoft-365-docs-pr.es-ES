...
> [!NOTE]
> Después de la incorporación a Defender para punto de conexión, es posible que tenga que establecer Microsoft Defender Antivirus en modo pasivo en Windows Server. Para validar que el modo pasivo se estableció según lo esperado, busque **Evento 5007** en el registro **operativo Microsoft-Windows-Windows डिफेन्डर** (ubicado en `C:\Windows\System32\winevt\Logs`) y confirme que las claves del Registro **ForceDefenderPassiveMode** o **PassiveMode** se establecieron en **0x1**.
