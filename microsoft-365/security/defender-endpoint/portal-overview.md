...
ms.locfileid: "51074320"
---
# <a name="microsoft-defender-security-center-portal-overview"></a>Introducción al portal del Centro de seguridad de Microsoft Defender
...
Los equipos de seguridad empresariales pueden usar el Centro de seguridad de Microsoft Defender para supervisar y ayudar a responder a las alertas de posibles infracciones de datos o actividad de amenazas persistentes avanzadas.

Puede usar el [Centro de seguridad de Microsoft Defender para:](https://securitycenter.windows.com/)
...
- (2) Búsqueda, Centro de la comunidad, Localización, Ayuda y soporte técnico, Comentarios
...
**Búsqueda avanzada** | La búsqueda avanzada le permite buscar e investigar proactivamente en toda la organización mediante una herramienta de búsqueda y consulta eficaz.
...
**(2) Búsqueda, Centro de la comunidad, Localización, Ayuda y soporte técnico, Comentarios** | **Búsqueda:** búsqueda por dispositivo, archivo, usuario, dirección URL, IP, vulnerabilidad, software y recomendación. </br></br> **Centro de la** comunidad: acceda al centro de la comunidad para aprender, colaborar y compartir experiencias sobre el producto. </br></br>  **Localización:** establecer zonas horarias. </br></br>  **Ayuda y** soporte técnico: obtenga acceso a la guía de Defender para endpoints, soporte técnico de Microsoft y Microsoft Premier, información de licencias, simulaciones & tutoriales, laboratorio de evaluación de Defender for Endpoint, consulte a un experto en amenazas.</br></br> **Comentarios:** proporcione comentarios sobre lo que le gusta o lo que podemos hacer mejor.

> [!NOTE]
> Para dispositivos con problemas de escalado de PPP de alta resolución, consulta Problemas de escalado de [Windows para dispositivos de ppp](https://support.microsoft.com/help/3025083/windows-scaling-issues-for-high-dpi-devices) altos para obtener posibles soluciones.
...
![Icono corregido1](images/remediated-icon.png)| Remediated: amenaza eliminada del dispositivo.
![Icono no corregido](images/not-remediated-icon.png)| No corregido: amenaza no eliminada del dispositivo.
...
![Icono de eventos antivirus de Microsoft Defender](images/atp-windows-defender-av-events-icon.png)| Eventos de Antivirus de Microsoft Defender
![Icono de eventos de Protección de aplicaciones](images/atp-Application-Guard-events-icon.png)| Windows Defender eventos de Application Guard
![Icono de eventos de Device Guard](images/atp-Device-Guard-events-icon.png)| Windows Defender eventos de Device Guard
![Icono de eventos de Protección contra vulnerabilidades](images/atp-Exploit-Guard-events-icon.png)| Windows Defender exploit Guard
![Icono de eventos de SmartScreen](images/atp-Smart-Screen-events-icon.png)| Windows Defender smartscreen
![Icono de eventos de firewall](images/atp-Firewall-events-icon.png)| Eventos de Firewall de Windows
...
![Icono del centro de la comunidad](images/atp-community-center.png) | Centro de la comunidad
