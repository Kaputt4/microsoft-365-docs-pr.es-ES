...
## <a name="scenario-2-security-orchestration-and-automation-response-soar-integration"></a>Escenario 2: Integración de la orquestación de seguridad y la respuesta de automatización (SOAR)
...
Siga los pasos descritos en Convertirse en un partner de [Microsoft Defender para endpoint](get-started-partner-integration.md) para integrar la solución en Defender para endpoint.
