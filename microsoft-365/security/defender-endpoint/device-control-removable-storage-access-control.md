...
1. Descripción: enumera las propiedades del dispositivo que quieres usar para cubrir en el grupo. Para cada propiedad de dispositivo, consulta **la sección Propiedades del** dispositivo anterior para obtener más detalles.
2. Opciones:
    - PrimaryId
...
Opciones: 0-4. Cuando el tipo Permitir o Denegar está seleccionado:
...
Esta funcionalidad (en el Centro de administración de Microsoft Endpoint Manager ( ) Perfiles de configuración de dispositivos Crear plataforma de perfil: Windows 10 y posterior <https://endpoint.microsoft.com/> \> & \> \> \> Profile: Device Control) todavía no está disponible.
...
Si hay un valor y la directiva se administra a través de la directiva de grupo, compruebe si el dispositivo cliente puede tener acceso a la ruta XML de directiva.
