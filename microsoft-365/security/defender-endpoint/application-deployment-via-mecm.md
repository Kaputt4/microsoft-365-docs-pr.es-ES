...
2. Descargue el script de migración del documento: [Escenarios de migración del servidor de la solución de Pertahanan Microsoft untuk Titik Akhir anterior basada en MMA](server-migration.md). Este script también se puede encontrar en GitHub: [GitHub - microsoft/mdefordownlevelserver](https://github.com/microsoft/mdefordownlevelserver).
...
- [Incorporación de servidores Windows al servicio Pertahanan Microsoft untuk Titik Akhir](configure-server-endpoints.md)
- [Pertahanan Microsoft untuk Titik Akhir: Defender Windows Server 2012 R2 y 2016](https://techcommunity.microsoft.com/t5/microsoft-defender-for-endpoint/defending-windows-server-2012-r2-and-2016/ba-p/2783292)
