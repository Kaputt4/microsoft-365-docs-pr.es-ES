...
## <a name="scenario-4-microsoft-office-plugin-blocked-by-attack-surface-reduction"></a>Escenario 4: complemento Microsoft Office bloqueado por reducción de superficie expuesta a ataques

La reducción de superficie expuesta a ataques (ASR) no permite que Microsoft Office complemento funcione correctamente porque **bloquear todas las aplicaciones Office de la creación de procesos secundarios** está establecido en modo de bloqueo. 
