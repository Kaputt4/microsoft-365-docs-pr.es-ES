...
**Bienvenido a la fase 3 de [cambio a Defender para endpoint](switch-to-mde-overview.md#the-migration-process)**. Esta fase de migración incluye los siguientes pasos:
...
|Método|Qué hacer|
|---|---|
|Símbolo del sistema|1. En un dispositivo Windows, abra símbolo del sistema.<br/><br/>2. Escriba `sc query windefend` y, a continuación, presione ENTRAR.<br/><br/>3. Revise los resultados para confirmar que antivirus de Microsoft Defender se está ejecutando en modo pasivo.|
...
|Aplicación seguridad de Windows|1. En un dispositivo Windows, abre la aplicación Seguridad de Windows.<br/><br/>2. Seleccione **Virus & protección contra amenazas**.<br/><br/>3. En **¿Quién me protege?** seleccione **Administrar proveedores**.<br/><br/>4. En la página **Proveedores de seguridad,** en **Antivirus,** busque **Antivirus de Microsoft Defender activado.**|
|Administrador de tareas|1. En un dispositivo Windows, abre la aplicación Administrador de tareas.<br/><br/>2. Seleccione la **pestaña** Detalles. Busque **MsMpEng.exe** en la lista.|
...
> Para obtener más información sobre el modo pasivo y el modo activo, consulta [Más detalles sobre los estados de Antivirus de Microsoft Defender](microsoft-defender-antivirus-compatibility.md#more-details-about-microsoft-defender-antivirus-states).

### <a name="set-microsoft-defender-antivirus-on-windows-server-to-passive-mode-manually"></a>Establecer el Antivirus de Microsoft Defender en Windows Server en modo pasivo manualmente

Para establecer Antivirus de Microsoft Defender en modo pasivo en Windows Server, versión 1803 o posterior, Windows Server 2019 o Windows Server 2022, siga estos pasos:
...
### <a name="start-microsoft-defender-antivirus-on-windows-server-2016"></a>Iniciar Microsoft Defender Antivirus en Windows Server 2016

Si usas Windows Server 2016, es posible que debas iniciar Antivirus de Microsoft Defender manualmente. Puede realizar esta tarea mediante el cmdlet de PowerShell `mpcmdrun.exe -wdenable` en el dispositivo.

## <a name="get-updates-for-microsoft-defender-antivirus"></a>Obtener actualizaciones para Antivirus de Microsoft Defender

Mantener el Antivirus de Microsoft Defender actualizado es fundamental para asegurar que los dispositivos tienen la tecnología y las características más recientes necesarias para protegerse contra nuevas técnicas de ataque y malware, incluso si antivirus de Microsoft Defender se está ejecutando en modo pasivo. (Consulte [Compatibilidad de Antivirus de Microsoft Defender](microsoft-defender-antivirus-compatibility.md).)
