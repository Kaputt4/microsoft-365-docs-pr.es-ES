...
description: Obtenga información sobre las Microsoft Defender para punto de conexión y las capacidades disponibles para los clientes del Gobierno de Estados Unidos
...
Microsoft Defender para punto de conexión para los clientes del gobierno de Estados Unidos, integrados en el entorno de Azure US Government, usa las mismas tecnologías subyacentes que Defender para endpoint en Azure Commercial.
...
Microsoft Defender para punto de conexión para los clientes del Gobierno de Estados Unidos requiere una de las siguientes ofertas de licencias por volumen de Microsoft:
...
|GCC|GCC High|DoD|
|---|---|---|
|Microsoft Defender para punto de conexión server GCC|Microsoft Defender para punto de conexión server for GCC High|Microsoft Defender para punto de conexión server para DOD|
...
A continuación se de Microsoft Defender para punto de conexión direcciones URL del portal para los clientes de US Government:
...
|
> [!NOTE]
> Si es un cliente GCC y está en el proceso de pasar de Microsoft Defender para punto de conexión comercial a GCC, https://transition.security.microsoft.com use para acceder a los datos Microsoft Defender para punto de conexión comerciales.
...
Estas son las características y las diferencias conocidas para [Mobile Threat Defense (Microsoft Defender para punto de conexión en Android & iOS)](mtd.md):
