...
### [Funcionalidades de Microsoft Defender para punto de conexión admitidas por plataforma](supported-capabilities-by-platform.md)
...
###### [Programación del examen antivirus en Defender para punto de conexión en Linux](schedule-antivirus-scan-in-mde.md)
...
###### [Solución de problemas de rendimiento de AuditD](troubleshoot-auditd-performance-issues.md)
...
##### [Administración de la protección contra alteraciones con Configuration Manager](manage-tamper-protection-configuration-manager.md)
##### [Administración de la protección contra alteraciones en un dispositivo individual](manage-tamper-protection-individual-device.md)
##### [Preguntas más frecuentes sobre la protección contra alteraciones](faqs-tamper-protection.md)
...
##### [Exclusiones contextuales de archivos y carpetas](configure-contextual-file-folder-exclusions-microsoft-defender-antivirus.md)
...
##### [Investigación de dominios y direcciones URL asociados a una alerta de Microsoft Defender para punto de conexión](investigate-domain.md)
...
## [Administración de vulnerabilidades de Defender](../defender-vulnerability-management/index.yml) 
