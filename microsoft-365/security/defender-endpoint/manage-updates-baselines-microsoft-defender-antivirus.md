...
- Se ha agregado una corrección para la[protección en tiempo real](configure-protection-features-microsoft-defender-antivirus.md) donde en algunos casos se deshabilite al usar `SharedSignaturesPath` configuración (para obtener más información sobre el parámetro `SharedSignaturesPath`, consulte [set-MpPreference](/powershell/module/defender/set-mppreference))
