---
title: Ocultar la interfaz Antivirus de Microsoft Defender interfaz
...
## <a name="hide-the-microsoft-defender-antivirus-interface"></a>Ocultar la interfaz Antivirus de Microsoft Defender interfaz

En Windows 10, la versión 1703, ocultar la interfaz ocultará las notificaciones de Antivirus de Microsoft Defender e impedirá que el icono protección contra amenazas de Virus & aparezca en la aplicación Seguridad de Windows.
...
:::image type="content" source="../../media/wdav-headless-mode-1703.png" alt-text="El Seguridad de Windows con el icono de escudo y las secciones de protección contra amenazas" lightbox="../../media/wdav-headless-mode-1703.png":::
...
:::image type="content" source="../../media/wdav-headless-mode-1607.png" alt-text="El mensaje de advertencia cuando el modo sin cabeza está habilitado en Windows 10 versiones anteriores a 1703" lightbox="../../media/wdav-headless-mode-1607.png":::
...
Consulta [Impedir que los usuarios modifiquen localmente la configuración](configure-local-policy-overrides-microsoft-defender-antivirus.md) de directiva para obtener más opciones sobre cómo impedir que los usuarios forme parte de la protección de sus equipos.
