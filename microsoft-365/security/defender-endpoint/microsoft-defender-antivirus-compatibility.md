...
En esta sección se describe lo que sucede con Antivirus de Microsoft Defender antivirus o antimalware de Microsoft en los puntos de conexión que no están incorporados a Defender for Endpoint. En la tabla siguiente se resume lo que se debe esperar: <br/>
...
| Windows Server 2016 <br/> Windows Servidor, versión 1803 o posterior <br/> Windows Server 2019 | Antivirus de Microsoft Defender  | Modo activo |
| Windows Server 2016 <br/> Windows Servidor, versión 1803 o posterior <br/> Windows Server 2019 | Una solución antivirus o antimalware que no es de Microsoft | Deshabilitado (establecido manualmente) <sup> [[1](#fn1)]<sup></sup>  |
...
Si su organización usa una solución antivirus o antimalware que no sea de Microsoft junto con Defender for Endpoint, Antivirus de Microsoft Defender puede, según el sistema operativo, ejecutarse en modo pasivo. <br/>
...
| Windows Server 2016 <br/> Windows Servidor, versión 1803 o posterior <br/> Windows Server 2019 | Antivirus de Microsoft Defender  | Modo activo |
| Windows Servidor, versión 1803 o posterior <br/> Windows Server 2019 | Una solución antivirus o antimalware que no es de Microsoft | Modo pasivo (configurado manualmente) <sup> [[2](#fn2)]<sup></sup>  |
...
En la tabla de esta sección se describen varios estados que puede ver con Antivirus de Microsoft Defender. <br/>
