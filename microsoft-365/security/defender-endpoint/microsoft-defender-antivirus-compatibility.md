...
> [!NOTE]
> El modo pasivo no se admite en Windows Server 2016. La clave del Registro se puede usar en Windows Server, versión 1803 o posterior, o Windows `ForcePassiveMode` Server 2019, pero no Windows Server 2016. 
