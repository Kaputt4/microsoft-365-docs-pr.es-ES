...
>[!NOTE]
>Intune usa Azure Active Directory (Azure AD) para administrar dispositivos y usuarios. Como administrador de Intune, puede configurar grupos que se adapten a sus necesidades organizativas.<br>
