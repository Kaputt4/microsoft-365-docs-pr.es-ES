...
1. Cree un [centro de eventos](https://docs.microsoft.com/azure/event-hubs/) en el espacio empresarial.
...
1. Inicie sesión en el Centro de [seguridad de Microsoft Defender](https://securitycenter.windows.com) como * Administrador **global** _ o _* Administrador _de seguridad_**.
...
- [Solucionar problemas de conectividad: Azure Event Hubs](https://docs.microsoft.com/azure/event-hubs/troubleshooting-guide)
