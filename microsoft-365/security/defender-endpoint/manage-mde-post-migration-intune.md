...
> [!IMPORTANT]
> Debe tener asignado el rol de administrador global o de administrador de servicio en Intune para configurar las opciones descritas en este artículo. Para obtener más información, consulta **[Tipos de administradores (Intune).](/mem/intune/fundamentals/users-add#types-of-administrators)**.
...
> [!TIP]
> ¿Necesita ayuda? Consulta **[Usar Microsoft Defender para endpoint con Intune](/mem/intune/protect/advanced-threat-protection#example-of-using-microsoft-defender-atp-with-intune)**.
