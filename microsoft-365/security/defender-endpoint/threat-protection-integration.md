...
Las actividades sospechosas son procesos que se ejecutan en un contexto de usuario. La integración entre Microsoft Defender para Endpoint y Azure ATP proporciona la flexibilidad de realizar investigaciones de ciberseguridad en todas las actividades e identidades.

### <a name="microsoft-defender-for-office"></a>Microsoft Defender para Office
[Defender para Office 365](https://docs.microsoft.com/office365/securitycompliance/office-365-atp) ayuda a proteger su organización contra malware en mensajes de correo electrónico o archivos a través de vínculos seguros de ATP, datos adjuntos seguros de ATP, capacidades avanzadas de inteligencia contra suplantación de identidad y suplantación de identidad. La integración entre ATP de Office 365 y Microsoft Defender para endpoint permite a los analistas de seguridad ir hacia arriba para investigar el punto de entrada de un ataque. A través del uso compartido de inteligencia de amenazas, los ataques pueden contenerse y bloquearse. 
