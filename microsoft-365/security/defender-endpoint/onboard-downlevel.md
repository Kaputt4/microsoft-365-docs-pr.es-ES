...
description: Incorporación de versiones anteriores compatibles Windows dispositivos para que puedan enviar datos del sensor al sensor de Microsoft Defender para endpoint
...
- [Configurar y actualizar clientes System Center Endpoint Protection cliente](#configure-and-update-system-center-endpoint-protection-clients)
...
> [!NOTE]
> La licencia de servidor independiente de Defender for Endpoint es necesaria, por nodo, para incorporar un servidor Windows a través de Microsoft Monitoring Agent (opción 1). Como alternativa, se requiere una licencia de Microsoft Defender para servidores, por nodo, para incorporar un servidor de Windows a través de Microsoft Defender para la nube (opción 2), consulta Características compatibles disponibles en [Microsoft Defender para](/azure/security-center/security-center-services) la nube.

> [!TIP]
> Después de incorporar el dispositivo, puedes elegir ejecutar una prueba de detección para comprobar que está correctamente incorporado al servicio. Para obtener más información, vea [Ejecutar una prueba de detección en un punto de conexión de Defender para endpoint recién incorporado](run-detection-test.md).

## <a name="configure-and-update-system-center-endpoint-protection-clients"></a>Configurar y actualizar clientes System Center Endpoint Protection cliente
...
- Instalar la [actualización de la plataforma antimalware de enero de 2017 para Endpoint Protection clientes](https://support.microsoft.com/help/3209361/january-2017-anti-malware-platform-update-for-endpoint-protection-clie)
...
1. En el panel Microsoft 365 Defender navegación, **seleccione Configuración** >  **Device** **managementOnboarding** > .
...
> [!NOTE]
>
> - Para la incorporación a través de Microsoft Defender para que los servidores funcionen según lo esperado, el servidor debe tener un área de trabajo y una clave adecuadas configuradas dentro de la configuración de Microsoft Monitoring Agent (MMA).
> - Una vez configurado, se implementa el paquete de administración de nube adecuado en el equipo y se implementa e inicia el proceso de sensor (MsSenseS.exe).
...
1. Descargue lo siguiente y colócalos en la carpeta MMA:
    ...
    >[!NOTE]
    > En este artículo se supone que usa servidores basados en x64 (mma agente .exe x64 nueva versión compatible con SHA-2).
...
:::image type="content" source="images/deploymma.png" alt-text="Las propiedades de implementar mma cmd" lightbox="images/deploymma.png":::
...
:::image type="content" source="images/startupprops.png" alt-text="Las propiedades de inicio" lightbox="images/startupprops.png":::
...
:::image type="content" source="images/deploymmadowmload.png" alt-text="Las propiedades de descarga de mma de implementación" lightbox="images/deploymmadowmload.png":::
...
Tiene dos opciones para salir de la Windows de conexión desde el servicio:
...
Para quitar el Windows de conexión, puede desinstalar el agente de MMA o desasoyérselo de los informes a su área de trabajo de Defender para endpoint. Después de salir del agente, el punto de conexión ya no enviará datos del sensor a Defender para Endpoint.
...
1. En el **Microsoft Monitoring Agent propiedades**, seleccione la pestaña **Azure Log Analytics (OMS**).
