...
ms.locfileid: "51186250"
---
# <a name="overview-of-attack-surface-reduction"></a>Información general sobre la reducción de superficie de ataque
...
Ayuda a reducir las superficies de ataque minimizando los lugares en los que tu organización es vulnerable a ataques y ciberamenazas. Use los siguientes recursos para configurar la protección de los dispositivos y aplicaciones de su organización.
...
[Protección contra vulnerabilidades](./exploit-protection.md) | Ayude a proteger los sistemas operativos y las aplicaciones que usa su organización para evitar que se aprovechen. La protección contra vulnerabilidades de seguridad también funciona con soluciones antivirus de terceros.
...
[Preguntas frecuentes sobre reducción de superficie de ataque](./attack-surface-reduction-faq.md) | Preguntas más frecuentes sobre las reglas de reducción de superficie de ataque, las licencias y mucho más.
