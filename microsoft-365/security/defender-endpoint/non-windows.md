...
**Se aplica a:**
- [Plan 1 y Plan 2 de Microsoft Defender para Endpoint](https://go.microsoft.com/fwlink/p/?linkid=2154037)
...
Para obtener más información sobre cómo empezar, visita la documentación de Defender for Endpoint en [macOS.](microsoft-defender-endpoint-mac.md)
...
> - Administración de seguridad para Microsoft Defender para endpoint
...
Para obtener más información sobre cómo empezar, visita la documentación de Microsoft Defender para Endpoint [en Linux.](microsoft-defender-endpoint-linux.md)
...
Para obtener más información sobre cómo empezar, visita la documentación de Microsoft Defender para Endpoint [en Android.](microsoft-defender-endpoint-android.md)
