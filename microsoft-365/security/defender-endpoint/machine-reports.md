...
description: Realizar un seguimiento de las detecciones de estado de mantenimiento del dispositivo, el estado del antivirus, la plataforma del sistema operativo y las versiones de Windows 10 mediante el informe de cumplimiento y estado del dispositivo
...
Aunque las tendencias de los dispositivos muestran información de dispositivo de tendencia, el resumen del dispositivo muestra la información del dispositivo en el ámbito del día actual.
...
- **Estado de mantenimiento**: muestra información sobre el estado del sensor en los dispositivos, lo que proporciona una vista agregada de los dispositivos que están activos, experimentan comunicaciones deterioradas, están inactivas o no se ven datos del sensor.
