---
title: Configurar y administrar las capacidades de Microsoft Threat Experts
ms.reviewer: ''
...
ms.locfileid: "51166106"
---
# <a name="configure-and-manage-microsoft-threat-experts-capabilities"></a>Configurar y administrar las capacidades de Microsoft Threat Experts
...
> [!NOTE]
> Analice los requisitos de elegibilidad con su proveedor de servicios técnicos de Microsoft y el equipo de cuenta antes de aplicar a Expertos en amenazas de Microsoft: servicio de búsqueda de amenazas administrada por notificación de ataque dirigida.
...
1. En el panel de navegación, ve a Configuración > General > Características avanzadas > Expertos en amenazas de **Microsoft: Notificaciones de ataques dirigidos**.

2. Haga clic en **Aplicar**.

    ![Imagen de la configuración de Microsoft Threat Experts](images/mte-collaboratewithmte.png)

3. Escriba su nombre y dirección de correo electrónico para que Microsoft pueda volver a usted en la aplicación.

    ![Imagen de la aplicación Expertos en amenazas de Microsoft](images/mte-apply.png)
...
4. Lea la [declaración de privacidad](https://privacy.microsoft.com/en-us/privacystatement)y, a continuación, haga clic en **Enviar** cuando haya terminado. Recibirá un correo electrónico de bienvenida una vez que se apruebe la aplicación.
    ...
    ![Imagen de confirmación de la aplicación Expertos en amenazas de Microsoft](images/mte-applicationconfirmation.png)
...
2. En el menú superior derecho, haga clic en **?** . A continuación, **seleccione Consultar a un experto en amenazas.** 
    ...
    ![Imagen de expertos en amenazas de Microsoft a petición desde el menú](images/mte-eod-menu.png)

    Se abre una pantalla desplegable. En la siguiente pantalla se muestra cuándo está en una suscripción de prueba.

    ![Imagen de la pantalla Expertos en amenazas de Microsoft](images/mte-eod.png)

    En la siguiente pantalla se muestra cuándo está en una suscripción completa de Expertos en amenazas de Microsoft: expertos a petición.

    ![Imagen de la pantalla completa de suscripción de Expertos en amenazas de Microsoft a petición](images/mte-eod-fullsubscription.png)
...
**Comunicaciones de alerta de expertos en amenazas de Microsoft** 
- ¿Puede su equipo de respuesta a incidentes ayudarnos a solucionar la notificación de ataque dirigida que tenemos?
- He recibido esta notificación de ataque dirigido de expertos en amenazas de Microsoft. No tenemos nuestro propio equipo de respuesta a incidentes. ¿Qué podemos hacer ahora y cómo podemos contener el incidente?
- He recibido una notificación de ataque dirigido de expertos en amenazas de Microsoft. ¿Qué datos nos puede proporcionar que podamos transmitir a nuestro equipo de respuesta a incidentes?

  >[!NOTE]
  >Microsoft Threat Experts es un servicio de búsqueda de ciberseguridad administrado y no un servicio de respuesta a incidentes. Sin embargo, los expertos pueden realizar una transición sin problemas de la investigación a los servicios del Equipo de detección y respuesta (DART) de Microsoft Cybersecurity Solutions Group (CSG), cuando sea necesario. También puede optar por interactuar con su propio equipo de respuesta a incidentes para solucionar problemas que requieren una respuesta a incidentes. 
...
La respuesta de los expertos en amenazas de Microsoft varía según la consulta. En un plazo de dos  días, le enviarán un informe de progreso sobre la consulta de un experto en amenazas para comunicar el estado de la investigación de las siguientes categorías: 
