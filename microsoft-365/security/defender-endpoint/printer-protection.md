...
---
# <a name="device-control-printer-protection"></a>Protección de impresora de control de dispositivos 
...
1. Si estás planeando implementar la directiva a través de la directiva de grupo, el dispositivo debe estar MDATP unido; si planea implementar la directiva a través de MEM, el dispositivo debe estar unido a Intune.
...
**Escenario 1: Bloquear la impresión de personas a través de cualquier impresora no corporativa** 
...
**Escenario 2: Permitir impresoras USB aprobadas específicas**
...
- Aplicar directiva sobre el equipo: 
    ...
    - Configuración del equipo > plantillas administrativas > impresora: Habilitar restricciones de impresión de control de dispositivos 
...
- Aplicar directiva sobre el equipo: 
    ...
    - Configuración del equipo > plantillas administrativas > impresora: lista de dispositivos de impresión conectados a USB aprobados 

- Aplicar directiva sobre el usuario:  

    - User Configuration > Administrative Templates > Control Panel > Printers: Lista de dispositivos de impresión conectados a USB aprobados 
