...
---
# <a name="troubleshoot-microsoft-defender-antivirus-while-migrating-from-a-third-party-solution"></a>Solucionar problemas de Antivirus de Microsoft Defender al migrar desde una solución de terceros
...
Puedes encontrar ayuda aquí si encuentras problemas al migrar desde una solución de seguridad de terceros al Antivirus de Microsoft Defender.
...
Encontrará información sobre Antivirus de Microsoft Defender en **Registros** de aplicaciones y servicios  >  **de Microsoft**  >  **Windows**  >  **Windows Defender**. 
...
-|-|-|-
15  | Aplicación | Se Windows Defender el estado correctamente a SECURITY_PRODUCT_STATE_OFF. | Centro de seguridad
5007 | Microsoft-Windows-Windows Defender/Operational | Windows Defender configuración del antivirus ha cambiado.  Si se trata de un evento inesperado, debes revisar la configuración, ya que puede ser el resultado de malware.<br /><br />**Valor antiguo:** Default\IsServiceRunning = 0x0<br />**Nuevo valor:** HKLM\SOFTWARE\Microsoft\Windows Defender\IsServiceRunning = 0x1 | Windows Defender
5010 | Microsoft-Windows-Windows Defender/Operational | Windows Defender está deshabilitada la detección de antivirus en busca de spyware y otro software potencialmente no deseado. | Windows Defender
...
> [!TIP]
> El escenario descrito solo se aplica a Windows 10. Otras versiones de Windows [tienen diferentes respuestas al](microsoft-defender-antivirus-compatibility.md) Antivirus de Microsoft Defender que se ejecuta junto con software de seguridad de terceros.
...
La información sobre Antivirus de Microsoft Defender se mostrará en la aplicación Servicios en **Windows Defender**  >  **Operativo**. El nombre del servicio antivirus *es Windows Defender Antivirus Service*.
...
Esto generará un informe ubicado en *./gpresult.html*. Abre este archivo y es posible que veas los siguientes resultados, según cómo se haya desactivado Antivirus de Microsoft Defender.
...
Dentro del informe GPResults, bajo el título Componentes de *Windows/antivirus de Windows Defender*, es posible que veas algo parecido a la siguiente entrada, que indica que Antivirus de Microsoft Defender está desactivado.

Policy | Configuración | GPO ganador
-|-|-
Desactivar Windows Defender Antivirus | Habilitado | Win10-Workstations
...
Bajo el encabezado, Elemento del Registro (ruta de acceso *clave: HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows Defender, Nombre de valor: DisableAntiSpyware),* puede ver algo parecido a la siguiente entrada, que indica que Antivirus de Microsoft Defender está desactivado.
...
###### <a name="if-security-settings-are-set-in-windows-or-your-windows-server-image"></a>Si la configuración de seguridad está establecida en Windows o la imagen de Windows Server
...
Antivirus de Microsoft Defender se activará automáticamente si ningún otro antivirus está activo actualmente. Tendrás que desactivar completamente el antivirus de terceros para asegurarte de que Antivirus de Microsoft Defender se pueda ejecutar con funcionalidad completa.
