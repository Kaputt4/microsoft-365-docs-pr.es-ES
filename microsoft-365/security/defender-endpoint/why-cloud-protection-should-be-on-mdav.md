---
title: Por qué se debe habilitar la protección en la nube para el Antivirus de Microsoft Defender
description: Vea por qué se debe activar la protección en la nube para el Antivirus de Microsoft Defender. Ayuda a muchas características de seguridad en Microsoft Defender para punto de conexión trabajo
...
ms.locfileid: "67682589"
---
# <a name="why-cloud-protection-should-be-enabled-for-microsoft-defender-antivirus"></a>Por qué se debe habilitar la protección en la nube para el Antivirus de Microsoft Defender
...
| Indicadores de riesgo (IoC) | Microsoft Defender para punto de conexión plan 2 (independiente o incluido en un plan como Microsoft 365 E5) | Los ioCs de Defender para punto de conexión se pueden configurar para definir la detección, prevención y exclusión de entidades. Por ejemplo, los indicadores "allow" se pueden usar para definir excepciones a los exámenes y acciones de corrección del Antivirus de Microsoft Defender en Defender para punto de conexión. Como otro ejemplo, se pueden usar indicadores de "alerta y bloqueo" para evitar que se ejecuten archivos o procesos, y para realizar un seguimiento de estas actividades con alertas que se pueden ver en el portal de Microsoft 365 Defender. <br/><br/>Para obtener más información, consulte [Creación de indicadores](manage-indicators.md).    |
...
Ahora que tiene información general sobre la protección en la nube y su rol en antivirus de Microsoft Defender, estos son algunos de los pasos siguientes:
