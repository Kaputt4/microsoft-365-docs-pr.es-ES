...
- Se han resuelto problemas de conectividad a Internet en dispositivos supervisados. Para obtener más información, vea [Deploy Defender for Endpoint on enrolled iOS devices](ios-install.md).
