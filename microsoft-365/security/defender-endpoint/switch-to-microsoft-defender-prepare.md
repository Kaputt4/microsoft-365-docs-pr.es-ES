...
> [!NOTE]
> El Centro de seguridad de Microsoft Defender se conoce a veces como el portal de Defender para endpoint y se puede obtener acceso a este en [https://aka.ms/MDATPportal](https://aka.ms/MDATPportal) . 
