...
En la tabla y subsecciones siguientes se describe cada una de las 16 reglas de reducción de superficie de ataque. Las reglas de reducción de superficie de ataque se enumeran en orden alfabético, por nombre de regla.
...
|[Bloquear la persistencia a través de la suscripción de eventos WMI](#block-persistence-through-wmi-event-subscription)|`e6db77e5-3df2-4cf1-b95a-636979351e5b`|No compatible|[Windows 10, versión 1903](/windows/whats-new/whats-new-windows-10-version-1903) (compilación 18362) o posterior, o Windows 11|
...
>[!NOTE]
>
> Puede configurar esta regla con [OMA-URI](enable-attack-surface-reduction.md#mem) de MEM para la información de procedimientos de reglas personalizadas de MEM OMA-URI.
>
