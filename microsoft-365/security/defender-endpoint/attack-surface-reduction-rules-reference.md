...
En la tabla siguiente se enumeran los sistemas operativos admitidos para las reglas de reducción de superficie expuesta a ataques que actualmente son producto preliminar. Las reglas se enumeran en orden alfabético. A menos que se indique lo contrario, la compilación mínima Windows&nbsp; 10 es la versión 1709 (RS3, compilación 16299) o posterior; la compilación mínima Windows&nbsp; Server es la versión 1809 o posterior.
...
|---|:---:|:---:|
|[Bloquear el abuso de controladores firmados vulnerables explotados](#block-abuse-of-exploited-vulnerable-signed-drivers) | v | v |
|[Impedir que Adobe Reader cree procesos secundarios](#block-adobe-reader-from-creating-child-processes) | v | v |
|[Impedir que todas las aplicaciones Office creen procesos secundarios](#block-all-office-applications-from-creating-child-processes) | v | v |
...
|[Impedir que los archivos ejecutables se ejecuten a menos que cumplan un criterio de prevalencia, edad o lista de confianza](#block-executable-files-from-running-unless-they-meet-a-prevalence-age-or-trusted-list-criterion) | v | v |
...
|[Impedir que las aplicaciones Office creen contenido ejecutable](#block-office-applications-from-creating-executable-content) | v | v |
|[Impedir que las aplicaciones Office inserten código en otros procesos](#block-office-applications-from-injecting-code-into-other-processes)  | v | v |
|[Impedir que Office aplicación de comunicación cree procesos secundarios](#block-office-communication-application-from-creating-child-processes) | v | v |
|[Bloquear la persistencia a través de la suscripción](#block-persistence-through-wmi-event-subscription) \* de eventos WMI _No se admiten las exclusiones de archivos y carpetas._ | N | N |
|[Bloquear las creaciones de procesos que se originen a partir de comandos PSExec y WMI](#block-process-creations-originating-from-psexec-and-wmi-commands) | v | v |
|[Bloquear procesos que no son de confianza y no firmados que se ejecutan desde USB](#block-untrusted-and-unsigned-processes-that-run-from-usb) | v | v |
|[Bloquear llamadas API de Win32 desde macros de Office](#block-win32-api-calls-from-office-macros) | N | N |
|[Uso de protección avanzada contra ransomware](#use-advanced-protection-against-ransomware) | v | v |
|  |  |  |
...
_Versión preliminar pública final: sistemas operativos compatibles_
...
|---|:---:|:---:|:---:|
|[Bloquear el abuso de controladores firmados vulnerables explotados](#block-abuse-of-exploited-vulnerable-signed-drivers) | v | v | v <br><br> versión 1803 (canal semianual) o posterior |
...
|[Impedir que todas las aplicaciones Office creen procesos secundarios](#block-all-office-applications-from-creating-child-processes) | v | v | v <br><br> |
...
|[Impedir que los archivos ejecutables se ejecuten a menos que cumplan un criterio de prevalencia, edad o lista de confianza](#block-executable-files-from-running-unless-they-meet-a-prevalence-age-or-trusted-list-criterion) | Versión Y 1803 o posterior | v <br><br> | v <br><br> |
...
|[Impedir que las aplicaciones Office creen contenido ejecutable](#block-office-applications-from-creating-executable-content) | v | v <br><br> | v <br><br> |
|[Impedir que las aplicaciones Office inserten código en otros procesos](#block-office-applications-from-injecting-code-into-other-processes)  | v | v <br><br> | v <br><br> |
|[Impedir que Office aplicación de comunicación cree procesos secundarios](#block-office-communication-application-from-creating-child-processes) | v | v <br><br> | v <br><br> |
|[Bloquear la persistencia a través de la suscripción de eventos WMI](#block-persistence-through-wmi-event-subscription) <br><br> \*_No se admiten las exclusiones de archivos y carpetas._ | Versión Y 1903 (compilación 18362) o posterior| v | v <br><br> versión 1903 (compilación 18362) o posterior |
|[Bloquear las creaciones de procesos que se originen a partir de comandos PSExec y WMI](#block-process-creations-originating-from-psexec-and-wmi-commands) | Versión Y 1803 o posterior | v <br><br> | v <br><br>  |
|[Bloquear procesos que no son de confianza y no firmados que se ejecutan desde USB](#block-untrusted-and-unsigned-processes-that-run-from-usb) | v | v <br><br> | v <br><br> |
|[Bloquear llamadas API de Win32 desde macros de Office](#block-win32-api-calls-from-office-macros) | v | v <br><br> | v <br><br> |
|[Uso de protección avanzada contra ransomware](#use-advanced-protection-against-ransomware) | Versión Y 1803 o posterior | v <br><br> | v <br><br> |
|  |  |  |  |
...
|[Impedir que todas las aplicaciones Office creen procesos secundarios](#block-all-office-applications-from-creating-child-processes) | v |   |v <br><br> CB 1710 | v  | v  |
...
|[Impedir que las aplicaciones Office creen contenido ejecutable](#block-office-applications-from-creating-executable-content) | v |  |v <br><br> CB 1710 | v  | v  |
|[Impedir que las aplicaciones Office inserten código en otros procesos](#block-office-applications-from-injecting-code-into-other-processes) | v |  | v <br><br> CB 1710 | v  | v  |
|[Impedir que Office aplicación de comunicación cree procesos secundarios](#block-office-communication-application-from-creating-child-processes) | v |  |v <br><br> CB 1710 | v  | v  |
...
- [System Center Configuration Manager (SCCM) CB 1710](/configmgr/core/servers/manage/updates) <br>_SCCM ahora está Microsoft Endpoint Configuration Manager._
...
|[Impedir que todas las aplicaciones Office creen procesos secundarios](#block-all-office-applications-from-creating-child-processes) |   | N | v |
...
| Impedir que todas las aplicaciones Office creen procesos secundarios | d4f940ab-401b-4efc-aadc-ad5f3c50688a |
...
| Impedir que las aplicaciones Office creen contenido ejecutable | 3b576869-a4ec-4529-8536-b80a7769e899 |
| Impedir que las aplicaciones Office inserten código en otros procesos | 75668c1f-73b5-4cf0-bb93-3ecf5cb7cc84 |
| Impedir que Office aplicación de comunicación cree procesos secundarios | 26190899-1602-49e8-8b27-eb1d0a1ce869 |
...
### <a name="block-all-office-applications-from-creating-child-processes"></a>Impedir que todas las aplicaciones Office creen procesos secundarios
...
- Archivos de script (como un archivo .ps de PowerShell, Visual Basic .vbs o javascript .js)
...
### <a name="block-office-applications-from-creating-executable-content"></a>Impedir que las aplicaciones Office creen contenido ejecutable

Esta regla impide que Office aplicaciones, incluidos Word, Excel y PowerPoint, creen contenido ejecutable potencialmente malintencionado, bloqueando que el código malintencionado se escriba en el disco.
...
### <a name="block-office-applications-from-injecting-code-into-other-processes"></a>Impedir que las aplicaciones Office inserten código en otros procesos

Esta regla bloquea los intentos de inserción de código de Office aplicaciones en otros procesos.

Los atacantes pueden intentar usar Office aplicaciones para migrar código malintencionado a otros procesos mediante la inyección de código, de modo que el código pueda enmascararse como un proceso limpio.
...
### <a name="block-office-communication-application-from-creating-child-processes"></a>Impedir que Office aplicación de comunicación cree procesos secundarios

Esta regla impide que Outlook cree procesos secundarios, a la vez que permite funciones Outlook legítimas.

Esta regla protege contra ataques de ingeniería social e impide que el código de explotación abuse de vulnerabilidades en Outlook. También protege contra [Outlook reglas y vulnerabilidades de seguridad de formularios](https://blogs.technet.microsoft.com/office365security/defending-against-rules-and-forms-injection/) que los atacantes pueden usar cuando las credenciales de un usuario están en peligro.
...
Office VBA habilita las llamadas API de Win32. El malware puede abusar de esta funcionalidad, como [llamar a las API win32 para iniciar código de shell malintencionado](https://www.microsoft.com/security/blog/2018/09/12/office-vba-amsi-parting-the-veil-on-malicious-macros/) sin escribir nada directamente en el disco. La mayoría de las organizaciones no se basan en la capacidad de llamar a las API win32 en su funcionamiento diario, incluso si usan macros de otras maneras.
