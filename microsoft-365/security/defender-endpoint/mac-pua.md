...
description: Detectar y bloquear aplicaciones potencialmente no deseadas (PUA) con Microsoft Defender para endpoint en macOS.
...
- **Bloque**: los archivos PUA se notifican en los registros del producto y en Microsoft 365 Defender portal. El usuario recibe una notificación y el producto toma una acción.
