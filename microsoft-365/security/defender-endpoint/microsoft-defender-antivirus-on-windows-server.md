...
### <a name="set-microsoft-defender-antivirus-to-passive-mode-using-group-policy"></a>Establecer Antivirus de Microsoft Defender en modo pasivo mediante la directiva de grupo
