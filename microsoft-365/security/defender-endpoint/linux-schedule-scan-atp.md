...
Para ejecutar un examen para Linux, vea [Comandos admitidos](https://docs.microsoft.com/microsoft-365/security/defender-endpoint/linux-resources#supported-commands).
