---
title: Migración de servidores de Pertahanan Microsoft untuk Titik Akhir a Microsoft Defender for Cloud
description: Obtenga información sobre cómo migrar servidores de Pertahanan Microsoft untuk Titik Akhir a Microsoft Defender for Cloud.
keywords: migrate server, server, Pertahanan Microsoft untuk Titik Akhir server, Microsoft Defender for Cloud, MDE, azure, azure cloud, CSPM, CWP, cloud workload protection, threat protection, advanced threat protection, Microsoft Azure, multi-cloud connector
author: alekyaj
ms.author: dansimp
manager: dansimp
audience: ITPro
...
ms.locfileid: "67275781"
---
# <a name="migrating-servers-from-microsoft-defender-for-endpoint-to-microsoft-defender-for-cloud"></a>Migración de servidores de Pertahanan Microsoft untuk Titik Akhir a Microsoft Defender for Cloud
...
Este artículo le guía en la migración de servidores de Pertahanan Microsoft untuk Titik Akhir (MDE) a Defender for Cloud.

[Pertahanan Microsoft untuk Titik Akhir](https://www.microsoft.com/security/business/endpoint-security/microsoft-defender-endpoint) (MDE) es una plataforma de seguridad de punto de conexión empresarial diseñada para ayudar a las redes empresariales a prevenir, detectar, investigar y responder a amenazas avanzadas.
...
## <a name="how-do-i-migrate-my-servers-from-microsoft-defender-for-endpoint-to-microsoft-defender-for-cloud"></a>Cómo migrar mis servidores de Pertahanan Microsoft untuk Titik Akhir a Microsoft Defender for Cloud?
...
3. Habilite el aprovisionamiento automático en el conector de nube múltiple para el agente de Azure Arc, la extensión de Pertahanan Microsoft untuk Titik Akhir, la evaluación de vulnerabilidades y, opcionalmente, la extensión de Log Analytics.
...
En caso de que tenga Windows Server 2012 máquinas R2 o 2016 aprovisionadas con la solución Pertahanan Microsoft untuk Titik Akhir heredada basada en Log Analytics, el proceso de implementación de Microsoft Defender for Cloud implementará la [solución unificada](configure-server-endpoints.md#new-windows-server-2012-r2-and-2016-functionality-in-the-modern-unified-solution) defender para punto de conexión. Después de una implementación correcta, detendrá y deshabilitará el proceso heredado de Defender para punto de conexión en estas máquinas.
