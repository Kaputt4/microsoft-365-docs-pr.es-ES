...
## <a name="configure-local-overrides-for-microsoft-defender-antivirus-settings"></a>Configurar invalidaciones locales para Antivirus de Microsoft Defender configuración
...
De forma predeterminada, las listas que se han configurado en la directiva de grupo local y la aplicación Seguridad de Windows se combinan con listas definidas por el objeto de directiva de grupo adecuado que haya implementado en la red. Cuando hay conflictos, la lista definida globalmente tiene prioridad.
