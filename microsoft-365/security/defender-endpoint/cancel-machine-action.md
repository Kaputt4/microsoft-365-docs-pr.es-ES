...
Si se realiza correctamente, este método devuelve 200 código de respuesta Aceptar con una entidad Acción de máquina. Si no se encontró la entidad de acción de la máquina con el identificador especificado: 404 No encontrado.
