...
description: Devuelve información para la actividad de corrección especificada.
...
Devuelve información para la actividad de corrección especificada. Presenta las mismas columnas que [Get all remediation activity](get-remediation-all-activities.md)", pero devuelve los resultados _solo para la actividad de corrección especificada_.
...
rbacGroupNames|Cadena|Nombres de grupos de dispositivos relacionados|[ "Windows Servers", "Windows 11", "Windows 10" ]
