...
Puede implementar, administrar e informar sobre el Antivirus de Microsoft Defender de muchas maneras.

Dado que el cliente antivirus de Microsoft Defender se instala como parte principal de Windows 10 y Windows 11, no se aplica la implementación tradicional de un cliente en los puntos de conexión.
