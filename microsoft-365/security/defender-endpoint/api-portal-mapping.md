...
Comprender qué campos de datos se exponen como parte de la API de detecciones y cómo se asignan al Centro de seguridad de Microsoft Defender.
...
> |                  | LogOnUsers                | sourceUserId        | contoso\liz-bean;   contoso\jay-hardee                                             | El dominio y el usuario del usuario o usuarios de inicio de sesión interactivos en el momento del evento. Nota: Para dispositivos de Windows 10 versión 1607, la información del dominio no estará disponible. |
