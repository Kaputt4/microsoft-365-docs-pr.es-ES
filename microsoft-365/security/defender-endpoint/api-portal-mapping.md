...
> ¿Desea experimentar Defender for Endpoint? [Regístrese para obtener una prueba gratuita.](https://www.microsoft.com/microsoft-365/windows/microsoft-defender-atp?ocid=docs-wdatp-apiportalmapping-abovefoldlink)
...
:::image type="content" alt-text="Imagen de alerta con números." source="images/atp-alert-page.png" lightbox="images/atp-alert-page.png":::

:::image type="content" alt-text="Imagen del panel de detalles de alerta con números." source="images/atp-siem-mapping13.png":::

:::image type="content" alt-text="Imagen de la escala de tiempo del artefacto con números1." source="images/atp-siem-mapping3.png" lightbox="images/atp-siem-mapping3.png":::

:::image type="content" alt-text="Imagen de la escala de tiempo del artefacto con números2." source="images/atp-siem-mapping4.png" lightbox="images/atp-siem-mapping4.png":::

:::image type="content" alt-text="Vista máquina de imagen." source="images/atp-mapping6.png" lightbox="images/atp-mapping6.png":::

:::image type="content" alt-text="Dirección URL del explorador de imágenes." source="images/atp-mapping5.png" lightbox="images/atp-mapping5.png":::

:::image type="content" alt-text="Alerta de actor de imagen." source="images/atp-mapping7.png" lightbox="images/atp-mapping7.png":::
