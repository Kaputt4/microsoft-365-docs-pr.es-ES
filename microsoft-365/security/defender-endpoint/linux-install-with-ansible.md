...
---
# <a name="deploy-microsoft-defender-for-endpoint-for-linux-with-ansible"></a>Implementar Microsoft Defender para endpoint para Linux con Ansible
...
- Es necesario instalar ansible en al menos un equipo (lo llamaremos el equipo principal).
- SSH debe configurarse para una cuenta de administrador entre el equipo principal y todos los clientes, y se recomienda que se configure con autenticación de clave pública.
- El siguiente software debe instalarse en todos los clientes:
  - rizo
  - python-apt

- Todos los hosts deben aparecer con el siguiente formato en el `/etc/ansible/hosts` archivo o correspondiente:
...
- Cree los archivos YAML de instalación y desinstalación de Ansible.
    ...
    - Para las distribuciones basadas en yum, use el siguiente archivo YAML:
...
- [Agregar o quitar repositorios de YUM](https://docs.ansible.com/ansible/2.3/yum_repository_module.html)

- [Administrar paquetes con el administrador de paquetes yum](https://docs.ansible.com/ansible/latest/modules/yum_module.html)

- [Agregar y quitar repositorios de APT](https://docs.ansible.com/ansible/latest/modules/apt_repository_module.html)

- [Administrar paquetes aptos](https://docs.ansible.com/ansible/latest/modules/apt_module.html)
