...
Los planes de seguridad de los puntos de conexión de Microsoft, como Pertahanan Microsoft untuk Titik Akhir y Microsoft 365 Defender, se diseñaron para ayudar a las organizaciones empresariales a prevenir, detectar, investigar y responder a amenazas avanzadas. Microsoft Defender for Business y Microsoft 365 Business Premium proporcionan funcionalidades similares, optimizadas para pequeñas y medianas empresas. Estos planes proporcionan protección contra amenazas avanzada con protección antivirus y antimalware, mitigación de ransomware, etc., junto con la administración centralizada y la generación de informes. 
...
- [Microsoft Defender for Business](../defender-business/mdb-overview.md) y [Microsoft 365 Business Premium](../../business-premium/index.md)
...
(<a id="fn1">1</a>) Pertahanan Microsoft untuk Titik Akhir Plan 1 está disponible como una suscripción independiente para clientes comerciales y educativos. También se incluye como parte de Microsoft 365 E3/A3.

(<a id="fn2">2</a>) Pertahanan Microsoft untuk Titik Akhir Plan 2, que anteriormente se denominaba Pertahanan Microsoft untuk Titik Akhir, está disponible como una suscripción independiente. También se incluye como parte de los siguientes planes:
...
(<a id="fn3">3</a>) Microsoft Defender for Business está disponible como una suscripción independiente para pequeñas y medianas empresas. También se incluye como parte de [Microsoft 365 Business Premium](/microsoft-365/business-premium). Estos planes incluyen funcionalidades de seguridad avanzadas con una experiencia de configuración y configuración simplificada. Consulte [Comparación de Microsoft Defender for Business con Microsoft 365 Business Premium](/microsoft-365/security/defender-business/compare-mdb-m365-plans#compare-microsoft-defender-for-business-to-microsoft-365-business-premium).

## <a name="options-for-onboarding-servers"></a>Opciones para la incorporación de servidores

Los planes 1 y 2 de Defender para punto de conexión (independientes), Defender para empresas (independientes) y Microsoft 365 Business Premium no incluyen licencias de servidor. Para incorporar servidores, elija entre las siguientes opciones:
...
- **Microsoft Defender for Business servidores (versión preliminar)** para pequeñas y medianas empresas. Consulta [Cómo obtener servidores de Microsoft Defender para Empresas (versión preliminar).](../defender-business/get-defender-business-servers.md)
...
- Para obtener información sobre cómo ponerse en contacto con el soporte técnico, consulte [Ponerse en contacto con el soporte técnico de Pertahanan Microsoft untuk Titik Akhir](contact-support.md).

> [!TIP]
> Si su organización es una pequeña o mediana empresa, consulte los artículos siguientes:
> - [¿Qué es Microsoft Defender for Business?](../defender-business/mdb-overview.md)
...
- [Microsoft Defender for Business](../defender-business/mdb-overview.md) (endpoint protection para pequeñas y medianas empresas)
