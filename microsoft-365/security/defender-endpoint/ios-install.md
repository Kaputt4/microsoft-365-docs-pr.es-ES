...
### <a name="add-ios-store-app"></a>Agregar iOS aplicación de la tienda

1. En el [Centro de administración de Microsoft Endpoint Manager](https://go.microsoft.com/fwlink/?linkid=2109431), vaya a **Aplicaciones** ->  **iOS/iPadOS** -> **Agregar** ->  **iOS aplicación de la tienda** y haga clic en **Seleccionar**.

    > [!div class="mx-imgBorder"]
    > :::image type="content" source="images/ios-deploy-1.png" alt-text="Pestaña Agregar aplicaciones en el Centro de Microsoft Endpoint Manager Administración" lightbox="images/ios-deploy-1.png":::
...
1. En la sección **Asignaciones** , vaya a la sección **Requerido** y seleccione **Agregar grupo**. A continuación, puede elegir los grupos de usuarios que desea que tengan como destino Defender para punto de conexión en iOS aplicación. Haga clic en **Seleccionar** y, a continuación, **en Siguiente**.

    > [!NOTE]
    > El grupo de usuarios seleccionado debe constar de Intune usuarios inscritos.

    > [!div class="mx-imgBorder"]
    > :::image type="content" source="images/ios-deploy-2.png" alt-text="Pestaña Agregar grupo en el Centro de Microsoft Endpoint Manager Administración" lightbox="images/ios-deploy-2.png":::
...
1. A continuación, debe implementar un perfil personalizado en dispositivos de iOS supervisados. Esto es para funcionalidades mejoradas de anti-phishing. Siga estos pasos:

    - Descargar el perfil de configuración desde [https://aka.ms/mdeiosprofilesupervised](https://aka.ms/mdeiosprofilesupervised)
    - Vaya a **Dispositivos** ->  iOS/**Perfiles** ->  de configuración de **iPadOS** -> **Crear perfil**
...
> [!NOTE]
> No se puede configurar Sin contacto en iOS dispositivos inscritos sin afinidad de usuario (dispositivos sin usuario o dispositivos compartidos).
...
El Microsoft Defender para punto de conexión en iOS aplicación tiene una capacidad especializada en dispositivos iOS/iPadOS supervisados, dadas las mayores capacidades de administración proporcionadas por la plataforma en estos tipos de dispositivos. Para aprovechar estas funcionalidades, la aplicación Defender para punto de conexión debe saber si un dispositivo está en modo supervisado.
...
- [Configuración de Defender para punto de conexión en iOS características](ios-configure-features.md)
