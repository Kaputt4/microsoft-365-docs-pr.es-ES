...
|---|:---:|:---:|:---:|---|
|**Vínculos de imagen a sitios remotos** <p> _IncreaseScoreWithImageLinks_|Desactivada|Desactivada|Desactivada||
|**Dirección IP numérica en URL** <p> _IncreaseScoreWithNumericIps_|Desactivada|Desactivada|Desactivada||
|**Redireccionamiento de direcciones URL a otro puerto** <p> _IncreaseScoreWithRedirectToOtherPort_|Desactivada|Desactivada|Desactivada||
|**Vínculos a sitios web .biz o .info** <p> _IncreaseScoreWithBizOrInfoUrls_|Desactivada|Desactivada|Desactivada||
|**Mensajes vacíos** <p> _MarkAsSpamEmptyMessages_|Desactivada|Desactivada|Desactivada||
|**Etiquetas Embed en HTML** <p> _MarkAsSpamEmbedTagsInHtml_|Desactivada|Desactivada|Desactivada||
|**JavaScript o VBScript en HTML** <p> _MarkAsSpamJavaScriptInHtml_|Desactivada|Desactivada|Desactivada||
|**Etiquetas Form en HTML** <p> _MarkAsSpamFormTagsInHtml_|Desactivada|Desactivada|Desactivada||
|**Etiquetas de marco o iframe en HTML** <p> _MarkAsSpamFramesInHtml_|Desactivada|Desactivada|Desactivada||
|**Errores web en HTML** <p> _MarkAsSpamWebBugsInHtml_|Desactivada|Desactivada|Desactivada||
|**Etiquetas Object en HTML** <p> _MarkAsSpamObjectTagsInHtml_|Desactivada|Desactivada|Desactivada||
|**Palabras confidenciales** <p> _MarkAsSpamSensitiveWordList_|Desactivada|Desactivada|Desactivada||
|**Registro de SPF: error** <p> _MarkAsSpamSpfRecordHardFail_|Desactivada|Desactivada|Desactivada||
|**Error de filtrado de identificador de remitente** <p> _MarkAsSpamFromAddressAuthFail_|Desactivada|Desactivada|Desactivada||
|**Retrodispersión** <p> _MarkAsSpamNdrBackscatter_|Desactivada|Desactivada|Desactivada||
...
|**Incluir dominios de mi propiedad** <p> _EnableOrganizationDomainsProtection_|Desactivada <p> `$false`|Seleccionado <p> `$true`|Seleccionado <p> `$true`||
|**Incluir dominios personalizados** <p> _EnableTargetedDomainsProtection_ <p> _TargetedDomainsToProtect_|Desactivada <p> `$false` <p> ninguno|Seleccionado <p> `$true` <p> \<list of domains\>|Seleccionado <p> `$true` <p> \<list of domains\>|Se recomienda agregar dominios (dominios de remitente) que no posea, pero que interactúe con frecuencia.|
...
|**Mostrar sugerencia de seguridad de suplantación de usuario** <p> _EnableSimilarUsersSafetyTips_|Desactivada <p> `$false`|Seleccionado <p> `$true`|Seleccionado <p> `$true`||
|**Mostrar sugerencia de seguridad de suplantación de dominio** <p> _EnableSimilarDomainsSafetyTips_|Desactivada <p> `$false`|Seleccionado <p> `$true`|Seleccionado <p> `$true`||
|**Mostrar sugerencia de seguridad de caracteres inusuales de suplantación de usuario** <p> _EnableUnusualCharactersSafetyTips_|Desactivada <p> `$false`|Seleccionado <p> `$true`|Seleccionado <p> `$true`||
...
|**Permitir a las personas hacer clic en la vista protegida incluso si documentos seguros identificaron el archivo como malintencionado** <p> _AllowSafeDocsOpen_|Desactivada <p> `$false`|Desactivada <p> `$false`|Esta configuración está relacionada con documentos seguros.|
...
|**Activado: vínculos seguros comprobará una lista de vínculos conocidos y malintencionados cuando los usuarios hagan clic en vínculos de correo electrónico** <p> _EnableSafeLinksForEmail_|No seleccionada <p> `$false`|Seleccionado <p> `$true`|Seleccionado <p> `$true`|Seleccionado <p> `$true`||
...
|**Aplicar un análisis de URL en tiempo real para vínculos sospechosos y vínculos que apunten a archivos** <p> _ScanUrls_|No seleccionada <p> `$false`|Seleccionado <p> `$true`|Seleccionado <p> `$true`|Seleccionado <p> `$true`||
...
|**No vuelva a escribir las direcciones URL. Realice las comprobaciones solo a través de la API de vínculos seguros** <p> _DisableURLRewrite_|No seleccionada <p> `$false`|Seleccionado <p> `$true`|No seleccionada <p> `$false`|No seleccionada <p> `$false`||
