---
title: 'Plan de seguridad: prioridades principales para los primeros 30 días, 90 días y más allá'
f1.keywords:
- NOCSH
ms.author: bcarter
author: BrendaCarter
...
|:-----|:-----|
|Área|Tarea|
|Administración de seguridad|* Continuar la planeación de las acciones siguientes mediante [https://securescore.office.com](https://securescore.office.com)calificación segura (). <br/> * Continúe revisando regularmente los paneles e informes en las herramientas Microsoft 365 Security Center, Cloud App Security y SIEM. <br/> * Seguir buscando e implementando actualizaciones de software. <br/> * Integre la exhibición de documentos electrónicos en sus procesos de respuesta legal y amenaza.|
