...
Si no es un cliente, pero está intentando enviar correo a alguien en el que se encuentra, está en el lugar correcto. Si es administrador y necesita ayuda para combatir el correo no deseado, esta no es la sección adecuada para usted. En su lugar, vaya a Protección contra correo no deseado y [antimalware en Microsoft 365](anti-spam-and-anti-malware-protection.md).
