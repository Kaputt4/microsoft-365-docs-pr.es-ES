...
La pila de protección o filtrado de Microsoft Defender para Office 365 se puede dividir en 4 fases, como en este artículo. En general, el correo entrante pasa por todas estas fases antes de la entrega, pero la ruta de acceso real que toma el correo electrónico está sujeta a la configuración de Defender para Office 365 de una organización.

> [!TIP]
> Permanezca atento hasta el final de este artículo para obtener un *gráfico* unificado de las 4 fases de protección de Defender para Office 365.
...
1. **La limitación de** red protege la infraestructura de Office 365 y los clientes de los ataques por denegación de servicio (DOS) limitando el número de mensajes que puede enviar un conjunto específico de infraestructura.
...
3.  La inteligencia suplantada es capaz de filtrar aquellos permitidos para "suplantar" (es decir, aquellos que envían correo en nombre de otra cuenta o reenvía para una lista de correo) de suplantadores malintencionados que imitan un dominio externo conocido o organizativo. Separa el correo legítimo "en nombre de" de la suplantación de identidad de los remitentes para entregar mensajes de correo no deseado y suplantación de identidad. 
...
4. Siempre que Microsoft Defender para Office 365 detecte datos adjuntos malintencionados, el hash del archivo y un hash de su contenido activo se agregan a la reputación de Exchange Online Protection (EOP). **El bloqueo de reputación** de datos adjuntos bloqueará ese archivo en todo Office 365 y en los puntos de conexión a través de llamadas en la nube de MSAV.
...
9. **Datos adjuntos** seguros espacio aislados para todos los datos adjuntos para los clientes de Defender para Office 365, mediante el análisis dinámico para detectar amenazas nunca antes vistas.
...
1. **Vínculos seguros** es la protección de tiempo de clic de MDO. Cada dirección URL de cada mensaje se ajusta para apuntar a los servidores de Vínculos seguros de Microsoft. Cuando se hace clic en una dirección URL, se comprueba con la reputación más reciente, antes de redirigir al usuario al sitio de destino. La dirección URL está asincrónicamente en espacio aislado para actualizar su reputación.

2. **Phish Zero-Hour Auto-purge (ZAP)** detecta y neutraliza de forma retroactiva los mensajes de suplantación de identidad malintencionados que ya se han entregado a los buzones de Exchange Online.

3. **Malware ZAP** detecta y neutraliza retroactivamente los mensajes de malware malintencionados que ya se han entregado a los buzones de Exchange Online.

4. **Zap de** correo no deseado detecta y neutraliza de forma retroactiva los mensajes de correo no deseado malintencionados que ya se han entregado a los buzones de Exchange Online.
...
7. **Vínculos seguros para** clientes de Office ofrece la misma protección de tiempo de clic de vínculos seguros, de forma nativa, dentro de clientes de Office como Word, PowerPoint y Excel.
