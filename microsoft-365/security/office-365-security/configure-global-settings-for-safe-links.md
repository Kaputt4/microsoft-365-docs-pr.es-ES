...
- Para agregar o quitar valores sin que ello afecte a otras entradas existentes, use la siguiente sintaxis:
  ...
  En este ejemplo se agrega una nueva entrada adatum.com y se quita la entrada para fabrikam.com.
...
En este ejemplo se configuran las siguientes opciones para la protección de vínculos seguros en las aplicaciones de Office 365:
