...
- Para enviar mensajes y archivos a Microsoft, debe ser miembro de uno de los siguientes grupos de roles:
  - **Administración de** la organización **o Lector de** seguridad en el portal Microsoft 365 [Defender](permissions-microsoft-365-security-center.md).
