...
**Resumen**  Obtenga información sobre cómo reconocer y corregir el ataque de concesión de consentimiento ilícito en Microsoft 365.

## <a name="what-is-the-illicit-consent-grant-attack-in-microsoft-365"></a>¿Cuál es el ataque de concesión de consentimiento ilegal en Microsoft 365?
...
3. Haga clic **en la** columna Actividad para ordenar los resultados y buscar Consentimiento para **la aplicación**.

4. Seleccione una entrada de la lista para ver los detalles de la actividad. Compruebe si IsAdminContent está establecido en True.
...
Puede buscar las aplicaciones a las que cualquier usuario individual ha concedido permisos mediante el Azure Active Directory Portal en <https://portal.azure.com> .
...
3. Abra una sesión de PowerShell como administrador y ábrala en la carpeta en la que guardó el script.
...
- Puede revocar el permiso de la aplicación en el portal de Azure Active Directory mediante:
  1. Vaya al usuario afectado en la **hoja Azure Active Directory Usuario.**
  2. Seleccione **Aplicaciones**.
  3. Seleccione la aplicación ilícita.
  4. Haga **clic en** Quitar en el desglose.
