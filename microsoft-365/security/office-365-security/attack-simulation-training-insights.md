...
**Simulador de ataques** [Crear una simulación de ataque de suplantación de identidad (phishing)](attack-simulation-training.md) y crear una carga útil para formar a los [usuarios](attack-simulation-training-payloads.md)
