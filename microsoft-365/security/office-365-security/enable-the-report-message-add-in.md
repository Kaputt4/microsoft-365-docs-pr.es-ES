...
Los complementos mensaje de informe y suplantación de identidad de informe para Outlook y Outlook en la Web (anteriormente conocidos como Outlook Web App) facilitan la notificación de falsos positivos (un buen correo electrónico marcado como incorrecto) o falsos negativos (correo electrónico incorrecto permitido) a Microsoft y sus filiales para su análisis.
...
- Ambos complementos no están disponibles para los buzones de Exchange locales.
