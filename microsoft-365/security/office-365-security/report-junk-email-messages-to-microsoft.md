...
> [!NOTE]
> Al informar de una entidad de correo electrónico a Microsoft, se realiza una copia de todo lo asociado al correo electrónico para incluirla en las revisiones. Esta copia incluye el contenido del correo electrónico, los encabezados de correo electrónico y los datos relacionados sobre el enrutamiento de correo electrónico. También se incluyen los datos adjuntos del mensaje.
>
> Microsoft trata sus comentarios como el permiso de su organización para analizar toda la información y mejorar el proceso de informe y revisión de mensajes sospechosos. El mensaje se almacena de forma segura hasta que se elimina a más tardar 30 días después de que lo haya proporcionado. Microsoft puede leer el mensaje enviado y los datos adjuntos; sin embargo, el correo electrónico se sigue tratando como confidencial entre usted y Microsoft. Su envío no se proporciona a ninguna otra parte para el proceso de revisión.
