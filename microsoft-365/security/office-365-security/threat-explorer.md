...
description: Use las detecciones de explorador y en tiempo real en el portal de Microsoft 365 Defender para investigar y responder a las amenazas de forma eficaz.
ms.custom:
  - seo-marvel-apr2020
ms.technology: mdo
...
Si su organización tiene [Microsoft Defender para Office 365](defender-for-office-365.md) y tiene los permisos [necesarios, tiene](#required-licenses-and-permissions) detecciones en tiempo **real** o **explorador** (anteriormente informes en tiempo *real*, vea las novedades [).](#new-features-in-threat-explorer-and-real-time-detections) En el Centro de & cumplimiento, vaya a **Administración** de amenazas y, a continuación, elija **Explorador**  o **Detecciones en tiempo real**.
...
:::image type="content" source="../../media/cab32fa2-66f1-4ad5-bc1d-2bac4dbeb48c.png" alt-text="El elemento de menú Explorador del portal de seguridad & cumplimiento" lightbox="../../media/cab32fa2-66f1-4ad5-bc1d-2bac4dbeb48c.png":::
...
### <a name="introduction-of-alert-id-for-defender-for-office-365-alerts-within-explorerreal-time-detections"></a>Introducción del identificador de alerta de Defender para Office 365 alertas de explorador/en tiempo real
...
> :::image type="content" source="../../media/AlertID-Filter.png" alt-text="El filtrado para el identificador de alerta" lightbox="../../media/AlertID-Filter.png":::

> [!div class="mx-imgBorder"]
> :::image type="content" source="../../media/AlertID-DetailsFlyout.png" alt-text="El identificador de alerta en el menú desplegable de detalles" lightbox="../../media/AlertID-DetailsFlyout.png":::
...
Las etiquetas de usuario identifican grupos específicos de usuarios en Microsoft Defender para Office 365. Para obtener más información acerca de las etiquetas, incluidas las licencias y la configuración, consulte [Etiquetas de usuario](user-tags.md).
...
> [!div class="mx-imgBorder"]
> :::image type="content" source="../../media/tags-grid.png" alt-text="La vista Filtrar etiquetas en la cuadrícula de correo electrónico" lightbox="../../media/tags-grid.png":::
...
> [!div class="mx-imgBorder"]
> :::image type="content" source="../../media/tags-flyout.png" alt-text="Las etiquetas Detalles del correo electrónico" lightbox="../../media/tags-flyout.png":::
...
> [!div class="mx-imgBorder"]
> :::image type="content" source="../../media/tags-urls.png" alt-text="Etiquetas url" lightbox="../../media/tags-urls.png":::
>
...
> [!div class="mx-imgBorder"]
> :::image type="content" source="../../media/URL_Threats.png" alt-text="Las amenazas de dirección URL" lightbox="../../media/URL_Threats.png":::
...
Actualmente, se muestra la ubicación de entrega en la cuadrícula de correo electrónico y el control de distribución de correo electrónico. El **campo Ubicación de** entrega cambia el nombre **_Ubicación de entrega_ *original_. Y presentamos otro campo, _*_Latest delivery location_**.
...
> [!div class="mx-imgBorder"]
> :::image type="content" source="../../media/Updated_Timeline_Delivery_Location.png" alt-text="Ubicaciones de entrega para escala de tiempo" lightbox="../../media/Updated_Timeline_Delivery_Location.png":::
...
*Las invalidaciones del* sistema permiten realizar excepciones a la ubicación de entrega prevista de un mensaje. Se invalida la ubicación de entrega proporcionada por el sistema, en función de las amenazas y otras detecciones identificadas por la pila de filtrado. Las invalidaciones del sistema se pueden establecer a través de la directiva de inquilino o de usuario para entregar el mensaje según lo sugerido por la directiva. Las invalidaciones pueden identificar la entrega no intencionada de mensajes malintencionados debido a las diferencias de configuraciones, como una directiva de remitente demasiado amplia Caja fuerte establecida por un usuario. Estos valores de invalidación pueden ser:
...
- Correcciones entre filtros de dirección *URL (dirección URL* frente a dominio url frente a dominio y ruta de acceso): las actualizaciones afectan a la búsqueda de mensajes que contienen un veredicto url/clic. Habilitamos la compatibilidad con búsquedas independientes del protocolo, por lo que puede buscar una dirección URL sin usar `http`. De forma predeterminada, la búsqueda de dirección URL se asigna a http, a menos que se especifique explícitamente otro valor. Por ejemplo:
  - Busque con y sin el prefijo `http://` en los campos **de filtro Dirección URL**, Dominio **de dirección URL** y **Dominio de dirección URL y Ruta** de acceso. Las búsquedas deben mostrar los mismos resultados.
  - Busque el prefijo `https://` en **la dirección URL**. Cuando no se especifica ningún valor, se `http://` asume el prefijo.
...
Ahora puede ordenar y filtrar las etiquetas de usuario personalizadas o del sistema para comprender rápidamente el ámbito de las amenazas. Para obtener más información, consulte [Etiquetas de usuario](user-tags.md).
...
> [!div class="mx-imgBorder"]
> :::image type="content" source="../../media/threat-explorer-tags.png" alt-text="La columna Etiquetas del Explorador" lightbox="../../media/threat-explorer-tags.png":::
...
> [!div class="mx-imgBorder"]
> :::image type="content" source="../../media/TimezoneImprovements.png" alt-text="La zona horaria Ver en el Explorador" lightbox="../../media/TimezoneImprovements.png":::
...
> [!div class="mx-imgBorder"]
> :::image type="content" source="../../media/ManualRefresh.png" alt-text="Botón Actualizar para filtrar resultados" lightbox="../../media/ManualRefresh.png":::
...
> [!div class="mx-imgBorder"]
> :::image type="content" source="../../media/ChartDrilldown.png" alt-text="Explorar los gráficos hasta Filtrar" lightbox="../../media/ChartDrilldown.png":::
...
> [!div class="mx-imgBorder"]
> :::image type="content" source="../../media/ProductInfo.png" alt-text="La información del producto que se va a ver" lightbox="../../media/ProductInfo.png":::
...
>
> > [!div class="mx-imgBorder"]
> > :::image type="content" source="../../media/ETR_Details.png" alt-text="Las Exchange de transporte" lightbox="../../media/ETR_Details.png":::
...
Para revisar los mensajes de suplantación de identidad y buscar usuarios o dominios suplantados, use la vista Correo electrónico [> phish del](threat-explorer-views.md) Explorador.

En este ejemplo se usa el Explorador de amenazas.

1. En el [Centro de seguridad & cumplimiento](https://protection.office.com) (https://protection.office.com)elija Administración de amenazas > explorador (o detecciones en tiempo real).
...
5. Seleccione la **pestaña Asunto** de cualquier mensaje  >  de la pestaña Correo **electrónicoDetails** para ver información de suplantación adicional sobre el usuario o dominio y la *ubicación detectada*.

    :::image type="content" source="../../media/threat-ex-views-impersonated-user-image.png" alt-text="Panel de detalles del Explorador de amenazas para un usuario protegido que muestra la ubicación de detección y la amenaza que se detectó (aquí suplantación de identidad de un usuario)" lightbox="../../media/threat-ex-views-impersonated-user-image.png":::

> [!NOTE]
> En los pasos 3 o 5, si elige Tecnología de  detección y selecciona  Dominio de suplantación  o Usuario de suplantación respectivamente,  >  la información de la pestaña Correo **electrónicoDetails** acerca del usuario o dominio,  y la ubicación detectada solo se mostrará en los mensajes relacionados con el usuario o el dominio enumerados  en la página Directiva contra suplantación de identidad.
...
**La ubicación de** entrega muestra los resultados de las directivas y detecciones que se ejecutan después de la entrega. Está vinculado a la **_acción Entrega_**. Estos son los valores posibles:
...
Cuando seleccione una dirección URL en la lista, verá un nuevo botón **Exportar** en el panel desplegable. Use este botón para mover datos a una hoja Excel para facilitar la creación de informes.
...
> [!div class="mx-imgBorder"]
> :::image type="content" source="../../media/tp_ExportClickResultAndNetworkID.png" alt-text="La pestaña Clics en el Explorador" lightbox="../../media/tp_ExportClickResultAndNetworkID.png":::
...
1. En el Centro de seguridad & cumplimiento (<https://protection.office.com>), elija **Explorador de administración** \> de **amenazas (o** **Detecciones en tiempo real**). (En este ejemplo se usa Explorer).

2. En el **menú Ver** , elija **Malware de** \> **correo electrónico**.

   > [!div class="mx-imgBorder"]
   > :::image type="content" source="../../media/ExplorerViewEmailMalwareMenu.png" alt-text="Menú Ver para el Explorador" lightbox="../../media/ExplorerViewEmailMalwareMenu.png":::
...
3. Haga **clic en Remitente** y, a continuación, **elija Tecnología** \> **básica de detección**.
   ...
   > [!div class="mx-imgBorder"]
   > :::image type="content" source="../../media/ExplorerEmailMalwareDetectionTech.png" alt-text="Las tecnologías de detección de malware" lightbox="../../media/ExplorerEmailMalwareDetectionTech.png":::
...
Supongamos que desea ver intentos de suplantación de identidad a través de direcciones URL en el correo electrónico, incluida una lista de direcciones URL permitidas, bloqueadas e invalidadas. Para identificar las direcciones URL en las que se hizo clic, [Caja fuerte deben](safe-links.md) configurarse los vínculos. Asegúrese de configurar las directivas Caja fuerte [vínculos](set-up-safe-links-policies.md) para la protección con tiempo de clic y el registro de veredictos de clics Caja fuerte vínculos.

Para revisar las direcciones URL de suplantación de identidad (phish) en mensajes y clics en direcciones URL en mensajes de suplantación de identidad (phish), use la vista [**EmailPhish** > ](threat-explorer-views.md#email--phish) del Explorador o detecciones en tiempo real.
...
Supongamos que desea ver mensajes de correo electrónico que los usuarios de su organización notificaron como correo no *deseado, no* deseado o *suplantación* de identidad a través del complemento Mensaje de informe o el complemento Report [Phishing](enable-the-report-phish-add-in.md).[](enable-the-report-message-add-in.md) Para verlos, use la [**vista** **EmailSubmissions** > ](threat-explorer-views.md#email--submissions) del Explorador (o detecciones en tiempo real).
...
2. En el **menú Ver** , elija **Envíos** \> **de correo electrónico**.
   ...
   > [!div class="mx-imgBorder"]
   > :::image type="content" source="../../media/explorer-view-menu-email-user-reported.png" alt-text="Menú Ver para el Explorador para correos electrónicos" lightbox="../../media/explorer-view-menu-email-user-reported.png":::
...
- Para el Centro de seguridad & cumplimiento, debe tener uno de los siguientes roles asignados:

  - Administración de la organización
  - Administrador de seguridad (se puede asignar en el centro Azure Active Directory administración (<https://aad.portal.azure.com>)
  - Lector de seguridad
