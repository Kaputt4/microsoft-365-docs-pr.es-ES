...
- **Se omitió el veredicto pendiente:** Al usuario se le presentó la página de detonación. Pero el usuario ha sobresalto el mensaje para tener acceso a la dirección URL.
