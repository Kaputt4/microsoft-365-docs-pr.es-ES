...
R. La generación de informes consolidados en las empresas que administra no está disponible para los informes del centro de administración de Microsoft 365 en este momento. Sin embargo, puede hacerlo con Windows PowerShell remoto o el [servicio Web de informes de Office 365](https://go.microsoft.com/fwlink/?LinkId=279926).
