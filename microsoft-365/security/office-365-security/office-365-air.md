...
[Microsoft Defender para Office 365](defender-for-office-365.md) incluye potentes capacidades automatizadas de investigación y respuesta (AIR) que pueden ahorrar tiempo y esfuerzo al equipo de operaciones de seguridad. A medida que se desencadenan las alertas, el equipo de operaciones de seguridad debe revisar, priorizar y responder a dichas alertas. Mantenerse al día con el volumen de alertas entrantes puede ser abrumador. Automatizar algunas de estas tareas puede ser de ayuda.
...
4. El equipo de operaciones de seguridad revisa [los resultados y recomendaciones](air-view-investigation-results.md) de la investigación y [aprueba o rechaza las acciones de corrección](air-review-approve-pending-completed-actions.md).
...
Además, asegúrese de [revisar las directivas](../../compliance/alert-policies.md) de alerta de su organización, especialmente las directivas predeterminadas [en la categoría Administración de amenazas](../../compliance/alert-policies.md#default-alert-policies).
...
[Microsoft Defender para Office 365 las licencias del Plan 2](defender-for-office-365.md#microsoft-defender-for-office-365-plan-1-and-plan-2) deben asignarse a:
...
>
> - Centro & cumplimiento de seguridad (<https://protection.office.com>)
