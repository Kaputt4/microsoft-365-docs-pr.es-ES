...
[Las licencias del Plan 2 de Microsoft Defender para Office 365](office-365-atp.md#microsoft-defender-for-office-365-plan-1-and-plan-2) deben asignarse a:
...
Si ya está usando las capacidades de AIR en Microsoft Defender para Office 365, está a punto de ver algunos cambios en el centro de seguridad de [Microsoft 365 mejorado.](../mtp/overview-security-center.md)
...
|**Página Incidentes**|La **página Incidentes** ahora correlaciona varias investigaciones para proporcionar una mejor vista consolidada de las investigaciones. ([Obtenga más información sobre incidentes](../mtp/incidents-overview.md).)|
|
