...
- **Notificaciones de simulación**: estos mensajes se envían cuando los usuarios están inscritos en cursos y como avisos para los cursos necesarios.
- **Notificaciones de refuerzo positivas**: estos mensajes se envían cuando los usuarios informan de un mensaje de suplantación de identidad simulada.

Para ver la notificación de usuario final disponible, abra el portal <https://security.microsoft.com>de Microsoft 365 Defender en y **, a continuación, vaya a** \>  \> Correo electrónico & la pestaña Aprendizaje de simulación de ataque **de ataque.** Para ir directamente a la **pestaña Notificaciones de usuario final**, use <https://security.microsoft.com/attacksimulator?viewid=endUserNotification>.
...
1. En la **página Definir detalles** **, configure las siguientes opciones:
   - **Seleccionar tipo de notificación**: **hay disponibles notificaciones de refuerzo positivas** **o de simulación** .
...
2. En la **página Definir contenido** , la única configuración disponible es el **botón Agregar contenido en idioma** empresarial. Al hacer clic en él, aparece un menú desplegable Agregar **contenido** en idioma predeterminado que contiene la siguiente configuración:
   ...
   - **Asunto**: el valor predeterminado es **Thanks for reporting phishing**, pero puedes cambiarlo.
