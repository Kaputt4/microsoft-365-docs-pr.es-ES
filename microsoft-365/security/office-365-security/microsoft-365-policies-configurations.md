---
title: 'configuraciones de acceso a dispositivos e identidades de Confianza cero: Microsoft 365 para empresas'
...
Estas recomendaciones están destinadas a arquitectos empresariales y profesionales de TI que están familiarizados con Microsoft 365 servicios de productividad y seguridad en la nube, lo que incluye Azure AD (identidad), Microsoft Intune (administración de dispositivos) y Microsoft Purview Information Protection (protección de datos) .

### <a name="customer-environment"></a>Entorno del cliente

Las directivas recomendadas se aplican a las organizaciones empresariales que operan por completo en la nube de Microsoft y a los clientes con infraestructura de identidad híbrida, que es un bosque de Active Directory local Domain Services (AD DS) que se sincroniza con un inquilino de Azure AD.
...
Para aquellas organizaciones que no tienen estas licencias, Microsoft recomienda al menos implementar [valores predeterminados de seguridad](/azure/active-directory/fundamentals/concept-fundamentals-security-defaults), que se incluyen con todos los planes de Microsoft 365.
...
Es importante usar niveles coherentes de protección en las identidades, dispositivos y datos. Por ejemplo, la protección para los usuarios con cuentas&mdash; prioritarias, como ejecutivos, líderes, administradores y otros&mdash;, debe incluir el mismo nivel de protección para sus identidades, sus dispositivos y los datos a los que acceden. 
<!--
...
Estos son los componentes de Confianza cero identidad y acceso al dispositivo, incluidos Intune y Azure AD objetos, configuración y subservicios.
...
- Analice esta lista de aplicaciones para determinar los conjuntos de directivas que proporcionan los niveles adecuados de protección.
  ...
  Por ejemplo, podría tener un conjunto de directivas que incluyan todas las aplicaciones Microsoft 365 para todos los usuarios para la protección de punto de partida y un segundo conjunto de directivas para todas las aplicaciones confidenciales, como las que usan los recursos humanos o los departamentos financieros, y aplicarlas a esos grupos.
...
4. Configure directivas de acceso condicional para Microsoft 365 aplicaciones&mdash; en la nube, como directivas de Microsoft Teams, Exchange y SharePoint&mdash; y Microsoft Defender for Cloud Apps.

Después de configurar Confianza cero acceso a identidades y dispositivos, consulte la [guía de implementación de características de Azure AD](/azure/active-directory/fundamentals/active-directory-deployment-checklist-p2) para obtener una lista de comprobación por fases de características adicionales que se deben tener en cuenta y [Azure AD la gobernanza de identidades](/azure/active-directory/governance/) para proteger, supervisar y auditar el acceso.
