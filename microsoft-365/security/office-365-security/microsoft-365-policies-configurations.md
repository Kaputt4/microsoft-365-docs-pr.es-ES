...
- Se alinean con [la puntuación segura de Microsoft,](../mtp/microsoft-secure-score.md) así como con la puntuación de identidad en [Azure AD,](/azure/active-directory/fundamentals/identity-secure-score)y aumentarán estas puntuaciones para su organización.
