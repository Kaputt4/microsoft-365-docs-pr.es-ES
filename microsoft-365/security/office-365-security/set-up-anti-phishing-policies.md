...
|**Habilitar la inteligencia de buzones** <br/> |Habilita o deshabilita la inteligencia de buzones para esta Directiva. Solo se puede habilitar la inteligencia de buzones de correo para cuentas basadas en la nube, es decir, cuentas cuyo buzón de correo se hospeda completamente en Office 365. <br/> | La inteligencia de buzones de correo se crea en torno a las personas que envían y reciben correo desde dentro de la organización y fuera de la organización. <br/> |
...
> [!IMPORTANT]
> ![Image](../media/EnableMailboxIntelligenceBasedImpersonation.png) New importante Settings, separting * * Mailbox Intelligence "from" Mailbox Intelligence based Impersonation Protection ". La suplantación es cuando se obtiene acceso mediante programación al buzón y se ejecutan acciones a través del buzón con un script, una API o un software de terceros, o incluso código malintencionado bajo el buzón.
