...
Microsoft defender para Office 365 para SharePoint, OneDrive y Microsoft Teams protege su organización de archivos malintencionados que se comparten de forma inadvertida. Para obtener más información, consulte [ATP para SharePoint, OneDrive y Microsoft Teams](atp-for-spo-odb-and-teams.md).
...
2. En la **configuración global** vuela hacia fuera que aparece, vaya a la opción **Activar ATP para SharePoint, OneDrive y Microsoft Teams** . Desplace el botón de alternancia a la derecha para ![ ](../../media/scc-toggle-on.png) Activar ATP para SharePoint, OneDrive y Microsoft Teams.
...
- Para comprobar si ha activado ATP para SharePoint, OneDrive y Microsoft Teams correctamente, siga uno de estos pasos:
  ...
  - En el [centro de seguridad & cumplimiento](https://protection.office.com), vaya a la Directiva de **Administración de amenazas** : \>  \> **datos adjuntos seguros de ATP**, seleccione **configuración global** y compruebe el valor de la opción **Activar ATP para SharePoint, OneDrive y Microsoft Teams** .
