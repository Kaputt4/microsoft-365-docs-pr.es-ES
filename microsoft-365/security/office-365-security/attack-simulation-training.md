...
Para crear su propia carga, haga clic en ![Crear un icono de carga.](../../media/m365-cc-sc-create-icon.png) **Cree una carga**. Para obtener más información, consulta [Crear cargas personalizadas para el aprendizaje de simulación de ataques](attack-simulation-training-payloads.md).
...
- **Incluir solo usuarios y grupos específicos**: elija una de las siguientes opciones:
  - ![Icono Agregar usuarios.](../../media/m365-cc-sc-create-icon.png) **Agregar usuarios**: **en el menú** desplegable Agregar usuarios que aparece, puede encontrar usuarios y grupos en función de los siguientes criterios:
    ...
    - **Buscar usuarios o grupos**: en el cuadro, puede escribir parte del nombre o  la dirección de correo **electrónico** del usuario o grupo y, a continuación, presionar ENTRAR. Puede seleccionar algunos o todos los resultados. Cuando haya terminado, haga clic **en Agregar x usuarios**.
    ...
    - **Filtrar usuarios por categorías**: seleccione entre ninguna, algunas o todas las opciones siguientes:
      ...
      - **Etiquetas de** usuario: las etiquetas de usuario son identificadores para grupos específicos de usuarios (por ejemplo, cuentas de prioridad). Para obtener más información, consulta [Etiquetas de usuario en Microsoft Defender para Office 365](user-tags.md).
        ...
        - **Búsqueda**: en Buscar ![por icono de etiquetas de usuario.](../../media/m365-cc-sc-search-icon.png) **Busque por etiquetas de** usuario, puede escribir parte de la etiqueta de usuario y, a continuación, presione ENTRAR. Puede seleccionar algunos o todos los resultados.
        - Seleccionar **todas las etiquetas de usuario**
        - Seleccione etiquetas de usuario existentes.

      - **Departamento**: use las siguientes opciones:
        - **Búsqueda**: en el ![icono Buscar por departamento.](../../media/m365-cc-sc-search-icon.png) **Buscar por departamento**, puede escribir parte del valor de Departamento y, a continuación, presionar ENTRAR. Puede seleccionar algunos o todos los resultados.
        - Seleccionar **todo el departamento**
        - Seleccione los valores de Departamento existentes.

      - **Título**: use las siguientes opciones:
        - **Búsqueda**: en el ![icono Buscar por título.](../../media/m365-cc-sc-search-icon.png) **Buscar por título**, puede escribir parte del valor título y, a continuación, presionar ENTRAR. Puede seleccionar algunos o todos los resultados.
...
- **No entregar notificaciones**: haga clic **en Continuar** en el cuadro de diálogo de alerta que aparece. Si seleccionas esta opción, te llevaremos a la página Detalles [de](#launch-details) inicio al hacer clic en **Siguiente**.
...
- **Notificación predeterminada de Microsoft (recomendada):** La siguiente configuración adicional está disponible en la página:
  ...
  Si seleccionas esta opción, te llevaremos a la página Detalles [de](#launch-details) inicio al hacer clic en **Siguiente**.
...
- Elija uno de los siguientes valores:
  ...
  - **Programe esta simulación para iniciarla más adelante**: este valor tiene las siguientes opciones asociadas para configurar:
