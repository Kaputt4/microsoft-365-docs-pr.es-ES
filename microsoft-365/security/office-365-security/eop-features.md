...
|Filtrado de correo masivo|EOP usa el umbral de reclamo en masa (BCL) para marcar los mensajes de correo electrónico masivos como correo no deseado. Para obtener más información, vea los siguientes temas: <br/><br/> [¿Cuál es la diferencia entre correo electrónico no deseado y correo electrónico masivo?](what-s-the-difference-between-junk-email-and-bulk-email.md) <br/> [Nivel de queja masiva (BCL) en EOP](bulk-complaint-level-values.md) <br/> [Configurar directivas contra correo electrónico no deseado](configure-your-spam-filter-policies.md)|
