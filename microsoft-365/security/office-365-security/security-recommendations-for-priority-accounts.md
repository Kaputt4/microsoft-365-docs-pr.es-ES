...
Para obtener más información sobre cómo la configuración de directivas estrictas difiere de la configuración predeterminada y la configuración de directiva estándar, vea Configuración recomendada para EOP y Microsoft Defender para la seguridad de [Office 365](recommended-settings-for-eop-and-office365-atp.md).
