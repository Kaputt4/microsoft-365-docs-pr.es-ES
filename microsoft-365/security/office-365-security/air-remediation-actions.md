...
La [funcionalidad de investigación y respuesta automatizada](https://docs.microsoft.com/microsoft-365/security/office-365-security/office-365-air) (Air) en [Microsoft Defender para Office 365](https://docs.microsoft.com/microsoft-365/security/office-365-security/office-365-atp) incluyen ciertas acciones de corrección. Siempre que una investigación automatizada esté en marcha o se haya completado, normalmente verá una o más medidas correctivas que requieren la aprobación de su equipo de operaciones de seguridad para proceder. Estas acciones de corrección pueden incluir lo siguiente:
...
|Usuario|Reglas de delegación de correo electrónico <br/>(La cuenta de un usuario tiene configurada la delegación).|Quitar regla de delegación <br/><br/> Si su organización está usando [Microsoft defender para el punto de conexión](https://docs.microsoft.com/windows/security/threat-protection/), considere la posibilidad de [investigar al usuario](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/investigate-user) que está obteniendo el permiso de delegación.|
