...
ms.locfileid: "43163891"
---
# <a name="remediation-actions-in-office-365"></a>Acciones de corrección en Office 365
...
> [!NOTE]
> En Office 365 ATP, las investigaciones automatizadas no se corrigen automáticamente. Las acciones de corrección solo se realizan tras la aprobación del equipo de seguridad de la organización. 
...
|Correo electrónico    |Conseguir      | Eliminación temporal de correo electrónico/clúster <br/><br/>Si más de un puñado de mensajes de correo electrónico en un clúster contienen intentos de suplantación de identidad, el clúster se considera phish.       |
...
- [Ver los detalles y los resultados de una investigación automatizada en Office 365](air-view-investigation-results.md)
