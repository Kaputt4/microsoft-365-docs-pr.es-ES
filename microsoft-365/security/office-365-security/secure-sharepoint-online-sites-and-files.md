...
|Descripción|Colaboración y detección abierta dentro de la organización.|Grupo y sitio privado con uso compartido permitido fuera del grupo.|Sitio privado con uso compartido permitido solo para los miembros del sitio. DLP advierte a los usuarios cuando se intenta enviar archivos fuera de la organización.|Sitio privado y cifrado de archivos y permisos con etiquetas de confidencialidad. DLP impide a los usuarios enviar archivos fuera de la organización.|
