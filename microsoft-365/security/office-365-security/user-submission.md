...
2. En la página **Envíos** de usuarios, lo que ve viene determinado en gran medida por el botón de alternancia **del mensaje de informe de Microsoft Outlook** :
   ...
   - **Apagado** ![ ](../../media/scc-toggle-off.png)Desactivar: se usan herramientas de informes de mensajes de terceros en lugar de la experiencia de informes integrada de Microsoft.
