...
Las capacidades de investigación y respuesta de amenazas en [Microsoft Defender para Office 365](office-365-atp.md) ayudan a los analistas y administradores de seguridad a proteger Microsoft 365 de su organización para usuarios empresariales mediante:
...
Usa el Explorador de amenazas (y detecciones en tiempo real) para analizar amenazas, ver el volumen de [ataques](threat-explorer.md) con el tiempo y analizar datos por familias de amenazas, infraestructura de atacantes y mucho más. El Explorador de amenazas (también denominado Explorador) es el punto de partida para el flujo de trabajo de investigación de cualquier analista de seguridad.
...
- [Integrar la investigación y respuesta de amenazas de Office 365 con Microsoft Defender para el extremo](integrate-office-365-ti-with-wdatp.md)
