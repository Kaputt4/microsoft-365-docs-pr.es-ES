...
Para evitarlo, todos los mensajes salientes de los servidores de centros de datos [](https://docs.microsoft.com/office365/servicedescriptions/exchange-online-service-description/exchange-online-limits#sending-limits-across-office-365-options) de Microsoft [](configure-the-outbound-spam-policy.md) 365 que se determinen como correo no deseado o que superen los límites de envío del servicio o las directivas de correo no deseado saliente se envían a través del grupo de entrega de alto _riesgo._
...
Todos estos problemas pueden provocar un aumento repentino en el número de NDRs que procesa el servicio. Muchas veces, estos NDRs parecen correo no deseado para otros servidores de correo electrónico y servicios (también conocidos como _[correo electrónico no deseado).](backscatter-messages-and-eop.md)_
