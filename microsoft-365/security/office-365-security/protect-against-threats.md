...
La protección con tiempo de clic frente a direcciones URL y archivos malintencionados está disponible en suscripciones que incluyen [Microsoft Defender para Office 365](/office365/servicedescriptions/office-365-advanced-threat-protection-service-description). Se configura a través de datos [adjuntos](atp-safe-attachments.md) seguros y [directivas de vínculos seguros.](atp-safe-links.md)
...
3. Revise (y, según corresponda, edite) las directivas de datos adjuntos seguros de su organización y [las directivas de vínculos seguros](set-up-atp-safe-links-policies.md). [](set-up-atp-safe-attachments-policies.md)
...
|---|---|
|Vea cómo funcionan las características de protección contra amenazas para su organización mediante la visualización de informes|[Panel de seguridad](security-dashboard.md) <p> [Informes de seguridad de correo electrónico](view-email-security-reports.md) <p> [Informes para Microsoft Defender para Office 365](view-reports-for-atp.md) <p> [Explorador de amenazas](threat-explorer.md)|
...
|Obtenga información sobre las configuraciones de seguridad estándar y estricta recomendadas para EOP y Defender para Office 365|[Configuración recomendada para EOP y Microsoft Defender para la seguridad de Office 365](recommended-settings-for-eop-and-office365-atp.md)|