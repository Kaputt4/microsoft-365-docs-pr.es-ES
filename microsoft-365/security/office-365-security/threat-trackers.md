...
Para ver y usar los rastreadores de amenazas de su organización, abra el portal de Microsoft 365 Defender en <https://security.microsoft.com>y vaya a **Email & seguimiento de amenazas de colaboración**\>. Para ir directamente a la página **Seguimiento de amenazas** , use <https://security.microsoft.com/threattrackerv2>.
...
Las consultas de seguimiento aprovechan las consultas guardadas para evaluar periódicamente la actividad de Microsoft 365 en su organización. Esto le ofrece tendencias de eventos, con más que venir en los próximos meses. Las consultas de seguimiento se ejecutan automáticamente, lo que proporciona información actualizada sin tener que recordar volver a ejecutar las consultas.
...
Con nuestra amenaza destacada inaugural, estamos resaltando las amenazas avanzadas de malware detectadas por [Datos adjuntos seguros](safe-attachments.md). Si es un cliente Office 365 Enterprise E5 y no usa [Microsoft Defender para Office 365](defender-for-office-365.md), debería estarlo: se incluye en su suscripción. Defender para Office 365 proporciona valor incluso si tiene otras herramientas de seguridad que filtran el flujo de correo electrónico con los servicios de Office 365. Sin embargo, las características de antispam y [vínculos seguros](safe-links.md) funcionan mejor cuando la solución de seguridad de correo electrónico principal es a través de Office 365.
...
- Si aún no lo ha hecho, obtenga más información y configure [Microsoft Defender para Office 365](defender-for-office-365.md) para su organización, [incluidos vínculos seguros](safe-links.md) y [datos adjuntos seguros](safe-attachments.md).
