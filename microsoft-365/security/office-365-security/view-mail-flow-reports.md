...
Además de los informes de flujo de correo que están disponibles en [](mail-flow-insights-v2.md) el panel flujo de correo en el Centro de seguridad y cumplimiento de &, hay una variedad de informes de flujo de correo adicionales disponibles en el panel Informes para ayudarle a supervisar su organización Microsoft 365 correo.

Si tiene los permisos [necesarios](#what-permissions-are-needed-to-view-these-reports), puede ver estos informes en el Centro de seguridad y & cumplimiento <https://protection.office.com> en el Panel **de** \> **informes**. Para ir directamente al panel Informes, abra <https://protection.office.com/insightdashboard>.

:::image type="content" source="../../media/6b213d34-adbb-44af-8549-be9a7e2db087.png" alt-text="El panel Informes del Centro de seguridad y & cumplimiento" lightbox="../../media/6b213d34-adbb-44af-8549-be9a7e2db087.png":::
...
Para ver el informe, abra el Centro de seguridad & cumplimiento <https://protection.office.com>en ,  \> vaya al Panel de informes y **seleccione Exchange de transporte**. Para ir directamente al informe, abra <https://security.microsoft.com/reports/ETRRuleReport>.

:::image type="content" source="../../media/scc-transport-rule-report-widget.png" alt-text="El widget Exchange regla de transporte en el panel Informes" lightbox="../../media/scc-transport-rule-report-widget.png":::
...
:::image type="content" source="../../media/scc-mail-flow-status-report-widget.png" alt-text="El widget Informe de estado de flujo de correo en el panel Informes" lightbox="../../media/scc-mail-flow-status-report-widget.png":::

> [!NOTE]
> Al hacer clic en el widget de este informe en el Centro de seguridad y cumplimiento de & (protection.office.com), ahora le llevará al informe completo en el portal de Microsoft 365 Defender (security.microsoft.com). Para obtener más información sobre el informe, vea [Informe de estado de flujo de correo](view-email-security-reports.md#mailflow-status-report).
...
Para ver el informe, abra el Centro de seguridad & cumplimiento <https://protection.office.com>en ,  \> vaya al Panel de informes y seleccione Principales **remitentes y destinatarios**. Para ir directamente al informe, abra una de las siguientes direcciones URL:
...
:::image type="content" source="../../media/scc-top-senders-and-recipients-widget.png" alt-text="El widget Principales remitentes y destinatarios en el panel Informes" lightbox="../../media/scc-top-senders-and-recipients-widget.png":::

> [!NOTE]
> Aunque hacer clic en el widget para este informe en el Centro de seguridad y cumplimiento de & le lleva a una página de protection.office.com, el contenido de la página es del portal Microsoft 365 Defender web. Para obtener más información sobre el informe, vea [Informe de remitentes y destinatarios principales](view-email-security-reports.md#top-senders-and-recipients-report).
