...
Al abrir por primera vez el Explorador (o el informe de detecciones en tiempo real), la vista predeterminada muestra las detecciones de malware de correo electrónico de los últimos 7 días. Este informe también puede mostrar Microsoft Defender para detecciones Office 365, como direcciones URL malintencionadas detectadas por [vínculos de Caja fuerte](safe-links.md) y archivos malintencionados detectados por [Caja fuerte adjuntos](safe-attachments.md). Este informe se puede modificar para mostrar datos de los últimos 30 días (con una suscripción de pago de Microsoft Defender Office 365 P2). Las suscripciones de prueba solo incluirán datos de los últimos siete días.
...
![Explorador filtrado para mostrar solo Defender para obtener Office 365 de detonación.](../../media/7241d7dd-27bc-467d-9db8-6e806c49df14.png)
