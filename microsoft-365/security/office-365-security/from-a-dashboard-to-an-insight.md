...
Si no está familiarizado con [los informes y la información del centro &amp; de seguridad y cumplimiento](reports-and-insights-in-security-and-compliance.md), es posible que le resulte útil ver cómo puede navegar fácilmente desde un panel hasta una perspectiva y las acciones recomendadas. 
...
1. Comenzamos con el panel de seguridad en [el &amp; centro de seguridad y cumplimiento](https://protection.office.com). (Vaya al **Threat management** \> **Panel**de administración de amenazas).<br>![En el centro &amp; de seguridad y cumplimiento, elija \> panel de administración de amenazas](../../media/05a38660-eb13-4960-a266-11809c453d95.png)<br>
