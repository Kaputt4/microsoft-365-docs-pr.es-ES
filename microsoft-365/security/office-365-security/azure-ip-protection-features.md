...
- Cada usuario que se beneficie de Cifrado de mensajes de Office 365 debe tener una licencia para ser cubierto por la característica.
...
2. Si no usa un SCP, Windows equipos que se conectan a un clúster de AD RMS deben configurarse para la detección de servicios del lado cliente o la redirección de licencias mediante el Windows: `HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\MSIPC\ServiceLocation or HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\MSIPC\ServiceLocation`.
...
:::image type="content" source="../../media/599ca9e7-c05a-429e-ae8d-359f1291a3d8.png" alt-text="Un mensaje protegido por OME en Outlook en la Web" lightbox="../../media/599ca9e7-c05a-429e-ae8d-359f1291a3d8.png":::
