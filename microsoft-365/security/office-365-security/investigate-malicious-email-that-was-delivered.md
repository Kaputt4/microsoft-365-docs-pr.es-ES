...
[Microsoft defender para Office 365](office-365-atp.md) le permite investigar las actividades que ponen en riesgo a las personas de su organización y emprender acciones para proteger su organización. Por ejemplo, si forma parte del equipo de seguridad de su organización, puede encontrar e investigar los mensajes de correo electrónico sospechosos que se entregaron. Para ello, puede usar el [Explorador de amenazas (o detecciones en tiempo real)](threat-explorer.md).
...
- Su organización tiene [Microsoft defender para Office 365](office-365-atp.md) y [se asignan licencias a los usuarios](../../admin/manage/assign-licenses-to-users.md).
...
- Es un administrador global o bien tiene el rol de administrador de seguridad o de la búsqueda y depuración asignado en el centro de seguridad & cumplimiento. Consulte [permisos en el centro de seguridad & cumplimiento](permissions-in-the-security-and-compliance-center.md). Para algunas acciones, también debe tener asignado un nuevo rol de vista previa.
...
3. **Vistas en el explorador de amenazas**: en el menú **Ver** , elija **todo el correo electrónico**.
    ...
    Sin embargo, en todas las vistas de *correo electrónico* se muestra cada correo recibido por la organización, independientemente de si se han detectado o no amenazas. Como puede imaginar, esta es una gran cantidad de datos, por lo que esta vista muestra un marcador de posición que le pide que se aplique un filtro. (Esta vista solo está disponible para clientes de defender para Office 365 P2).
