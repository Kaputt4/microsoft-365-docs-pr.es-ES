...
1. Haga clic en [**Aplicar**](https://aka.ms/expandedMTEprev). Cualquier persona de su empresa puede solicitar unirse a la versión preliminar, pero si se acepta, solo el administrador global puede firmar el contrato legal y entrar en la versión preliminar. 
...
### <a name="alerts-page-flyout-menu"></a>Menú flotante de la página Alertas
...
### <a name="incidents-inventory-page"></a>Página de inventario de incidentes
