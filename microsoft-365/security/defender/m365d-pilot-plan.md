...
|![Fase de preparación](../../media/mtp/prep.png) <br>[Fase de preparación](prepare-m365d-eval.md) | Preparar el entorno Microsoft 365 Defender piloto
|:-------|:-----|
