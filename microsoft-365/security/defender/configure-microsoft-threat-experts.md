...
> [!IMPORTANT]
> Antes de aplicar, asegúrese de analizar los requisitos de idoneidad para el servicio de búsqueda de amenazas administrada de Microsoft Threat Experts – Targeted Attack Notifications con el proveedor de servicios técnicos de Microsoft y el equipo de cuentas.

Para recibir notificaciones de ataque dirigidas, deberá tener Microsoft 365 Defender implementado con dispositivos inscritos. A continuación, envíe una aplicación a través del portal de M365 para microsoft threat experts - Targeted Attack Notifications.

Póngase en contacto con el equipo de su cuenta o con el representante de Microsoft para suscribirse a Microsoft Threat Experts - Experts on Demand. Expertos a petición le permite consultar con nuestros expertos en amenazas sobre cómo proteger su organización frente a detecciones y adversarios pertinentes.
...
Si ya tiene Microsoft Defender para punto de conexión y Microsoft 365 Defender, puede solicitar expertos en amenazas de Microsoft: notificaciones de ataque dirigidas a través de su portal de Microsoft 365 Defender.  Las notificaciones de ataque dirigidas le conceden información y análisis especiales para ayudar a identificar las amenazas más críticas para su organización, de modo que pueda responder a ellas rápidamente.

1. En el panel de navegación, vaya a **Configuración > puntos de conexión > Características generales > avanzadas > Microsoft Threat Experts - Targeted Attack Notifications**.
...
4. Lea la [declaración de privacidad](https://privacy.microsoft.com/en-us/privacystatement) y, a continuación, seleccione **Enviar** cuando haya terminado. Recibirá un correo electrónico de bienvenida una vez aprobada la aplicación.
    ...
    :::image type="content" source="../../media/mte/mte-applicationconfirmation.png" alt-text="Confirmación de la aplicación Microsoft Threat Experts en el portal de Microsoft 365 Defender" lightbox="../../media/mte/mte-applicationconfirmation.png":::
...
## <a name="where-youll-see-the-targeted-attack-notifications-from-microsoft-threat-experts"></a>Donde verá las notificaciones de ataque dirigidas de expertos en amenazas de Microsoft

Puede recibir una notificación de ataque dirigida de expertos en amenazas de Microsoft a través de los siguientes medios:

- Página **Incidentes** del portal de Microsoft 365 Defender
- Panel **alertas** del portal de Microsoft 365 Defender
...
Empezará a recibir notificaciones de ataque dirigidas de expertos en amenazas de Microsoft en su correo electrónico después de haber configurado el sistema para recibir una notificación por correo electrónico.
...
Si ya es cliente de Microsoft Defender para punto de conexión, puede ponerse en contacto con su representante de Microsoft para suscribirse a Microsoft Threat Experts - Experts on Demand.
...
2. En el menú superior, seleccione **? Consulte a un experto en amenazas**.
    ...
    :::image type="content" source="../../media/mte/incidents-action-mte-highlighted.png" alt-text="Expertos en amenazas de Microsoft a petición en el menú del portal de Microsoft 365 Defender" lightbox="../../media/mte/incidents-action-mte-highlighted.png":::

    Se abrirá una pantalla flotante.

    El encabezado indicará si está en una suscripción de prueba o en una suscripción completa de Microsoft Threat Experts - Experts on-Demand.

    :::image type="content" source="../../media/mte/mte-trial.png" alt-text="Pantalla de suscripción de prueba de Expertos en amenazas de Microsoft a petición en el portal de Microsoft 365 Defender" lightbox="../../media/mte/mte-trial.png":::

    El campo **Tema de investigación** ya se rellenará con el vínculo a la página correspondiente de la solicitud.

3. En el siguiente campo, proporcione suficiente información para proporcionar a los expertos en amenazas de Microsoft suficiente contexto para iniciar la investigación.
...
- Recientemente hemos visto una entrada de blog sobre una amenaza que está dirigida a nuestro sector. ¿Puede ayudarnos a comprender qué protección proporciona Microsoft 365 Defender contra este actor de amenazas?
...
### <a name="microsoft-threat-experts-alert-communications"></a>Comunicaciones de alertas de expertos en amenazas de Microsoft
...
- Hemos recibido una notificación de ataque dirigida por expertos en amenazas de Microsoft. ¿Qué datos puede proporcionarnos que podemos pasar a nuestro equipo de respuesta a incidentes?

> [!NOTE]
> Microsoft Threat Experts es un servicio administrado de búsqueda de amenazas y no un servicio de respuesta a incidentes. Sin embargo, puede interactuar con su propio equipo de respuesta a incidentes para abordar los problemas que requieren una respuesta a incidentes. Si no tiene su propio equipo de respuesta a incidentes y desea la ayuda de Microsoft, puede interactuar con el equipo de respuesta a incidentes de ciberseguridad (CIRT) de CSS. Pueden abrir una incidencia para ayudar a abordar su consulta.
...
La respuesta de los expertos en amenazas de Microsoft variará según su consulta. Por lo general, recibirá una de las siguientes respuestas:
