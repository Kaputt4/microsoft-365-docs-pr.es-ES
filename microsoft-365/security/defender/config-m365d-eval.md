...
Microsoft 365 Defender consta de cuatro pilares. Aunque un pilar ya puede proporcionar valor a la seguridad de la organización de red, habilitar los cuatro pilares Microsoft 365 Defender le dará a la organización el mayor valor.
...
¡Enhorabuena! Acaba de crear su entorno piloto Microsoft 365 Defender de prueba o de prueba. Ahora puedes familiarizarte con la interfaz Microsoft 365 Defender usuario. Vea lo que puede aprender en la siguiente guía Microsoft 365 Defender interactiva y sepa cómo usar cada panel para sus tareas diarias de operación de seguridad.
...
- [Generar una alerta de prueba:](generate-test-alert.md) ejecute una simulación de ataque en el Microsoft 365 Defender de prueba.
