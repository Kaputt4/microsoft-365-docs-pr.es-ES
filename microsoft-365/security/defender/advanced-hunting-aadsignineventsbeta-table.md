...
|`ApplicationId`|cadenas|Identificador único de la aplicación|
|`LogonType`|cadenas|Tipo de sesión de inicio de sesión, interactivo, remoto interactivo (RDP), red, lote y servicio|
...
|`CorrelationId`|cadenas|Identificador único del evento de inicio de sesión|
|`SessionId`|cadenas|Número único asignado a un usuario por el servidor de un sitio web durante la visita o la sesión|
|`AccountDisplayName`|cadenas|Nombre del usuario de la cuenta que se muestra en la libreta de direcciones. Normalmente, una combinación de un nombre o un nombre determinado, una inicial central y un apellido o apellido.|
|`AccountObjectId`|cadenas|Identificador único de la cuenta en Azure AD|
|`AccountUpn`|cadenas|Nombre principal de usuario (UPN) de la cuenta|
...
|`AlternateSignInName`|cadenas|Nombre principal de usuario local (UPN) del usuario que inicia sesión en Azure AD|
...
|`ResourceDisplayName`|cadenas|Nombre para mostrar del recurso al que se ha accedido|
|`ResourceId`|cadenas|Identificador único del recurso al que se ha accedido|
|`ResourceTenantId`|cadenas|Identificador único del inquilino del recurso al que se ha accedido|
...
|`DeviceTrustType`|cadenas|Indica el tipo de confianza del dispositivo que ha iniciado sesión. Solo para escenarios de dispositivos administrados. Los valores posibles son Workplace, AzureAd y ServerAd.|
...
|`AuthenticationProcessingDetails`|cadenas|Detalles sobre el procesador de autenticación|
|`AuthenticationRequirement`|cadenas|Tipo de autenticación necesaria para el inicio de sesión. Valores posibles: multiFactorAuthentication (se requería MFA) y singleFactorAuthentication (no se requería MFA).|
...
|`UserAgent`|cadenas|Información del agente de usuario desde el explorador web u otra aplicación cliente|
|`ClientAppUsed`|cadenas|Indica la aplicación cliente usada|
|`Browser`|cadenas|Detalles sobre la versión del explorador que se usa para iniciar sesión|
|`ConditionalAccessPolicies`|cadenas|Detalles de las directivas de acceso condicional aplicadas al evento de inicio de sesión|
...
|`IPAddress`|cadenas|Dirección IP asignada al extremo y usada durante las comunicaciones de red relacionadas|
|`Country`|cadenas|Código de dos letras que indica el país donde se geolocalización de la dirección IP del cliente|
|`State`|cadenas|Estado en el que se produjo el inicio de sesión, si está disponible|
|`City`|cadenas|Ciudad donde se encuentra el usuario de la cuenta|
|`Latitude`|cadenas|Las coordenadas de norte a sur de la ubicación de inicio de sesión|
|`Longitude`|cadenas|Las coordenadas de este a oeste de la ubicación de inicio de sesión|
|`NetworkLocationDetails`|cadenas|Detalles de ubicación de red del procesador de autenticación del evento de inicio de sesión|
|`RequestId`|cadenas|Identificador único de la solicitud|
|`ReportId`|cadenas|Identificador único del evento|
