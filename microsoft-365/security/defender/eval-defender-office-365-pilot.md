...
7. Agregue condiciones para aplicar protecciones ***EOP** _ de línea base a usuarios piloto específicos o grupos de usuarios, según sea necesario, y seleccione _Next* para continuar.
   ...
   :::image type="content" source="../../media/mdo-eval/9-mdo-eval-pilot-eop-protections.png" alt-text="Directivas que se consideran protecciones EOP." lightbox="../../media/mdo-eval/9-mdo-eval-pilot-eop-protections.png":::
...
8. Agregue condiciones para aplicar protecciones de línea base ***MDO** _ a usuarios piloto específicos o grupos de usuarios, según sea necesario. Haga clic en _Next* para continuar.
   ...
   :::image type="content" source="../../media/mdo-eval/10-mdo-eval-pilot-mdo-protections.png" alt-text="Las directivas consideradas defensivas de Office 365 protección." lightbox="../../media/mdo-eval/10-mdo-eval-pilot-mdo-protections.png":::
...
|Contra correo electrónico no deseado|Proteja a los usuarios del correo no deseado de correo electrónico, incluidas las acciones que se realizarán si se detecta correo no deseado.|[Configuración de directivas contra correo no deseado en Defender para Office 365](../office-365-security/configure-your-spam-filter-policies.md)|
|Protección contra la suplantación de identidad (anti-phishing)|Protección de los usuarios frente a ataques de suplantación de identidad (phishing) y configuración de sugerencias de seguridad en mensajes sospechosos|[Configurar directivas contra suplantación de identidad (phishing) en Defender para Office 365](../office-365-security/configure-mdo-anti-phishing-policies.md)|
