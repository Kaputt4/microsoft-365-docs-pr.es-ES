...
2. En el menú de navegación, expanda **Destinatarios y** seleccione <a href="https://go.microsoft.com/fwlink/?linkid=2183233" target="_blank">**Grupos**</a>.
...
6. Haga *clic en* Editar para configurar y asignar la directiva estándar o la directiva Estricta.
   ...
   :::image type="content" source="../../media/mdo-eval/8-mdo-eval-pilot-preset.png" alt-text="En el panel Directivas de seguridad preestablecidas, haga clic en Editar.":::
