...
El **portal Microsoft 365 Defender** ( ) combina protección, detección, investigación y respuesta a las amenazas de correo electrónico, colaboración, identidad, dispositivo y aplicación, en un lugar [https://security.microsoft.com](https://security.microsoft.com) central.     
...
- **[Microsoft Cloud App Security](/cloud-app-security/)** es una solución completa entre SaaS y PaaS que ofrece visibilidad profunda, controles de datos sólidos y protección contra amenazas mejorada para las aplicaciones en la nube. 
