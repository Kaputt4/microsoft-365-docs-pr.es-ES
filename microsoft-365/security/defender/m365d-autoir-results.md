...
Con Microsoft 365 Defender, [cuando se ejecuta](m365d-autoir.md) una investigación automatizada, los detalles sobre esa investigación están disponibles durante y después del proceso de investigación automatizado. Si tiene los permisos [necesarios, puede](m365d-action-center.md#required-permissions-for-action-center-tasks) ver esos detalles en una vista de detalles de investigación que le proporciona el estado actualizado y la capacidad de aprobar cualquier acción pendiente. 
...
- Cualquier página de investigación en el <a href="https://go.microsoft.com/fwlink/p/?linkid=2077143" target="_blank">Centro de Office 365 seguridad & cumplimiento</a>
...
El Centro [de acción](m365d-action-center.md) mejorado ([https://security.microsoft.com/action-center](https://security.microsoft.com/action-center)) reúne acciones de [corrección](m365d-remediation-actions.md) en todos los dispositivos, correo electrónico & de colaboración e identidades. Las acciones enumeradas incluyen acciones de corrección que se realizaron de forma automática o manual. En el Centro de actividades, puede ver las acciones que están esperando la aprobación y las acciones que ya se aprobaron o completaron. También puede navegar a más detalles, como una página de investigación.
...
2. En el panel de navegación, elija **Incidentes &** **alertsIncidents** > . 
