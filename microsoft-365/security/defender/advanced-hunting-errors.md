...
| Errores desconocidos | Error en la consulta debido a un motivo desconocido. | Intente ejecutar nuevamente la consulta. Póngase en contacto con Microsoft a través del portal si las consultas siguen devolviendo errores desconocidos. | `An unexpected error occurred during query execution. Please try again in a few minutes.`
