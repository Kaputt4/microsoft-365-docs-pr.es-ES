...
![Arquitectura de Microsoft Defender para aplicaciones en la nube.](../../media/defender/m365-defender-mcas-architecture-a.png)
...
![Arquitectura de Microsoft Defender para aplicaciones en la nube: administración de aplicaciones en la nube.](../../media/defender/m365-defender-mcas-architecture-c.png)
...
Microsoft Defender para aplicaciones en la nube sirve como proxy inverso, lo que proporciona acceso de proxy a aplicaciones en la nube sancionadas. Esto permite que Defender for Cloud Apps aplique los controles de sesión que configure. 

![Arquitectura de Microsoft Defender para aplicaciones en la nube: control de sesión de acceso proxy.](../../media/defender/m365-defender-mcas-architecture-d.png)
...
![Arquitectura de Microsoft Defender para aplicaciones en la nube: aplicaciones SaaS.](../../media/defender/m365-defender-mcas-architecture-e.png)

En esta ilustración:
- Las aplicaciones SaaS se integran con Azure AD inquilino. Esto permite a Azure AD directivas de acceso condicional, incluida la autenticación multifactor.
- Se agrega una directiva a Azure Active Directory para dirigir el tráfico de aplicaciones SaaS a Defender para aplicaciones en la nube. La directiva especifica a qué aplicaciones SaaS aplicar esta directiva. Por lo tanto, Azure AD aplica las directivas de acceso condicional que se aplican a estas aplicaciones SaaS, Azure AD dirigirá (servidores proxy) el tráfico de sesión a través de Defender para aplicaciones en la nube.
...
Es posible que haya detectado y sancionado aplicaciones en la nube con Defender para aplicaciones en la nube que no se han agregado a Azure AD. Puedes aprovechar el control de aplicaciones de acceso condicional agregando estas aplicaciones en la nube al espacio empresarial Azure AD y el ámbito de las reglas de acceso condicional.

#### <a name="protecting-your-organization-from-hackers"></a>Proteger su organización de los hackers

Defender para aplicaciones en la nube proporciona una protección eficaz por sí solo. Sin embargo, cuando se combina con las otras funcionalidades de Microsoft 365 Defender, Defender para aplicaciones en la nube proporciona datos en las señales compartidas que, juntos, ayudan a detener los ataques.
...
Centrándose en el lado derecho de esta ilustración, Microsoft Defender para Aplicaciones en la nube observa comportamientos anómalos como viajes imposibles, acceso a credenciales y descarga inusual, recurso compartido de archivos o actividad de reenvío de correo e informa de ello al equipo de seguridad. Por lo tanto, Defender para aplicaciones en la nube ayuda a evitar el movimiento lateral de los hackers y la filtración de datos confidenciales. Microsoft 356 Defender para la nube correlaciona las señales de todos los componentes para proporcionar la historia de ataque completa.
...
|Aplicaciones conectadas |Defender para aplicaciones en la nube proporciona protección de extremo a extremo para aplicaciones conectadas que usan integración de nube a nube, conectores de API y controles de acceso y sesión en tiempo real que aprovechan nuestros controles de acceso a aplicaciones condicionales. |[Protección de aplicaciones conectadas](/cloud-app-security/protect-connected-apps) |
| | | |
