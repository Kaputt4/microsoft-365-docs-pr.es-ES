---
title: Crear una aplicación para obtener acceso Microsoft 365 Defender sin un usuario
...
ms.locfileid: "63755591"
---
# <a name="create-an-app-to-access-microsoft-365-defender-without-a-user"></a>Crear una aplicación para obtener acceso Microsoft 365 Defender sin un usuario
...
Si necesitas acceso mediante programación a Microsoft 365 Defender en nombre de uno o más usuarios, consulta Crear una aplicación para obtener acceso [Microsoft 365 Defender](api-create-app-user-context.md) api en nombre de un usuario y Crear una aplicación con acceso de asociado [a Microsoft 365 Defender API](api-partner-access.md). Si no está seguro del tipo de acceso que necesita, consulte [Introducción](api-access.md).
...
2. Vaya a **Azure Active Directory** >  **Inscripciones de la** **aplicaciónNuevo** >  registro.
   ...
   :::image type="content" source="../../media/atp-azure-new-app2.png" alt-text="La pestaña Nuevo registro en el Microsoft 365 Defender web" lightbox="../../media/atp-azure-new-app2.png":::
...
4. En la página de la aplicación, seleccione **Permisos de APIAgregue** >  **permisosAPIs** >  mi organización usa >, escriba **Protección contra** amenazas de Microsoft y seleccione **Protección contra amenazas de Microsoft**. La aplicación ahora puede acceder a Microsoft 365 Defender.
   ...
   :::image type="content" source="../../media/apis-in-my-org-tab.PNG" alt-text="Pestaña de uso de API de la organización en el portal Microsoft 365 Defender organización" lightbox="../../media/apis-in-my-org-tab.PNG":::
...
5. Seleccione **Permisos de aplicación**. Elija los permisos relevantes para su escenario (por ejemplo, **Incident.Read.All**) y, a continuación, **seleccione Agregar permisos**.
   ...
   :::image type="content" source="../../media/request-api-permissions.PNG" alt-text="El panel de permisos de la aplicación en el portal Microsoft 365 Defender aplicación" lightbox="../../media/request-api-permissions.PNG":::
...
6. Seleccione **Conceder consentimiento de administrador**. Cada vez que agregue un permiso, debe seleccionar Conceder consentimiento **de administrador** para que su efecto.
    ...
    :::image type="content" source="../../media/grant-consent.PNG" alt-text="El panel relacionado con la concesión de consentimiento en el portal Microsoft 365 Defender concesión de consentimiento" lightbox="../../media/grant-consent.PNG":::
...
7. Para agregar un secreto a la aplicación, seleccione Certificados **& secretos**, agregue una descripción al secreto y, a continuación, **seleccione Agregar**.
    ...
    :::image type="content" source="../../media/defender-endpoint/webapp-create-key2.png" alt-text="El panel crear aplicación en el portal Microsoft 365 Defender aplicación" lightbox="../../media/defender-endpoint/webapp-create-key2.png":::
...
1. Asegúrese de que la notificación *de roles* dentro del token descodificado contiene los permisos deseados.
   ...
   :::image type="content" source="../../media/defender-endpoint/webapp-decoded-token.png" alt-text="El panel Decoded token en el portal de Microsoft 365 Defender web" lightbox="../../media/defender-endpoint/webapp-decoded-token.png":::
