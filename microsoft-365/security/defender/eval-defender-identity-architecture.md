...
description: El diagrama técnico de Microsoft Defender for Identity en Microsoft 365 Defender le ayudará a comprender la identidad en Microsoft 365 antes de crear el entorno piloto o el laboratorio de prueba.
...
Para obtener una visión más profunda de la arquitectura de Defender for Identity, incluida la integración con Defender para aplicaciones en la nube, consulta [Arquitectura de Microsoft Defender para identidades](/defender-for-identity/architecture).
...
Defender for Identity requiere algunos requisitos previos para garantizar que la identidad local y los componentes de red cumplan los requisitos mínimos. Use este artículo como una lista de comprobación para asegurarse de que el entorno está listo: [requisitos previos de Microsoft Defender para la identidad](/defender-for-identity/prerequisites).
