---
title: Crear una aplicación para acceder a Microsoft 365 Defender API en nombre de un usuario
description: Obtenga información sobre cómo obtener Microsoft 365 Defender API en nombre de un usuario.
...
ms.locfileid: "63755216"
---
# <a name="create-an-app-to-access-microsoft-365-defender-apis-on-behalf-of-a-user"></a>Crear una aplicación para acceder a Microsoft 365 Defender API en nombre de un usuario
...
Si necesitas acceso mediante programación a Microsoft 365 Defender sin un usuario definido (por ejemplo, si estás escribiendo una aplicación en segundo plano o un demonio), consulta Crear una aplicación para tener acceso a Microsoft 365 Defender sin un [usuario](api-create-app-web.md). Si necesitas proporcionar acceso a varios inquilinos (por ejemplo, si estás prestando servicio a una organización grande o a un grupo de clientes), consulta Crear una aplicación con acceso de asociado a Microsoft 365 Defender [API](api-partner-access.md). Si no está seguro del tipo de acceso que necesita, consulte [Introducción](api-access.md).
...
2. Vaya a **Azure Active Directory** >  **Inscripciones de la** **aplicaciónNuevo** >  registro.
   ...
   :::image type="content" source="../../media/atp-azure-new-app2.png" alt-text="La opción Nuevo registro en el panel Administrar en Azure Portal" lightbox="../../media/atp-azure-new-app2.png":::
...
3. En el formulario, elija un nombre para la aplicación y escriba la siguiente información para el URI de redireccionamiento y, a continuación, **seleccione Registrar**.
   ...
   :::image type="content" source="../../media/nativeapp-create2.PNG" alt-text="El panel de registro de aplicaciones en Azure Portal" lightbox="../../media/nativeapp-create2.PNG":::
...
4. En la página de la aplicación, seleccione **Permisos de APIAgregue** >  **permisosAPIs** >  mi organización usa >, escriba **Protección contra** amenazas de Microsoft y seleccione **Protección contra amenazas de Microsoft**. La aplicación ahora puede acceder a Microsoft 365 Defender.
   ...
   :::image type="content" source="../../media/apis-in-my-org-tab.PNG" alt-text="Panel de API de la organización en el portal de Microsoft 365 Defender organización" lightbox="../../media/apis-in-my-org-tab.PNG":::

   - Elija **Permisos delegados**. Elija los permisos relevantes para el escenario (por ejemplo **, Incident.Read**) y, a continuación, **seleccione Agregar permisos**.

     :::image type="content" source="../../media/request-api-permissions-delegated.PNG" alt-text="El panel Permisos delegados en el portal de Microsoft 365 Defender delegado" lightbox="../../media/request-api-permissions-delegated.PNG":::
...
5. Seleccione **Conceder consentimiento de administrador**. Cada vez que agregue un permiso, debe seleccionar Conceder consentimiento **de administrador** para que su efecto.
   ...
   :::image type="content" source="../../media/grant-consent-delegated.PNG" alt-text="El panel de concesión de consentimiento de administrador en el portal de Microsoft 365 Defender administración" lightbox="../../media/grant-consent-delegated.PNG":::
...
:::image type="content" source="../../media/defender-endpoint/webapp-decoded-token.png" alt-text="Sección permisos del panel Token descodificado del portal de Microsoft 365 Defender web" lightbox="../../media/defender-endpoint/webapp-decoded-token.png":::
