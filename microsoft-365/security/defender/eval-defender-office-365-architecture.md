...
|6      | Al integrar un entorno local, se recomienda encarecidamente usar un servidor de Exchange para la administración y administración compatibles de atributos, configuraciones y configuraciones relacionados con el correo |
