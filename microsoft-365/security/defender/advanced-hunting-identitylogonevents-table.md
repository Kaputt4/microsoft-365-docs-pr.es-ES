...
>[!NOTE]
>En esta tabla se tratan Azure Active Directory de inicio de sesión de Cloud App Security (Azure AD), especialmente las actividades de autenticación y inicios de sesión interactivos mediante ActiveSync y otros protocolos heredados. Los inicios de sesión no interactivos que no están disponibles en esta tabla se pueden ver en el registro de auditoría de Azure AD. [Obtenga más información sobre cómo Cloud App Security a Microsoft 365](/cloud-app-security/connect-office-365-to-microsoft-cloud-app-security)
