---
title: Obtener ayuda y soporte técnico para Microsoft Defender para empresas (versión preliminar)
f1.keywords: NOCSH
ms.author: deniseb
author: denisebmsft
manager: dansimp
...
Si necesitas ayuda con Microsoft Defender para empresas (versión preliminar), selecciona el icono ayuda (?) en la esquina superior derecha de la pantalla. Escriba su pregunta o problema. Se mostrarán varias opciones, como respuestas rápidas o artículos de ayuda.

Si no ve la respuesta a su pregunta, puede abrir un vale de soporte técnico.
...
- [Microsoft Defender para empresas (versión preliminar): preguntas y respuestas más frecuentes](mdb-faq.yml)

- [Solución de problemas de Microsoft Defender para empresas (versión preliminar)](mdb-troubleshooting.yml) 