---
title: Firewall en Microsoft Defender para empresas (versión preliminar)
description: Obtenga información sobre Windows Defender firewall en Microsoft Defender para empresas (versión preliminar), incluidas las opciones de configuración
...
- [Configuración predeterminada del firewall en Defender para empresas (versión preliminar)](#default-firewall-settings-in-defender-for-business)
- [Configuración del firewall que puedes configurar en Defender para empresas (versión preliminar)](#firewall-settings-you-can-configure-in-defender-for-business)
...
Microsoft Defender para empresas (versión preliminar) incluye las directivas de firewall predeterminadas y la configuración para ayudar a proteger los dispositivos de su organización desde el primer día. Tan pronto como los dispositivos de la organización se incorpore a Microsoft Defender para empresas (versión preliminar), la directiva de firewall predeterminada funciona de la siguiente manera:
...
Microsoft Defender para empresas (versión preliminar) incluye protección de firewall a través Windows Defender Firewall. En la tabla siguiente se enumeran las opciones que se pueden configurar para la protección de firewall en Microsoft Defender para empresas (versión preliminar). <br/><br/>
