...
|[Configuración de cliente simplificada](mdb-simplified-configuration.md)|Yes|No|No|
|[Administración de vulnerabilidades de Microsoft Defender](../defender-endpoint/next-gen-threat-and-vuln-mgt.md)|Yes|No|Sí|
...
|[integración Microsoft 365 Lighthouse](../../lighthouse/m365-lighthouse-overview.md) <br/>(Para ver los incidentes de seguridad entre los inquilinos del cliente)|Yes |Sí <sup>[[7](#fn7)]</sup>|Sí <sup>[[7](#fn7)]</sup>|
