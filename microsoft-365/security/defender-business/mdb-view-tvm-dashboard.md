...
¿Quieres ver cómo funciona? Vea este vídeo, en el que se describe Threat & Vulnerability Management en [Microsoft Defender para punto de conexión](../defender-endpoint/microsoft-defender-endpoint.md).

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RE4r1nv]

Para obtener más información sobre Threat & Vulnerability Management, consulte [Threat and administración de vulnerabilidades in Microsoft Defender para punto de conexión (Amenazas y administración de vulnerabilidades en Microsoft Defender para punto de conexión](../defender-endpoint/next-gen-threat-and-vuln-mgt.md)).
