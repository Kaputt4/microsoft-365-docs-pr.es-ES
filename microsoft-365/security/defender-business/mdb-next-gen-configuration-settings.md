...
| **Exclusiones de procesos** | Las exclusiones de procesos impiden que antivirus de Microsoft Defender analice los archivos abiertos por procesos específicos. [Obtenga más información sobre las exclusiones de procesos](../defender-endpoint/configure-process-opened-file-exclusions-microsoft-defender-antivirus.md). |
