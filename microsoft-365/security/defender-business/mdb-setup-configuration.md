---
title: Configurar y configurar Microsoft Defender para empresas (versión preliminar)
description: Obtener información general sobre el proceso de configuración y configuración de Microsoft Defender para empresas (versión preliminar)
...
Microsoft Defender para empresas (versión preliminar) proporciona una experiencia de configuración y configuración optimizadas, diseñada especialmente para la pequeña y mediana empresa. Use este artículo como guía.
...
:::image type="content" source="media/mdb-setup-process-2.png" alt-text="Proceso de configuración y configuración de Microsoft Defender para empresas (versión preliminar).":::
...
- [Paso 1: Revisar los requisitos de Microsoft Defender para empresas (versión preliminar)](mdb-requirements.md)
