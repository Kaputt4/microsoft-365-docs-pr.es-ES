...
1. [Elija dónde administrar sus directivas de seguridad y dispositivos](#choose-where-to-manage-security-policies-and-devices).
...
5. [Revisar la configuración para las características avanzadas](#review-settings-for-advanced-features).
...
3. Seleccione las categorías que desea bloquear. Use el icono expandir para expandir por completo cada categoría primaria y, a continuación, seleccione categorías de contenido web específicas. Para configurar una directiva de solo auditoría que no bloquee ningún sitio web, no seleccione ninguna categoría. No seleccione **Sin categoría**.
...
Además de las directivas de protección, firewall y filtrado de contenido web de última generación, Defender for Business incluye características de seguridad avanzadas. Estas características están preconfiguradas para la configuración recomendada. Puede revisar y editar la configuración para adaptarla a sus necesidades empresariales.
