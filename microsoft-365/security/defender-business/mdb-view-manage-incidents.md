...
Microsoft Defender para empresas asigna una gravedad de alerta según la gravedad del comportamiento detectado, el riesgo real para un punto de conexión (dispositivo) y, lo que es más importante, el riesgo potencial para la organización. En la tabla siguiente se enumeran algunos ejemplos: <br/><br/>
...
| Microsoft Defender para empresas detecta el malware que se está ejecutando. El malware se bloquea casi inmediatamente. | Medio o alto | El malware representa una amenaza para puntos de conexión individuales y para su organización. |
