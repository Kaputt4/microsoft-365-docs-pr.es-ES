...
Para obtener la lista de funciones requeridas y cómo se regula el acceso a los datos, consulte Acerca de la [Administración del acceso a la protección contra amenazas de Microsoft](mtp-permissions.md).
