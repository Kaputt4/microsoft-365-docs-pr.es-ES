...
- Automatizar la respuesta al peligro desencadenando la recuperación automática de los activos afectados mediante la corrección automatizada
...
- Recuperación automática para **dispositivos, identidades** de usuario y buzones de correo comprometidos: Microsoft 365 Defender usa acciones automáticas con tecnología de IA y guías de reproducción para corregir los activos afectados a un estado seguro. Microsoft 365 Defender aprovecha las capacidades de corrección automática de los productos del conjunto de aplicaciones para garantizar que todos los activos afectados relacionados con un incidente se corrigen automáticamente siempre que sea posible.
