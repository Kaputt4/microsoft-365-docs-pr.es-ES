...
---
# <a name="list-incidents-api-in-microsoft-threat-protection"></a>API de lista de incidentes en protección contra amenazas de Microsoft
...
| serviceSource                             | Servicio del que se origina la alerta, como ATP de Microsoft defender, Microsoft Cloud App Security, Azure ATP o Office 365 ATP.                                                                                                                                                                                                                                                                     | MicrosoftCloudAppSecurity                                                                                                                                                                                                                         |
...
| entityType                                | Entidades que se han identificado como parte de una alerta determinada o están relacionadas con ella.<br>Los valores de las propiedades son: *usuario*, *IP*, *dirección URL*, *archivo*, *proceso*, *buzón*, *MailMessage*, *MailCluster*, *registro*                                                                                                                                                                                                     | User                                                                                                                                                                                                                                              |
...
| remitente                                    | Disponible si entityType es *User* / MailMessage de*buzón*de usuario / *MailMessage*.                                                                                                                                                                                                                                                                                                                                  | user.abc@mail.contoso.co.in                                                                                                                                                                 |
...
- [Actualizar incidente](api-update-incidents.md)
