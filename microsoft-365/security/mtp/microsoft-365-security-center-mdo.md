...
| [Investigación](../office-365-security/office-365-air.md#changes-are-coming-soon-in-your-security-center) | Aúna capacidades de AIR en [Microsoft Defender para Office 365](../office-365-security/office-365-atp.md) y [Microsoft Defender para punto de conexión](/windows/security/threat-protection/microsoft-defender-atp/automated-investigations). Con estas actualizaciones y mejoras, su equipo de operaciones de seguridad podrá ver detalles sobre investigaciones automatizadas y acciones de corrección en todos sus correos electrónicos, contenido de colaboración, cuentas de usuario y dispositivos, todo en un mismo sitio.  | 
...
La sección [Introducción](../office-365-security/office-365-atp.md#getting-started) del [artículo de Microsoft Defender para Office 365](../office-365-security/office-365-atp.md) tiene fragmentos lógicos de configuración temprana que tienen este aspecto:
...
- [Reglas de detección personalizada](/windows/security/threat-protection/microsoft-defender-atp/custom-detection-rules)
