...
|[![Planeación](../../media/phase-diagrams/1-planning.png)](mtp-pilot-plan.md)<br/>[Planeación](mtp-pilot-plan.md)|[![Preparación](../../media/phase-diagrams/2-prepare.png)](prepare-mtpeval.md)<br/>[Declaración](prepare-mtpeval.md)|![Simular ataque](../../media/phase-diagrams/3-simluate.png)<br/>Simular ataque|[![Cerrar y resumir](../../media/phase-diagrams/4-summary.png)](mtp-pilot-close.md)<br/>[Cerrar y resumir](mtp-pilot-close.md)|
|--|--|--|--|
|||*Ya está aquí.*||
...
2. Compruebe la configuración del controlador de dominio de prueba:
   ...
   - Compruebe que se hayan habilitado [Microsoft defender para la integración de Microsoft Cloud App Security](https://docs.microsoft.com/cloud-app-security/mdi-integration) .
...
#### <a name="alert-suspicious-process-injection-observed-source-microsoft-defender-for-endpoint-edr"></a>Alerta: se observó la inyección de procesos sospechoso (origen: Microsoft defender para el extremo EDR)
...
#### <a name="alert-unexpected-behavior-observed-by-a-process-run-with-no-command-line-arguments-source-microsoft-defender-for-endpoint-edr"></a>Alerta: comportamiento inesperado observado por un proceso ejecutar sin argumentos de línea de comandos (origen: Microsoft defender para el extremo EDR)
...
#### <a name="alert-user-and-ip-address-reconnaissance-smb-source-microsoft-defender-for-identity"></a>Alerta: el usuario y el reconocimiento de direcciones IP (SMB) (origen: Microsoft defender para la identidad)
...
#### <a name="go-hunting"></a>Ir a la caza
