...
|||
|:-------|:-----|
|![Fase 2: configuración](../../media/setup.png) <br>[Fase 2: configuración](setup-mtpeval.md) | Configurar el entorno de laboratorio de prueba de Microsoft Threat Protection
