...
![Fase 2: configuración](../../media/setup.png) <br>[Fase 2: configuración](setup-mtpeval.md)<br> Configurar el entorno piloto o el laboratorio de pruebas de Microsoft Threat Protection
