...
---
# <a name="remediate-malicious-emails-that-were-delivered-in-office-365"></a>Corregir los correos electrónicos malintencionados que se entregaron en Office 365
...
> [!NOTE]
> Ir a un artículo de investigación [aquí](https://docs.microsoft.com/microsoft-365/security/office-365-security/investigate-malicious-email-that-was-delivered?view=o365-worldwide).
...
## <a name="remediations-through-manual-investigation-or-air"></a>Correcciones mediante investigación manual o aire
...
1. Mensajes de correo de selección manual: Esto significa que los equipos de operaciones de seguridad pueden usar filtros en las vistas correspondientes y seleccionar unos pocos correos electrónicos del explorador de amenazas que necesitan ser corregidos. El límite superior para seleccionar correos electrónicos es 100 (100). Los equipos de operaciones de seguridad no pueden elegir más de cientos de mensajes de correo electrónico de forma manual.
...
Una vez que se seleccionan los correos electrónicos en el explorador de amenazas, la creación de la corrección puede comenzar realizando una acción directa o poniendo en cola los correos electrónicos para una acción:
 ...
 - Aprobación directa: cuando acciones como "mover a la bandeja de entrada", "mover a correo no deseado", "mover a elementos eliminados", "eliminación temporal", "eliminación temporal" los selecciona el personal de seguridad con los permisos adecuados y se siguen los pasos siguientes, el proceso de corrección comienza a ejecutar una acción seleccionada. Un control flotante temporal muestra la corrección en curso.

 - Aprobación en dos pasos: la acción "Agregar a corrección" puede llevarla a cabo un administrador que no tenga los permisos adecuados o que tenga que esperar más para ejecutar la acción. En este caso, la acción de corrección no se ejecuta directamente. En su lugar, los correos electrónicos se agregan a un contenedor de corrección que debe aprobarse para ejecutarse. Hasta que se apruebe la corrección, los mensajes de correo electrónico no serán corregidos. Una vez que se aprueba la corrección, se realizarán acciones en los correos electrónicos.

Las investigaciones **automatizadas de investigación y respuesta (Air)** se desencadenan mediante criterios de coincidencia en el sistema (ZAP, notificado por el usuario, etc.) o por los equipos de operaciones de seguridad desde dentro del explorador de amenazas seleccionando manualmente los correos electrónicos que se van a investigar. Estas investigaciones pueden incluir algunas acciones recomendadas que deben ser aprobadas por los equipos de operaciones de seguridad. Estas acciones de corrección se muestran en la ficha acción dentro de la investigación automatizada.  
...
1. **Ficha envío de correo**: es el número de correos electrónicos enviados a través del explorador de amenazas o investigaciones automatizadas que se van a corregir. Estos mensajes de correo electrónico pueden ser:
   ...
   **Accionable**: los correos electrónicos en las siguientes ubicaciones de buzones de la nube pueden actuar y moverse, es decir, cualquier correo electrónico dentro de la categoría remedible se puede mover de una ubicación a otra:
  - Bandeja de entrada 
  - Desea  
  - Carpeta eliminada
   ...
   **No se puede accionar**: los correos electrónicos en las siguientes ubicaciones no se pueden actuar o mover como parte de las acciones de correo electrónico, es decir, los correos electrónicos en categorías no remedibles no se pueden mover ni en la categoría no remedible ni en remedibles. Las ubicaciones no remedibles son:
   ...
   Si la corrección se detiene en un estado "en curso" durante un tiempo, es probable que se deba a retrasos en el sistema. La corrección puede tardar hasta unas pocas horas en corregirse. Puede haber una variación observada en el envío de correo se recuento porque algunos de los correos electrónicos no formaban parte de la consulta al iniciar la corrección, debido a retrasos en el sistema. Es una buena idea volver a intentar la corrección en estos casos.  
...
2. **Ficha registros de acciones**: esta pestaña muestra el resultado de los mensajes corregidos, incluidos los detalles como fecha aprobada, aprobador (administrador que aprobó la acción), acción, estado y recuentos.  
   ...
   - **Success**: cuando se lleva a cabo la acción deseada en los correos electrónicos remedibles, es decir, coincide con la ubicación de destino deseada y con la intención de administrador. Por ejemplo: un administrador desea quitar los correos electrónicos de los buzones de correo, de modo que lleve a cabo la acción de eliminar temporalmente los correos electrónicos. Si se encuentra un mensaje de correo electrónico remedible en la carpeta eliminada temporalmente después de que se haya realizado la acción, el estado mostrará como correcto.  
...
Consulte [investigar el correo electrónico malintencionado que se entregó en Office 365](https://docs.microsoft.com/microsoft-365/security/office-365-security/investigate-malicious-email-that-was-delivered?view=o365-worldwide).
