...
La tabla del esquema de búsqueda avanzada contiene eventos relacionados con un controlador de dominio local que `IdentityDirectoryEvents` ejecuta Active Directory (AD). [](advanced-hunting-overview.md) En esta tabla se capturan varios eventos relacionados con la identidad, como cambios de contraseña, expiración de contraseñas y cambios de nombre principal de usuario (UPN). También captura eventos del sistema en el controlador de dominio, como la programación de tareas y la actividad de PowerShell. Utilice esta referencia para crear consultas que devuelvan información sobre la tabla.
