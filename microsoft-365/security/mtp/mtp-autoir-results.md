...
| **Alertas**    | Muestra las alertas relacionadas con la investigación. Las alertas pueden provenir de características de protección contra amenazas en el equipo de un usuario, en aplicaciones de Office, Cloud App Security y otras características de Microsoft 365 defender.|
...
- [Revisión de acciones de corrección](mtp-remediation-actions.md)
