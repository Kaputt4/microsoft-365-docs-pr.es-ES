...
| **Entender el esquema** | Obtenga una visión adecuada y de alto nivel de las tablas en el esquema y sus columnas. Obtenga información sobre dónde buscar datos al construir las consultas. | - [Referencia de esquema](advanced-hunting-schema-tables.md)<br>- [Transición desde Microsoft Defender para endpoint](advanced-hunting-migrate-from-mdatp.md) |
