...
Para obtener más información, consulte [Microsoft defender para la integración de identidades](https://docs.microsoft.com/cloud-app-security/aatp-integration).
