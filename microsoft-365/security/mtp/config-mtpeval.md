...
8. Asegúrese de que la opción No realizar **un seguimiento** cuando los usuarios hacen clic en vínculos seguros no está seleccionada, mientras que el resto de las opciones están seleccionadas. Consulta [Configuración de vínculos seguros](../office-365-security/recommended-settings-for-eop-and-office365-atp.md) para obtener más información. Haga clic en **Guardar**. 
