...
Cada acción se registra individualmente en el centro [de acciones](mtp-action-center.md) en Historial **del centro** de acciones (  >   [security.microsoft.com/action-center/history](https://security.microsoft.com/action-center/history)). Vaya al centro de acciones para comprobar el estado de cada acción.
...
- [Introducción al Centro de acciones](mtp-action-center.md)