...
|Recomendación|E3|E5|
|---|---|---|
|**Configurar Microsoft Defender para Office 365**:<ul><li>Datos adjuntos seguros</li><li>Vínculos seguros</li><li>Datos adjuntos seguros para SharePoint, OneDrive y Microsoft Teams</li><li>Protección contra suplantación en directivas antiphishing</li></ul>||![marca de verificación verde.](../media/green-check-mark.png)|
|**Configuración de las funcionalidades de Microsoft Defender para punto de conexión**:<ul><li>Antivirus de Windows Defender</li><li>Protección contra vulnerabilidades de seguridad</li><li>Reducción de la superficie expuesta a ataques</li><li>Aislamiento basado en hardware</li><li>Acceso controlado a carpetas</li></ul>||![marca de verificación verde.](../media/green-check-mark.png)|
...
|**Proteja los datos en aplicaciones y servicios de terceros mediante aplicaciones de Defender for Cloud**. Configure directivas de aplicaciones de Defender for Cloud para proteger la información confidencial en aplicaciones en la nube de terceros, como Salesforce, Box o Dropbox. Puede usar tipos de información confidencial y las etiquetas de confidencialidad que creó en las directivas de Defender for Cloud Apps y aplicarlas en las aplicaciones SaaS. <p> Microsoft Defender for Cloud Apps permite aplicar una amplia gama de procesos automatizados. Las directivas se pueden establecer para proporcionar exámenes de cumplimiento continuos, tareas de exhibición de documentos electrónicos legales, DLP para contenido confidencial compartido públicamente, etc. Defender for Cloud Apps puede supervisar cualquier tipo de archivo en función de más de 20 filtros de metadatos (por ejemplo, nivel de acceso, tipo de archivo).||![marca de verificación verde.](../media/green-check-mark.png)|
|**Use [Microsoft Defender para punto de conexión](/windows/security/threat-protection/microsoft-defender-atp/information-protection-in-windows-overview) para identificar si los usuarios almacenan información confidencial en sus dispositivos Windows**.||![marca de verificación verde.](../media/green-check-mark.png)|
...
|Use **las herramientas de Microsoft Defender para Office 365**: <ul><li>Capacidades de investigación y respuesta de amenazas</li><li>Investigación y respuesta de amenazas</li></ul>||![marca de verificación verde.](../media/green-check-mark.png)|
|Use **Microsoft Defender para punto de conexión**: <ul><li>[EDR](/windows/security/threat-protection/microsoft-defender-atp/overview-endpoint-detection-response)</li><li>Investigación y corrección automatizadas Puntuación segura</li><li>[Búsqueda avanzada de amenazas](/windows/security/threat-protection/microsoft-defender-atp/advanced-hunting-overview)</li></ul>||![marca de verificación verde.](../media/green-check-mark.png)|
