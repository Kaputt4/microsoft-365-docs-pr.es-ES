...
|**Deshabilitar el uso compartido de calendario externo anónimo**. De forma predeterminada, se permite el uso compartido de calendario anónimo externo. [Deshabilite el uso compartido del calendario](https://docs.microsoft.com/exchange/sharing/sharing-policies/modify-a-sharing-policy) para reducir posibles pérdidas de información confidencial.|![marca de verificación verde](../images/green-check-mark.png) |![marca de verificación verde](../images/green-check-mark.png)|
...
|**Implemente [Azure ATP](https://docs.microsoft.com/azure-advanced-threat-protection/what-is-atp) ** para supervisar y proteger contra las amenazas dirigidas a su entorno local de Active Directory.   |         |![marca de verificación verde](../images/green-check-mark.png) |
