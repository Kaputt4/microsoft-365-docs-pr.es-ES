# [Seguridad de 365 de Microsoft](index.yml)
...
### [Puntuación segura](./mtp/microsoft-secure-score.md)

### [Informes]()
#### [Supervisión y visualización de informes](./mtp/monitoring-and-reporting.md)
#### [Supervisión e informes de identidades](./mtp/monitor-and-report-identities.md)
#### [Supervisión y generación de informes de datos](./mtp/monitor-data.md)
#### [Supervisión y generación de informes de dispositivos](./mtp/monitor-devices.md)
#### [Supervisión y generación de informes de aplicaciones](./mtp/monitor-apps.md)
...
#### [Nuevo centro de seguridad 365 de Microsoft](./office-365-security/microsoft-security-and-compliance.md)
...
##### [Preguntas más frecuentes sobre protección contra malware](./office-365-security/anti-malware-protection-faq-eop.md)
...
##### [Preguntas más frecuentes sobre protección contra correo no deseado](./office-365-security/anti-spam-protection-faq.md)
##### [Controlar el correo no deseado saliente en Office 365](./office-365-security/controlling-outbound-spam-in-Office-365.md)
##### [Evitar caracteres no válidos en las reglas de filtro de correo no deseado y la Directiva de filtro de correo no deseado](./office-365-security/invalid-characters-hosted-spam-filter-rules-policies.md)
...
##### [Sugerencias de seguridad en los mensajes de correo electrónico en Office 365](./office-365-security/safety-tips-in-office-365.md)
##### [Notificación de muestra cuando se bloquea a un remitente que envía correo no deseado saliente](./office-365-security/sample-notification-when-a-sender-is-blocked-sending-outbound-spam.md)
##### [Usar notificaciones de correo no deseado para el usuario final para liberar y notificar mensajes de correo no deseado en cuarentena](./office-365-security/use-end-user-spam-notifications-to-release-and-report-spam-quarantined-messages.md)
...
##### [Combinación de directivas y protecciones](./office-365-security/how-policies-and-protections-are-combined.md)
...
##### [Corregir el código de error 5.7.7 XX en Exchange Online](./office-365-security/fix-error-code-5-7-7xx-in-exchange-online.md)
...
##### [Envíos administrativos en Office 365](./office-365-security/admin-submission.md)
...
##### [Tutorial suplantación de información sobre inteligencia](./office-365-security/walkthrough-spoof-intelligence-insight.md)
...
##### [Configurar notificaciones de correo no deseado para el usuario final en EOP](./office-365-security/configure-end-user-spam-notifications-in-eop.md)
##### [Configurar notificaciones de correo no deseado para el usuario final en Exchange Online](./office-365-security/configure-end-user-spam-notifications-in-exchange-online.md)
##### [Informar sobre correo no deseado y estafas de suplantación de identidad (phishing) en Outlook en la web](./office-365-security/report-junk-email-and-phishing-scams-in-outlook-on-the-web-eop.md)
...
#####[Desactivar la creación de informes de correo no deseado en Outlook en la web](./office-365-security/turn-off-junk-email-reporting-in-outlook-on-the-web.md)
...
##### [Tareas de configuración del administrador de roles]()
###### [Activar ATP para SharePoint, OneDrive y Microsoft Teams](./office-365-security/turn-on-atp-for-spo-odb-and-teams.md).
#### [Información sobre las campañas de ataque más recientes con el análisis de amenazas](./mtp/latest-attack-campaigns.md)
#### [Ver y leer los informes de ATP](./office-365-security/view-reports-for-atp.md)
#### [Significado de las páginas de advertencia de los vínculos seguros de ATP](./office-365-security/atp-safe-links-warning-pages.md)
#### [Usar los rastreadores de amenazas](./office-365-security/threat-trackers.md)
#### [Usar el simulador de ataques en Office 365](./office-365-security/attack-simulator.md)
#### [Mantener la seguridad de los usuarios con la investigación y respuesta de amenazas](./office-365-security/keep-users-safe-with-office-365-ti.md)
#### [Investigar y responder automáticamente a las amenazas en Office 365](./office-365-security/office-365-air.md)
...
#### [Integración con mayor seguridad]()
##### [Integrar Office 365 ATP con Microsoft defender ATP](./office-365-security/integrate-office-365-ti-with-wdatp.md)
##### [Integración de SIEM con ATP de Office 365](./office-365-security/siem-integration-with-office-365-ti.md)

#### [Cómo funciona ATP]()
##### [Cómo funcionan los vínculos seguros ATP](./office-365-security/how-atp-safe-links-works.md)
##### [Cómo funcionan los datos adjuntos seguros de ATP](./office-365-security/how-atp-safe-attachments-works.md)
##### [Detalles de la entrega y vista previa dinámica](./office-365-security/dynamic-delivery-and-previewing.md)
##### [ATP para SharePoint, OneDrive y Microsoft Teams](./office-365-security/atp-for-spo-odb-and-teams.md).
##### [Cómo funciona la respuesta y la investigación de amenazas](./office-365-security/office-365-ti.md)
##### [Cómo funciona la investigación y la respuesta automatizadas](./office-365-security/automated-investigation-response-office.md)
...
##### [Información del estado del flujo de correo de dominio superior](./office-365-security/mfi-domain-mail-flow-status-insight.md)
##### [Informe de clientes de autenticación SMTP](./office-365-security/mfi-smtp-auth-clients-report.md)
##### [Revisión del conocimiento del dominio del remitente](./office-365-security/mfi-sender-domain-insight.md)
##### [Informe de no entrega](./office-365-security/mfi-non-delivery-report.md)
##### [Informe de dominio no aceptado](./office-365-security/mfi-non-accepted-domain-report.md)
...
### [Capacidades de seguridad heredadas]()
