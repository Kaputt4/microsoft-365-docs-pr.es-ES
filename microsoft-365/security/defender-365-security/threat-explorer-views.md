...
- Si tiene [Microsoft Defender para Office 365](defender-for-office-365.md) Plan 2, tiene Explorer.
...
En esta vista, ahora estamos buscando datos para los archivos que fueron detonados por [datos adjuntos seguros](safe-attachments.md). Debajo del gráfico, podemos ver detalles sobre mensajes de correo electrónico específicos que tenían datos adjuntos detectados por datos adjuntos seguros.
