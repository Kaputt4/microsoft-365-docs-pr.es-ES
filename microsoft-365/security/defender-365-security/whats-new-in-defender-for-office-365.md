...
- [Mejoras en el Explorador de](threat-explorer.md#improvements-to-the-threat-hunting-experience-upcoming) amenazas de experiencia de búsqueda con actualizaciones sobre amenazas, acciones adicionales, ubicaciones de entrega y vista escala de tiempo actualizada (Defender para Office 365 Plan 2)

## <a name="julyaugust-2020"></a>Julio/agosto de 2020

- [Mejoras en la experiencia de búsqueda](threat-explorer.md#improvements-to-threat-hunting-experience) (Microsoft Defender para Office 365 Plan 1 o Plan 2)
...
- [Exportar datos de clic url para análisis sin conexión](threat-explorer.md#new-features-in-threat-explorer-and-real-time-detections) (Microsoft Defender para Office 365 Plan 1 o Plan 2)
