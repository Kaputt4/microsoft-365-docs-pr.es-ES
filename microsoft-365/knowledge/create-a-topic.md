...
> [!Note] 
> Aunque la información de un tema recopilado por la IA tiene recortes de [seguridad,](topic-experiences-security-trimming.md)tenga en cuenta que la descripción del tema y la información de personas de un tema creado manualmente son visibles para todos los usuarios que tienen permisos para ver el tema. 
...
5. En la sección de páginas <b>y archivos</b> anclados, puede agregar o "anclar" un archivo o página de sitio de SharePoint asociado al tema.
   ...
   ![Páginas y archivos anclados](../media/knowledge-management/pinned-files-and-pages.png)</br>
    ...
    > [!Note] 
    > Los archivos y páginas que agregue deben estar ubicados en el mismo inquilino de Microsoft 365. Si desea agregar un vínculo a un recurso externo en el tema, puede agregarlo a través del icono del lienzo en el paso 8.
