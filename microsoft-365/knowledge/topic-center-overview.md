...
El centro de temas se crea durante la configuración de administración del conocimiento. Una vez finalizada la instalación, un administrador puede encontrar la dirección URL en la [Página de administración del centro de información](manage-knowledge-network.md).
