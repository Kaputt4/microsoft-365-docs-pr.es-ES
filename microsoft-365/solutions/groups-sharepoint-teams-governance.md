...
|Configuración de SharePoint|Descripción|Efecto en grupos y equipos de Microsoft 365|Recomendación|
|:-----------------|:----------|:---------------------------------------|:-------------|
...
|Configuración de Microsoft 365 Groups|Descripción|Efecto en Microsoft Teams|Recomendación|
|:---------------------------|:----------|:--------------|:-------------|
