...
En mi rol, me centraré en ayudar a los clientes a llegar a la mejor solución técnica para abordar su conjunto único de objetivos empresariales. Oficialmente, me concentro en la identidad, la seguridad, la privacidad y el cumplimiento. Me encanta el hecho de que toquen todo lo que hacemos. Me da la oportunidad de participar en la mayoría de los proyectos. Esto me mantiene ocupado y disfrutando de este papel.
...
- **Larga cola de procedimientos recomendados anteriores**: reconozca que los procedimientos recomendados cambian a velocidad de luz. Si ha visto Azure AD hace más de tres meses, es probable que esté obsoleto. Todo esto está sujeto a cambios después de la publicación. La opción "Mejor" hoy puede no ser la misma en seis meses.
