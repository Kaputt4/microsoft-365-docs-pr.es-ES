...
Esta serie de artículos le ayudará a comprender cómo interactúan los grupos, los equipos y la configuración de SharePoint, qué funcionalidades de gobernanza están disponibles y cómo crear e implementar un marco de gobernanza para las características de colaboración de Microsoft 365.

### <a name="setting-up-secure-collaboration-with-microsoft-365"></a>Configuración de una colaboración segura con Microsoft 365

Hay muchas opciones para implementar Grupos de Microsoft 365 y Teams para una colaboración segura en su organización. Se recomienda usar este contenido de gobernanza junto [con Configurar el uso compartido de archivos seguro y la colaboración con Microsoft Teams](setup-secure-collaboration-with-teams.md) y sus artículos asociados para crear la mejor solución de colaboración para su organización.
...
Los grupos de Microsoft 365 le permiten elegir un conjunto de personas con las que desea colaborar y configurar fácilmente una colección de recursos para que esas personas puedan compartir. Al agregar miembros al grupo, se conceden automáticamente los permisos necesarios a todos los recursos proporcionados por el grupo. Tanto Teams como Yammer usan grupos de Microsoft 365 para administrar su pertenencia.
...
|[Proyecto y hoja de ruta](https://support.microsoft.com/project)|Herramientas de administración de proyectos basadas en web|
...
Hay varios lugares para colaborar y tener conversaciones en Microsoft 365. Comprender dónde pueden iniciar conversaciones los usuarios puede ayudarle a definir una estrategia de comunicación.
...
- Microsoft Teams: un área de trabajo basada en chat persistente en la que puede tener conversaciones informales en tiempo real en torno a diversos temas, organizados por subgrupos específicos.
...
> [!NOTE]
> Cuando se crea un nuevo grupo de Office 365 a través de Yammer o Teams, el grupo no es visible en Outlook ni en la libreta de direcciones porque la comunicación principal entre esos usuarios se produce en sus respectivos clientes. Los grupos de Yammer no se pueden conectar a Teams.
...
- **Adaptarse a diferentes organizaciones y diferentes tipos de contenido y escenarios** : tenga en cuenta las diferentes necesidades de los distintos grupos o departamentos y los distintos tipos de contenido, como el contenido de la intranet frente al contenido de OneDrive de un usuario.
...
- **Reforzar con el entrenamiento** : adapte soluciones como [los caminos de aprendizaje de Microsoft 365](/office365/customlearning) para asegurarse de que las expectativas específicas de la organización se refuerzan con el entrenamiento proporcionado por Microsoft.

- **Tener una estrategia para comunicar directivas y directrices de gobernanza en su organización** : cree un Centro de adopción de Microsoft 365 en un sitio de comunicación de SharePoint para comunicar directivas y procedimientos.
...
Las funcionalidades de gobernanza para la colaboración en Microsoft 365 incluyen características de Microsoft 365, Teams, SharePoint y Azure Active Directory.
...
|Creación de grupos restringidos|Restrinja la creación de grupos y equipos a los miembros de un grupo de seguridad específico.|Microsoft 365 E5 o E3 con licencias EDU de Azure AD Premium o Azure AD Basic|
|Directiva de nomenclatura de grupos|Aplicar prefijos o sufijos en los nombres de grupo y equipo.|Microsoft 365 E5 o E3 con licencias EDU de Azure AD Premium o Azure AD Basic|
|Directiva de expiración de grupo|Establezca grupos inactivos y equipos para que expiren y se eliminen después de un período de tiempo especificado.|Microsoft 365 E5 o E3 con licencias premium de Azure AD|
...
4. Planear la administración de la configuración de cumplimiento: revise las [opciones de cumplimiento disponibles para los grupos de Microsoft 365, Teams y la colaboración de SharePoint](groups-teams-compliance-governance.md).
...
6. Planeamiento de la gobernanza de la organización y del ciclo de vida: elija [las directivas que desea usar para la creación, nomenclatura, expiración y archivado de grupos y equipos](plan-organization-lifecycle-governance.md). Además, comprenda las [opciones de fin del ciclo de vida para grupos, equipos y Yammer](end-life-cycle-groups-teams-sites-yammer.md).
...
### <a name="microsoft-365-information-protection-and-compliance-capabilities"></a>Funcionalidades de cumplimiento y protección de la información de Microsoft 365
...
Vea estas sesiones de conferencia para obtener más información sobre la gobernanza para Grupos de Microsoft 365 y Teams.
