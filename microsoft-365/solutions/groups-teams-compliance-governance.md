---
title: Opciones de cumplimiento para grupos de Microsoft 365, Teams y colaboración SharePoint
ms.reviewer: ''
ms.author: mikeplum
...
description: Obtenga información sobre las opciones de cumplimiento para grupos de Microsoft 365, Teams y colaboración SharePoint.
ms.openlocfilehash: afbbc6e507d613e028f65dbc157ec2222414af8c
ms.sourcegitcommit: 52eea2b65c0598ba4a1b930c58b42dbe62cdaadc
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 04/19/2022
ms.locfileid: "64939134"
---
# <a name="compliance-options-for-microsoft-365-groups-teams-and-sharepoint-collaboration"></a>Opciones de cumplimiento para grupos de Microsoft 365, Teams y colaboración SharePoint
...
||Conservar el correo de grupos y SharePoint contenido|[Más información sobre las directivas de retención para SharePoint y OneDrive](../compliance/retention-policies-sharepoint.md)|
...
||Evitar la pérdida de información confidencial|[Más información sobre la prevención de pérdida de datos de Microsoft Purview](../compliance/dlp-learn-about-dlp.md)|
||Proteja la información confidencial en el chat.|[Prevención y Microsoft Teams de pérdida de datos de Microsoft Purview](../compliance/dlp-microsoft-teams.md)|
...
La configuración de una directiva de retención para Grupos de Microsoft 365 cubre el buzón de grupo y los archivos y el sitio SharePoint asociados.

- [Más información sobre las directivas de retención para SharePoint y OneDrive](../compliance/retention-policies-sharepoint.md)

Las directivas de retención para Teams conservar mensajes de chat y canal. Aunque los mensajes de chat y de canal se almacenan en buzones de Exchange, no se ven afectados por las directivas de retención de Exchange. Debe establecer las directivas de retención para que se apliquen a Teams chats y Teams mensajes de canal. 
...
Se puede establecer una única directiva de retención para aplicarla a Teams mensajes de chat y Teams canal. 
