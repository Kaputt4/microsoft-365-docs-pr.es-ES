...
---
# <a name="security-hurdles-you-can-sail-overone-architects-viewpoint"></a>Obstáculos de seguridad que puede gobernar: el punto de vista de un arquitecto
...
Otro obstáculo en el que veo a los clientes Stumble es tomar un enfoque de "mejor calidad" para las herramientas de seguridad. La organización continua en capas de soluciones puntuales de "mejor raza" para abordar las necesidades de seguridad emergentes hace que la seguridad de la empresa se interrumpa. Incluso con las mejores intenciones, las herramientas de la mayoría de los entornos no se integran porque se convierten en demasiado caros y complejos. Esto, a su vez, crea brechas en la visibilidad a medida que hay más alertas para evaluar de las que el equipo puede controlar. Volver a entrenar al equipo de SecOps en nuevas herramientas también se convierte en un reto constante.
...
|---------|---------|
|[Las tareas principales de los equipos de seguridad para dar soporte al trabajo desde casa](../security/top-security-tasks-for-remote-work.md)      | Si se ve que, de repente, admite un personal de trabajo en casa principalmente, este artículo le ayudará a incrementar la seguridad rápidamente. Incluye las principales tareas recomendadas basadas en el plan de licencias.    |
