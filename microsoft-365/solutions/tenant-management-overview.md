...
Un inquilino de Microsoft 365 es una instancia dedicada de los servicios de Microsoft 365 y los datos de su organización almacenados en una ubicación predeterminada específica, como Europa o Norteamérica. Esta ubicación se especifica al crear el espacio empresarial para la organización. Cada inquilino de Microsoft 365 es distinto, único y independiente de todos los demás inquilinos de Microsoft 365. Se crea un inquilino de Microsoft 365 al comprar uno o varios productos de Microsoft, como Microsoft 365 E3 o E5, y un conjunto de licencias para cada uno.
...
*La administración de* inquilinos es la planeación, implementación y operación continua de los inquilinos de Microsoft 365. 
...
- Has sincronizado tus cuentas, grupos y otros objetos de Servicios de dominio de Active Directory (AD DS).
  ...
  - Se han asignado las licencias correctas a las cuentas de usuario de los productos comprados correctos (como Microsoft 365 E3 o E5).
...
|:-------|:-----|:-------|
| Varios inquilinos | Cada inquilino de Microsoft 365 es distinto, único y independiente de todos los demás inquilinos de Microsoft 365. Con varios inquilinos, existen restricciones y consideraciones adicionales al administrarlos y proporcionar servicios a los usuarios. | Microsoft 365 E3 o E5 | 
...
| Funcionalidad o característica | Description | Licencias |
|:-------|:-----|:-------|
| Network Insights | Métricas de rendimiento de red recopiladas de su inquilino de Microsoft 365 para ayudarle a diseñar perímetros de red para las ubicaciones de la oficina. | Microsoft 365 E3 o E5 | 
| Automatizar actualizaciones de puntos de conexión | Automatice la configuración y las actualizaciones continuas de los puntos de conexión de Microsoft 365 en los archivos PAC de cliente y los dispositivos y servicios de red. | Microsoft 365 E3 o E5 | 
||||
...
| Migrar servidores y datos locales a Microsoft 365 | Migre los buzones de Exchange, los sitios de SharePoint y Skype Empresarial Online a los servicios en la nube de Microsoft 365. | Microsoft 365 E3 o E5 | 
||||
...
| Movilidad y seguridad básicas | Protege y administra los dispositivos móviles de los usuarios como iPhones, iPads, Android y teléfonos Windows con este servicio integrado.  | Microsoft 365 E3 o E5 | 
||||
...
Para comprender cómo una organización multinacionales ficticia pero representativa implementó los elementos de su inquilino de Microsoft 365, vea el [caso práctico de Contoso](../enterprise/contoso-case-study.md).
