...
Para invitar invitados de una organización asociada, debe agregar el dominio del partner como organización conectada en Azure Active Directory.

Para agregar una organización conectada
1. En [Azure Active Directory,](https://aad.portal.azure.com)haga clic **en Identity Governance**.
...
8. Haga **clic en Conectar** y, a continuación, en **Siguiente: Patrocinadores**.
...
Una vez creado el catálogo, se agrega el sitio o el equipo de SharePoint que desea compartir con la organización asociada.
