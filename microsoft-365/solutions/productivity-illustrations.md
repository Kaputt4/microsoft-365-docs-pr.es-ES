...
La serie de soluciones de Microsoft 365 Enterprise ofrece orientación para implementar capacidades de Microsoft 365, sobre todo cuando las capacidades se cruzan entre tecnologías, incluidos los diagramas de arquitectura de Teams.
...
### <a name="microsoft-defender-for-endpoint-deployment-strategy"></a>Microsoft defender para la estrategia de implementación de extremos
...
Con Microsoft 365 y otras tecnologías de nube de Microsoft, puede proporcionar a sus trabajadores acceso seguro a la información, las herramientas y los recursos basados en la nube y la implementación local de su organización desde sus casas. 
...
Se actualizó el 2020 de julio

Para obtener más información, vea el artículo para este póster: conceder a los [trabajadores remotos con Microsoft 365](empower-people-to-work-remotely.md).

### <a name="microsoft-teams-with-security-isolation"></a>Microsoft Teams con aislamiento de seguridad

Con Microsoft 365, puede configurar un equipo privado en Microsoft Teams y usar la configuración de seguridad de sitios de SharePoint y una etiqueta de confidencialidad única para cifrar archivos de modo que solo los miembros del equipo puedan descifrarlos.
...
[ARCHIVO](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/downloads/team-security-isolation-poster.pdf) <br> Se actualizó el 2020 de agosto

Para obtener más información, vea el artículo para este póster: [Configure a Team with Security Isolation](secure-teams-security-isolation.md).
