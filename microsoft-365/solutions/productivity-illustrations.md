...
description: Obtenga información sobre cómo implementar soluciones de productividad de Microsoft 365 y Microsoft Teams con estos diagramas de arquitectura.
ms.author: samanro
author: samanro
manager: bcarter
ms.audience: ITPro
...
ms.locfileid: "67728240"
---
# <a name="microsoft-365-productivity-illustrations"></a>Ilustraciones de productividad de Microsoft 365

La serie de soluciones empresariales de Microsoft 365 proporciona instrucciones para implementar las funcionalidades de Microsoft 365, especialmente cuando las funcionalidades se cruzan entre tecnologías, incluidos los diagramas de arquitectura de Teams.
...
Con Microsoft 365, puede configurar un equipo privado en Microsoft Teams y usar la configuración de seguridad del sitio de SharePoint y una etiqueta de confidencialidad única para cifrar los archivos de modo que solo los miembros del equipo puedan descifrarlos.
