...
ms.locfileid: "52583645"
---
# <a name="microsoft-365-productivity-illustrations"></a>Ilustraciones de productividad de Microsoft 365

La Microsoft 365 de soluciones empresariales proporciona instrucciones para implementar Microsoft 365 capacidades, especialmente cuando las capacidades se cruzan entre tecnologías, incluidos Teams de arquitectura.
...
## <a name="advanced-ediscovery-architecture-in-microsoft-365"></a>Advanced eDiscovery arquitectura en Microsoft 365
...
Para obtener más información, vea el artículo de este póster: Facultar a [los trabajadores remotos con Microsoft 365](empower-people-to-work-remotely.md).

## <a name="microsoft-teams-with-security-isolation"></a>Microsoft Teams aislamiento de seguridad

Con Microsoft 365, puede configurar un equipo privado en Microsoft Teams y usar una configuración de seguridad del sitio SharePoint y una etiqueta de confidencialidad única para cifrar archivos para que solo los miembros del equipo puedan descifrarlos.
