...
description: Obtenga información sobre cómo implementar soluciones de productividad Microsoft 365 y Microsoft Teams con estos diagramas de arquitectura.
ms.author: samanro
author: samanro
manager: bcarter
ms.audience: ITPro
...
La serie de soluciones empresariales Microsoft 365 proporciona instrucciones para implementar funcionalidades de Microsoft 365, especialmente cuando las funcionalidades se cruzan entre tecnologías, incluidos los diagramas de arquitectura de Teams.
...
Seguridad y protección de la información para organizaciones de varias regiones con un único inquilino Microsoft 365
...
## <a name="microsoft-defender-for-endpoint-deployment-strategy"></a>estrategia de implementación de Microsoft Defender para punto de conexión
...
Para obtener más información, consulte el artículo de este póster: [Configuración de la infraestructura para el trabajo híbrido con Microsoft 365](empower-people-to-work-remotely.md).

## <a name="microsoft-teams-with-security-isolation"></a>Microsoft Teams con aislamiento de seguridad

Con Microsoft 365, puede configurar un equipo privado en Microsoft Teams y usar SharePoint configuración de seguridad del sitio y una etiqueta de confidencialidad única para cifrar los archivos de modo que solo los miembros del equipo puedan descifrarlos.
