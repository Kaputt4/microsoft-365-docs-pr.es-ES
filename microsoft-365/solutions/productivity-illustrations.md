...
La serie de soluciones empresariales de Microsoft 365 proporciona instrucciones para implementar las capacidades de Microsoft 365, especialmente cuando las capacidades se cruzan entre tecnologías, incluidos los diagramas de arquitectura de Teams.
...
Microsoft proporciona herramientas para migrar los recursos compartidos de archivos de red local y los sitios de SharePoint Server a Microsoft 365 con énfasis en proteger y garantizar la seguridad del contenido durante la migración. Este conjunto de ilustraciones muestra los distintos métodos disponibles para mover el contenido a SharePoint, Teams y OneDrive y cómo fluyen los datos a través del proceso. 

| Elemento | Descripción |
|:-----|:-----|
|[![Póster del modelo: Migrar a Microsoft 365](../media/solutions-architecture-center/msft-migration-thumb.png)](https://download.microsoft.com/download/0/5/b/05b7fb7c-1557-4ebb-9036-c5fc3a4cd94c/Migration-posters-mm-spmt.pdf) <br/> [Descargar como pdf](https://download.microsoft.com/download/0/5/b/05b7fb7c-1557-4ebb-9036-c5fc3a4cd94c/Migration-posters-mm-spmt.pdf) \| [Descargar como Visio](https://download.microsoft.com/download/0/5/b/05b7fb7c-1557-4ebb-9036-c5fc3a4cd94c/Migration-posters-mm-spmt.vsdx)   <br/> Actualizado en marzo de 2021 |Incluye: <ul><li>  Migración de recurso compartido de archivos</li><li>Migración de SharePoint Server </li> </ul><br> Para obtener más información, vea [Migrate your content to Microsoft 365](/sharepointmigration/migrate-to-sharepoint-online).|
...
Para obtener más información, vea el artículo para este póster: [Facultar a los trabajadores remotos con Microsoft 365](empower-people-to-work-remotely.md).

## <a name="microsoft-teams-with-security-isolation"></a>Microsoft Teams con aislamiento de seguridad

Con Microsoft 365, puede configurar un equipo privado en Microsoft Teams y usar la configuración de seguridad del sitio de SharePoint y una etiqueta de confidencialidad única para cifrar archivos para que solo los miembros del equipo puedan descifrarlos.
