...
---
# <a name="how-exchange-online-uses-tls-to-secure-email-connections"></a>Uso de TLS por Exchange Online para proteger las conexiones de correo electrónico

Obtenga información sobre cómo Exchange Online y Microsoft 365 usan la seguridad de la capa de transporte (TLS) y la confidencialidad directa (FS) para proteger las comunicaciones de correo electrónico. También proporciona información sobre el certificado emitido por Microsoft para Exchange Online.
...
Los servidores de Exchange Online siempre cifran las conexiones con otros servidores de Exchange Online de nuestros centros de datos con TLS 1.2. Cuando envía correo a un destinatario que está dentro de su organización, dicho correo se envía automáticamente a través de una conexión cifrada mediante TLS. Además, todo el correo electrónico que envíe a otros clientes se envía a través de conexiones cifradas mediante TLS y se protegen mediante confidencialidad directa.
  
## <a name="how-microsoft-365-uses-tls-between-microsoft-365-and-external-trusted-partners"></a>Cómo usa Microsoft 365 TLS entre Microsoft 365 y los asociados de confianza externos
...
## <a name="get-more-information-about-tls-and-microsoft-365"></a>Obtener más información acerca de TLS y Microsoft 365

Para obtener una lista de los conjuntos de programas de cifrado compatibles, consulte [Technical Reference details for Encryption](technical-reference-details-about-encryption.md).
