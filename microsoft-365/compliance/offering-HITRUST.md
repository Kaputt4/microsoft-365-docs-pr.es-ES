...
ms.locfileid: "38691039"
---
# <a name="compliance-offering-health-information-trust-alliance-hitrust-common-security-framework-csf"></a>Oferta de cumplimiento: Common Security Framework (HITRUST) de Health Information Trust Alliance (CSF)
...
Information Trust Trust Alliance (HITRUST) Common Security Framework (CSF)
...
¿Necesita el documento de fondo para esta oferta? Descargue el [archivo PDF](https://download.microsoft.com/download/7/2/6/7265470A-862D-4665-91E8-E17BF0C8A1E2/HITRUST-Compliance.pdf).
