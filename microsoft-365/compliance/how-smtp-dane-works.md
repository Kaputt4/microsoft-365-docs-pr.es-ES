---
title: Funcionamiento de la autenticación basada en DNS SMTP de entidades con nombre (DANE) para proteger las comunicaciones por correo electrónico
f1.keywords:
- NOCSH
...
|11<sup></sup>|PKIX-EE|El certificado comprobado es el servidor de destino; Las comprobaciones de DNSSEC deben comprobar su autenticidad.|
