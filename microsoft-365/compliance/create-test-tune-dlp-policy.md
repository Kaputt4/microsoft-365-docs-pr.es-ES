...
![Una regla para volumen alto y una regla para volumen bajo.](../media/DLP-create-test-tune-two-rules.png)
...
![Opción para notificar falso positivo en la sugerencia de directiva.](../media/DLP-create-test-tune-policy-tip-closeup.png)
