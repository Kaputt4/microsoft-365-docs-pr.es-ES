...
El script que ejecute en este primer paso devolverá una lista de carpetas de buzones de correo o carpetas de SharePoint y OneDrive para la Empresa, así como el identificador de carpeta o ruta de acceso correspondiente para cada carpeta. Al ejecutar este script, se le pedirá la siguiente información.
  
- **Dirección de correo electrónico o dirección URL** del sitio: escriba una dirección de correo electrónico del custodio para devolver una lista de carpetas de buzones de Exchange e IDs de carpeta. O escriba la dirección URL de un sitio de SharePoint o un sitio de OneDrive para la Empresa para devolver una lista de rutas de acceso para el sitio especificado. Aquí le mostramos otros ejemplos:
...
- **Sus credenciales de usuario:** el script usará sus credenciales para conectarse a PowerShell de Exchange Online o Al Centro de seguridad & PowerShell mediante la autenticación moderna. Como se explicó anteriormente, debe tener asignados los permisos adecuados para ejecutar correctamente este script.
...
1. Vaya a e inicie sesión con la cuenta y las credenciales que [https://compliance.microsoft.com](https://compliance.microsoft.com) usó para ejecutar el script en el paso 1.
...
5. Realice una de las siguientes acciones, en función de si está buscando en una carpeta de buzón o en una carpeta de sitio:
    ...
    - Junto al **correo electrónico de Exchange,** haga clic en Elegir usuarios, grupos o equipos **y,** a continuación, agregue el mismo buzón que especificó al ejecutar el script en el paso 1.

      O bien

    - Junto a Sitios de  **SharePoint,** haga clic en Elegir sitios y, a continuación, agregue la misma dirección URL del sitio que especificó al ejecutar el script en el paso 1.
