...
La pestaña **Estadísticas de búsqueda** contiene para las secciones siguientes que contienen diferentes tipos de estadísticas sobre la búsqueda.

### <a name="search-content"></a>Buscar contenido

En esta sección se muestra un resumen gráfico de los elementos estimados devueltos por la búsqueda. Esto indica el número de elementos que coinciden con los criterios de búsqueda. Esta información le proporciona una idea sobre el número estimado de elementos devueltos por la búsqueda.
...
3. Escriba una palabra clave o una fase de palabra clave en una fila de la tabla keywords. Por ejemplo, escriba **budget** en la primera fila, escriba **security** en la segunda fila y escriba **FY2021** en la tercera fila.

   ![Escriba hasta 20 palabras clave o frases clave en la lista.](../media/SearchKeywordsList2.png)
...
4. Después de agregar las palabras clave a la lista para la que desea buscar y obtener estadísticas, ejecute la búsqueda.
