...
En este artículo se describen los límites de la solución de exhibición de documentos electrónicos avanzada en Microsoft 365.

## <a name="case-and-review-set-limits"></a>Límites de conjunto de casos y revisión

En la tabla siguiente se enumeran los límites de los casos y los conjuntos de revisión de eDiscovery avanzada.
...
|Tamaño total del archivo por conjunto de carga. Esto incluye cargar que no es Office 365 en un conjunto de opiniones.  <br/> |300 GB <br/> |
...
En la tabla siguiente se enumeran los límites para las retenciones asociadas a un caso de exhibición de documentos electrónicos avanzada.
...
En la tabla siguiente se enumeran los límites de indización en eDiscovery avanzada.
...
Los límites descritos en esta sección están relacionados con el uso de la herramienta de búsqueda en la pestaña **Búsquedas** para recopilar datos de un caso. Para obtener más información, vea [Recopilar datos para un caso en Exhibición](collecting-data-for-ediscovery.md)de documentos electrónicos avanzada .
...
|Número máximo de elementos de sitios de SharePoint y OneDrive para la Empresa que se muestran en la página de vista previa para las búsquedas. Se muestran los elementos más recientes. |200|
...
| Descripción del límite | Límite |
|:-----|:-----|
|Tamaño máximo de una sola exportación.|3 millones de documentos o 100 GB, lo que sea menor|
...
>
> <sup>2</sup> Al buscar en ubicaciones de SharePoint y OneDrive para la Empresa, los caracteres de las direcciones URL de los sitios que se buscan cuentan con este límite.
>
...
>
> <sup>4</sup> Este límite se comparte con la exportación de contenido en otras herramientas de exhibición de documentos electrónicos. Esto significa que las exportaciones simultáneas en búsqueda de contenido y exhibición de documentos electrónicos principales (y agregar contenido para revisar conjuntos de exhibición de documentos electrónicos avanzados) se aplican a este límite.
>
