...
|Descripción del límite|Límite|
|---|---|
|Número máximo de caracteres extraídos de un único archivo.|10 millones<sup>4</sup>|
|Tamaño máximo de un solo archivo.|150 MB<sup>4</sup>|
|Profundidad máxima de los elementos incrustados en un documento.|25<sup>4</sup>|
...
|Descripción del límite|Límite|
|---|---|
|Tamaño total de archivo o número máximo de documentos descargados de un conjunto de revisión.|3 MB o 50 documentos<sup>7</sup>|
...
<sup>2</sup> Este límite se comparte con la exportación de contenido en otras herramientas de exhibición de documentos electrónicos. Esto significa que las exportaciones simultáneas en búsqueda de contenido y exhibición de documentos electrónicos (estándar) (y agregar contenido a conjuntos de revisión en eDiscovery (Premium)) se aplican a este límite.
...
<sup>7</sup> El período de antigüedad de los blobs de Azure que almacenan colecciones de eDiscovery (Premium) es de un año. Es posible que ya no se pueda acceder a cualquier colección creada hace un año.
 
<sup>8</sup> Este límite se aplica a la descarga de documentos seleccionados de un conjunto de revisión. No se aplica a la exportación de documentos desde un conjunto de revisión. Para obtener más información sobre cómo descargar y exportar documentos, vea [Exportar datos de casos en eDiscovery (Premium).](exporting-data-ediscover20.md)
