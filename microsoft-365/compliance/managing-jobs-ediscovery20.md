...
| :----------------- | :----------     |
|Agregar datos a un conjunto de revisión | Un usuario agrega una colección a un conjunto de opiniones. Este trabajo consta de dos sub trabajos: </br>• **Exportar:** se genera una lista de elementos de la colección. </br>• **Indización de &** ingesta: los elementos de la colección que coinciden con la consulta de búsqueda se copian en una ubicación de Azure Storage (en un proceso denominado *ingesta)* y, a continuación, los elementos de la ubicación de Azure Storage se indizan de nuevo. Este nuevo índice se usa al consultar y analizar elementos del conjunto de datos. </br></br>Para obtener más información, vea [Agregar resultados de búsqueda a un conjunto de revisión.](add-data-to-review-set.md) |
