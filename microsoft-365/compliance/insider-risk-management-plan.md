...
Seleccione partes interesadas dedicadas para supervisar y revisar las alertas y los casos en una cadencia regular en el centro de Microsoft 365 [cumplimiento.](https://compliance.microsoft.com/) Asegúrese de comprender cómo asignará diferentes partes interesadas a los diferentes grupos de roles disponibles en la administración de riesgos de insider.
