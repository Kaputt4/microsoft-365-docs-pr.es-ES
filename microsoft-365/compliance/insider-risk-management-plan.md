...
Comparta la documentación de administración de riesgos interno con las partes interesadas de su organización que se incluyen en el flujo de trabajo de administración y corrección:
...
¿Está preparado para configurar la administración de riesgos interno para su organización? Revise los artículos siguientes:

- [Introducción a las opciones de administración](insider-risk-management-settings.md) de riesgos de Insider para configurar las opciones de directiva global.
