...
- ** [Directivas de retención de Microsoft 365](retention-policies.md):** Se puede configurar para conservar (o conservar y luego eliminar) el contenido de los buzones de usuario en Exchange Online y en el buzón de correo correspondiente para los grupos de Microsoft 365 y Microsoft Teams. También puede crear una directiva de retención para conservar las conversaciones de Skype empresarial, que se almacenan en los buzones de los usuarios.
  ...
  Para obtener más información, consulte la sección "aplicar una directiva de retención a toda la organización o ubicaciones específicas" en [Overview of Microsoft 365 Retention Policies](retention-policies.md#applying-a-retention-policy-to-an-entire-organization-or-specific-locations).
...
Para conectarse a PowerShell de Exchange Online, consulte [Conectarse a PowerShell de Exchange Online](https://docs.microsoft.com/powershell/exchange/exchange-online/connect-to-exchange-online-powershell/connect-to-exchange-online-powershell?view=exchange-ps).
...
|---------|---------|---------|
|Retención por juicio     |    `True`     |     La retención por juicio está habilitada para un buzón *LitigationHoldEnabled* de correo cuando la propiedad `True`LitigationHoldEnabled se establece en.    |
