...
- **[Suspensión de eDiscovery](create-ediscovery-holds.md):** Retenciones asociadas a un caso de exhibición de documentos electrónicos (estándar) de Microsoft Purview en el Centro de seguridad y cumplimiento. Las retenciones de eDiscovery se pueden aplicar a los buzones de usuario y al buzón correspondiente para Grupos de Microsoft 365 y Microsoft Teams.

- **[Suspensión local](/Exchange/security-and-compliance/create-or-remove-in-place-holds):** retenciones que se aplican a los buzones de usuario mediante la herramienta de In-Place eDiscovery & Hold en el <a href="https://go.microsoft.com/fwlink/p/?linkid=2059104" target="_blank">centro de administración de Exchange</a> en Exchange Online. 
...
- **[Microsoft 365 directivas de retención](retention.md):** se puede configurar para conservar (o conservar y eliminar) contenido en buzones de usuario en Exchange Online y en el buzón correspondiente para Grupos de Microsoft 365 y Microsoft Teams. También puede crear una directiva de retención para conservar Skype Empresarial Conversaciones, que se almacenan en buzones de usuario.
...
| -------------------------------------------------------------------------------------------------------- | --------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Microsoft 365 directivas de retención aplicadas a buzones de Exchange, carpetas públicas Exchange y chats de Teams | `mbx7cfb30345d454ac0a989ab3041051209:2` | Las directivas de retención de toda la organización aplicadas a Exchange buzones, Exchange carpetas públicas y chats 1xN en Microsoft Teams se identifican mediante GUID que comienzan con el `mbx` prefijo . Nota Los chats 1xN se almacenan en el buzón de los participantes de chat individuales.  |
| Microsoft 365 directiva de retención aplicada a los mensajes de canal de Grupos de Microsoft 365 y Teams                | `grp1a0a132ee8944501a4bb6a452ec31171:3` | Las directivas de retención de toda la organización aplicadas a Microsoft 365 grupos y mensajes de canal en Microsoft Teams se identifican mediante GUID que comienzan con el `grp` prefijo . Tenga en cuenta que los mensajes de canal se almacenan en el buzón de grupo asociado a un equipo de Microsoft. |
...
> [!TIP]
> La mejor manera de especificar un buzón inactivo en el comando anterior es usar su nombre distintivo o Exchange valor GUID. El uso de uno de estos valores ayuda a impedir que se especifique accidentalmente el buzón equivocado. 
...
- Como se indicó anteriormente, se considera que un buzón está en espera durante una duración de retención ilimitada si la propiedad DelayHoldApplied o DelayReleaseHoldApplied está establecida en **True**. Sin embargo, eso no significa que *se conserve todo* el contenido del buzón. Depende del valor establecido en cada propiedad. Por ejemplo, supongamos que ambas propiedades están establecidas en **True** porque las retenciones se quitan del buzón. A continuación, solo se quita la suspensión de retraso que se aplica a datos en la nube que no son Outlook (mediante el parámetro *RemoveDelayReleaseHoldApplied*). La próxima vez que el Asistente para carpetas administradas procese el buzón, se purgan los elementos que no son Outlook marcados para la eliminación. Los elementos Outlook marcados para la eliminación no se purgarán porque la propiedad DelayHoldApplied sigue estando establecida en **True**. Lo contrario también sería true: si DelayHoldApplied se establece en **False** y DelayReleaseHoldApplied se establece en **True**, solo se purgarán Outlook elementos marcados para su eliminación.
...
| **Osd** | Indica la fecha de inicio original, que es la fecha en que Exchange primera información registrada sobre la directiva de retención. |
|||
