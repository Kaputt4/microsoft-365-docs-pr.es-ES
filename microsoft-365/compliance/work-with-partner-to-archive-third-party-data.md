...
3. Habilite las siguientes características relacionadas con el cumplimiento para el buzón de datos de terceros:
    ...
    - Habilitar el buzón de archivo; vea [Habilitar buzones de archivo](enable-archive-mailboxes.md) y Habilitar el archivado de [expansión automática.](enable-autoexpanding-archiving.md) Esto le permite liberar espacio de almacenamiento en el buzón principal configurando una directiva de archivo que mueve elementos de datos de terceros al buzón de archivo. Esto le proporciona hasta 1,5 TB de almacenamiento para datos de terceros.
