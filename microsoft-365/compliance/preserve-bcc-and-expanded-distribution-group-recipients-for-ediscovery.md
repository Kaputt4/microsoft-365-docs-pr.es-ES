...
In-Place retención local, retención por juicio y directivas de retención de [Microsoft 365](https://go.microsoft.com/fwlink/?LinkID=827811) (creadas en el Centro de seguridad & Cumplimiento) permiten conservar el contenido del buzón para cumplir los requisitos de cumplimiento normativo y exhibición de documentos electrónicos. De forma predeterminada, la información sobre los destinatarios a los que se dirige directamente en los campos Para y CC de un mensaje se incluye en todos los mensajes. Pero es posible que su organización requiera la capacidad de buscar y reproducir detalles sobre todos los destinatarios de un mensaje. Incluye lo siguiente:
...
- **Destinatarios del grupo de distribución expandido:** Destinatarios que reciben el mensaje porque son miembros de un grupo de distribución al que se ha dirigido el mensaje, ya sea en los campos Para, CC o CCO. 
    
Exchange Online y Exchange Server 2013 (actualización acumulativa 7 y versiones posteriores) conservan información sobre los destinatarios del grupo de distribución expandido y CCO. Puede buscar esta información mediante una búsqueda de exhibición de documentos electrónicos de In-Place en el Centro de administración de Exchange (EAC) o una búsqueda de contenido en el Centro de & cumplimiento. 
...
|Buzón de correo de Bob  <br/> |Bcc:Jack (mediante grupo de distribución)  <br/> |Sí  <br/> |La lista de miembros del grupo de distribución CCO, expandida cuando se envió el mensaje, es visible en la vista previa, exportación y registros de la búsqueda de exhibición de documentos electrónicos.  <br/> |
...
R. La información de CCO se conserva de forma predeterminada en el mensaje original en el buzón de correo del remitente. Si el destinatario CCO es un grupo de distribución, la pertenencia al grupo de distribución solo se expande si el buzón del remitente está en suspensión o está asignado a una directiva de retención de Microsoft 365.
  
 **P. ¿Cuándo y dónde está almacenada la lista de destinatarios del grupo de distribución expandido?**
  
R. La pertenencia al grupo se expande en el momento en el que se envía el mensaje. La lista de miembros del grupo de distribución expandido se almacena en el mensaje original en el buzón de correo del remitente. El buzón del remitente debe estar en retención In-Place, retención por juicio o estar asignado a una directiva de retención de Microsoft 365.
 ...
 **P. ¿Cómo puedo asegurarme de que los destinatarios del grupo de distribución expandido se conserven siempre?**
  
A. Para asegurarse de que los miembros del grupo de distribución expandido siempre se conservan con un [mensaje,](https://technet.microsoft.com/library/4c141604-3210-44cc-b98e-f3e0f15613b8.aspx) coloque todos los buzones en espera o cree una directiva de retención de Microsoft 365 en toda la organización. 
...
R. No pasa nada. Si los destinatarios están ocultos en la GAL, aún se incluyen en la lista de destinatarios del grupo de distribución expandido.
