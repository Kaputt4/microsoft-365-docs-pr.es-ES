...
La sección **responder** de la Página principal muestra las [alertas](/security/office-365-security/alerts.md) y las [disposiciones pendientes](disposition-reviews.md) que desea revisar y que podrían actuar.

![Sección responder en el centro de cumplimiento de Microsoft 365](media/m365-compliance-center-respond.png)

Las tarjetas, como la tarjeta de [alertas activas](/security/office-365-security/alerts.md) , incluyen un vínculo a una página donde puede ver información más detallada, como gravedad, estado, categoría y más.
...
Además de los vínculos de las tarjetas en la Página principal, encontrará un panel de navegación en la parte izquierda de la pantalla que le proporcionará un acceso sencillo a sus [alertas](/security/office-365-security/alerts.md), [informes](reports-in-security-and-compliance.md), [directivas](alert-policies.md), soluciones de cumplimiento y mucho más. 

|  |  |
|---------|---------|
|![Navegación en el centro de cumplimiento de Microsoft 365](media/m365-compliance-center-leftnav.png)  |<br/><br/> Ir a **alertas** para ver y resolver [alertas](/security/office-365-security/alerts.md)<br/><br/>Visite **Reports** para ver los datos sobre el [uso y la retención de etiquetas](sensitivity-labels.md), las [coincidencias de directivas de DLP y las invalidaciones](view-the-dlp-reports.md), [los archivos compartidos](https://docs.microsoft.com/cloud-app-security/file-filters), las [aplicaciones de terceros en uso](https://docs.microsoft.com/cloud-app-security/discovered-apps)y mucho más.<br/><br/>Expanda la sección **clasificación** para obtener acceso a las [etiquetas](labels.md), [las directivas de etiquetas](sensitivity-labels.md#what-label-policies-can-do), los [tipos de información confidencial](what-the-sensitive-information-types-look-for.md)y el análisis de las [etiquetas](view-label-activity-for-documents.md).<br/><br/>Vaya a **directivas** para ver las [alertas](/security/office-365-security/alerts.md) y acceder a sus [DLP](data-loss-prevention-policies.md) y directivas de [retención](retention-policies.md) .<br/><br/> Use los vínculos de la sección **soluciones** para acceder a las soluciones de cumplimiento de la organización. Entre ellos se incluyen: <br/>[Disposiciones > del gobierno de datos](disposition-reviews.md)<br/>[Exhibición de documentos electrónicos (eDiscovery)](overview-ediscovery-20.md)<br/>[Supervisión](supervision-policies.md)<br/>[Investigaciones de datos](overview-data-investigations.md)<br/>[Solicitudes de interesados](manage-gdpr-data-subject-requests-with-the-dsr-case-tool.md)        |


## <a name="how-do-i-get-this"></a>¿Cómo obtengo esto?

- Si aún no tiene el nuevo centro de cumplimiento de Microsoft 365, lo tendrá pronto. El [nuevo centro de cumplimiento de Microsoft 365](/security/office-365-security/microsoft-security-and-compliance.md#microsoft-365-compliance-center) estará disponible para el público en general.
