...
2. En la página **Conectores de datos** en **Mensaje de Bloomberg**, seleccione **Ver**.

3. En la página **Bloomberg Message product description (Descripción del producto del mensaje de Bloomberg** ), seleccione **Add connector (Agregar conector).**
