...
2. Con regularidad, DataParser recopila los elementos FactSet. DataParser también convierte el contenido de un mensaje en un formato de mensaje de correo electrónico.
...
1. Vaya a Data **Connectors** FactSet DataParser y, a <https://compliance.microsoft.com> continuación, seleccione Data Connectors  > **DataParser**.

2. En la página de descripción del producto **FactSet DataParser** , seleccione **Agregar conector**.
...
2. Seleccione la pestaña **Conectores** y, a continuación, seleccione el conector FactSet DataParser que creó para mostrar la página de control flotante, que contiene las propiedades y la información sobre el conector.
