...
3. El conector FactSet DataParser que se crea en el Centro de cumplimiento de Microsoft 365 se conecta a DataParser y transfiere los mensajes a una ubicación de Azure Storage segura en la nube de Microsoft.
...
El primer paso consiste en acceder a la página Conectores de datos de la Centro de cumplimiento de Microsoft 365 y crear un conector 17a-4 para los datos de FactSet.

1. Vaya a y, a <https://compliance.microsoft.com> continuación, haga clic en **Conectores** >  de **datosFactSet DataParser**.
...
El conector DataParser de FactSet asignará automáticamente los usuarios a sus direcciones de correo electrónico Microsoft 365 antes de importar datos a Microsoft 365.
