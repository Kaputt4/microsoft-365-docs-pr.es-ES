...
| **Validez no antes de** | 12 18:46:00 2000 de mayo de UTC |
| **Validez no posterior a** | 12 23:59:00 2025 de mayo de UTC |
...
### <a name="cnnic-root"></a>**RAÍZ CNNIC**

| **Subject** | CN = RAÍZ CNNIC<br>O = CNNIC<br>C = CN |
| --- | --- |
| **Número de serie** | 49:33:00:01 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no antes de** | Apr 16 07:09:14 2007 UTC |
| **Validez no posterior a** | Apr 16 07:09:14 2027 UTC |
| **Identificador de clave de asunto** | 65: F2:31: ad: 2A: F7: F7: DD: 52:96:0A: C7:02: C1:0E: EF: A6: D5:3B: 11 |
| **Identificador de clave de entidad de certificación** | ID de la: 65: F2:31: ad: 2A: F7: F7: DD: 52:96:0A: C7:02: C1:0E: EF: A6: D5:3B: 11 |
| **Huella digital (SHA-1)** | 8BAF4C9B1DF02A92F7DA128EB91BACF498604B6F |
| **Huella digital (SHA-256)** | E28393773DA845A679F2080CC7FB44A3B7A1C3792CB7EB7729FDCB6A8D99AEA7 |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no antes de** | Nov 10 00:00:00 2006 UTC |
| **Validez no posterior a** | Nov 10 00:00:00 2031 UTC |
...
| **Identificador de clave de entidad de certificación** | ID. de la versión: B1:3E: C3:69:03: F8: BF: 47:01: D4:98:26:1A: 08:02: EF: 63:64:2B: C3 |
...
### <a name="d-trust-root-class-3-ca-2-2009"></a>**D-TRUST raíz clase 3 CA 2 2009**

| **Subject** | CN = D-TRUST raíz clase 3 CA 2 2009<br>O = D-Trust GmbH<br>C = DE |
| --- | --- |
| **Número de serie** | 09:83: F3 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Nov 05 08:35:58 2009 UTC |
| **Validez no posterior a** | Nov 05 08:35:58 2029 UTC |
| **Identificador de clave de asunto** | FD: da: 14: C4:9F: 30: de: 21: BD: 1E: 42:41: FC: AB: 63:23:49: E0: F1:84 |
| **Huella digital (SHA-1)** | 58E8ABB0361533FB80F79B1B6D29D3FF8D5F00F0 |
| **Huella digital (SHA-256)** | 49E7A442ACF0EA6287050054B52564B650E4F49E42E348D6AA38E039E957B1C1 |
...
### <a name="d-trust-root-class-3-ca-2-ev-2009"></a>**D-TRUST raíz clase 3 CA 2 EV 2009**

| **Subject** | CN = D-TRUST raíz clase 3 CA 2 EV 2009<br>O = D-Trust GmbH<br>C = DE |
| --- | --- |
| **Número de serie** | 09:83: F4 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Nov 05 08:50:46 2009 UTC |
| **Validez no posterior a** | Nov 05 08:50:46 2029 UTC |
| **Identificador de clave de asunto** | D3:94:8A: 4C: 62:13:2A: 19:2E: CC: AF: 72:8A: 7D: 36: D7:9 bis: 1C: DC: 67 |
| **Huella digital (SHA-1)** | 96C91B0B95B4109842FAD0D82279FE60FAB91683 |
| **Huella digital (SHA-256)** | EEC5496B988CE98625B934092EEC2908BED0B0F316C2D4730C84EAF1F3D34881 |
...
| **Subject** | CN = DST raíz CA X3<br>O = confianza de la firma digital Co. |
| --- | --- |
| **Número de serie** | 44: AF: B0:80: D6: A3:27: BA: 89:30:39:86:2E: F8:40:6B |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no antes de** | Sep 30 21:12:19 2000 UTC |
| **Validez no posterior a** | Sep 30 14:01:15 2021 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Jul 07 17:25:54 2009 UTC |
| **Validez no posterior a** | DEC 07 17:55:54 2030 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no antes de** | Dec 24 17:50:51 1999 UTC |
| **Validez no posterior a** | Jul 24 14:15:12 2029 UTC |
...
| **Subject** | CN = GlobalSign<br>O = GlobalSign<br>OU = GlobalSign raíz CA-R2 |
| --- | --- |
| **Número de serie** | 04:00:00:00:00:01:0F: 86:26: E6:0D |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no antes de** | Dec 15 08:00:00 2006 UTC |
| **Validez no posterior a** | Dec 15 08:00:00 2021 UTC |
| **Identificador de clave de asunto** | 9: E2:07:57:67:1C: 1E: C0:6A: 06: de: 59: B4:9 bis: 2D: DF: DC: 19:86:2E |
| **Identificador de clave de entidad de certificación** | ID de identificación: 9 bis: E2:07:57:67:1C: 1E: C0:6A: 06: de: 59: B4:9 bis: 2D: DF: DC: 19:86:2E |
| **Huella digital (SHA-1)** | 75E0ABB6138512271C04F85FDDDE38E4B7242EFE |
| **Huella digital (SHA-256)** | CA42DD41745FD0B81EB902362CF9D8BF719DA1BD1B1EFC946F5B4C99F42C1B9E |
| **PIN (SHA-256)** | iie1VXtL7HzAMF +/PVPR9xzT80kQxdZeJ + zduCB3uj0 = |
| **Direcciones URL de CRL** | http://crl.globalsign.net/root-r2.crl |

### <a name="globalsign"></a>**GlobalSign**

| **Subject** | CN = GlobalSign<br>O = GlobalSign<br>OU = GlobalSign raíz CA-R3 |
| --- | --- |
| **Emisor** | CN = GlobalSign, O = GlobalSign, OU = GlobalSign raíz CA-R3 |
| **Número de serie** | 04:00:00:00:00:01:21:58:53:08: a2 |
| **Longitud de clave pública** | RSA 2048 bits |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Miércoles, 18 de marzo de 2009 3:00 A.M. |
| **Validez no hasta** | Domingo, 18 de marzo de 2029 3:00 A.M. |
| **Identificador de clave de asunto** | 8FF04B7FA82E4524AE4D50FA639A8BDEE2DD1BBC |
| **Identificador de clave de entidad de certificación** | ID de 8F: F0:4B: 7F: A8:2E: 45:24: AE: 4D: 50: FA: 63:9 bis: 8B: de: E2: DD: 1B: BC |
| **Huella digital (SHA-1)** | D69B561148F01C77C54578C10926DF5B856976AD |
| **Huella digital (SHA-256)** | CBB522D7B7F127AD6A0113865BDF1CD4102E7D0759AF635A7CF4720DC963C53B |

### <a name="globalsign-root-ca"></a>**GlobalSign Root CA**

| **Subject** | CN = entidad de certificación raíz GlobalSign<br>OU = CA raíz<br>O = GlobalSign NV-SA<br>C = BE |
| --- | --- |
| **Número de serie** | 04:00:00:00:00:01:15:4B: 5A: C3:94 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no antes de** | Sep 01 12:00:00 1998 UTC |
| **Validez no posterior a** | Ene 28 12:00:00 2028 UTC |
| **Identificador de clave de asunto** | 60:7B: 66:1A: 45:0D: 97: CA: 89:50:2F: 7D: 04: CD: 34: A8: FF: FC: FD: 4B |
| **Huella digital (SHA-1)** | B1BC968BD4F49D622AA89A81F2150152A41D829C |
| **Huella digital (SHA-256)** | EBD41040E4BB3EC742C9E381D31EF2A41A48B6685C96E7CEF3C1DF6CD4331C99 |
| **PIN (SHA-256)** | K87oWBWM9UZfyddvDfoxL + 8lpNyoUB2ptGtn0fv6G2Q = |

### <a name="thawte-primary-root-ca---g3"></a>**entidad de certificación raíz de Thawte primario-G3**

| **Subject** | CN = Thawte raíz primario CA-G3<br>OU = &quot; (c) 2008 Thawte, Inc.-solo para uso autorizado&quot;<br>OU = División de servicios de certificación<br>O = &quot; Thawte, Inc.&quot;<br>C = US |
| --- | --- |
| **Número de serie** | 60:01:97: B7:46: A7: EA: B4: B4:9 BIS: D6:4B: 2F: F7:90: FB |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Apr 02 00:00:00 2008 UTC |
| **Validez no posterior a** | Dec 01 23:59:59 2037 UTC |
...
### <a name="verisign-class-3-public-primary-certification-authority---g5"></a>**Entidad de certificación principal pública de clase 3 de VeriSign-G5**

| **Subject** | CN = VeriSign clase 3: entidad de certificación principal pública-G5<br>OU = &quot; (c) 2006 VeriSign, Inc.-solo para uso autorizado&quot;<br>OU = VeriSign Trust Network<br>O = &quot; Verisign, Inc.&quot;<br>C = US |
| --- | --- |
| **Número de serie** | 18: DA: D1:9E: 26:7D: E8: BB: 4A: 21:58: CD: CC: 6B: 3B: 4A |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no antes de** | Nov 08 00:00:00 2006 UTC |
| **Validez no posterior a** | Jul 16 23:59:59 2036 UTC |
| **Identificador de clave de asunto** | 7F: D3:65: A7: C2: DD: CE: BB: F0:30:09: F3:43:39: FA: 02: AF: 33:31:33 |
| **Huella digital (SHA-1)** | 4EB6D578499B1CCF5F581EAD56BE3D9B6744A5E5 |
| **Huella digital (SHA-256)** | 9ACFAB7E43C8D880D06B262A94DEEEE4B4659989C3D0CAF19BAF6405E41AB7DF |
| **PIN (SHA-256)** | JbQbUG5JMJUoI6brnx0x3vZF6jilxsapbXGVfjhN8Fg = |

## <a name="microsoft-365-intermediate-certificate-details"></a>**Detalles de certificado intermedio de Microsoft 365**

### <a name="cnnic-sha256-ssl"></a>**SSL DE CNNIC SHA256**

| **Subject** | CN = CNNIC SHA256 SSL <br>O = SSL DE CNNIC SHA256 <br>C = CN |
| --- | --- |
| **Emisor** | CN = RAÍZ CNNIC <br>O = CNNIC <br>C = CN |
| **Número de serie** | 49:33:00:7C |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Dec 18 12:32:18 2014 UTC |
| **Validez no posterior a** | Dec 18 12:32:18 2024 UTC |
...
| **Huella digital (SHA-256)** | FA8B9F99DBB94E7B772AA9190846E777047C15C7A3BF4A1AF9C0CA984A689511 |
| **PIN (SHA-256)** | dKZRcLDh7hBNZTmTIHOGJ6C2Om/ITjUCPkOnLTnrZXk = |
| **Direcciones URL de AIA** | http://www.cnnic.cn/download/cert/CNNICROOT.cer |
| **Direcciones URL de CRL** | ldap:///CN=crl1,%20OU=crl,%20O=CNNIC,%20C=CN?certificateRevocationList;binary,authorityRevocationList;binary,deltaRevocationList;binary<br>http://crl.cnnic.cn/download/rootsha2crl/CRL1.crl |
| **Direcciones URL de OCSP** | <http://ocspcnnicroot.cnnic.cn> |

### <a name="d-trust-ssl-class-3-ca-1-2009"></a>**D-TRUST SSL clase 3 CA 1 2009**

| **Subject** | CN = D-TRUST SSL clase 3 CA 1 2009<br>O = D-Trust GmbH<br>C = DE |
| --- | --- |
| **Emisor** | CN = D-TRUST raíz clase 3 CA 2 2009<br>O = D-Trust GmbH<br>C = DE |
| **Nombre alternativo del sujeto** | RFC822 Name=info@d-trust.net<br>Dirección URL =http://www.d-trust.net |
| **Número de serie** | 09:90:63 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Nov 12 12:46:55 2009 UTC |
| **Validez no posterior a** | Nov 05 08:35:58 2029 UTC |
| **Identificador de clave de asunto** | 50:19:32:94:94: C4: B5:04:4D: 56: d0: C0:83:21: D5:35:55: B0: B1:7a |
| **Identificador de clave de entidad de certificación** | ID: FD: da: 14: C4:9F: 30: de: 21: BD: 1E: 42:39: FC: AB: 63:23:49: E0: F1:84 |
| **Huella digital (SHA-1)** | 2FC5DE6528CDBE50A14C382FC1DE524FAABF95FC |
...
| --- | --- |
| **Emisor** | CN = D-TRUST raíz clase 3 CA 2 EV 2009<br>O = D-Trust GmbH<br>C = DE |
| **Nombre alternativo del sujeto** | RFC822 Name=info@d-trust.net<br>Dirección URL =http://www.d-trust.net |
| **Número de serie** | 09:90:64 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Nov 12 12:52:43 2009 UTC |
| **Validez no posterior a** | Nov 05 08:50:46 2029 UTC |
| **Identificador de clave de asunto** | AC: Ed: A5:9D: 7a: a2: B6:43: F1:18:8A: 25:6A: 6C: B1: CC: A8: F2:5A: D4 |
| **Identificador de clave de entidad de certificación** | ID: D3:94:8A: 4C: 62:13:2A: 19:2E: CC: AF: 72:8A: 7D: 36: D7:9 bis: 1C: DC: 67 |
| **Huella digital (SHA-1)** | 1069423D308D0FC54575059638560FC7556E32B3 |
...
### <a name="digicert-basic-rsa-cn-ca-g2"></a>**DigiCert base de certificados CN de RSA básico G2**
...
| **Longitud de clave pública** | RSA 2048 bits |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Miércoles, 4 de marzo de 2020 4:04 A.M. |
...
| **Huella digital (SHA-256)** | CB57B3FF2040CB269497625BC90FA9D7B4ED4938C6F60F42F69AFDF508AC2993 |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Ago 04 12:00:00 2015 UTC |
| **Validez no posterior a** | Ago 04 12:00:00 2030 UTC |
...
| --- | --- |
| **Emisor** | CN = DigiCert raíz de validación extendida de seguridad alta CA, OU = www. DigiCert. com, O = DigiCert Inc, C = US |
| **Número de serie** | 0C: 79: A9:44: B0:8C: 11:95:20:92:61:5F: E2:6B: 1D: 83 |
| **Longitud de clave pública** | RSA 2048 bits |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Martes, 22 de octubre de 2013 5:00 A.M. |
| **Validez no hasta** | Domingo, 22 de octubre de 2028 5:00 A.M. |
| **Identificador de clave de asunto** | 3DD350A5D6A0ADEEF34A600A65D321D4F8F8D60F |
| **Identificador de clave de entidad de certificación** | ID. de la versión: B1:3E: C3:69:03: F8: BF: 47:01: D4:98:26:1A: 08:02: EF: 63:64:2B: C3 |
...
| **Direcciones URL de CRL** | http://crl4.digicert.com/DigiCertHighAssuranceEVRootCA.crl |
| **Direcciones URL de OCSP** | http://ocsp.digicert.com |

### <a name="digicert-sha2-high-assurance-server-ca"></a>**CA del servidor de seguridad alta de DigiCert SHA2**

| **Subject** | CN = DigiCert SHA2 del servidor de seguridad alto (CA)<br>OU = www. DigiCert. com<br>O = DigiCert Inc<br>C = US |
| --- | --- |
| **Emisor** | CN = DigiCert de certificados raíz de validación extendida de alta seguridad<br>OU = www. DigiCert. com<br>O = DigiCert Inc<br>C = US |
| **Número de serie** | 04: E1: E7: A4: DC: 5C: F2: F3:6D: C0:2B: 42: B8:5D: 15:9F |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Oct 22 12:00:00 2013 UTC |
| **Validez no posterior a** | Oct 22 12:00:00 2028 UTC |
| **Identificador de clave de asunto** | 51:68: FF: 90: AF: 02:07:75:3C: CC: D9:65:64:62: a2:12: B8:59:72:3B |
| **Identificador de clave de entidad de certificación** | ID. de la versión: B1:3E: C3:69:03: F8: BF: 47:01: D4:98:26:1A: 08:02: EF: 63:64:2B: C3 |
| **Huella digital (SHA-1)** | A031C46782E6E6C662C2C87C76DA9AA62CCABD8E |
| **Huella digital (SHA-256)** | 19400BE5B7A31FB733917700789D2F0A2471C0C9D506C0E504C06C16D7CB17C0 |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Mar 08 12:00:00 2013 UTC |
| **Validez no posterior a** | Mar 08 12:00:00 2023 UTC |
| **Identificador de clave de asunto** | 0F: 80:61:1C: 82:31:61: D5:2F: 28: E7:8D: 46:38: B4:2C: E1: C6: D9: E2 |
| **Identificador de clave de entidad de certificación** | ID de la identificación: 03: de: 50:35:56: D1:4C: BB: 66: F0: a3: E2:1B: 1B: C3:97: B2:3D: D1:55 |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no antes de** | Nov 11 15:40:40 2011 UTC |
| **Validez no posterior a** | Nov 12 02:51:17 2021 UTC |
| **Identificador de clave de asunto** | 1E: F1: AB: 89:06: F8:49:0F: 01:33:77: EE: 14:7a: 4D: 19:7C: 93:28:4D |
| **Identificador de clave de entidad de certificación** | ID: 55: E4:81: D1:11:80: ser: D8:89: B9:08: a3:31: F9: a1:24:09:16: B9:70 |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Oct 05 19:13:56 2015 UTC |
| **Validez no posterior a** | DEC 05 19:43:56 2030 UTC |
| **Identificador de clave de asunto** | 82: a2:70:74: DD: BC: 53:3F: CF: 7B: D4: F7: CD: 7F: A7:60: C6:0A: 4C: |
| **Identificador de clave de entidad de certificación** | ID de la ID: 6A: 72:26:7a: d0:1E: EF: 7D: E7:3B: 69:51: D4:6C: 8D: 9F: 90:12:66: AB |
...
### <a name="globalsign-extended-validation-ca---sha256---g2"></a>**GlobalSign validación extendida CA-SHA256-G2**

| **Subject** | CN = GlobalSign validación extendida CA-SHA256-G2<br>O = GlobalSign NV-SA<br>C = BE |
| --- | --- |
| **Emisor** | CN = GlobalSign<br>O = GlobalSign<br>OU = GlobalSign raíz CA-R2 |
| **Número de serie** | 04:00:00:00:00:01:44:4E: F0:4A: 55 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Feb 20 10:00:00 2014 UTC |
| **Validez no posterior a** | Dec 15 08:00:00 2021 UTC |
| **Identificador de clave de asunto** | da: 40:77:43:65:1C: F8: fe: A7: E3: F4:64:82:3E: 4D: 43:13:22:31:02 |
| **Identificador de clave de entidad de certificación** | ID de identificación: 9 bis: E2:07:57:67:1C: 1E: C0:6A: 06: de: 59: B4:9 bis: 2D: DF: DC: 19:86:2E |
...
### <a name="globalsign-extended-validation-ca---sha256---g3"></a>**GlobalSign validación extendida CA-SHA256-G3**

| **Subject** | CN = GlobalSign validación extendida CA-SHA256-G3<br>O = GlobalSign NV-SA<br>C = BE |
| --- | --- |
| **Emisor** | CN = GlobalSign<br>O = GlobalSign<br>OU = GlobalSign raíz CA-R3 |
| **Número de serie** | 48: A4:02: DD: 27:92:0D: A2:08:34:9D: D1:99:7B |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Sep 21 00:00:00 2016 UTC |
| **Validez no posterior a** | Sep 21 00:00:00 2026 UTC |
| **Identificador de clave de asunto** | DD: B3: E7:6D: A8:2E: E8: C5:4E: 6e: CF: 74: e6:75:3C: 94:15: CE: E8:1D |
| **Identificador de clave de entidad de certificación** | ID de 8F: F0:4B: 7F: A8:2E: 45:24: AE: 4D: 50: FA: 63:9 bis: 8B: de: E2: DD: 1B: BC |
| **Huella digital (SHA-1)** | 6023192FE7B59D2789130A9FE4094F9B5570D4A2 |
| **Huella digital (SHA-256)** | AED5DD9A5339685DFB029F6D89A14335A96512C3CACC52B2994AF8B6B37FA4D2 |
| **PIN (SHA-256)** | 86fLIetopQLDNxFZ0uMI66Xpl1pFgLlHHn9v6kT0i4I = |
| **Direcciones URL de CRL** | http://crl.globalsign.com/root-r3.crl |
| **Direcciones URL de OCSP** | http://ocsp2.globalsign.com/rootr3 |

### <a name="globalsign-organization-validation-ca---sha256---g2"></a>**GlobalSign de validación de organización CA-SHA256-G2**

| **Subject** | CN = GlobalSign de validación de organización CA-SHA256-G2<br>O = GlobalSign NV-SA<br>C = BE |
| --- | --- |
| **Emisor** | CN = GlobalSign<br>O = GlobalSign<br>OU = GlobalSign raíz CA-R3 |
| **Número de serie** | 04:00:00:00:00:01:31:89: C6:44: C9 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Ago 02 10:00:00 2011 UTC |
| **Validez no posterior a** | Ago 02 10:00:00 2022 UTC |
| **Identificador de clave de asunto** | 96: de: 61: F1: BD: 1C: 16:29:53:1C: C0: CC: 7D: 3B: 83:00:40: e6:1A: 7C |
| **Identificador de clave de entidad de certificación** | ID de 8F: F0:4B: 7F: A8:2E: 45:24: AE: 4D: 50: FA: 63:9 bis: 8B: de: E2: DD: 1B: BC |
| **Huella digital (SHA-1)** | EF90B2B86F4756EBE7D36FF3015D63523A0076E9 |
| **Huella digital (SHA-256)** | 0B339212D7CFF17A2C59E35669B58E77350133750A78DA9404770EDD470DEF76 |
| **PIN (SHA-256)** | IQBnNBEiFuhj + 8x6X8XLgh01V9Ic5/V3IRQLNFFc7v4 = |
| **Direcciones URL de CRL** | http://crl.globalsign.net/root-r3.crl |
| **Direcciones URL de OCSP** | http://ocsp2.globalsign.com/rootr3 |
...
| **Subject** | CN = GlobalSign de validación de organización CA-SHA256-G2<br>O = GlobalSign NV-SA<br>C = BE |
| --- | --- |
| **Emisor** | CN = entidad de certificación raíz GlobalSign<br>OU = CA raíz<br>O = GlobalSign NV-SA<br>C = BE |
| **Número de serie** | 04:00:00:00:00:01:44:4E: F0:42:47 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Feb 20 10:00:00 2014 UTC |
| **Validez no posterior a** | Feb 20 10:00:00 2024 UTC |
| **Identificador de clave de asunto** | 96: de: 61: F1: BD: 1C: 16:29:53:1C: C0: CC: 7D: 3B: 83:00:40: e6:1A: 7C |
| **Identificador de clave de entidad de certificación** | ID. de la entidad: 60:7B: 66:1A: 45:0D: 97: CA: 89:50:2F: 7D: 04: CD: 34: A8: FF: FC: FD: 4B |
| **Huella digital (SHA-1)** | 902EF2DEEB3C5B13EA4C3D5193629309E231AE55 |
| **Huella digital (SHA-256)** | 74EF335E5E18788307FB9D89CB704BEC112ABD23487DBFF41C4DED5070F241D9 |
| **PIN (SHA-256)** | IQBnNBEiFuhj + 8x6X8XLgh01V9Ic5/V3IRQLNFFc7v4 = |
| **Direcciones URL de CRL** | http://crl.globalsign.net/root.crl |
| **Direcciones URL de OCSP** | http://ocsp.globalsign.com/rootr1 |

### <a name="globalsign-organization-validation-ca---sha256---g3"></a>**GlobalSign la validación de la organización CA-SHA256-G3**

| **Subject** | CN = GlobalSign organizativa Validation CA-SHA256-G3<br>O = GlobalSign NV-SA<br>C = BE |
| --- | --- |
| **Emisor** | CN = GlobalSign raíz CA, OU = CA raíz, O = GlobalSign NV-SA, C = |
| **Número de serie** | 47:07: B1:01:9 BIS: 0C: 57: AD: 39: B3: E1:7D: A9: F9 |
| **Longitud de clave pública** | RSA 2048 bits |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Jueves, 3 de septiembre de 2015 5:00 PM |
| **Validez no hasta** | Miércoles, 3 de septiembre de 2025 5:00 PM |
| **Identificador de clave de asunto** | 6886B87D7AD96D496B872F188B15346CD7B47A0E |
| **Identificador de clave de entidad de certificación** | ID. de la entidad: 60:7B: 66:1A: 45:0D: 97: CA: 89:50:2F: 7D: 04: CD: 34: A8: FF: FC: FD: 4B |
| **Huella digital (SHA-1)** | 20D1EBAB5A71587B9116E4C74415D1A85B0DDDA5 |
| **Huella digital (SHA-256)** | 699D54B7482A5D329331EA0415CC2EDCD60FDA01D19E71D054196BCE0677735C |
| **Direcciones URL de CRL** | http://crl.globalsign.com/root.crl |
| **Direcciones URL de OCSP** | http://ocsp.globalsign.com/rootr1 |
...
| --- | --- |
| **Emisor** | CN = GlobalSign, O = GlobalSign, OU = GlobalSign raíz CA-R3 |
| **Número de serie** | 01: EE: 5F: 22:1D: FC: 62:3B: D4:33:3A: 85:57 |
| **Longitud de clave pública** | RSA 2048 bits |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Martes, 20 de noviembre de 2018 4:00 PM |
| **Validez no hasta** | Lunes, 20 de noviembre de 2028 4:00 PM |
| **Identificador de clave de asunto** | F8EF7FF2CD7867A8DE6F8F248D88F1870302B3EB |
| **Identificador de clave de entidad de certificación** | ID de 8F: F0:4B: 7F: A8:2E: 45:24: AE: 4D: 50: FA: 63:9 bis: 8B: de: E2: DD: 1B: BC |
| **Huella digital (SHA-1)** | DFE83023062B997682708B4EAB8E819AFF5D9775 |
| **Huella digital (SHA-256)** | B676FFA3179E8812093A1B5EAFEE876AE7A6AAF231078DAD1BFB21CD2893764A |
| **Direcciones URL de CRL** | http://crl.globalsign.com/root-r3.crl |
| **Direcciones URL de OCSP** | http://ocsp2.globalsign.com/rootr3 |

### <a name="lets-encrypt-authority-x3"></a>**Vamos a cifrar la autoridad X3**

| **Subject** | CN = permitir cifrar la autoridad X3<br>O = vamos a cifrar<br>C = US |
| --- | --- |
| **Emisor** | CN = DST raíz CA X3<br>O = confianza de la firma digital Co. |
| **Número de serie** | 0A: 01:41:42:00:00:01:53:85:73:6A: 0B: 85: EC: A7:08 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Mar 17 16:40:46 2016 UTC |
| **Validez no posterior a** | Mar 17 16:40:46 2021 UTC |
| **Identificador de clave de asunto** | A8:4a: 6A: 63:04:7D: DD: BA: e6: D1:39: B7: A6:45:65: EF: F3: A8: EC: a1 |
| **Identificador de clave de entidad de certificación** | ID. de la: C4: A7: B1: A4:7B: 2C: 71: FA: DB: E1:4B: 90:75: FF: C4:15:60:85:89:10 |
| **Huella digital (SHA-1)** | E6A3B45B062D509B3382282D196EFE97D5956CCB |
| **Huella digital (SHA-256)** | 25847D668EB4F04FDD40B12B6B0740C567DA7D024308EB6C2C96FE41D9DE218D |
| **PIN (SHA-256)** | YLh1dUR9y6Kja30RrAn7JKnbQG/uEtLMkBgFF2Fuihg = |
| **Direcciones URL de AIA** | http://apps.identrust.com/roots/dstrootcax3.p7c |
| **Direcciones URL de CRL** | http://crl.identrust.com/DSTROOTCAX3CRL.crl |
| **Direcciones URL de OCSP** | http://isrg.trustid.ocsp.identrust.com |
...
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | 20 12:51:28 2016 de mayo de UTC |
| **Validez no posterior a** | 20 12:51:28 2024 de mayo de UTC |
...
| **Longitud de clave pública** | RSA 4096 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | 20 12:51:57 2016 de mayo de UTC |
| **Validez no posterior a** | 20 12:51:57 2024 de mayo de UTC |
...
| **Longitud de clave pública** | RSA 4096 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | 20 12:52:38 2016 de mayo de UTC |
| **Validez no posterior a** | 20 12:52:38 2024 de mayo de UTC |
...
| **Longitud de clave pública** | RSA 4096 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | 20 12:53:03 2016 de mayo de UTC |
| **Validez no posterior a** | 20 12:53:03 2024 de mayo de UTC |
...
| --- | --- |
| **Emisor** | CN = VeriSign clase 3: entidad de certificación principal pública-G5<br>OU = &quot; (c) 2006 VeriSign, Inc.-solo para uso autorizado&quot;<br>OU = VeriSign Trust Network<br>O = &quot; Verisign, Inc.&quot;<br>C = US |
| **Nombre alternativo del sujeto** | Dirección de directorio: CN = SymantecPKI-1-533 |
| **Número de serie** | 7E: E1:4A: 6F: 6F: EF: F2: D3:7F: 3F: AD: 65:4D: 3A: DA: B4 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Oct 31 00:00:00 2013 UTC |
| **Validez no posterior a** | Oct 30 23:59:59 2023 UTC |
| **Identificador de clave de asunto** | 01:59: AB: E7: DD: 3A: 0B: 59: A6:64:63: D6: CF: 20:07:57: D5:91: E7:6A |
| **Identificador de clave de entidad de certificación** | ID de.: 7F: D3:65: A7: C2: DD: CE: BB: F0:30:09: F3:43:39: FA: 02: AF: 33:31: FA |
| **Huella digital (SHA-1)** | E3FC0AD84F2F5A83ED6F86F567F8B14B40DCBF12 |
| **Huella digital (SHA-256)** | 9E6BC5F9ECC52460E8EDC02C644D1BE1CB9F2316F41DAF3B616A0B2058294B31 |
| **PIN (SHA-256)** | gMxWOrX4PMQesK9qFNbYBxjBfjUvlkn/vN1n + L9lE5E = |
| **Direcciones URL de CRL** | http://s1.symcb.com/pca3-g5.crl |
| **Direcciones URL de OCSP** | http://s2.symcb.com |

### <a name="symantec-class-3-secure-server-ca---g4"></a>**Symantec clase 3 Secure Server CA-G4**

| **Subject** | CN = Symantec clase 3 Secure Server CA-G4<br>OU = Symantec Trust Network<br>O = Symantec Corporation<br>C = US |
| --- | --- |
| **Emisor** | CN = VeriSign clase 3: entidad de certificación principal pública-G5<br>OU = &quot; (c) 2006 VeriSign, Inc.-solo para uso autorizado&quot;<br>OU = VeriSign Trust Network<br>O = &quot; Verisign, Inc.&quot;<br>C = US |
...
| **Validez no antes de** | Oct 31 00:00:00 2013 UTC |
| **Validez no posterior a** | Oct 30 23:59:59 2023 UTC |
| **Identificador de clave de asunto** | 5F: 60: CF: 61:90:55: DF: 84:43:14:8A: 60:2A: B2: F5:7a: F4:43:18: EF |
| **Identificador de clave de entidad de certificación** | ID de.: 7F: D3:65: A7: C2: DD: CE: BB: F0:30:09: F3:43:39: FA: 02: AF: 33:31: FA |
| **Huella digital (SHA-1)** | FF67367C5CD4DE4AE18BCCE1D70FDABD7C866135 |
| **Huella digital (SHA-256)** | EAE72EB454BF6C3977EBD289E970B2F5282949190093D0D26F98D0F0D6A9CF17 |
| **PIN (SHA-256)** | 9n0izTnSRF + W4W4JTq51avSXkWhQB8duS2bxVLfzXsY = |
| **Direcciones URL de CRL** | http://s1.symcb.com/pca3-g5.crl |
| **Direcciones URL de OCSP** | http://s2.symcb.com |

### <a name="thawte-sha256-ssl-ca"></a>**entidad de certificación SSL de Thawte SHA256**

| **Subject** | CN = Thawte SHA256 SSL CA<br>O = &quot; Thawte, Inc.&quot;<br>C = US |
| --- | --- |
| **Emisor** | CN = Thawte raíz primario CA-G3<br>OU = &quot; (c) 2008 Thawte, Inc.-solo para uso autorizado&quot;<br>OU = División de servicios de certificación<br>O = &quot; Thawte, Inc.&quot;<br>C = US |
| **Nombre alternativo del sujeto** | Dirección de directorio: CN = VeriSignMPKI-2-415 |
| **Número de serie** | 36:34:9E: 18: C9:9C: 26:69: B6:56:2E: 6C: E5: AD: 71:32 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | 23 00:00:00 2013 de mayo de UTC |
| **Validez no posterior a** | 22 23:59:59 2023 de mayo de UTC |
| **Identificador de clave de asunto** | 2B: 9 bis: 35: AE: 01:18:38:30: E1:70:7a: 05: E0:11:76: a3: CE: BD: 90:14 |
| **Identificador de clave de entidad de certificación** | ID. de la firma: ad: 6C: AA: 94:60:9C: Ed: E4: FF: FA: 3E: 0A: 74:2B: 63:03: F7: B6:59: BF |
| **Huella digital (SHA-1)** | 67D147D5DAB7F28D663CA5B7A9568F087427B9F7 |
| **Huella digital (SHA-256)** | 3F3AF9C9CC2C7599EF8F6DD7CA516CFC1797D7D12002254F3BFD0D4D0FE9DE86 |
| **PIN (SHA-256)** | /36ymPAVaJl3QDyB1lUkVf9GqJNug0R8JJPDN6348p8 = |
| **Direcciones URL de CRL** | http://crl.thawte.com/ThawtePCA-G3.crl |
| **Direcciones URL de OCSP** | http://ocsp.thawte.com |

### <a name="verizon-akamai-sureserver-ca-g14-sha2"></a>**Verizon Akamai SureServer CA G14-SHA2**

| **Subject** | CN = Verizon Akamai SureServer CA G14-SHA2<br>OU = Cybertrust<br>O = soluciones de Verizon Enterprise<br>L = Amsterdam<br>C = NL |
| --- | --- |
| **Emisor** | CN = raíz de Baltimore CyberTrust<br>OU = CyberTrust<br>O = Baltimore<br>C = IE |
| **Número de serie** | 07:27: A4:6B |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no antes de** | Apr 02 14:36:10 2014 UTC |
| **Validez no posterior a** | Apr 02 14:35:52 2021 UTC |
| **Identificador de clave de asunto** | F8: BD: FA: AF: 73:77: C6: C7:1B: F9:4B: 4D: 11: A7: D1:33: AF: AF: 72:11 |
| **Identificador de clave de entidad de certificación** | ID de la la ID: E5:9D: 59:30:82:47:58: CC: AC: FA: 08:54:36:86:7B: 3A: B5:04:4D: F0 |
| **Huella digital (SHA-1)** | 6AD2B04E2196E48BF685752890E811CD2ED60606 |
| **Huella digital (SHA-256)** | 7373D219B42547E41BCB752BCBCBE93F592FF6F99C340CE57B73D38C3EC0BA98 |
...
## <a name="additional-certificate-paths"></a>**Rutas de certificado adicionales**

En la siguiente lista se incluyen los certificados heredados que no se incluyeron más arriba y que se combinarán con la lista anterior a lo largo del tiempo.
