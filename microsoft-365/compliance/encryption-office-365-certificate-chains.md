...
Microsoft 365 aprovecha varios proveedores de certificados diferentes. A continuación se describe la lista completa de certificados raíz Microsoft 365 conocidos que los clientes pueden encontrar al acceder a Microsoft 365. Para obtener información sobre los certificados que puede necesitar instalar en su propia infraestructura, consulte [Planeamiento de certificados SSL de terceros para Microsoft 365](../enterprise/plan-for-third-party-ssl-certificates.md). La siguiente información de certificado se aplica a todas las instancias en la nube nacionales y mundiales de Microsoft 365.

Última actualización: **25/4/2022**

> [!NOTE]
> Para obtener información sobre el certificado que se aplica al **DOD y a los clientes de GCC High**, consulte [Microsoft 365 cadenas de cifrado: DOD y GCC High](encryption-office-365-certificate-chains-itar.md).

| **Tipo de certificado** | **Descarga de P7b** | **Puntos de conexión CRL** | **Puntos de conexión OCSP** | **Puntos de conexión de AIA** |
| --- | --- | --- | --- | --- |
| Certificados raíz de confianza pública | [Microsoft 365 lote de certificados raíz (P7B)](https://download.microsoft.com/download/4/a/b/4ab1c940-826b-444b-b287-b7a902e68da0/m365_root_certs_20220331.p7b) | crl.globalsign.net<br>www.d-trust.net | N/D | N/D |
| Certificados intermedios de confianza pública | [Microsoft 365 lote de certificados intermedios (P7B)](https://download.microsoft.com/download/1/4/7/14777f28-3fde-4958-aebf-bd192a4a7fac/m365_intermediate_certs_20201013.p7b) | cdp1.public-trust.com<br>crl.cnnic.cn<br>crl.entrust.net<br>crl.globalsign.com<br>crl.globalsign.net<br>crl.identrust.com<br>crl.thawte.com<br>crl3.digicert.com<br>crl4.digicert.com<br>s1.symcb.com<br>www.d-trust.net | isrg.trustid.ocsp.identrust.com<br>ocsp.digicert.com<br>ocsp.entrust.net<br>ocsp.globalsign.com<br>ocsp.omniroot.com<br>ocsp.startssl.com<br>ocsp.thawte.com<br>ocsp2.globalsign.com<br>ocspcnnicroot.cnnic.cn<br>root-c3-ca2-2009.ocsp.d-trust.net<br>root-c3-ca2-ev-2009.ocsp.d-trust.net<br>s2.symcb.com | aia.startssl.com<br>apps.identrust.com<br>cacert.omniroot.com<br>www.cnnic.cn |
...
| **Asunto** | CN=CNNIC ROOT<br>O=CNNIC<br>C=CN |
| --- | --- |
| **Número de serie** | 49:33:00:01 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no anterior** | 16 de abril de 07:09:14 2007 UTC |
| **Validez no posterior** | 16 de abril de 07:09:14 2027 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | Nov 05 08:35:58 2009 UTC |
| **Validez no posterior** | Nov 05 08:35:58 2029 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | Nov 05 08:50:46 2009 UTC |
| **Validez no posterior** | Nov 05 08:50:46 2029 UTC |
...
| **Huella digital (SHA-256)** | CEE5496B988CE98625B934092EEC2908BED0B0F316C2D4730C84EAF1F3D34881 |
...
| **Asunto** | CN=GlobalSign Root CA<br>OU=Entidad de certificación raíz<br>O=GlobalSign nv-sa<br>C=BE |
| --- | --- |
| **Número de serie** | 04:00:00:00:00:01:15:4B:5A:C3:94 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no anterior** | Sep 01 12:00:00 1998 UTC |
| **Validez no posterior** | 28 de enero de 12:00:00 2028 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | Miércoles, 18 de marzo de 2009 3:00 AM |
| **Validez no hasta** | Domingo, 18 de marzo de 2029 3:00 AM |
...
| **Validez no anterior** | 4 de junio de 11:04:38 2015 UTC |
| **Validez no posterior** | 4 de junio de 11:04:38 2035 UTC |
...
| **Huella digital (SHA-256)** | 96BCEC06264976F37460779ACF28C5A7CFE8A3C0AAE11A8FFCEE05C0BDDF08C6 |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | Abr 02 00:00:00 2008 UTC |
| **Validez no posterior** | 01 de dic 23:59:59 2037 UTC |
...
| **Huella digital (SHA-256)** | 4B03F45807AD70F21BFC2CAE71C9FDE4604C064CF5FFB686BAE5DBAAD7FDDD34C |
| **Pin (SHA-256)** | GQbGEk27Q4V40A4GbVBUxsN/D6YCjAVUXgmU7drshik= |

### <a name="verisign-class-3-public-primary-certification-authority---g5"></a>**Entidad de certificación principal pública veriSign de clase 3: G5**
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no anterior** | Nov 08 00:00:00 2006 UTC |
| **Validez no posterior** | 16 de julio de 23:59:59 2036 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 18 de dic 12:32:18 2014 UTC |
| **Validez no posterior** | 18 de dic 12:32:18 2024 UTC |
...
| **Huella digital (SHA-256)** | FA8B9F99DBB94E7B772AAA9190846E777047C15C7A3BF4A1AF9C0CA984A689511 |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 12 de noviembre de 12:46:55 2009 UTC |
| **Validez no posterior** | Nov 05 08:35:58 2029 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 12 de noviembre de 12:52:43 2009 UTC |
| **Validez no posterior** | Nov 05 08:50:46 2029 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | Miércoles, 4 de marzo de 2020 4:04 AM |
| **Validez no hasta** | Lunes, 4 de marzo de 2030 4:04 AM |
...
| **Longitud de clave pública** | RSA 2048 bits |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 25 de septiembre de 2020 00:00 AM |
| **Validez no posterior** | 24 de septiembre de 2030 11:59 p.m. |
| **Identificador de clave de asunto** | dd:51:d0:a2:31:73:a9:73:ae:8f:b4:01:7e:5d:8c:57:cb:9f:f0:f7 |
| **Identificador de clave de autoridad** | 03:de:50:35:56:d1:4c:bb:66:f0:a3:e2:1b:1b:c3:97:b2:3d:d1:55 |
...
| **Longitud de clave pública** | RSA 2048 bits |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | Martes, 22 de octubre de 2013 5:00 AM |
| **Validez no hasta** | Domingo, 22 de octubre de 2028 5:00 AM |
...
| **Validez no posterior** | 22 de octubre de 12:00:00 2028 UTC |
...
| **Validez no posterior** | Mar 08 12:00:00 2023 UTC |
...
| --- | --- |
| **Emisor** | CN=Entidad de certificación de Entrust.net (2048)<br>OU=(c) 1999 Entrust.net Limited<br>OU=www.entrust.net/CPS2048\_ incorp. por referencia (limita el liab).<br>O=Entrust.net |
| **Número de serie** | 4C:0E:8C:39 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no anterior** | 11 de noviembre de 15:40:40 2011 UTC |
| **Validez no posterior** | 12 de noviembre de 02:51:17 2021 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 20 de febrero de 10:00:00 2014 UTC |
| **Validez no posterior** | 15 de dic 08:00:00 2021 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | Sep 21 00:00:00 2016 UTC |
| **Validez no posterior** | Sep 21 00:00:00 2026 UTC |
...
| **Huella digital (SHA-256)** | AED5DDD9A5339685DFB029F6D89A14335A96512C3CACC52B2994AF8B6B37FA4D2 |
...
### <a name="globalsign-organization-validation-ca---sha256---g2-older"></a>**GlobalSign Organization Validation CA - SHA256 - G2** (anterior)
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | Ago 02 10:00:00 2011 UTC |
| **Validez no posterior** | 02 de agosto de 10:00:00 2022 UTC |
...
| **Huella digital (SHA-256)** | 0B339212D7CFF17A2C59E35669B58E7735013750A78DA9404770EDD470DEF76 |
...
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 20 de febrero de 10:00:00 2014 UTC |
| **Validez no posterior** | 20 de febrero de 10:00:00 2024 UTC |
| **Identificador de clave de asunto** | 96:de:61:f1:bd:1c:16:29:53:1c:c0:cc:7d:3b:83:00:40:e6:1a:7c |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 17 de marzo de 16:40:46 2016 UTC |
| **Validez no posterior** | 17 de marzo de 16:40:46 2021 UTC |
...
### <a name="microsoft-azure-tls-issuing-ca-05"></a>**Microsoft Azure ENTIDAD de certificación de emisión de TLS 05**

| **Asunto** | CN=Microsoft Azure ENTIDAD de certificación emisora de TLS 05<br>O=Microsoft Corporation<br>C=US |
| --- | --- |
| **Emisor** | CN=DigiCert Global Root G2, OU=www.digicert.com, O=DigiCert Inc, C=US |
...
| **Validez no posterior** | Oct 30 23:59:59 2023 UTC |
...
| **Huella digital (SHA-256)** | 9E6BC5F9ECC52460E8EDC02C644D1CB9F2316F41DAF3B616A0B2058294B31 |
...
| **Asunto** | CN=Symantec Class 3 Secure Server CA - G4<br>OU=Symantec Trust Network<br>O=Symantec Corporation<br>C=US |
| --- | --- |
| **Emisor** | CN=VeriSign Class 3 Public Primary Certification Authority - G5<br>OU=&quot;(c) 2006 VeriSign, Inc. - Solo para uso autorizado&quot;<br>OU=VeriSign Trust Network<br>O=&quot;VeriSign, Inc.&quot;<br>C=US |
| **Nombre alternativo del firmante** | Dirección del directorio: CN=SymantecPKI-1-534 |
...
| **Huella digital (SHA-256)** | EAE72EB454BF6C3977EBD289E970B2F5282949190093D0D26F98D0F0F0D6A9CF17 |
...
| **Nombre alternativo del firmante** | Dirección del directorio: CN=VeriSignMPKI-2-415 |
| **Número de serie** | 36:34:9E:18:C9:9C:26:69:B6:56:2E:6C:E5:AD:71:32 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 23 de mayo de 00:00:00 2013 UTC |
| **Validez no posterior** | 22 de mayo de 23:59:59 2023 UTC |
...
| **Huella digital (SHA-256)** | 3F3AF9C9CC2C7599EF8F6DDD7CA516CFC1797D7D12002254F3BFDD4D4D0FE9DE86 |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | Abr 02 14:36:10 2014 UTC |
| **Validez no posterior** | Abr 02 14:35:52 2021 UTC |
| **Identificador de clave de asunto** | f8:bd:fa:af:73:77:c6:c7:1b:f9:4b:4d:11:a7:d1:33:af:72:11 |
| **Identificador de clave de autoridad** | keyid:e5:9d:59:30:82:47:58:cc:ac:fa:08:54:36:86:7b:3a:b5:04:4d:f0 |
...
La lista siguiente incluye certificados heredados que no se incluyen anteriormente y se combinarán con la lista anterior con el tiempo.
