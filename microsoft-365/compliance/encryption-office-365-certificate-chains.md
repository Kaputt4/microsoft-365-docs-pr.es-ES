...
Expanda las secciones raíz e intermedia a continuación para ver detalles adicionales sobre los proveedores de certificados.

## <a name="microsoft-365-root-certificate-details"></a>**Detalles del certificado raíz de Microsoft 365**

### <a name="baltimore-cybertrust-root"></a>**Baltimore CyberTrust Root**

| **Asunto** | CN=Root de CyberTrust de Baltimore<br>OU=CyberTrust<br>O=Baltimore<br>C=IE |
| --- | --- |
| **Número de serie** | 02:00:00:B9 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no anterior** | 12 de mayo 18:46:00 2000 UTC |
| **Validity Not After** | 12 de mayo 23:59:00 2025 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no anterior** | 16 abr 07:09:14 2007 UTC |
...
| **Asunto** | CN=Ca raíz global DigiCert<br>OU=www.digicert.com<br>O=DigiCert Inc<br>C=US |
| --- | --- |
| **Número de serie** | 08:3B:E0:56:90:42:46:B1:A1:75:6A:C9:59:91:C7:4A |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no anterior** | 10 de noviembre 00:00:00 2006 UTC |
| **Validity Not After** | 10 de noviembre 00:00:00 2031 UTC |
...
| **Validez no anterior** | Jueves, 1 de agosto de 2013 5:00 a.m. |
...
| **Asunto** | CN=Entidad de certificación raíz ev de alta garantía de DigiCert<br>OU=www.digicert.com<br>O=DigiCert Inc<br>C=US |
| --- | --- |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 05 de noviembre 08:35:58 2009 UTC |
| **Validity Not After** | 05 de noviembre 08:35:58 2029 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 05 de noviembre 08:50:46 2009 UTC |
| **Validity Not After** | 05 de noviembre 08:50:46 2029 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no anterior** | 30 de septiembre 21:12:19 2000 UTC |
| **Validity Not After** | 30 de septiembre 14:01:15 2021 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 7 de julio 17:25:54 2009 UTC |
| **Validity Not After** | 07 dic 17:55:54 2030 UTC |
...
| **Pin (SHA-256)** | du6FkDdMcVQ3u8prumAo6t3i3G27uMP2EHhR8R0at/U= |

### <a name="entrustnet-certification-authority-2048"></a>**Entrust.net Certification Authority (2048)**

| **Asunto** | CN=Entidad de certificación Entrust.net (2048)<br>OU=(c) 1999 Entrust.net Limited<br>OU=www.entrust.net/CPS \_ 2048 incorp. por referencia. (limit s liab.)<br>O=Entrust.net |
| --- | --- |
| **Número de serie** | 38:63:DE:F8 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no anterior** | 24 de diciembre 17:50:51 1999 UTC |
...
| **Asunto** | CN=GlobalSign Root CA<br>OU=CA raíz<br>O=GlobalSign nv-sa<br>C=BE |
| --- | --- |
| **Número de serie** | 04:00:00:00:00:01:15:4B:5A:C3:94 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no anterior** | 11 de septiembre 12:00:00 1998 UTC |
| **Validity Not After** | 28 de enero 12:00:00 2028 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | Miércoles, 18 de marzo de 2009 3:00 a.m. |
...
| **Asunto** | CN=thawte Primary Root CA - G3<br>OU= &quot; (c) 2008 thawte, Inc.: solo para uso autorizado&quot;<br>OU=División de servicios de certificación<br>O= &quot; thawte, Inc.&quot;<br>C=US |
| --- | --- |
| **Número de serie** | 60:01:97:B7:46:A7:EA:B4:B4:9A:D6:4B:2F:F7:90:FB |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 02 abr 00:00:00 2008 UTC |
| **Validity Not After** | 1 de diciembre de 23:59:59 2037 UTC |
...
| **Asunto** | CN=VeriSign Class 3 Public Primary Certification Authority - G5<br>OU= &quot; (c) 2006 VeriSign, Inc.: solo para uso autorizado&quot;<br>OU=Red de confianza VeriSign<br>O= &quot; VeriSign, Inc.&quot;<br>C=US |
| --- | --- |
| **Número de serie** | 18:DA:D1:9E:26:7D:E8:BB:4A:21:58:CD:CC:6B:3B:4A |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no anterior** | 08 de noviembre 00:00:00 2006 UTC |
| **Validity Not After** | 16 de julio 23:59:59 2036 UTC |
...
| **Pin (SHA-256)** | JbQbUG5JMJUoI6brnx0x3vZF6jilxsapbXG DragjhN8Fg= |
...
| **Pin (SHA-256)** | dKZRcLDh7hBNZTmTICELAJ6C2Om/ITjUCPkOnLTnrZXk= |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 12 de noviembre 12:46:55 2009 UTC |
| **Validity Not After** | 05 de noviembre 08:35:58 2029 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 12 de noviembre 12:52:43 2009 UTC |
| **Validity Not After** | 05 de noviembre 08:50:46 2029 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | Martes, 22 de octubre de 2013 5:00 a.m. |
...
| --- | --- |
| **Emisor** | CN=Entidad de certificación raíz ev de alta garantía de DigiCert<br>OU=www.digicert.com<br>O=DigiCert Inc<br>C=US |
| **Número de serie** | 04:E1:E7:A4:DC:5C:F2:F3:6D:C0:2B:42:B8:5D:15:9F |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | Oct 22 12:00:00 2013 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | Mar 08 12:00:00 2013 UTC |
...
| --- | --- |
| **Emisor** | CN=Entidad de certificación Entrust.net (2048)<br>OU=(c) 1999 Entrust.net Limited<br>OU=www.entrust.net/CPS \_ 2048 incorp. por referencia. (limita liab).)<br>O=Entrust.net |
| **Número de serie** | 4C:0E:8C:39 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validez no anterior** | 11 de noviembre 15:40:40 2011 UTC |
| **Validity Not After** | 12 de noviembre 02:51:17 2021 UTC |
...
| **Validity Not After** | 05 dic 19:43:56 2030 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 20 de febrero 10:00:00 2014 UTC |
| **Validity Not After** | 15 de diciembre 08:00:00 2021 UTC |
...
| **Asunto** | CN=CA de validación extendida de GlobalSign - SHA256 - G3<br>O=GlobalSign nv-sa<br>C=BE |
| --- | --- |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 21 de septiembre 00:00:00 2016 UTC |
| **Validity Not After** | 21 de septiembre 00:00:00 2026 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 2 de agosto a las 10:00:00 UTC de 2011 |
| **Validity Not After** | 2 de agosto 10:00:00 2022 UTC |
...
| **Longitud de clave pública** | RSA 2048 bits |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | Jueves, 3 de septiembre de 2015 17:00 |
| **Validez No hasta** | Miércoles, 3 de septiembre de 2025 17:00 |
...
| **Longitud de clave pública** | RSA 2048 bits |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | Martes, 20 de noviembre de 2018 16:00 |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | Mar 17 16:40:46 2016 UTC |
...
| **Asunto** | CN=ENTIDAD emisora de TLS de Microsoft Azure 01<br>O=Microsoft Corporation<br>C=US |
| --- | --- |
| **Emisor** | CN=DigiCert Global Root G2, OU=www.digicert.com, O=DigiCert Inc, C=US |
...
| **Asunto** | CN=ENTIDAD emisora de TLS de Microsoft Azure 02<br>O=Microsoft Corporation<br>C=US |
| --- | --- |
| **Emisor** | CN=DigiCert Global Root G2, OU=www.digicert.com, O=DigiCert Inc, C=US |
...
| **Huella digital (SHA-256)** | 15A98761EBE011554DA3A46D206B0812CB2EB69AE87AA11A6DD4CB84ED5142A |
| **DIRECCIONES URL de CRL** | http://crl3.digicert.com/DigiCertGlobalRootG2.crl http://crl4.digicert.com/DigiCertGlobalRootG2.crl |
| **Direcciones URL de OCSP** | http://ocsp.digicert.com |
...
| **Asunto** | CN=ENTIDAD emisora de TLS de Microsoft Azure 06<br>O=Microsoft Corporation<br>C=US |
| --- | --- |
| **Emisor** | CN=DigiCert Global Root G2, OU=www.digicert.com, O=DigiCert Inc, C=US |
...
| --- | --- |
| **Emisor** | CN=Root de CyberTrust de Baltimore<br>OU=CyberTrust<br>O=Baltimore<br>C=IE |
| **Número de serie** | 08:B8:7A:50:1B:BE:9C:DA:2D:16:4D:3E:39:51:BF:55 |
| **Longitud de clave pública** | RSA 4096 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 20 de mayo 12:51:28 2016 UTC |
| **Validity Not After** | 20 de mayo 12:51:28 2024 UTC |
...
| **Longitud de clave pública** | RSA 4096 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 20 de mayo 12:51:57 2016 UTC |
| **Validity Not After** | 20 de mayo 12:51:57 2024 UTC |
...
| **Longitud de clave pública** | RSA 4096 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 20 de mayo 12:52:38 2016 UTC |
| **Validity Not After** | 20 de mayo 12:52:38 2024 UTC |
...
| **Longitud de clave pública** | RSA 4096 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 20 de mayo 12:53:03 2016 UTC |
...
| --- | --- |
| **Emisor** | CN=Root de CyberTrust de Baltimore, OU=CyberTrust, O=Baltimore, C=IE |
...
| **Asunto** | CN=Symantec Class 3 EV SSL CA - G3<br>OU=Red de confianza de Symantec<br>O=Symantec Corporation<br>C=US |
| --- | --- |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | Oct 31 00:00:00 2013 UTC |
...
| --- | --- |
| **Emisor** | CN=thawte Primary Root CA - G3<br>OU= &quot; (c) 2008 thawte, Inc.: solo para uso autorizado&quot;<br>OU=División de servicios de certificación<br>O= &quot; thawte, Inc.&quot;<br>C=US |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 23 de mayo 00:00:00 2013 UTC |
| **Validity Not After** | 22 de mayo 23:59:59 2023 UTC |
...
| **Pin (SHA-256)** | /36ymPAVaJl3QDyB1lUk Drag9GqJNug0R8JJPDN6348p8= |
...
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validez no anterior** | 02 abr 14:36:10 2014 UTC |
| **Validity Not After** | 02 abr 14:35:52 2021 UTC |
...
La siguiente lista incluye certificados heredados que no se incluyen anteriormente y se combinarán con la lista anterior con el tiempo.
