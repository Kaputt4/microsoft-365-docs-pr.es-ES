...
---
# <a name="microsoft-365-encryption-chains---dod-and-gcc-high"></a>Microsoft 365 de cifrado: DOD y GCC High

Microsoft 365 aprovecha una serie de proveedores de certificados diferentes. A continuación se describe la lista completa de certificados raíz Microsoft 365 conocidos que pueden encontrar los clientes **de DOD** y GCC High al obtener acceso a Microsoft 365. Para obtener información sobre los certificados que puede que necesite instalar en su propia infraestructura, vea [Plan for third-party SSL certificates for Microsoft 365](../enterprise/plan-for-third-party-ssl-certificates.md).

La siguiente información de certificado se aplica a **todos los clientes de DOD GCC High**.

Last updated: **10/16/2020**

> [!NOTE]
> Para obtener información sobre certificados que se aplica **a** clientes de todo el mundo, consulte [Microsoft 365 cadenas de cifrado](encryption-office-365-certificate-chains.md).

| **Tipo de certificado** | **Descarga de P7b** | **Puntos de conexión crl** | **Puntos de conexión de OCSP** |
| --- | --- | --- | --- | --- |
| Certificados intermedios y raíz de confianza pública | [Microsoft 365 Paquete de certificados ITAR (P7B)](https://download.microsoft.com/download/b/3/a/b3ae08a2-516c-46a9-8723-6256e4fd6383/m365_chain_certs_itar20201012.p7b) | crl.entrust.net<br>crl3.digicert.com<br>crl4.digicert.com | ocsp.digicert.com<br>ocsp.entrust.net |

Expanda las secciones raíz e intermedia siguientes para ver detalles adicionales sobre los proveedores de certificados.

## <a name="microsoft-365-certificate-details"></a>**Microsoft 365 Detalles del certificado**
...
| **Validity Not Before** | Ago 04 12:00:00 2015 UTC |
| **Validity Not After** | 04 de agosto de 12:00:00 2030 UTC |
...
| **Algoritmo de firma** | sha256RSA |
| **Validity Not Before** | Jueves, 24 de septiembre de 2020 17:00 |
| **Validez no hasta** | martes, 24 de septiembre de 2030 04:59 p.m. |
...
| **Longitud de clave pública** | RSA 2048 bits |
| **Algoritmo de firma** | sha256RSA |
| **Validity Not Before** | viernes, 8 de marzo de 2013 4:00 a.m. |
...
| **Subject** | CN=Entrust Root Certification Authority<br>OU="(c) 2006 Entrust, Inc."<br>OU=www.entrust.net/CPS se incorpora por referencia<br>OU=See www.entrust.net/legal-terms<br>O= &quot; Entrust, Inc.&quot;<br>C=US |
| --- | --- |
| **Número de serie** | 45:6B:50:54 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha1RSA |
| **Validity Not Before** | 27 de noviembre de 2006 12:23:42 UTC |
| **Validity Not After** | 27 de noviembre de 12:53:42 2026 UTC |
...
| **Validity Not After** | 11 de noviembre de 02:51:17 2021 UTC |
...
| **Subject** | CN=Entrust Certification Authority - L1E<br>OU= &quot; (c) 2009 Entrust, Inc.&quot;<br>OU=www.entrust.net/rpa se incorpora por referencia<br>O= &quot; Entrust, Inc.&quot;<br>C=US |
| --- | --- |
| **Emisor** | CN=Entrust.net Certification Authority (2048)<br>OU=(c) 1999 Entrust.net Limited<br>OU=www.entrust.net/CPS \_ 2048 incorp. por ref. (limits liab.)<br>O=Entrust.net |
...
| **Subject** | CN=Entrust Certification Authority - L1M, OU= &quot; (c) 2014 Entrust, Inc. - solo para uso autorizado&quot;<br>OU=See www.entrust.net/legal-terms<br>O= &quot; Entrust, Inc.&quot;<br>C=US |
| --- | --- |
| **Emisor** | CN=Entrust Root Certification Authority - G2<br>OU= &quot; (c) 2009 Entrust, Inc. - solo para uso autorizado&quot;<br>OU=See www.entrust.net/legal-terms<br>O= &quot; Entrust, Inc.&quot;<br>C=US |
| **Número de serie** | 61:A1:E7:D2:00:00:00:00:51:D3:66:A6 |
| **Longitud de clave pública** | RSA 2048 bits (e 65537) |
| **Algoritmo de firma** | sha256RSA |
| **Validity Not Before** | 15 de diciembre de 07:25:03 2014 UTC |
