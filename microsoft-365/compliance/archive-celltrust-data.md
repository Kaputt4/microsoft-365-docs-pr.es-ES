...
1. Vaya a y, a [https://compliance.microsoft.com](https://compliance.microsoft.com/) continuación, seleccione **Conectores** \> de datos **CellTrust**.

2. En la página CellTrust product description (Descripción del producto **CellTrust**), seleccione **Add connector (Agregar conector).**
...
2. Seleccione la pestaña **Conectores** y, a continuación, seleccione el conector **CellTrust** para mostrar la página de control flotante, que contiene las propiedades y la información sobre el conector.
