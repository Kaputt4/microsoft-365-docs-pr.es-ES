...
En la información general siguiente se explica el proceso de uso de un conector para archivar los datos de CellTrust en Microsoft 365.

![Flujo de trabajo de archivado de datos de CellTrust.](../media/CellTrustConnectorWorkflow.png)
...
El primer paso consiste en acceder a Los **conectores de datos** en el portal de cumplimiento y crear un conector para los datos de CellTrust.

1. Vaya a y, a [https://compliance.microsoft.com](https://compliance.microsoft.com/) continuación, haga clic en **Conectores** \> de datos **CellTrust**.
...
## <a name="step-2-configure-the-celltrust-connector-on-the-veritas-merge1-site"></a>Paso 2: Configurar el conector CellTrust en el sitio de Veritas Merge1
...
## <a name="step-4-monitor-the-celltrust-connector"></a>Paso 4: Supervisión del conector CellTrust

Después de crear el conector CellTrust, puede ver el estado del conector en el portal de cumplimiento.
...
2. Haga clic en la pestaña **Conectores** y, a continuación, seleccione el conector **CellTrust** para mostrar la página de control flotante, que contiene las propiedades y la información sobre el conector.
