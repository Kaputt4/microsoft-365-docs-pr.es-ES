...
ms.locfileid: "48200579"
---
# <a name="set-up-a-connector-to-archive-bell-network-data"></a>Configurar un conector para archivar datos de la red de Bell
...
Algunos de los pasos de implementación necesarios para archivar los datos de la red de Bell son externos a Microsoft 365 y deben completarse antes de poder crear un conector en el centro de cumplimiento.
