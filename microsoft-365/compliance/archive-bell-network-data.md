...
Use un conector TeleMessage en el portal de cumplimiento Microsoft Purview para importar y archivar mensajes de Servicio de mensajería breve (SMS) y Servicio de mensajería multimedia (MMS) de Bell Network. Después de configurar y configurar un conector, se conecta a bell network de la organización una vez al día e importa mensajes SMS y MMS a buzones de Microsoft 365.
...
3. El conector de Bell Network que se crea en el portal de cumplimiento se conecta al sitio de TeleMessage todos los días y transfiere los mensajes SMS y MMS de las 24 horas anteriores a una ubicación segura de Azure Storage en la nube de Microsoft. El conector también convierte el contenido de los mensajes SMS y MMS en un formato de mensaje de correo electrónico.
...
1. Vaya a y, a [https://compliance.microsoft.com](https://compliance.microsoft.com) continuación, seleccione **Conectores** >  de datos **Bell SMS/MMS Network Archiver**.

2. En la página de descripción **del producto de Bell Network** , seleccione **Agregar conector.**
