...
El primer paso es obtener acceso a los  conectores de datos de la Centro de cumplimiento de Microsoft 365 y crear un conector para Cisco Jabber en MS SQL datos.

1. Vaya a [https://compliance.microsoft.com](https://compliance.microsoft.com/)y, a continuación, haga clic en **Conectores de datosCisco** >  **Jabber en MS SQL**.
...
Después de crear el cisco jabber en el conector SQL MS, puede ver el estado del conector en el Centro de cumplimiento de Microsoft 365.
