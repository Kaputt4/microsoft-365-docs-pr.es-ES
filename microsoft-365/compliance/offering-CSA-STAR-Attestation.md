...
ms.locfileid: "39233603"
---
# <a name="compliance-offering-cloud-security-alliance-csa-star-attestation"></a>Oferta de cumplimiento: Certificación STAR de Cloud Security Alliance (CSA) 
...
- **Nivel 2**: **Certificación CSA STAR**: Azure, Cloud App Security, Intune y Microsoft Power BI. La Certificación STAR se basa en lograr la certificación ISO/IEC 27001 y cumplir los criterios especificados en la CCM. Se otorga después de una evaluación rigurosa hecha por terceros de los controles y prácticas de seguridad de un proveedor de servicios en la nube.
...
¿Necesita el documento de información general de esta oferta? Descargue el [PDF](https://download.microsoft.com/download/0/0/F/00F2766F-00E5-4235-8CE8-90FE657D768F/CSA-STAR-Attestation-Compliance.pdf).
