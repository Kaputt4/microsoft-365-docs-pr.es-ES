...
## <a name="november--december-2020"></a>Noviembre & 2020 de diciembre
Solo un recordatorio de que a menudo publicamos características nuevas y actualizadas en un estado de vista previa para saber cómo se usan para que podamos perfeccionarlas y mejorarlas antes de publicarla para la disponibilidad general. Sus comentarios son críticos durante la vista previa (y posteriores), por lo que debe asegurarse de que sabemos lo que piensa al abrir la tarjeta de comentarios en la parte inferior derecha del centro de cumplimiento.

![feedback](../media/Feedback_card_MCC.JPG)

### <a name="spotlight-endpoint-data-loss-prevention-dlp-released"></a>Spotlight: se ha lanzado la prevención de pérdida de datos (DLP) de punto de conexión

El [punto de conexión de DLP](endpoint-dlp-learn-about.md) amplía las capacidades de supervisión y protección de actividades de DLP a información confidencial en dispositivos con Windows 10. Una vez que los dispositivos se [incorporan](dlp-configure-endpoints.md) al centro de cumplimiento de Microsoft 365, puede configurar directivas de DLP para proteger la información confidencial de dichos dispositivos.

### <a name="advanced-ediscovery"></a>eDiscovery avanzado

Para facilitar la administración del contenido cifrado en el flujo de trabajo de eDiscovery, las herramientas de eDiscovery de 365 de Microsoft incorporan ahora el [descifrado de los archivos cifrados](ediscovery-decryption.md) que se adjuntan a los mensajes de correo electrónico y se envían a Exchange. Además, los documentos cifrados almacenados en SharePoint y OneDrive se descifran en eDiscovery avanzado.

### <a name="compliance-manager"></a>Administrador de cumplimiento

- [Compatibilidad con suscripciones de Microsoft 365 Government](compliance-manager.md). El administrador de cumplimiento ahora está disponible para clientes moderados y de nivel bajo de la comunidad de administración de Estados Unidos (GCC).
...
- [Plantillas nuevas](compliance-manager-templates-list.md). Se agregaron 56 nuevas plantillas, que aportan plantillas totales de administrador de cumplimiento a más de 230.

### <a name="data-connectors"></a>Conectores de datos

[Cinco nuevos conectores de Globanet en versión preliminar](archiving-third-party-data.md#third-party-data-connectors). Los nuevos conectores incluyen los datos de las bases de datos genéricas MS SQL, Reuters FX, CellTrust, XIP.

### <a name="retention-labels-disposition-review"></a>Etiquetas de retención (revisión de disposición)

Para ver los elementos durante una revisión de disposición, los usuarios deben ser ahora miembros del visor de contenido del [Explorador de contenido y](disposition.md#permissions-for-disposition)de los grupos de roles del visor de contenido. Aunque es necesario revisar los elementos, estos grupos de roles no son necesarios para completar la revisión de disposición.

### <a name="sensitivity-labels"></a>Etiquetas de confidencialidad

- [(Versión preliminar) configuración de uso compartido externo para los sitios de SharePoint](sensitivity-labels-teams-groups-sites.md#how-to-configure-groups-and-site-settings). Al crear una etiqueta que se usará para grupos y sitios, verá una opción para controlar el uso compartido externo de los sitios de SharePoint que tienen aplicada la etiqueta. Puede especificar que se permita el uso compartido para todos, invitados nuevos y existentes, sólo invitados existentes o solo usuarios de la organización. Cuando se aplica la etiqueta, la configuración de la etiqueta reemplazará cualquier configuración de uso compartido externo que se haya [configurado en el centro de administración de SharePoint](https://docs.microsoft.com/sharepoint/change-external-sharing-site).
- [Quitar la etiqueta y el cifrado de un documento con etiquetas](sensitivity-labels-sharepoint-onedrive-files.md#remove-encryption-for-a-labeled-document). Para quitar una etiqueta y el cifrado que aplica desde un documento con etiquetas en SharePoint, los administradores globales y los administradores de SharePoint pueden ejecutar el nuevo `Unlock-SPOSensitivityLabelEncryptedFile` cmdlet. Este cmdlet se ejecuta incluso si el administrador no tiene permisos de acceso al sitio o archivo, o si el servicio Azure Rights Management no está disponible.
