...
>
> - [Novedades del Centro de administración de Microsoft 365](/office365/admin/whats-new-in-preview)
...
- [Obtenga información sobre las barreras de información](information-barriers.md), [Introducción a las barreras de información](information-barriers-policies.md) : estructura refactorización de temas y aclaración adicional para el soporte técnico y las limitaciones de Exchange Online, actualizado para incluir compatibilidad con la nueva experiencia de interfaz de usuario de IB.
...
- [Usar entidades con nombre en las directivas DLP](named-entities-use.md) : se ha agregado una instrucción de soporte técnico para Microsoft Defender for Cloud Apps.
...
- Las etiquetas de contenedor son compatibles con las redes de entrega de contenido (CDN) de Office 365.
