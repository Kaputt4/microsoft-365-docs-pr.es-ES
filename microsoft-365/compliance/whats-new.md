...
- **Exporte documentos** en un conjunto de revisión en [una Almacenamiento de Azure](/microsoft-365/compliance/download-export-jobs) cuenta.
...
- **Encrypt-Only para Outlook**. Las opciones de cifrado para Outlook ahora incluyen Encrypt-Only cuando selecciona [Permitir que los usuarios asignen permisos](encryption-sensitivity-labels.md#let-users-assign-permissions).
- **Aplicar etiquetas integradas en aplicaciones de Office**. Instrucciones [actualizadas](sensitivity-labels-office-apps.md#office-built-in-labeling-client-and-the-azure-information-protection-client) sobre cómo aplicar etiquetas integradas en aplicaciones de Office cuando tenga instalado el cliente de etiquetado unificado de Azure Information Protection.

## <a name="february-2021"></a>Febrero de 2021

Estos son algunos de los cambios en el contenido y las soluciones de cumplimiento de Microsoft 365 para el mes de febrero.
...
- [Obtenga información sobre el escáner local de prevención de pérdida de datos de Microsoft 365](/microsoft-365/compliance/dlp-on-premises-scanner-learn)
...
- [Descifrado en herramientas de exhibición de documentos electrónicos de Microsoft 365](/microsoft-365/compliance/ediscovery-decryption)
...
- [Retirada del módulo Relevancia en eDiscovery avanzada](/microsoft-365/compliance/relevance-module-retirement)
...
- [Cifrado de correo de Exchange Online con AD RMS](/microsoft-365/compliance/information-rights-management-in-exchange-online). La compatibilidad con este servicio ha quedado en desuso. Ya no puede usar AD RMS en un entorno híbrido de Exchange. En su lugar, migre a Azure RMS.
...
- [Configure IRM para que use un servidor de AD RMS local.](/microsoft-365/compliance/configure-irm-to-use-an-on-premises-ad-rms-server) La compatibilidad con este servicio en un entorno híbrido de Exchange ha quedado en desuso.
...
- **Uso compartido externo de SharePoint**. En [el caso de las etiquetas](sensitivity-labels-teams-groups-sites.md) de contenedor, la opción de uso compartido externo de sitios de SharePoint ahora se libera como disponible en general. Además, el Centro de administración de Microsoft 365 y Planner ahora admiten la aplicación de estas etiquetas de confidencialidad. 
