...
Las siguientes soluciones de cumplimiento de Microsoft 365 ahora admiten la detección de contenido de [tarjeta](/microsoftteams/platform/task-modules-and-cards/what-are-cards) generado a través de aplicaciones en mensajes de Teams:

- **EDiscovery** básica y avanzada. El contenido de la tarjeta ahora se [puede colocar en espera](create-ediscovery-holds.md#preserve-card-content) o incluirse en las [búsquedas](/microsoftteams/ediscovery-investigation#search-for-card-content) (también se aplica a la búsqueda de contenido).
...
- Las etiquetas de confidencialidad ahora son compatibles con los inquilinos del Gobierno de Estados Unidos (GCC y GCC-H).
...
El equipo de contenido de cumplimiento de Microsoft 365 está trabajando duro creando documentos de "solución de contenido" para promover la forma en que las capacidades de cumplimiento se pueden usar conjuntamente para ayudar a cumplir sus objetivos de cumplimiento.
...
Flujo de trabajo y funcionalidad mejorados para [agregar custodios](add-custodians-to-case.md) y orígenes de datos no [custodiados](non-custodial-data-sources.md) a un caso de exhibición de documentos electrónicos avanzada.
...
[Endpoint DLP](endpoint-dlp-learn-about.md) amplía las funciones de supervisión y protección de actividad de DLP a información confidencial en dispositivos Windows 10. Después de que [los dispositivos](dlp-configure-endpoints.md) se incorpore al Centro de cumplimiento de Microsoft 365, puedes configurar directivas DLP para proteger la información confidencial en esos dispositivos.

### <a name="advanced-ediscovery"></a>eDiscovery avanzado

Para facilitar la administración del contenido cifrado en el flujo de trabajo de [](ediscovery-decryption.md) exhibición de documentos electrónicos, las herramientas de exhibición de documentos electrónicos de Microsoft 365 ahora incorporan el descifrado de archivos cifrados adjuntos a mensajes de correo electrónico y enviados en Exchange. Además, los documentos cifrados almacenados en SharePoint y OneDrive se descifran en la exhibición de documentos electrónicos avanzada.

### <a name="compliance-manager"></a>Administrador de cumplimiento

- [Compatibilidad con suscripciones de Microsoft 365 Government](compliance-manager.md). El Administrador de cumplimiento ya está disponible para los clientes moderados y altos de la Comunidad gubernamental de Estados Unidos (GCC).
...
[Compatibilidad con el idioma CJK](ediscovery-cjk-support.md). La exhibición de documentos electrónicos avanzada ahora admite idiomas de juego de caracteres de doble byte, conocidos colectivamente como idiomas CJK (incluye chino simplificado, chino tradicional, japonés y coreano). Se pueden usar en varios escenarios de conjunto de revisión avanzada.
...
### <a name="spotlight-compliance-manager"></a>Destacado: Administrador de cumplimiento
...
- La nueva retención de registros de auditoría de 10 años ayuda a admitir investigaciones de larga ejecución y responder a las obligaciones reglamentarias, legales e internas.
- [Tres nuevos eventos cruciales](advanced-audit.md#access-to-crucial-events-for-investigations). Los siguientes eventos nuevos pueden ayudarle a investigar posibles infracciones y determinar el ámbito de peligro: Send, SearchQueryInitiatedExchange y SearchQueryInitiatedSharePoint.

### <a name="communication-compliance"></a>Cumplimiento de comunicaciones

- [Grupos de roles actualizados](communication-compliance-configure.md#step-1-required-enable-permissions-for-communication-compliance). Los grupos de roles de cumplimiento de comunicación ahora coinciden con la estructura del grupo de roles disponible para la solución de administración de riesgos insider.
- [Panel informes](communication-compliance-feature-reference.md#reports). Ubicación central para ver todos los informes de cumplimiento de comunicaciones. Los widgets de informe proporcionan una vista rápida de los conocimientos más necesarios para una evaluación general del estado de las actividades de cumplimiento de comunicaciones.
- [Flujos de Power Automate](communication-compliance-feature-reference.md#power-automate-flows). Configurar flujos para automatizar tareas para alertas y usuarios, notificar a los administradores cuando los usuarios desencadenan una alerta y mucho más.
- [Acción de corrección 'Mejorar clasificación'.](communication-compliance-investigate-remediate.md#step-3-decide-on-a-remediation-action) Las alertas que contienen elementos que coinciden con clasificadores capacitados pueden beneficiarse de los comentarios para ayudar a minimizar falsos positivos en la organización. La **opción Mejorar clasificación** le permite proporcionar comentarios sobre si los elementos detectados coinciden con el clasificador configurado en la directiva de cumplimiento de comunicación relacionada. Incluso puedes sugerir a otros clasificadores que se asocien con el elemento para mejorar la precisión de coincidencia para futuras alertas.
...
### <a name="spotlight-insider-risk-and-communication-compliance-updates"></a>Spotlight: Actualizaciones de cumplimiento de comunicaciones y riesgos de Insider

Varias características nuevas y mejoradas alcanzaron la vista previa pública este mes:
...
- La integración [con Microsoft Defender para](/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection) endpoint permite importar y filtrar alertas de Microsoft Defender para puntos de conexión para las actividades detectadas por directivas creadas a partir de las nuevas plantillas de directiva de infracción de seguridad. También hay una configuración de riesgo [insider](insider-risk-management-settings.md#microsoft-defender-for-endpoint-preview) relacionada en la que puedes elegir importar alertas de seguridad a la administración de riesgos de insider según el estado de evaluación de alertas de Microsoft Defender para endpoint.

    > [!NOTE]
    > Para aprovechar la integración de Microsoft Defender para endpoints (incluidas las nuevas plantillas de infracción de directivas de seguridad), tendrás que configurar Microsoft Defender para Endpoint en tu organización. También tendrás que habilitar Microsoft Defender para endpoint para la integración de la administración de riesgos insider mediante la configuración de características avanzadas en [Microsoft Defender para endpoint.](/windows/security/threat-protection/microsoft-defender-atp/advanced-features#share-endpoint-alerts-with-microsoft-compliance-center)
 
- Personalizar umbrales de indicador al [crear una directiva](insider-risk-management-policies.md#create-a-new-policy).
- Configure grupos [de](insider-risk-management-settings.md#priority-user-groups-preview) usuarios prioritarios para definir usuarios de la organización cuya actividad requiere una inspección más detallada en función de factores como su posición, nivel de acceso a información confidencial o historial de riesgos.
- Use las API de actividad de [](insider-risk-management-settings.md#export-alerts-preview) administración de Office 365 para exportar detalles de alertas de riesgo de información interna a otras aplicaciones que su organización podría usar para administrar o agregar datos de riesgo de insider.
- Las [nuevas opciones de configuración de](insider-risk-management-settings.md#domains-preview) dominio le ayudan a definir y controlar los niveles de riesgo de la actividad en dominios específicos.

**Cumplimiento de las comunicaciones**

- Al [revisar mensajes en una alerta,](communication-compliance-investigate-remediate.md#step-3-decide-on-a-remediation-action)ahora puede quitar mensajes inapropiados en canales de Microsoft Teams, 1:1 y chats de grupo. Los mensajes y el contenido eliminados se reemplazan por una sugerencia de directiva que explica que se quitó debido al contenido confidencial.
- Nuevas [funciones de comunicación](communication-compliance-configure.md#step-1-required-enable-permissions-for-communication-compliance) (también se incluirán en los nuevos grupos de roles de cumplimiento de comunicación que se publicarán en septiembre).
- Nueva experiencia de configuración de cumplimiento de comunicaciones que incluye opciones de [privacidad y](communication-compliance-feature-reference.md#privacy) plantillas [de aviso.](communication-compliance-feature-reference.md#notice-templates)
- Nuevos [clasificadores para](communication-compliance-feature-reference.md#classifiers) ayudar a detectar imágenes de adultos, racy y gory.
- La nueva notificación "Patrón [](communication-compliance-investigate-remediate.md#step-2-examine-the-message-details) detectado" que aparece al revisar los mensajes de una alerta le permite saber sobre las instancias recurrentes del mismo comportamiento por parte de un usuario.
...
- Ahora puede usar [PowerShell & Centro](create-sensitivity-labels.md#use-powershell-for-sensitivity-labels-and-their-policies) de seguridad y cumplimiento para crear y configurar todas las opciones que vea en el Centro de administración de etiquetado. Esto significa que, además de usar PowerShell para configuraciones que no están disponibles en los centros de administración de etiquetado, ahora puede crear y mantener completamente las etiquetas de confidencialidad y las directivas de etiquetas de confidencialidad.

### <a name="records-management-content-overhaul"></a>Administración de registros: revisión de contenido

Nuevos documentos que abarcan los pasos de implementación, el marcado del contenido como registros y el control de versiones de registros:
...
La actividad de administrador relacionada con la retención ahora está registrada y está disponible para su revisión en el registro de auditoría. Para obtener la lista completa, consulte las [Actividades de las directivas y etiquetas de retención](search-the-audit-log-in-security-and-compliance.md#retention-policy-and-retention-label-activities).
...
- Nueva [experiencia de exportación de descarga directa,](export-documents-from-review-set.md)lo que elimina la necesidad de usar el Explorador de Azure Storage para descargar contenido de casos.