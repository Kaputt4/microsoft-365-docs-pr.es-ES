...
Al usar búsqueda de contenido en el portal de cumplimiento para buscar un gran número de buzones de correo, puede obtener errores de búsqueda similares al error:
...
Al reiniciar la búsqueda, a menudo se producirán errores similares en distintos servidores. En lugar de reiniciar la búsqueda, seleccione el botón **Reintentar** que se muestra en la parte superior de la página de resultados de la búsqueda.

![Seleccione el botón Reintentar para resolver errores de ubicación de contenido.](../media/retrycontentsearch3.png)
