...
## <a name="before-you-export-content-search-results"></a>Antes de exportar los resultados de búsqueda de contenido
...
6. En la herramienta de exportación de exhibición **de documentos electrónicos,** haga lo siguiente:
   ...
   2. Haga clic en **Examinar** para especificar la ubicación en la que desea descargar los archivos de los resultados de la búsqueda.
      ...
      >- Deshabilite el análisis antivirus de la carpeta en la que descarga el resultado de la búsqueda.<br/>
...
- Si el nombre de la ruta de acceso del archivo de un mensaje supera el límite máximo de caracteres de Windows, el nombre de la ruta de acceso del archivo se trunca. Pero el nombre de la ruta de acceso del archivo original aparecerá en el manifiesto y el registro de resultados.
...
- Los mensajes descifrados se identifican en el informe **ResultsLog.** Este informe contiene una columna denominada **Descodificar** estado y un valor **de Descodificado** en esta columna identifica los mensajes que se descifraron.
