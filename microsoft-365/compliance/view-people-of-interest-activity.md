...
## <a name="step-1-create-an-data-investigations-preview-audit-log-search"></a>Paso 1: crear una búsqueda de registros de auditoría de investigación de datos (versión preliminar)
   ...
   5. Haga clic en **Búsqueda** para ejecutar la búsqueda mediante sus criterios de búsqueda.  Los resultados de la búsqueda se cargan y, después de unos segundos, se muestran en resultados en la página de búsqueda actividades de personas de interés.
