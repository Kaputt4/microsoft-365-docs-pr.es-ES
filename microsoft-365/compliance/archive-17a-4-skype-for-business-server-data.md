...
3. El Skype Empresarial Server DataParser que cree en el Centro de cumplimiento de Microsoft 365 se conecta a DataParser y transfiere los mensajes a una ubicación Azure Storage segura en la nube de Microsoft.

4. Se crea una subcarpeta en la carpeta Bandeja de entrada denominada **Skype Empresarial Server DataParser en los buzones** de usuario y los elementos Skype Empresarial Server se importan a esa carpeta. El conector determina a qué buzón se importarán los elementos mediante el valor de la *propiedad Email* . Cada Skype Empresarial Server contiene esta propiedad, que se rellena con la dirección de correo electrónico de cada participante.
...
El primer paso es obtener acceso a la página Conectores de datos de la Centro de cumplimiento de Microsoft 365 y crear un conector de 17a-4 para los Skype Empresarial Server datos.

1. Vaya a <https://compliance.microsoft.com> y, a continuación, haga clic en **Conectores** >  Skype Empresarial Server **DataParser**.
...
El Skype Empresarial Server DataParser asigna automáticamente a los usuarios a sus Microsoft 365 de correo electrónico antes de importar datos a Microsoft 365.
...
2. Haga **clic en** la pestaña Conectores y, a continuación, seleccione el conector DataParser de Skype Empresarial Server que creó para mostrar la página desplegable, que contiene las propiedades e información sobre el conector.
