...
Las señales de estos eventos se detectan en Microsoft Edge mediante funcionalidades de explorador integradas y mediante el complemento de extensión de riesgo de *Microsoft Insider.* En Google Chrome, los clientes usan la *Extensión de cumplimiento de Microsoft para* la detección de señales.
...
| ---------------------------------------------- | ------------------ | ----------------- |
| Archivos copiados en el almacenamiento en la nube personal         | Nativas             | Extensión         |
| Archivos impresos en dispositivos locales o de red      | Nativas             | Extensión         |
...
Antes de instalar la extensión de riesgo *de Microsoft Insider* o la extensión de cumplimiento de *Microsoft,* los clientes deben asegurarse de que los dispositivos para usuarios de directivas en el ámbito cumplan los siguientes requisitos
...
- *Complemento de extensión de* riesgo de Microsoft Insider versión 1.0.0.44 o posterior
...
1. Vaya a [Extensión de riesgo de Microsoft Insider](https://microsoftedge.microsoft.com/addons/detail/microsoft-insider-risk-ex/lcmcgbabdcbngcbcfabdncmoppkajglo).
...
**Paso 2: Agregar el complemento extensión de administración de riesgos de *Microsoft Insider* a la *lista Forzar instalación.***
...
2. Expanda la siguiente ruta de **acceso Directivas de configuración de equipo/usuario** Plantillas \>  \> **administrativas** \>  \> **clásicas Microsoft Edge** \> **extensiones**. Esta ruta de acceso puede variar según la configuración de la organización.
...
3. Haga clic con el botón secundario y **seleccione Crear un GPO en este dominio y vincule aquí**. Cuando se le pida, asigne un nombre descriptivo a este objeto de directiva de grupo (GPO). Por ejemplo, *Dlp Chrome Immediate PowerShell Script*.
...
1. En el **Editor de administración de directivas de** grupo, vaya a la unidad organizativa (OU).
2. Expanda la siguiente ruta de acceso **Equipo/Directivas de configuración de** usuario \>  \> **Plantillas administrativas** \>  \>  \>  \> **clásicas** Plantillas administrativas de Google Chrome Extensiones . Esta ruta de acceso puede variar según la configuración de la organización.
