# [Cumplimiento de Microsoft 365](index.yml)
...
# [Administrar la protección de la información](protect-information.md)
...
## [Cifrado de correo electrónico](email-encryption.md)
...
### [Crear y publicar etiquetas de retención con PowerShell](bulk-create-publish-labels-using-powershell.md)
...
### [Administrar el ciclo de vida de los documentos de SharePoint](auto-apply-retention-labels-scenario.md)
...
## [Solución de eDiscovery avanzado de Microsoft 365](overview-ediscovery-20.md)
### [Crear un nuevo caso](create-new-ediscovery-case.md)

### [Trabajar con administradores](managing-custodians.md)
#### [Agregar administradores a un caso](add-custodians-to-case.md)
#### [Administrar los administradores](manage-new-custodians.md)
...
#### [Crear una notificación de retención](create-hold-notification.md)
...
### [Administrar retenciones](managing-holds.md)
...
### [Recopilar datos para un caso](collecting-data-for-ediscovery.md)
#### [Crear una búsqueda](create-search-to-collect-data.md)
#### [Crear consultas de búsqueda](building-search-queries.md)
#### [Estadísticas de búsqueda](search-statistics.md)
#### [Agregar los resultados de búsqueda a un conjunto de revisión](add-data-to-review-set.md)

### [Administrar conjuntos de revisión](managing-review-sets.md)
#### [Cargar datos que no son de Office 365 a un conjunto de revisión](load-non-Office-365-data-into-a-review-set.md)
#### [Agregar datos a otro conjunto de revisión](add-data-to-review-set-from-another-review-set.md)
#### [Administrar conjuntos de carga](manage-load-sets-in-advanced-ediscovery.md)
...
#### [Configurar la detección de privilegios abogado-cliente](attorney-privilege-detection.md)
...
#### [Usar el módulo de relevancia para analizar datos](using-relevance.md)
...
#### [Agregar o quitar miembros de un caso](add-or-remove-members-from-a-case-in-advanced-ediscovery.md)
...
#### [Notas de la versión](release-notes-ediscovery20.md)
#### [Límites de eDiscovery avanzado](limits-ediscovery20.md)
#### [Tipos de archivo admitidos](supported-filetypes-ediscovery20.md)
#### [Campos de metadatos del documento](document-metadata-fields-in-advanced-ediscovery.md)
#### [Conjuntos de revisión de conversación](conversation-review-sets.md)
#### [Solución de problemas de AzCopy](troubleshooting-azcopy.md)
...
# [Límites de administración de datos](overview-data-investigations.md)
## [Administrar un incidente de pérdidas de datos](manage-data-spillage-incidents.md)
## [Crear una nueva investigación](create-new-investigation.md)
## [Asignar permisos para investigaciones de datos](permissions.md)
 
## [Buscar datos en una investigación](search-for-data.md)
### [Crear consultas de búsqueda](build-search-queries.md)
### [Estadísticas de búsqueda](search-statistics.md)

## [Revisar los datos como evidencia](review-data-in-evidence.md)
### [Consultar los datos](evidence-query.md)
### [Etiquetar documentos](tag-documents.md)
### [Tomar notas y editar documentos](annotate-and-redact-documents.md)
### [Cargar datos que no son de Office 365](load-non-office365-data.md)
### [Corrección de errores al procesar los datos](error-remediation.md)
### [Eliminar elementos de su ubicación original](delete-items-from-original-locations.md)
...
### [Temas](themes.md)
### [Usar el módulo de relevancia](use-relevance-module.md)

## [Administrar usuarios de interés en una investigación](manage-people-of-interest.md)
### [Indizar los datos de usuarios en una investigación](index-data-people-of-interest.md)
### [Ver la actividad de auditoría de usuarios en una investigación](view-people-of-interest-activity.md)

## [Exportar datos de una investigación](export-data.md)
...
### [Notas de la versión](data-investigations-release-notes.md)
### [Límites de investigaciones de datos](limits-datainvestigations.md)
### [Tipos de archivo admitidos](supported-filetypes-datainvestigations.md)
...
#### [Soporte técnico de Microsoft y Servicios profesionales](gdpr-arc-prof-services.md)
...
#### [Soporte técnico de Microsoft y Servicios profesionales](gdpr-dsr-prof-services.md)
...
#### [Azure y Dynamics 365](gdpr-breach-azure-dynamics.md)
...
#### [Soporte técnico de Microsoft y Servicios profesionales](gdpr-dpia-prof-services.md)
#### [Office 365](gdpr-dpia-office365.md)

### [Responsable de la protección de datos de Microsoft](gdpr-data-protection-officer.md)

# Funcionalidades de cumplimiento híbrido
...
## [Oferta de cumplimiento de Microsoft](offering-home.md)

## Global
### [Referencia de la CIS](offering-cis-benchmark.md)
### [Certificación CSA-STAR](offering-csa-star-attestation.md)
### [Certificación STAR de CSA](offering-csa-star-certification.md)
### [Autoevaluación STAR de CSA](offering-csa-star-self-assessment.md)
...
### [VPATS para la sección 508](offering-section-508-vpats.md)
...
#### [AFM + DNB (Países Bajos)](offering-afm-dnb-netherlands.md)
#### [APRA (Australia)](offering-apra-australia.md)
#### [AMF y ACPR (Francia)](offering-amf-acpr-france.md)
#### [EBA (EU)](offering-eba-eu.md)
#### [FCA (UK)](offering-fca-uk.md)
#### [FFIEC (ESTADOS UNIDOS)](offering-ffiec-us.md)
#### [FINMA (Suiza)](offering-finma-switzerland.md)
...
#### [RBI + IRDA (India)](offering-rbi-irdai-india.md)
...
#### [NEN-7510(Países Bajos)](offering-nen-7510-netherlands.md)
#### [Kit de herramientas NHS IG (UK)](offering-nhs-ig-toolkit-uk.md)

### Industria
#### [FDA CFR título 21, parte 11](offering-fda-cfr-title-21-part-11.md)
#### [GxP](offering-gxp.md)
#### [TISAX (Alemania)](offering-tisax-germany.md)

### Elementos multimedia
#### [CDSA](offering-cdsa.md)
#### [DPP (REINO UNIDO)](offering-dpp-uk.md)
#### [HECHO(REINO UNIDO)](offering-fact-uk.md)
...
#### [Cláusulas del modelo de EU](offering-eu-model-clauses.md)
#### [EBA (EU)](offering-eba-eu.md)
...
#### [PCI DSS](offering-pci-dss.md)
#### [VPATS para la sección 508](offering-section-508-vpats.md)
#### [Evaluaciones compartidas](offering-shared-assessments.md)
#### [SOC](offering-soc.md)
...
## Regional
### Asia
#### [Marca CS (oro) (Japón))](offering-cs-mark-gold-japan.md)
...
#### [ISMS (Corea)](offering-ISMS-korea.md)
#### [MeitY (India)](offering-meity-india.md)
#### [MTCS (Singapur)](offering-mtcs-singapore.md)
#### [Mi número (Japón)](offering-my-number-act-japan.md)
#### [TRUCS (China)](https://aka.ms/TRUCS-Compliance)

### Australia y Pacífico
#### [CCSL/IRAP (Australia)](offering-CCSL-IRAP-Australia.md)
#### [NZ CC marco (Nueva Zelanda)](offering-nz-cc-framework-nz.md)

### Europa
#### [BIR 2012 (Países Bajos)](offering-bir-2012-netherlands.md)
#### [C5 (Alemania)](offering-c5-germany.md)
#### [Cyber Essentials Plus (Reino Unido)](offering-cyber-essentials-plus-uk.md)
#### [EN 301 549 (UE)](offering-en-301-549-eu.md)
#### [ENS (España)](offering-ens-spain.md)
#### [ENISA IAF (EU)](https://aka.ms/ENISA)
#### [Cláusulas del modelo de EU](offering-eu-model-clauses.md)
#### [Escudo de privacidad estadounidense UE](offering-eu-us-privacy-shield.md)
#### [GDPR (EU)](offering-gdpr-eu.md)
...
### Sudamérica
#### [Ley de protección de datos personales (Argentina)](offering-pdpa-argentina.md)

# [Office 365 Enterprise](https://docs.microsoft.com/Office365/Enterprise)
# [Office 365 Empresa](https://docs.microsoft.com/office365/admin/admin-home)
