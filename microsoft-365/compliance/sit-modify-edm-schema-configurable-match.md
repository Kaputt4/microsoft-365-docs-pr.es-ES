...
<span data-ttu-id="3acc4-125">El indicador `ignoredDelimiters` no es compatible con:</span><span class="sxs-lookup"><span data-stu-id="3acc4-125">The `ignoredDelimiters` flag doesn't support:</span></span>
