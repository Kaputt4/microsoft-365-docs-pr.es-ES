...
3. En la página **RR. HH. (versión preliminar),** haga clic en **Agregar conector**.
...
5. En la página Escenarios de RR. HH., seleccione uno o varios escenarios de RR. HH. para los que desea importar datos y, a continuación, haga clic en **Siguiente**.
...
10. Haga clic en el conector de RR. HH. que acaba de crear para mostrar la página de control flotante, que contiene propiedades y otra información sobre el conector.
...
7. Ejecute el siguiente comando para cargar los datos de RR. HH. en el archivo CSV en la nube de Microsoft; por ejemplo:
   ...
   |`appId` |Este es el identificador de aplicación Azure AD de la aplicación que creó en Azure AD en el paso 2. Esto lo usa Azure AD para la autenticación cuando el script intenta acceder a la organización Microsoft 365. | 
   |`appSecret`|Este es el secreto de aplicación Azure AD de la aplicación que creó en Azure AD en el paso 2. Esto también se usa para la autenticación.|
