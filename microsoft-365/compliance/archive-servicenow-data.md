...
2. Una vez cada 24 horas, los elementos ServiceNow se copian en el sitio de Globanet Merge1. El conector también convierte los elementos ServiceNow a un formato de mensaje de correo electrónico.

3. El conector ServiceNow que cree en el Centro de cumplimiento de Microsoft 365 se conecta al sitio de Globanet Merge1 todos los días y transfiere el contenido de ServiceNow a una ubicación segura de Azure Storage en la nube de Microsoft.
...
## <a name="step-2-configure-the-servicenow-on-the-globanet-merge1-site"></a>Paso 2: Configurar ServiceNow en el sitio de Globanet Merge1

El segundo paso es configurar el conector ServiceNow en el sitio de Globanet Merge1. Para obtener información acerca de cómo configurar el conector ServiceNow, vea la Guía del usuario de [Conectores de terceros Merge1](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20ServiceNow%20User%20Guide%20.pdf).
...
## <a name="step-4-monitor-the-servicenow-connector"></a>Paso 4: Supervisar el conector ServiceNow
