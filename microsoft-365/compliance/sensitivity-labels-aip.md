...
Hay más características planeadas y en desarrollo. Si hay una característica específica que le interese, consulte el [plan de desarrollo de Microsoft 365](https://www.microsoft.com/microsoft-365/roadmap?filters=Microsoft%20Information%20Protection&searchterms=label) y considere la posibilidad de unirse a la [protección de la información de Microsoft en la versión preliminar privada de Office](https://aka.ms/MIP/PreviewRing).
