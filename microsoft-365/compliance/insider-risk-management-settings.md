...
1. Debe ejecutar Windows 10 x64 compilación 1809 o posterior y debe haber instalado la actualización de Windows 10 (compilación del sistema operativo [17763.1075)](https://support.microsoft.com/help/4537818/windows-10-update-kb4537818) desde el 20 de febrero de 2020.
...
Los dispositivos MacOS (Catalina 10.15 o posterior) se pueden incorporar a Microsoft 365 para admitir directivas de administración de riesgos internas mediante Intune o JAMF Pro. Para obtener más información y instrucciones de configuración, consulte [Incorporación de dispositivos macOS Microsoft 365 información general (versión preliminar).](device-onboarding-macos-overview.md).
...
1. Habilite la Office 365 api de actividad de administración en las alertas de administración de riesgos de **Insider** >  **Configuración** >  **Export**. De forma predeterminada, esta configuración está deshabilitada para la Microsoft 365 organización.
...
Los siguientes campos y valores se exportan para alertas de administración de riesgos insider [para el esquema Office 365 API de actividad de administración.](/office/office-365-management-api/office-365-management-activity-api-schema#common-schema)
...
1. En el [Centro de cumplimiento de Microsoft 365](https://compliance.microsoft.com), ve a Administración de riesgos **de Insider** y selecciona Configuración de riesgos de **Insider** >  **Power Automate flujos**. También puede obtener acceso desde las páginas **de paneles Casos** o Usuarios  **seleccionando AutomateManage** >  **Power Automate flujos**.
...
3. Seleccione los **puntos suspensivos** >  **Configuración** cambiar una configuración de componente de flujo o **puntos** >  suspensivosDelete para eliminar un componente de flujo.
...
- **Microsoft 365 de auditoría**: incluidos en todos los exámenes, este es el origen principal para identificar la mayoría de las actividades potencialmente arriesgadas.
- **Exchange Online**: incluida en todos los exámenes, la actividad Exchange Online ayuda a identificar actividades en las que los datos adjuntos se enviarán por correo electrónico a los contactos o servicios externos.
