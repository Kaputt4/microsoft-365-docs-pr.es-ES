...
description: El administrador puede aprender a importar masivamente archivos PST a buzones de Microsoft 365 copiando archivos PST en un disco duro y, a continuación, env a Microsoft.
ms.openlocfilehash: f0942fbb91e1b1eab20aa2867c27e1f025b96ed3
ms.sourcegitcommit: 27b2b2e5c41934b918cac2c171556c45e36661bf
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 03/19/2021
ms.locfileid: "50925506"
---
...
Para obtener preguntas más frecuentes acerca del uso del trasvase de unidades para importar archivos PST a Office 365, vea Preguntas más frecuentes sobre cómo usar el trasvase de unidades para [importar archivos PST](faqimporting-pst-files-to-office-365.md#using-drive-shipping-to-import-pst-files). 
...
> [!IMPORTANT]
> Debe usar la versión 1 de la herramienta de importación y exportación de Azure (WAimportExportV1) para importar correctamente archivos PST mediante el método de envío de unidades. La versión 2 de la herramienta Azure Import/Export no es compatible y su uso dará como resultado la preparación incorrecta del disco duro para el trabajo de importación. Asegúrese de descargar la herramienta Azure Import/Export del Centro de seguridad y & cumplimiento siguiendo los procedimientos descritos en este paso. 
...
2. En el panel izquierdo del Centro de seguridad y cumplimiento, haga clic en **gobernanza de información**\>**Importar**\>**archivos PST**.
    ...
    > [!NOTE]
    > Como se ha indicado anteriormente, debe tener asignados  los permisos adecuados para tener acceso a la página Importar en el Centro de seguridad & cumplimiento. 
...
7. Haga **clic en** Cancelar para cerrar el asistente. 
    ...
    Cuando cree el  trabajo de importación en el paso 4, vuelva a la página Importar en el Centro de seguridad y cumplimiento de &. 
...
16. En la **página Importar archivos PST,** haga clic en Actualizar icono Actualizar para mostrar el nuevo trabajo de importación de trasvase de unidades ![ en la lista de trabajos de ](../media/O365-MDM-Policy-RefreshIcon.gif)  importación. El estado se establece en **Waiting for tracking number**. También puede hacer clic en el trabajo de importación para mostrar la página desplegable de estado, que contiene información más detallada sobre el trabajo de importación.
...
> [!NOTE]
> Si no proporciona el número de seguimiento y devuelve la información de envío dentro de los 14 días siguientes a la creación del trabajo de importación, el trabajo de importación expirará. Si esto sucede, tendrá que crear un nuevo trabajo de importación de trasvase de unidades (vea Step [4: Create a PST Import job in Office 365](#step-4-create-a-pst-import-job-in-office-365)) y volver a enviar el archivo de unidad y el archivo de asignación de importación de PST. 
...
3. En la **página Importar archivos PST,** haga clic en el trabajo para el envío de unidad para el que desea especificar el número de seguimiento. 
...
6. Haga clic en **Guardar** para guardar esta información del trabajo de importación. 
    ...
    En la **página Importar archivos PST,** haga clic en Actualizar icono Actualizar para actualizar la información del trabajo de importación ![ de ](../media/O365-MDM-Policy-RefreshIcon.gif)  trasvase de unidades. Observe que el estado ahora está establecido en **Unidades en tránsito**.
...
2. En el panel izquierdo, haga clic **en Gobierno de información** \> **Importar** importar archivos \> **PST**.
...
5. Haga clic en Usar **un URI de SAS**, pegue la dirección URL de SAS que obtuvo en el paso 1 en el cuadro bajo **URI** y, a continuación, haga clic en **Siguiente**.
