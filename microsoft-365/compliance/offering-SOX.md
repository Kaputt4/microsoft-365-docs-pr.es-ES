...
description: Las empresas de servicios financieros pueden usar los informes de cumplimiento de Microsoft para abordar su cumplimiento con la ley Sarbanes-Oxley.
...
ms.locfileid: "38691058"
---
# <a name="compliance-offering-sarbanes-oxley-act-of-2002-sox"></a>Oferta de cumplimiento: Ley Sarbanes-Oxley de 2002 (SOX)

## <a name="sox-overview"></a>Información general sobre SOX

La ley Sarbanes-Oxley de 2002 es un derecho federal de Estados Unidos que administra Securities and Exchange Commission (SEC). Entre otras directivas, la SOX requiere que las empresas públicas tengan estructuras de control internas adecuadas para validar que sus Estados financieros reflejen con precisión sus resultados financieros.
...
Los clientes de los servicios en la nube de Microsoft sujetos al cumplimiento de la ley Sarbanes-Oxley (SOX) pueden usar la atestación de SOC 1 tipo 2 que Microsoft recibió de una empresa independiente de auditoría al tratar sus propias obligaciones de cumplimiento de SOX. Esta atestación es adecuada para informar sobre controles internos sobre la generación de informes financieros.
...
¿Necesita el documento de fondo para esta oferta? Descargue el [archivo PDF](https://download.microsoft.com/download/5/D/2/5D278460-AF57-470F-B166-5BD9258BCE3E/SOX-Compliance.pdf).
