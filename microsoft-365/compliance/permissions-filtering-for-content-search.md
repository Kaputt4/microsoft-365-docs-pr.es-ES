...
El filtrado de permisos de búsqueda es compatible con la característica de búsqueda de contenido en el Centro de seguridad & cumplimiento. Estos cuatro cmdlets permiten configurar y administrar filtros de permisos de búsqueda:
