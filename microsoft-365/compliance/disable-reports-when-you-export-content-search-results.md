...
Se crea una nueva clave del Registro la primera vez que ejecuta el archivo .reg que creó en el procedimiento de este tema. A continuación, la configuración se edita cada vez que cambia y vuelve a ejecutar el archivo de edición .reg.
