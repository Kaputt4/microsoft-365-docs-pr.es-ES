...
1. Edite **eledm.xml** (este es el archivo que se describe en el tema Crear el esquema para obtener datos exactos según los tipos de información [confidencial basada en coincidencias de datos](sit-get-started-exact-data-match-create-schema.md#create-the-schema-for-exact-data-match-based-sensitive-information-types).
...
2. Ejecute el siguiente comando, sustituyendo el nombre del almacén de datos de "registros de pacientes" por el que desea quitar (con el almacén de registros de pacientes como ejemplo):
      ...
      > [!TIP]
      > Si desea que los cambios se produzcan sin confirmación, no lo use `-Confirm:$true` en el paso 2.

### <a name="edit-or-delete-the-edm-schema-with-the-wizard"></a>Editar o eliminar el esquema de EDM con el asistente

1. Abrir **Clasificación de datos del Centro de** \> **cumplimiento** \> **Coincidencias exactas de datos**.

2. Elija **esquemas de EDM**.
