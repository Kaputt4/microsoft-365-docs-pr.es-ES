...
1. Su organización trabaja con un proveedor de MS SQL Database para configurar y configurar un sitio de base de datos de SQL MS.
...
El primer paso es obtener acceso a la página **Conectores** de datos en el Centro de cumplimiento de Microsoft 365 y crear un conector para la base de datos SQL MS.

1. Vaya a y [https://compliance.microsoft.com](https://compliance.microsoft.com), a continuación, haga clic en **Conectores** >  de **datosMS SQL importador de base de datos**.
...
El segundo paso es configurar el conector de MS SQL importador de base de datos en el sitio Merge1. Para obtener información sobre cómo configurar MS SQL de base de datos, consulte [Merge1 Third-Party Connectors User Guide](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20MS%20SQL%20Database%20Importer%20User%20Guide%20.pdf).
...
## <a name="step-4-monitor-the-ms-sql-database-importer-connector"></a>Paso 4: Supervisar el conector de MS SQL importador de base de datos
