...
En la siguiente introducción se explica el proceso de uso de un conector para archivar los Skype Empresarial datos en Microsoft 365.
...
4. El conector importa los elementos convertidos a los buzones de usuarios específicos mediante el valor de la propiedad *Email* de la asignación automática de usuarios, tal como se describe en [el paso 3](#step-3-map-users-and-complete-the-connector-setup). Una subcarpeta de la carpeta Bandeja de entrada denominada **Skype Empresarial** se crea en los buzones de usuario y los elementos se importan a esa carpeta. El conector hace esto mediante el valor de la *propiedad Email* . Cada Skype Empresarial contiene esta propiedad, que se rellena con la dirección de correo electrónico de cada participante del elemento.
