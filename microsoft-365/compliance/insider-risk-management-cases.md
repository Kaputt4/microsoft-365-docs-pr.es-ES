...
Se puede conceder acceso temporal a un caso agregando un usuario como colaborador. Los colaboradores tienen control de administración de casos en el caso específico excepto:
