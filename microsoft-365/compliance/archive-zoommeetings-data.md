...
2. Haga clic en la pestaña **conectores** y seleccione el conector **zoom para reuniones** para mostrar la página de flotante. Esta página contiene las propiedades y la información sobre el conector.
