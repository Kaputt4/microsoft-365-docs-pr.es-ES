...
- [Búsqueda de buzones basados en la nube](search-cloud-based-mailboxes-for-on-premises-users.md) para usuarios locales en Microsoft 365
...
- [Búsqueda de datos de terceros](use-content-search-to-search-third-party-data-that-was-imported.md) que la organización ha importado a Microsoft 365
...
- [Elementos indizados parcialmente en Exchange y SharePoint y](partially-indexed-items-in-content-search.md) cómo incluirlos o excluirlos al exportar y descargar los resultados de la búsqueda
