...
- [Conservar los destinatarios de CCO](https://docs.microsoft.com/exchange/policy-and-compliance/holds/preserve-bcc-recipients-and-group-members) para poder buscarlos 
...
- [Buscar en buzones de correo y carpetas específicas](use-content-search-for-targeted-collections.md) (denominado una recopilación de destino) cuando se confía en que los elementos que responden a un caso se encuentran en esa carpeta
