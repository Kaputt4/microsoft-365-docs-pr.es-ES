...
En la siguiente introducción se explica el proceso de uso de un conector para archivar la información de eDiscovery de demora en Microsoft 365.

![Flujo de trabajo de archivado de eDiscovery de demora](../media/SlackeDiscoveryConnectorWorkflow.png)

1. Su organización trabaja con la exhibición de documentos electrónicos de demora para instalar y configurar un sitio de eDiscovery de demora.
...
El primer paso es obtener acceso a la página **conectores de datos** en el centro de cumplimiento de Microsoft 365 y crear un conector para los datos de la exhibición de documentos electrónicos de demora.
...
2. Haga clic en la pestaña **conectores** y seleccione el conector **eDiscovery de demora** para mostrar la página de flotante, que contiene las propiedades y la información sobre el conector.
