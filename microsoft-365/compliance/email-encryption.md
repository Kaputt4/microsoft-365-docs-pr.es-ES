...
|¿Qué no hace?|OME no permite aplicar restricciones de uso a los mensajes. Por ejemplo, no puede usarlo para impedir que un destinatario reenvíe o imprima un mensaje cifrado.|Es posible que algunas aplicaciones no admitan correos electrónicos IRM en todos los dispositivos. Para obtener más información sobre estos y otros productos que admiten el correo electrónico de IRM, consulte [capacidades del dispositivo cliente](/azure/information-protection/requirements#BKMK_ClientCapabilities).|S/MIME no permite analizar los mensajes cifrados en búsqueda de malware, correo no deseado o directivas.|
...
Para obtener información sobre las opciones de cifrado de correo electrónico para su suscripción de Microsoft 365, consulte la [descripción del servicio Exchange Online](/office365/servicedescriptions/exchange-online-service-description/exchange-online-service-description). Aquí puede encontrar información sobre las siguientes características de cifrado:
...
"Datos en reposo" hace referencia a datos que no están activamente en tránsito. En Microsoft 365, los datos de correo electrónico en reposo se cifran mediante Cifrado de unidad BitLocker. BitLocker cifra las unidades de disco duro de los centros de datos de Microsoft para proporcionar una protección mejorada contra el acceso no autorizado. Para obtener más información, consulte [Introducción a BitLocker](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/hh831713(v=ws.11)).
