...
Vaya a una sección siguiente para ver las plantillas por área o sector:
- [Global](#global)
- [Industria](#industry)
- [Gobierno de Estados Unidos](#us-government)
- [Estados y territorios de EE. UU.](#us-states-and-territories)
- [Países de Asia y el Pacífico](#asia-pacific-countries)
- [Europa, Oriente Medio y África (EMEA)](#europe-middle-east-and-africa-emea)
- [América Latina](#latin-america)
- [Norteamérica](#north-america)
- [Sudamérica](#south-america)

### <a name="where-to-find-your-templates-in-compliance-manager"></a>Dónde encontrar las plantillas en el Administrador de cumplimiento
...
Una o varias de las plantillas que se enumeran a continuación se incluyen como parte del contrato de licencia. La plantilla Base de referencia de Microsoft Data Protection se incluye para todas las organizaciones.
...
Las plantillas que se enumeran a continuación están disponibles actualmente para la versión preliminar. La creación de evaluaciones con estas plantillas no contará para el total de plantillas con licencia usadas.
...
- SIG 2022  
- [Controles del sistema y la organización (SOC) 1](/compliance/regulatory/offering-soc)
- [Controles del sistema y la organización (SOC) 2](/compliance/regulatory/offering-soc)

### <a name="industry"></a>Industria

- Principios de privacidad generalmente aceptados (GAPP) de AICPA/CICA  
- ARMA: Implementación de los principios de mantenimiento de registros generalmente aceptados (GARP)  
...
- CIS Microsoft 365 Foundation Level 1 y 2
- [Matriz de controles en la nube de Cloud Security Alliance (CSA) (CCM)](/compliance/regulatory/offering-csa-star-attestation)
- COBIT 5  
- Lista de comprobación de ciberseguridad de FINRA  
- Marco de administración de seguridad de la información X.1052 de la UIT  
- Estándar de administración de la información de la Comisión Conjunta  
- [Procedimientos recomendados de seguridad de contenido de Motion Picture Association (MPA)](/compliance/regulatory/offering-mpaa)  
- [NERC CIP](/compliance/regulatory/offering-nerc-cip)  
- Controles de seguridad del cliente de SWIFT  
- Controles proactivos de OWASP para desarrolladores 2018 v3.0  
- (NAIC) Normas para proteger la regulación del modelo de información del cliente MDL-673
...
- Apéndice III de la Circular Nº de OMB. A-130: Seguridad de los recursos de información automatizados federales
- [CFR - Código de Regulaciones Federales Título 21, Parte 11, Registros Electrónicos, Firmas Electrónicas](/compliance/regulatory/offering-fda-cfr-title-21-part-11)  
...
- [Directiva de seguridad de Servicios de información de justicia penal (CJIS)](/compliance/regulatory/offering-cjis)  
...
- [Folleto del Consejo Federal de Examen de Instituciones Financieras (FFIEC)](/compliance/regulatory/offering-ffiec-us)  
...
- Publicación especial 800-210 de NIST: Guía general de Access Control para sistemas en la nube  
...
- [Ley de privacidad del consumidor de California (CCPA)](/compliance/regulatory/offering-ccpa)  
...
- Ley de notificación de infracciones de seguridad de la base de datos de Louisiana (Ley No. 382)  
...
- Ley de protección de crédito al consumidor de Utah  
...
#### <a name="asia-pacific-countries"></a>países Asia-Pacific
...
- [Marco de ciberseguridad del Banco de la India](/compliance/regulatory/offering-rbi-irdai-india)  
...
- Ley Japonesa de Protección de Información Personal (Ley No. 57 de 2003)  
...
- [Singapur: estándar de seguridad en la nube de varios niveles (MTCS)](/compliance/regulatory/offering-mtcs-singapore)  
...
- Taiwán- Regulaciones que rigen las normas para el sistema de información y la gestión de la seguridad de las instituciones de pago electrónico  
- Ley de Protección de Datos Personales de Taiwán (PDPA)  
- PDPA de Tailandia  
- Ley de Secretos Comerciales de la República de China  
- Ley de la República de Uzbekistán sobre datos personales  
...
- Albania - La Ley de Protección de Datos Personales No. 9887
...
- [Bélgica NBB dic 2015](/compliance/regulatory/offering-nbb-fsma-belgium)  
...
- Checo - Acto No. 110/2019 Coll. on Personal Data Processing - 2019  
- Checo - Sobre ciberseguridad y cambio de actos relacionados (Ley sobre ciberseguridad) - Ley No. 181  
...
- [Catálogo de controles de cumplimiento de informática en la nube de Alemania (C5)](/compliance/regulatory/offering-c5-germany)  
...
- [Argentina - Ley 25.326 de protección de datos personales](/compliance/regulatory/offering-pdpa-argentina)  
- Brasil - Ley No del Código de Protección del Consumidor. 8078 (Office 365)
- Brasil - Ley General de Protección de Datos (LGPD)  
- Colombia - Decreto No. 1377/2013  
