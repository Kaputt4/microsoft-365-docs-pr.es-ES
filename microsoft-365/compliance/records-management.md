...
- **Etiquetar contenido como un registro**. Cree y publique las etiquetas de retención que declaran el contenido como un [registro](records.md) que puede ser aplicado por los usuarios finales o [aplicado automáticamente](labels.md#applying-a-retention-label-automatically-based-on-conditions) mediante la identificación de información confidencial, palabras clave o tipos de contenido
