...
3. **[Agregar datos a un conjunto de revisión.](add-data-to-review-set.md)** Una vez que haya configurado y comprobado que una búsqueda devuelve los datos deseados, el siguiente paso es agregar los resultados de la búsqueda a un conjunto de revisión. Al agregar datos a un conjunto de revisión, los elementos se copian de su ubicación original a una ubicación segura de Azure Storage. Los datos se vuelve a indexar para optimizarlos para realizar búsquedas exhaustivas y rápidas al revisar y analizar elementos del conjunto de revisión. Además, también puede agregar datos que no son de [Office 365 a un conjunto de revisión.](load-non-office-365-data-into-a-review-set.md)
