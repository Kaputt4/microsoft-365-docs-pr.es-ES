...
Use el conector TeleMessage en el Centro de cumplimiento de Microsoft 365 para importar y archivar datos DE SMS y MMS desde la red móvil de Rogers. Después de configurar y configurar un [conector de Rogers Network Archiver](https://www.telemessage.com/mobile-archiver/network-archiver/rogers/), se conecta a la red móvil de Rogers de su organización e importa datos SMS y MMS a buzones de Microsoft 365.

Una vez que los datos de la red móvil de Rogers se almacenan en buzones de usuario, puede aplicar Microsoft 365 características de cumplimiento, como la suspensión por juicio, la búsqueda de contenido y las directivas de retención de Microsoft 365 a los datos. Por ejemplo, puede buscar mensajes SMS y MMS desde la red móvil de Rogers mediante la búsqueda de contenido o una búsqueda asociada a un caso de eDiscovery principal. El uso de un conector de Rogers Network Archiver para importar y archivar datos en Microsoft 365 puede ayudar a su organización a cumplir las normas de gobernanza corporativa y las directivas reglamentarias.
...
3. El conector de Rogers Network Archiver que se crea en el Centro de cumplimiento de Microsoft 365 se conecta al sitio de TeleMessage todos los días y transfiere los mensajes de correo electrónico de las 24 horas anteriores a un área de Azure Storage segura en la nube de Microsoft.
