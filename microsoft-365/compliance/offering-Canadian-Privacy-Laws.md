...
ms.locfileid: "39622544"
---
# <a name="compliance-offering-canadian-privacy-laws"></a>Oferta de cumplimiento: Leyes de privacidad de Canadá
...
Por lo tanto, la privacidad es una responsabilidad compartida entre Microsoft, como proveedor de servicios en la nube y el cliente que usa los servicios en la nube. En un nivel alto, esto significa que los clientes deben asegurarse de que sus soluciones implementadas en entornos de Microsoft aborden los 10 principios codificados en la ley PIPEDA. Por ejemplo, obtener el consentimiento de los usuarios para recopilar sus datos y protegerlos con medidas de seguridad adecuadas.
...
¿Necesita el documento de información general de esta oferta? Descargue el [PDF](https://download.microsoft.com/download/1/9/3/19390188-F5C7-4819-80BB-30B84304E499/CanadianPrivacyLaws-Compliance.pdf).
