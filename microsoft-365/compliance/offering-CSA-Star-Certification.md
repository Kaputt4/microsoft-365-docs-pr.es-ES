...
---
# <a name="compliance-offering-cloud-security-alliance-csa-star-certification"></a>Oferta de cumplimiento: Certificación Cloud Security Alliance (CSA) STAR
...
Obtenga más información sobre las ventajas de la certificación CSA STAR en la nube de Microsoft: [Descargar el documento de visión general de la certificación de CSA STAR](https://aka.ms/csastar-certification-backgrounder)
...
- [Certificación CSA STAR: Azure, Cloud App Security, Flow, Genomics, Graph, Health Bot, Intune, OMS Service Map, PowerApps, Power BI y Stream](https://servicetrust.microsoft.com/Documents/ComplianceReports?command=Download&downloadType=Document&downloadId=6d07d7e3-da62-4153-a91c-14d259dac9f1&docTab=4ce99610-c9c0-11e7-8c2c-f908a777fa4d_ISO_Reports)
...
Puede descargar la [Certificación CSA STAR](https://aka.ms/csastar-certification) para Azure, que también cubre Intune y Power BI, desde el Registro de CSA.

**¿Qué nivel de madurez lograron los servicios en la nube de Microsoft?**

Azure, Cloud App Security, Intune y Power BI lograron la categoría "Oro", que es el mayor reconocimiento posible en la evaluación de la Capacidad de Madurez.
...
¿Necesita el documento de información general de esta oferta? Descargue el [PDF](https://download.microsoft.com/download/C/3/6/C36C6DBB-AF39-44A2-B6C6-50CC6E4991D7/CSA-STAR-Certification-Compliance.pdf).
