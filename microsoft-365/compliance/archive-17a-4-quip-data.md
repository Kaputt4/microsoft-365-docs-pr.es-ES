...
1. Vaya a y, a <https://compliance.microsoft.com> continuación, haga clic en **Conectores** >  de datos **Quip DataParser**.

2. En la página **Quip DataParser product description (Descripción del producto de Quip DataParser** ), haga clic en **Agregar conector**.
...
2. Haga clic en la pestaña **Conectores** y, a continuación, seleccione el conector Quip DataParser que creó para mostrar la página de control flotante, que contiene las propiedades y la información sobre el conector.
