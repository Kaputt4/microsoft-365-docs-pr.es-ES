---
title: Configuración de un conector para archivar datos quip en Microsoft 365
...
En la información general siguiente se explica el proceso de uso de un conector de datos para archivar datos quip en Microsoft 365.

![Flujo de trabajo de archivado de datos quip de 17a-4.](../media/QuipDataParserConnectorWorkflow.png)

1. Su organización funciona con 17a-4 para configurar y configurar Quip DataParser.

2. DataParser recopila periódicamente los elementos quip. DataParser también convierte el contenido de un mensaje en un formato de mensaje de correo electrónico.

3. El conector Quip DataParser que se crea en el portal de cumplimiento Microsoft Purview se conecta a DataParser y transfiere los mensajes a una ubicación segura de Azure Storage en la nube de Microsoft.
...
1. Vaya a y, a <https://compliance.microsoft.com> continuación, seleccione **Conectores** >  de datos **Quip DataParser**.

2. En la página **Quip DataParser product description (Descripción del producto de Quip DataParser** ), seleccione **Agregar conector**.
...
5. Inicie sesión en su cuenta 17a-4 y complete los pasos del Asistente para conexión de Quip DataParser.

## <a name="step-2-configure-the-quip-dataparser-connector"></a>Paso 2: Configuración del conector Quip DataParser

Trabaje con compatibilidad con 17a-4 para configurar el conector Quip DataParser.

## <a name="step-3-map-users"></a>Paso 3: Asignar usuarios

El conector Quip DataParser asignará automáticamente los usuarios a sus direcciones de correo electrónico de Microsoft 365 antes de importar datos a Microsoft 365.
...
2. Seleccione la pestaña **Conectores** y, a continuación, seleccione el conector Quip DataParser que creó para mostrar la página de control flotante, que contiene las propiedades y la información sobre el conector.
