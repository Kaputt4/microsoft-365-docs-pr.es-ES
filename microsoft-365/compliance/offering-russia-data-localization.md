...
Microsoft invita a los clientes a considerar la suscripción a Microsoft Online Services (Microsoft Azure, Microsoft 365, Dynamics 365 y la plataforma de energía) a través de un socio de Microsoft Cloud Solution Provider (CSP). Consulte esta [lista de asociados de CSP](https://pinpoint.microsoft.com/search?type=services&campaign=691) para obtener más información.
