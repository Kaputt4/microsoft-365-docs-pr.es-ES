...
Use un conector TeleMessage en el Centro de cumplimiento de Microsoft 365 para importar y archivar SMS, MMS, llamadas de voz y registros de llamadas desde teléfonos móviles Android. Después de configurar y configurar un conector, se conecta a la cuenta TeleMessage de su organización una vez al día e importa la comunicación móvil de los empleados mediante el Archivador de Android de TeleMessage a los buzones de Microsoft 365.

Después de almacenar los datos de teléfonos móviles Android en buzones de usuario, puede aplicar características de cumplimiento de Microsoft 365, como retención por juicio, búsqueda de contenido y directivas de retención de Microsoft 365 a los datos del Archivador de Android. Por ejemplo, puede buscar en la comunicación móvil del Archiver de Android mediante la búsqueda de contenido o asociar el buzón que contiene los datos del conector archiver de Android con un administrador en un caso de eDiscovery avanzado. El uso de un conector archiver de Android para importar y archivar datos en Microsoft 365 puede ayudar a su organización a cumplir con las directivas gubernamentales y reglamentarias.
...
1. Su organización funciona con TeleMessage para configurar un conector de Archivador de Android. Para obtener más información, [vea Archivador de Android.](https://www.telemessage.com/office365-activation-for-android-archiver/)

2. Una vez cada 24 horas, los sms, MMS, las llamadas de voz y los registros de llamadas de los teléfonos móviles Android de la organización se copian en el sitio de TeleMessage.
...
1. Vaya a [https://compliance.microsoft.com](https://compliance.microsoft.com) y haga clic en **Conectores de datos** del  >  **Archivador de Android.**

2. En la página **de descripción del producto Archiver** de Android, haga clic en Agregar **conector.**
