...
ms.locfileid: "63327397"
---
# <a name="set-up-a-connector-to-archive-telus-network-data"></a>Configurar un conector para archivar datos de red TELUS

Use el conector de TeleMessage en el Centro de cumplimiento de Microsoft 365 para importar y archivar datos del Servicio de mensajería corta (SMS) de la red TELUS de su organización. Después de configurar y configurar un conector, se conecta a la red TELUS de la organización una vez al día e importa datos SMS a buzones de correo en Microsoft 365.

Una vez que los mensajes SMS se almacenan en buzones de usuario, puede aplicar Microsoft 365 características de cumplimiento como retención por juicio, búsqueda de contenido y directivas de retención Microsoft 365 a los datos TELUS. Por ejemplo, puede buscar mensajes SMS telus mediante búsqueda de contenido o asociar el buzón que contiene los datos telus con un custodio en un Advanced eDiscovery caso. El uso de un conector de red TELUS para importar y archivar datos en Microsoft 365 puede ayudar a su organización a cumplir con las directivas gubernamentales y reglamentarias.
...
- Registre todos los usuarios que requieran el archivado de la red DE SMS telus en la cuenta de TeleMessage. Al registrar usuarios, asegúrese de usar la misma dirección de correo electrónico que se usa para su cuenta Microsoft 365 usuario.
...
1. Vaya a [https://compliance.microsoft.com](https://compliance.microsoft.com/) y, a continuación, **haga clic en Conectores** **de datosTELUS** >  Network.
