---
title: Configurar la auditoría básica en Microsoft 365
f1.keywords:
- NOCSH
ms.author: markjjo
author: markjjo
...
Para obtener más información, [vea Auditoría básica en Microsoft 365](auditing-solutions-overview.md#basic-auditing).
...
Las licencias para la auditoría básica requieren la suscripción de la organización adecuada que proporciona acceso a la herramienta de búsqueda de registros de auditoría y a las licencias por usuario necesarias para registrar y conservar registros de auditoría.
...
Para obtener una lista de los requisitos de suscripción y licencias para la auditoría básica, vea [Auditing solutions in Microsoft 365](auditing-solutions-overview.md#licensing-requirements).
