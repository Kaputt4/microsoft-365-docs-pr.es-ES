...
1. Vaya a [https://compliance.microsoft.com](https://compliance.microsoft.com/) y, a continuación, haga clic en Pivot **Data Connectors**  >  .
...
2. Haga clic en la pestaña **conectores** y, a continuación, seleccione el conector **Pivot** para mostrar la página de flotante. Esta página contiene las propiedades y la información sobre el conector.
