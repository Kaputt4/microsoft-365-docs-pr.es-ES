...
También puede crear un nuevo grupo de roles que se alinee con las necesidades de su organización. Por ejemplo, es posible que desee que un grupo de investigadores de derrames de datos de la organización obtenga acceso y colabore en todos los casos de derrame de datos. Para ello, puede crear un grupo de funciones "investigación de derramamiento de datos", asignar los roles apropiados (exportar, descifrar RMS, revisar, vista previa, búsqueda de cumplimiento y administración de casos), agregar los investigadores del derrame de datos al grupo de roles y, a continuación, agregar el grupo de roles como miembro del caso de la exhibición de documentos electrónicos de datos. Para obtener instrucciones detalladas sobre cómo hacerlo, consulte [configurar límites de cumplimiento para investigaciones de eDiscovery en Office 365](tagging-and-assessment-in-advanced-ediscovery.md) . 
