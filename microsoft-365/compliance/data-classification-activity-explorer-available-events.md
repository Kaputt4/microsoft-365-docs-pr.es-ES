...
Este evento se genera cada vez que se etiqueta un documento sin etiquetar o se envía un correo electrónico con una etiqueta. 
...
|Escritorio y web de Power BI        | no| accesible en los registros de auditoría de Microsoft 365         |
|Microsoft Cloud App Security (MCAS)         |no|         |

## <a name="sensitivity-label-changed"></a>Etiqueta de confidencialidad modificada

Este evento se genera cada vez que se actualiza una etiqueta en el documento o el correo electrónico.
...
- Se captura en el punto de guardar en aplicaciones nativas de Office y aplicaciones web. 
...
- Las acciones de actualización y degradación de etiquetas también se pueden supervisar a través del campo y filtro *tipo de evento Label.* El *texto* de justificación también se captura excepto para SharePoint Online y OneDrive.
- El etiquetado de confidencialidad realizado en aplicaciones nativas de Office en Outlook recopila la última acción que se generó antes de las acciones de envío de correo electrónico/guardar archivos. Por ejemplo, si el usuario cambia de etiqueta en un correo electrónico varias veces antes de enviarlo, la última etiqueta que se encuentra en el correo electrónico cuando se envía se captura en el registro de auditoría y, a continuación, se notifica en el explorador de actividades. 
...
- Se captura en el momento de la aparición en complementos de Azure Information Protection. 
- El etiquetado de confidencialidad, con la etiqueta MIP nativa de Office, en Outlook recopila el último evento de etiquetado que se generó antes de las acciones de envío de correo electrónico/guardar archivos.
...
Este evento se genera cada vez que se abre un documento etiquetado o protegido.
...
## <a name="sensitivity-label-files-discovered"></a>Archivos de etiqueta de confidencialidad detectados
...
|Servicio RMS         |no aplicable         |
|Escritorio y web de Power BI         |no aplicable         |
|MCAS     |no aplicable         |         |
...
|MIP SDK         |no         |
|Servicio RMS         |no      |
|Escritorio y web de Power BI         |no         |
|MCAS     |no         |         |


## <a name="sensitivity-label-file-removed"></a>Archivo de etiqueta de confidencialidad quitado
...
### <a name="sensitivity-label-protection-applied"></a>Protección de etiquetas de confidencialidad aplicada
...
## <a name="sensitivity-label-protection-changed"></a>Se cambió la protección de etiquetas de confidencialidad
...
## <a name="sensitivity-label-protection-removed"></a>Se quitó la protección de etiquetas de confidencialidad
...
## <a name="sensitivity-label-dlp-policy-matched"></a>Directiva DLP de etiqueta de confidencialidad coincidente

Este evento se genera cada vez que se coincide con una directiva DLP.
...
Los eventos para dispositivos con Windows 10 (DLP de punto de conexión) son:
...
- Se captura en el momento de guardar.
