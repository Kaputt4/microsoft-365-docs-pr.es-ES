...
6. En **Aplicar esta regla si**, seleccione las condiciones en las que se debe quitar el cifrado de los mensajes. Agregar **El remitente se encuentra dentro** de la \> **organización** _o_ El destinatario se **encuentra dentro** de la \> **organización**.
...
[Reglas de flujo de correo (reglas de transporte) en Exchange Online Protection](../security/defender-365-security/mail-flow-rules-transport-rules-0.md)
