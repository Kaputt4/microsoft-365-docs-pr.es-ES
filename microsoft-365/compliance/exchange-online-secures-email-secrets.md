...
Microsoft usa [el Administrador de claves distribuidas](office-365-bitlocker-and-distributed-key-manager-for-encryption.md) para cifrar sus secretos en centros de datos de Exchange Online. Por ejemplo:
...
- Clave de cliente. Si usa cifrado [de servicio con clave de](customer-key-overview.md)cliente, usará Azure Key [Vault](https://docs.microsoft.com/azure/key-vault/key-vault-whatis) para proteger sus secretos.
...
[Garantía de servicio en el Centro de &amp; cumplimiento de seguridad](https://go.microsoft.com/fwlink/?linkid=874645)
