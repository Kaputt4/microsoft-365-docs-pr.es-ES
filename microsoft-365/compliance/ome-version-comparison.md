...
|*Plantilla de administración de derechos*       |   N/A      |Opción No reenviar y plantillas personalizadas|Opción No reenviar, opción de solo cifrado y plantillas personalizadas|
...
|*Experiencia para destinatarios externos*|Los destinatarios reciben un mensaje HTML, que descargan y abren en un explorador web o una aplicación móvil|N/A|Experiencia en línea nativa para Microsoft 365 destinatarios. Todos los demás destinatarios pueden leer mensajes desde el portal de OME (no se requiere descarga ni aplicación).|
