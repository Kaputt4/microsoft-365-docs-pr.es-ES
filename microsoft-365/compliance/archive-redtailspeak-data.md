...
1. Su organización trabaja con Redtail Speak para configurar y configurar una puerta de enlace SMTP en la que los mensajes se reenván de Redtail Speak al servidor SFTP de su organización a diario.
...
3. El conector Redtail Speak que cree en el Centro de cumplimiento de Microsoft 365 se conecta al sitio de Globanet Merge1 todos los días y transfiere los mensajes a una ubicación segura de Azure Storage en la nube de Microsoft.
...
2. En la **página de descripción del producto Redtail Speak,** seleccione Agregar nuevo **conector.**
...
## <a name="step-2-configure-the-redtail-speak-connector-on-the-globanet-merge1-site"></a>Paso 2: Configurar el conector Redtail Speak en el sitio de Globanet Merge1

El segundo paso es configurar el conector Redtail Speak en el sitio Merge1. Para obtener información acerca de cómo configurar el conector Redtail Speak, vea la Guía del usuario de [Merge1 Third-Party Connectors](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20Redtail%20Speak%20User%20Guide%20.pdf).

Después de seleccionar Guardar &  **finalizar,** se muestra la página Asignación de usuarios en el Asistente para conectores en el Centro de cumplimiento de Microsoft 365.
...
2. Seleccione **Siguiente,** revise la configuración  y vaya a la página Conectores de datos para ver el progreso del proceso de importación para el nuevo conector.
...
1. Vaya a [https://compliance.microsoft.com](https://compliance.microsoft.com/) conectores de **datos y selecciónelos** en el panel de navegación izquierdo.

2. Seleccione la **pestaña Conectores** y, a continuación, seleccione el **conector Redtail Speak** para mostrar la página desplegable. En esta página se muestran las propiedades y la información sobre el conector.
