...
>[!NOTE]
>Las directivas que usan clasificadores inspeccionarán y evaluarán los mensajes con un número de palabras seis o superior. Los mensajes que contienen menos de seis palabras no se evalúan en las directivas que usan clasificadores. Para identificar y realizar acciones en mensajes más cortos que contienen contenido inadecuado, se recomienda incluir un diccionario de palabras clave personalizado para la supervisión de directivas de cumplimiento de este tipo de contenido.
