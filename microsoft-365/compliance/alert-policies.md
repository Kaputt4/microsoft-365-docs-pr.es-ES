...
- **Etiquetas.** Use este filtro para mostrar alertas de una o varias etiquetas de usuario. Las etiquetas se reflejan en función de buzones etiquetados o usuarios que aparecen en las alertas. Vea [Etiquetas de usuario en ATP de Office 356](../security/office-365-security/user-tags.md) para obtener más información.
