...
- **Efectividad de** la directiva: el porcentaje determinado por el total de alertas confirmadas dividido por el total de acciones realizadas en las alertas (que es la suma de las alertas que se confirmaron o descartaron durante el año pasado).
