...
Las directivas de administración de riesgos internos determinan qué usuarios deben estar dentro del ámbito de búsqueda y qué tipos de indicadores de riesgo están configurados para las alertas. Puede crear rápidamente una directiva de seguridad que se aplique a todos los usuarios de su organización o definir usuarios o grupos individuales para la administración en una directiva. Las directivas son compatibles con las prioridades de contenido para centrar las condiciones de las directivas en varios o determinados Microsoft Teams, sitios de SharePoint, tipos de confidencialidad de datos y etiquetas de datos. Mediante el uso de plantillas, puede seleccionar indicadores de riesgo específicos y personalizar los umbrales de los eventos para los indicadores de directivas, personalizando eficazmente las puntuaciones de riesgo y el nivel y la frecuencia de las alertas. Con directivas rápidas, incluso puede crear fugas de datos o robo de datos si abandona las directivas de usuario que definen automáticamente las condiciones de directiva en función de los resultados de los exámenes de análisis más recientes. Además, los refuerzos de puntuación de riesgo y las detecciones de anomalías ayudan a identificar la actividad de usuario de riesgo que es de mayor importancia o más inusual. Las ventanas de la directiva permiten definir el marco temporal para aplicar la directiva a las actividades de alerta y se usan para determinar la duración de la directiva una vez activada.
...
- **Alertas confirmadas**: el número total de alertas que dieron lugar a casos de la directiva en los últimos 365 días.
...
Para algunas organizaciones, empezar a trabajar con una directiva inicial puede ser un desafío. Si no está familiarizado con la administración de riesgos internos y usa las acciones recomendadas para empezar, puede usar una directiva rápida para acelerar la configuración de una directiva general de *pérdidas de datos* o *robo de datos.* La configuración rápida de la directiva se rellena automáticamente en función de los resultados del examen de análisis más reciente de su organización. Por ejemplo, si el examen detectase posibles actividades de fuga de datos, la directiva rápida incluiría los indicadores usados para detectar esas actividades. Solo tendrá que revisar la configuración de directiva rápida y configurar la directiva con una sola selección. Si necesita personalizar una directiva rápida, puede cambiar las condiciones durante la configuración inicial o después de que se haya creado la directiva. Además, puede mantenerse al día con los resultados de detección de una directiva rápida mediante la configuración de notificaciones por correo electrónico cada vez que tenga una advertencia de directiva o cada vez que la directiva genere una alerta de gravedad alta.
...
Al usar esta plantilla, también debe configurar un conector de RR. HH. de Microsoft para importar periódicamente señales del sistema relacionadas con las notificaciones de mejora del rendimiento, el estado de revisión de rendimiento deficiente o la información de cambios de nivel de trabajo para los usuarios de su organización. Consulte el artículo [Importación de datos con el conector de RR. HH](import-hr-data.md) . para obtener instrucciones paso a paso para configurar el conector de RR. HH. de Microsoft para su organización.
...
| **Filtraciones de datos por parte de usuarios inconformes** | Indicadores de mejora del rendimiento, bajo rendimiento o cambio de nivel de trabajo del conector de recursos humanos | Conector de RR. HH. de Microsoft configurado para indicadores de descontento |
...
- **Colección**: estas señales de categoría se centran en las actividades de descarga de los usuarios de la directiva dentro del ámbito de búsqueda. Algunas actividades de ejemplo de esta categoría serían descargar archivos de sitios de SharePoint o mover archivos a una carpeta comprimida.
...
- *Recomendaciones*: hay algunos problemas con la directiva que pueden impedir que la directiva funcione según lo previsto.
