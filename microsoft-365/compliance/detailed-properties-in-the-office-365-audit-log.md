...
|Target|El usuario en el que se realizó la acción (identificada en **la propiedad Operation).** Por ejemplo, si se agrega un usuario invitado a SharePoint un equipo de Microsoft, ese usuario se enumeraría en esta propiedad.|Azure Active Directory|
