...
description: Los administradores pueden configurar un conector para importar y archivar datos Jive de Veritas en Microsoft 365. Este conector le permite archivar datos de terceros en Microsoft 365 para que pueda usar características de cumplimiento como la retención legal, la búsqueda de contenido y las directivas de retención para administrar los datos de terceros de la organización.
...
1. Vaya a [https://compliance.microsoft.com](https://compliance.microsoft.com/) y, a continuación, **haga clic en Conectores de** **datosJive** > .
...
El segundo paso es configurar el conector Jive en el sitio Merge1. Para obtener información sobre cómo configurar el conector Jive, consulte [Merge1 Third-Party Connectors User Guide](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20Jive%20User%20Guide.pdf).
