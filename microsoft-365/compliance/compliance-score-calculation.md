...
El Administrador de cumplimiento identifica automáticamente la configuración del entorno Microsoft 365 que ayudan a determinar cuándo determinadas configuraciones cumplen los requisitos de implementación de la acción de mejora. El Administrador de cumplimiento detecta las señales de otras soluciones de cumplimiento que puede haber implementado, como el gobierno de la información, la protección de la información, el cumplimiento de comunicaciones y la administración de riesgos de información confidencial, y también aprovecha la supervisión de puntuación segura de Microsoft de las acciones de mejora complementarias.

El estado de la acción se actualiza en el panel en las 24 horas siguientes a la realización de un cambio. Una vez que sigas una recomendación para implementar un control, normalmente verás el estado del control actualizado al día siguiente.
