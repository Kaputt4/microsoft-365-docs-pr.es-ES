...
Para obtener los detalles del proceso de diseño, vea [Diseñar un sitio de grupo SharePoint Online aislado](/security/office-365-security/design-an-isolated-sharepoint-online-team-site.md).
...
Para obtener los pasos detallados, vea la **fase 1** de [Implementar un sitio de grupo aislado de SharePoint Online](/security/office-365-security/design-an-isolated-sharepoint-online-team-site.md).
...
Para obtener los pasos detallados, vea [Implementar un sitio de grupo aislado de SharePoint Online](/security/office-365-security/design-an-isolated-sharepoint-online-team-site.md).
