...
4. Registrar la aplicación. En URI de redireccionamiento, seleccione Web en la lista desplegable tipo de aplicación y, a continuación, escriba <https://portal.azure.com> en el cuadro del URI.
...
2. En la página **conectores de datos** , en **páginas empresariales de Facebook**, haga clic en **Ver**.
