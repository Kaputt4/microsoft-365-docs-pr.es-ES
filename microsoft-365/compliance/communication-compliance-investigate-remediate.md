...
Los detalles del mensaje se pueden exportar o descargar si necesita archivar los mensajes en una solución de almacenamiento independiente. Al seleccionar el control **Descargar,** se agregan automáticamente los mensajes seleccionados a un archivo . Archivo ZIP que se puede guardar en el almacenamiento fuera de Microsoft 365.
