...
- Microsoft Online Services: esta cuenta de facturación se crea cuando te registras para obtener una suscripción a Microsoft 365 directamente.
...
La <a href="https://go.microsoft.com/fwlink/p/?linkid=2084771" target="_blank">página Cuentas de</a> facturación proporciona una vista de sus cuentas comerciales con Microsoft. De forma predeterminada, la organización tiene al menos una cuenta de facturación asociada a un contrato aceptado en el momento de la compra directa o mediante un acuerdo de licencias por volumen.
...
> [!NOTE]
> Si necesita cambiar el **nombre** o la dirección de venta, pero no ve un vínculo Editar, debe ponerse en contacto con el soporte técnico [para](https://docs.microsoft.com/microsoft-365/admin/contact-support-for-business-products) cambiarlo.  Las solicitudes para un cambio **de nombre** vendido requerirán una comprobación de crédito. Complete [este formulario](https://www.microsoft.com/download/details.aspx?id=102732)y esté listo para compartir uno de los siguientes documentos con Microsoft cuando se pondrá en contacto con el soporte técnico:
>
