...
## <a name="manage-payment-methods"></a>Administrar los métodos de pago
...
Para obtener más información sobre facturas, consulte [Descripción de la factura de su acuerdo de cliente de Microsoft](https://docs.microsoft.com/microsoft-store/billing-understand-your-invoice-msfb).

## <a name="cancel-subscription"></a>Cancelar la suscripción
Los clientes pueden cancelar la aplicación de software como servicio desde la página de la aplicación. 
