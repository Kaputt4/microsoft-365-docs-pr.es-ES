...
1. Inicie sesión en https://admin.microsoft.com como administrador global o de SharePoint. (Si ve un mensaje que indica que no tiene permiso para obtener acceso a la página, no tiene permisos de administrador de Microsoft 365 en su organización).
...
Para obtener información sobre cómo establecer los límites de almacenamiento de la colección de sitios, vea [Manage site Collection Storage limits](https://docs.microsoft.com/sharepoint/manage-site-collection-storage-limits).
  
## <a name="add-storage-to-your-subscription"></a>Agregar almacenamiento a su suscripción
...
5. Escriba el número de licencias de usuario que necesita y, si se muestra, elija una suscripción base. Seleccione **Desproteger ahora**.
