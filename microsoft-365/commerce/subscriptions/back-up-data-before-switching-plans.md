...
Si un usuario cambiará a otra suscripción que tenga menos servicios relacionados con datos o un usuario abandona la organización, se puede descargar una copia de sus datos almacenados en Microsoft 365 antes de cambiar a la nueva suscripción.
...
Sin embargo, siempre y cuando la nueva suscripción esté dentro de la misma organización de la que se cambia, los usuarios podrán acceder al sitio del equipo de SharePoint. Pueden ver y actualizar cuadernos, documentos, tareas y calendarios mediante la dirección URL directa al sitio del equipo.
