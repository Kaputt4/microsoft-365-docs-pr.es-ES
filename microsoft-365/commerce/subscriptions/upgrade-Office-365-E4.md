...
ms.locfileid: "50917551"
---
# <a name="upgrade-from-an-office-365-e4-subscription"></a>Actualización desde una suscripción a Office 365 E4

En este artículo se describe el proceso de actualización de office 365 E4 a una suscripción nueva. Para obtener información sobre las opciones disponibles al actualizar desde Office 365 E4, vea Información importante para los clientes [de Office 365 E4](important-information-e4.md).

> [!IMPORTANT]
> Este artículo se aplica a las suscripciones de Office 365 E4 que se compraron directamente a Microsoft mediante tarjeta de crédito o factura. Si la suscripción se compró de otra forma, como a través de un partner o a través del Centro de servicios de licencias por volumen, póngase en contacto con el representante o socio de su cuenta microsoft para ayudarle a actualizar los planes.
...
- Cancele la suscripción original de Office 365 E4.
...
5. En la **página Carro,** compruebe que todo es correcto. Seleccione si desea pagar mensual o anualmente y compruebe el número de licencias en **Cantidad**.
    > [!NOTE]
    > También se enumeran todas las suscripciones de complementos asociadas con su suscripción a Office 365 E4, como Almacenamiento de archivos adicional de Office 365. Sin embargo, si tienes suscripciones de complementos que se incluyen en la suscripción a la que estás actualizando, las quitaremos.
...
Si aún no tiene una suscripción nueva, puede comprar otra suscripción de [Microsoft 365 para empresas](../try-or-buy-microsoft-365.md).
...
> [!TIP]
> Si tiene muchos usuarios, puede usar PowerShell de [Office 365 para](../../enterprise/assign-licenses-to-user-accounts-with-microsoft-365-powershell.md)asignar licencias de usuario en masa.

### <a name="step-4-cancel-the-office-365-e4-subscription"></a>Paso 4: Cancelar la suscripción a Office 365 E4

Después de reasignar todos los usuarios a la nueva suscripción, cancele la suscripción a [Office 365 E4](cancel-your-subscription.md).
