...
Si tu plan no es apto para actualizar los planes automáticamente, es posible que puedas cambiar los [planes manualmente,](change-plans-manually.md)en su lugar. También puede llamar [al soporte técnico](../../admin/contact-support-for-business-products.md) para obtener ayuda.
