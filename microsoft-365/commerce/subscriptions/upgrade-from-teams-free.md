...
ms.locfileid: "50924331"
---
# <a name="upgrade-from-microsoft-teams-free-to-microsoft-365-for-business"></a>Actualización de Microsoft Teams Gratuito a Microsoft 365 para empresas

> [!IMPORTANT]
> Este documento solo se aplica a las organizaciones gratuitas de Microsoft Teams en india.

## <a name="before-you-begin"></a>Antes de empezar

Debe ser administrador gratuito de Microsoft Teams para actualizar una organización gratuita de Microsoft Teams. Eres automáticamente un administrador si creaste la organización gratuita de Microsoft Teams.

## <a name="step-1-get-your-work-or-school-account-id"></a>Paso 1: Obtener el identificador de la cuenta de trabajo o escuela

Para comenzar el proceso, obtenga el identificador de cuenta de trabajo o escuela subyacente. Este identificador de cuenta es diferente de la dirección de correo electrónico que usa para tener acceso a Microsoft Teams Free.
...
Después de tener la cuenta de trabajo o escuela subyacente para su organización gratuita de Microsoft Teams, debe restablecer la contraseña de la cuenta.
...
Usa la cuenta de trabajo o escuela subyacente que recuperaste y la nueva contraseña de administrador para comprar una nueva suscripción a Microsoft 365 para empresas.
...
2. Busca el producto de Microsoft 365 para empresas que quieras comprar.
    > [!IMPORTANT]
    > Asegúrese de elegir uno que incluya Microsoft Teams.
3. Complete la compra. Recuerda comprar suficientes licencias para todos los usuarios de tu organización gratuita de Microsoft Teams que quieras mover a Microsoft 365 para empresas.

## <a name="step-4-assign-new-licenses-to-users"></a>Paso 4: Asignar nuevas licencias a los usuarios

Ahora que tiene una nueva suscripción a Microsoft 365 para empresas, puede asignar licencias a los usuarios existentes en su organización gratuita de Microsoft Teams.
...
4. En el **panel Reemplazar productos existentes,** busque el producto de Microsoft 365 para empresas que compró y cambie la alternancia a **On**.
...
[Actualizar Microsoft Teams gratuitamente a la versión de suscripción](/microsoftteams/upgrade-freemium) (artículo)\
