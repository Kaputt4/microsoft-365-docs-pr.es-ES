...
3. En el cuadro **total de licencias** , escriba el número total de licencias que necesita para esta suscripción y, después, seleccione **Enviar cambio**. Por ejemplo, si tiene 100 licencias y necesita agregar 5 más, escriba 105. Si desea quitar 5 de ellos, escriba 95.
...
- Si paga con tarjeta de crédito o mediante cuenta bancaria, el cargo por la compra de nuevas licencias se mostrará en el método de pago elegido en 2 días.
- Si se le facturan los pagos, el cargo por la compra de nuevas licencias se mostrará en el extracto de facturación siguiente.
- Si compra nuevas licencias en mitad del período de facturación, es posible que aparezca un cargo parcial en el primer extracto de facturación. La cantidad pendiente se incluirá en el extracto de facturación siguiente.
