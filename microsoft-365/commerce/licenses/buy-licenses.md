...
Si prepagó la suscripción con una clave de producto, puede agregar más licencias mediante otra clave de producto, o agregando una tarjeta de crédito o débito, o una cuenta bancaria para cubrir el costo adicional de las nuevas licencias. Si su suscripción es de prepago, no puede quitar licencias.

## <a name="how-does-buying-or-removing-licenses-affect-my-billing-statements"></a>¿Cómo afecta la compra o eliminación de licencias a mis estados de facturación?
...
Si ha reducido el número de licencias de la suscripción porque alguien ha dejado la organización, es posible que desee quitar la cuenta de ese usuario. Para obtener más información, vea [Remove a former employee](../../admin/add-users/remove-former-employee.md).
