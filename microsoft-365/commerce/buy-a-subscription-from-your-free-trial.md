...
4. En la página siguiente, Compruebe la suscripción y seleccione **Desproteger**.

5. En la página siguiente, Compruebe la dirección **vendido a** , la información **facturada** y **los elementos en este orden**. Si necesita realizar cambios, seleccione **cambiar** junto a la sección correspondiente.

6. Cuando haya terminado, seleccione **Aceptar contrato & realizar pedido**.
...
3. Revise la información de precios y seleccione **siguiente**.

4. Especifique la información de pago y seleccione **realizar pedido**.

5. En la página Confirmación, seleccione **ir a**la Página principal de administración.
...
3. Especifique el número de licencias que necesita y elija si desea pagar por meses o por todo el año. Elija si desea asignar licencias automáticamente a todos los usuarios que actualmente no tienen licencia. A continuación, seleccione **Desproteger ahora**.

4. Se abrirá el carro. Si el carro desaparece de la pantalla, seleccione **carro** para volver a abrirlo, revise el pedido y, a continuación, seleccione **Desproteger**.

5. Revise la información de precios y seleccione **siguiente**.

6. Especifique la información de pago y seleccione **realizar pedido** \> **ir a la Página principal de administración**.
...
2. En la página de **suscripción** , seleccione **Agregar suscripciones**.
    ...
    Verá las suscripciones que están disponibles para su organización. Todas las suscripciones que ya haya comprado se identificarán como **en prueba** o **compra**.
  
3. Busca la suscripción que quieras comprar y, a continuación, selecciona **comprar ahora**.
  
4. Escriba el número de licencias de usuario que necesita, elija si desea pagar cada mes o por todo el año y, a continuación, seleccione **Agregar al carro**.

5. Se abrirá el carro. Si el carro desaparece de la pantalla, seleccione **carro** para volver a abrirlo, revise el pedido y, a continuación, seleccione **Desproteger**.

6. Revise la información de precios y seleccione **siguiente**.

7. Especifique la información de pago y seleccione **realizar pedido**.
