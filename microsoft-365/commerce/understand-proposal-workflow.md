...
El Contrato de cliente de Microsoft (MCA) permite a una organización comprar productos y servicios de Microsoft. Para obtener más información, vea [Contrato de cliente de Microsoft](https://www.microsoft.com/en-us/Licensing/how-to-buy/microsoft-customer-agreement).
...
Para obtener más información acerca de los roles de cuenta de facturación, vea [Comprender el acceso a cuentas de facturación.](manage-billing-accounts.md#understand-access-to-billing-accounts)
...
Para obtener más información sobre los IDs fiscales y cómo solicitar el estado de exención de impuestos, vea [Tax information](billing-and-payments/tax-information.md).
...
Para obtener información acerca de los perfiles de facturación, vea [Administrar perfiles de facturación.](billing-and-payments/manage-billing-profiles.md)
...
Las instrucciones de pago para dónde enviar cheque o transferencias bancarias se incluyen en la copia PDF de la factura. Para ver o descargar la factura, vea [Ver la factura o factura.](billing-and-payments/view-your-bill-or-invoice.md)
