...
ms.locfileid: "63321087"
---
# <a name="understand-the-proposal-workflow"></a>Comprender el flujo de trabajo de propuestas

Una propuesta es una oferta formal de Microsoft para que su organización compre productos y servicios de Microsoft. Trabaja directamente con un representante de Microsoft para determinar los productos, servicios y términos específicos de la propuesta.

Un representante de Microsoft redacta una propuesta que contiene los elementos que usted y su representante trataron. El representante le envía un correo electrónico que tiene un vínculo al sitio de propuesta. El sitio contiene la propuesta preparada específicamente para usted y su organización.
...
## <a name="prerequisites-for-buying-items-with-a-proposal"></a>Requisitos previos para comprar elementos con una propuesta

Para poder comprar elementos para una propuesta, debes tener una cuenta de facturación y un acuerdo con Microsoft.
...
El Contrato de cliente de Microsoft (MCA) permite a una organización comprar productos y servicios de Microsoft. Para obtener más información, consulte [Contrato de cliente de Microsoft](https://www.microsoft.com/en-us/Licensing/how-to-buy/microsoft-customer-agreement).

## <a name="permissions-needed-to-sign-an-agreement-or-pay-for-items"></a>Permisos necesarios para firmar un contrato o pagar por los elementos

Si no tienes un rol asignado en la cuenta de facturación, al ver la propuesta, se te asigna el rol de lector básico. Este rol le permite ver, pero no realizar ninguna acción, en la propuesta. Debes tener asignado el rol de colaborador de cuenta de facturación o propietario de la cuenta de facturación para poder firmar un contrato o comprar productos y servicios. El propietario de la cuenta de facturación puede asignarte este rol.

Para obtener más información acerca de los roles de cuenta de facturación, vea [Comprender el acceso a las cuentas de facturación](manage-billing-accounts.md#understand-access-to-billing-accounts).
...
- Ya son [administradores Azure Active Directory global de](/azure/active-directory/roles/permissions-reference#global-administrator) la organización
...
| Acuerdos existentes | Cualquier acuerdo que su organización ya tenga en marcha con Microsoft. Esto puede incluir, pero no se limita a, un Enterprise Agreement, el Contrato de servicios de & microsoft o el Contrato de cliente de Microsoft. |
...
| Términos complementarios | Modificaciones del MCA que contienen términos específicos de su organización. Para aceptar términos complementarios, debe usar DocuSign para registrar una firma electrónica. |
...
Si desea realizar cualquier cambio en la propuesta después de la revisión, póngase en contacto con su representante de Microsoft.
...
| Elementos de línea de propuesta | Esta sección contiene la cantidad, el precio unitario y el subtotal de todos los elementos incluidos en la propuesta. |
| Paso siguiente | Esta sección indica la acción necesaria que debe realizar. |

Para firmar un MCA, seleccione el botón en **Paso siguiente**. Si debe firmar términos complementarios, un vínculo le llevará al sitio DocuSign, donde sigue los pasos para firmar el documento.

Después de firmar los acuerdos necesarios o los términos complementarios, seleccione **Ir a la desprotección**.

## <a name="step-3-checkout"></a>Paso 3: Desprotección

La página de desprotección contiene las siguientes secciones:

### <a name="sold-to"></a>Vendido a

En esta sección se muestra la cuenta de facturación usada para la propuesta. Si necesita cambiar cualquier información, seleccione el **vínculo** Editar. También puede usar el vínculo **Editar** para agregar el identificador fiscal de su organización. El identificador de impuestos debe estar relacionado con el país enumerado en la **sección Vendido a** . Si tiene una exención fiscal, debe abrir un vale de soporte técnico para solicitar el estado de exención de impuestos.

Para obtener más información sobre los IDs fiscales y cómo solicitar el estado de exención de impuestos, consulte [Información fiscal](billing-and-payments/tax-information.md).

### <a name="billed-to"></a>Facturado a

En esta sección se muestra el perfil de facturación usado para determinar qué elementos se incluyen en la factura y cómo paga las facturas. Cada ciclo de facturación, recibe una factura independiente para cada perfil de facturación. Paga las facturas mediante cheque o transferencia bancaria, o el pago por adelantado de Azure. Si aún no tiene un perfil de facturación, su representante de Microsoft crea uno para usted. Durante la desprotección, puedes seleccionar un perfil de facturación diferente, si lo tienes, cambiar el nombre del perfil de facturación o agregar una OP. número. También puedes crear un nuevo perfil de facturación.

Para obtener información acerca de los perfiles de facturación, consulte [Administrar perfiles de facturación](billing-and-payments/manage-billing-profiles.md).
...
Después de des check-out y completar el pedido, se envía una factura inicial en un plazo de 24-48 horas. Después de eso, recibirá facturas alrededor del 5 de cada mes. La factura mensual contiene cargos del mes anterior. Si tienes créditos para tu cuenta, se descuentan de los créditos monetarios de tu perfil de facturación y se aplican al saldo de la factura. El saldo restante después de aplicar los créditos es el saldo pendiente. Tienes 30 días a partir de la fecha de facturación para pagar la factura.

Las instrucciones de pago para dónde enviar cheque o transferencias bancarias se incluyen en la copia PDF de la factura. Para ver o descargar la factura, vea [Ver la factura o la factura](billing-and-payments/view-your-bill-or-invoice.md).
