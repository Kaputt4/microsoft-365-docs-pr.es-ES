...
3. En la página **servicios de compra** , seleccione la suscripción de complemento que desea comprar.

4. Especifique el número de licencias que necesita y elija si desea pagar por meses o por todo el año. Elija si desea asignar licencias automáticamente a todos los usuarios que actualmente no tienen licencia. Si se muestra, seleccione una suscripción base.

5. Seleccione **Desproteger ahora**.

6. Revise la información de precios y, a continuación, seleccione **siguiente**.

7. Especifique la información de pago y seleccione **realizar pedido** \> **ir a la Página principal de administración**.
...
5. Especifique el número de licencias que necesita y elija si desea pagar por meses o por todo el año. Elija si desea asignar licencias automáticamente a todos los usuarios que actualmente no tienen licencia. Si se muestra, seleccione una suscripción base.

6. Seleccione **Desproteger ahora**.

7. Revise la información de precios y, a continuación, seleccione **siguiente**.

8. Especifique la información de pago y seleccione **realizar pedido** \> **ir a la Página principal de administración**.
...
4. Seleccione **cambiar la cantidad** del complemento que desea cambiar.
...
### <a name="update-a-standalone-add-on"></a>Actualizar un complemento independiente
...
3. Escriba el número de licencias que necesita en el cuadro y, a continuación, seleccione **Enviar**.
