---
title: Entender la factura de Office 365 para empresas
f1.keywords:
- NOCSH
ms.author: cmcatee
author: cmcatee-MSFT
...
Antes de ver su factura, es útil entender algunos conceptos principales de facturación.
  
### <a name="invoice-balance-vs-order-balance"></a>Saldo de factura frente saldo del pedido
...
### <a name="billing-frequency-vs-invoice-frequency"></a>Frecuencia de facturación frente a la frecuencia de facturas

 **Frecuencia de facturación** significa con qué frecuencia se le factura. Las suscripciones se facturan mensual o anualmente, en función de la opción seleccionada durante la compra de la suscripción. **Frecuencia de facturas** significa con qué frecuencia recibe una factura. Si eligió la facturación anual, solo recibirá una factura al año, a no ser que la actividad de la suscripción requiera un cargo o crédito.
...
3. Busque la suscripción que desea cambiar.
...
3. En la parte inferior del panel **cambiar detalles de pago** , escriba el número de pedido de compra y, a continuación, seleccione **Enviar**.
...
[Pagar la suscripción a Office 365 para empresas](pay-for-your-subscription.md)
