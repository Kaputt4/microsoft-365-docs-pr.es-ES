...
¿Es un nuevo cliente y todavía no tiene una cuenta con Microsoft? Siga estos pasos para crear una cuenta y registrarse para una suscripción de prueba gratuita de Microsoft 365 Business Standard, Microsoft 365 Empresa Premium o Aplicaciones de Microsoft 365 para empresas.

1. Vaya al sitio <a href="https://www.aka.ms/office365signup" target="_blank">productos de Microsoft 365</a>.
2. Seleccione el plan para el que desea registrarse, como **Microsoft 365 Business Standard,** desplácese hacia abajo por la página y seleccione Probar gratis **durante 1 mes**.
3. En la página siguiente, siga los pasos para configurar su cuenta.
4. El proceso de registro puede tardar varios minutos en completarse. Una vez completado, estará listo para iniciar el \' asistente de configuración de la suscripción. Para obtener más información acerca de cómo configurar la suscripción, vea [Pasos siguientes](#next-steps).
...
5. En la página siguiente, compruebe la suscripción y seleccione **Checkout**.
6. En la página siguiente, compruebe la dirección **Vendida** a, la información **facturada** y **Elementos en este orden**. Si necesita realizar cambios, seleccione **Cambiar** junto a la sección correspondiente.
...
Si ya tienes una suscripción a Microsoft 365 para empresas, puedes usar el Centro de administración de Microsoft 365 para probar una suscripción diferente.
...
2. En la **página Servicios de** compra, verá los planes que están disponibles para su organización. Elige el plan de Microsoft 365 que quieras probar.
...
4. Elija recibir un texto o una llamada, escriba su número de teléfono y, a continuación, elija **Text me** o **Call me**.
5. Escriba el código de comprobación y, a **continuación, seleccione Iniciar la prueba gratuita.**
6. En la **página Des check-out,** seleccione **Probar ahora**.
...
Si ya tiene una suscripción a Microsoft 365 para empresas, puede pasar por el Centro de administración de Microsoft 365 para comprar una suscripción diferente para su organización.

Al comprar otra suscripción a través del Centro de administración, la nueva suscripción se asocia a la misma organización (espacio de nombres de dominio) que la suscripción existente. Esto facilita el traslado de usuarios de la organización entre suscripciones o la asignación de una licencia para la suscripción adicional que necesiten.
...
5. Proporcione la información de pago y, a continuación, **seleccione Realizar pedido** Vaya a Inicio de \> **administración**.
...
[Vídeos de aprendizaje de Microsoft 365](https://support.office.com/article/6ab4bbcd-79cf-4000-a0bd-d42ce4d12816) para empresas (vídeos de aprendizaje)\
