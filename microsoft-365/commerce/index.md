...
| [Asignar licencias](https://docs.microsoft.com/office365/admin/manage/assign-licenses-to-users?view=o365-worldwide) | Asignar licencias a los usuarios de la organización. |
| [Cancelar la asignación de licencias](https://docs.microsoft.com/office365/admin/manage/remove-licenses-from-users?view=o365-worldwide) | Cancelar la asignación de licencias de los usuarios de la organización. |
...
| [Actualizar la suscripción](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/upgrade-to-different-plan) | Actualice la suscripción a un plan diferente. |
...
| [Administrar los métodos de pago](https://docs.microsoft.com/office365/Admin/subscriptions-and-billing/add-update-or-remove-credit-card-or-bank-account) | Agregar, editar o eliminar métodos de pago. |
...
| [Directiva 2 de servicios de pago y autenticación de cliente segura](/microsoft-365/commerce/billing-and-payments/psd2) | Información sobre la verificación de identidad para las compras realizadas en países del espacio económico europeo. |
