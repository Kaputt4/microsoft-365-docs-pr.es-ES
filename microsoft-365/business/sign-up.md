...
Para averiguar qué incluye Microsoft 365 Empresa Premium, vea un [breve vídeo](../business-video/what-is-microsoft-365.md) y vea [overview](microsoft-365-business-overview.md).

Hay tres formas de obtener Microsoft 365 Empresa Premium:
- **Comprar Microsoft 365 Empresa Premium** y completar su propia configuración : Para comprar Microsoft 365 Empresa Premium en línea, [siga los pasos que se indican a continuación.](#sign-up-steps)
...
3. En la **página Gracias por elegir Microsoft 365 Empresa Premium,** escribe tu información para empezar.
...
5. En **el paso 2,** escriba su nombre, número de teléfono empresarial, nombre de empresa y ubicación. Su país o región determina los servicios exactos que recibe de Microsoft y no se puede cambiar después de completar este paso. Seleccione **Siguiente**.
    > [!NOTE]
    > Se muestra el nombre de la empresa en el Centro de administración; aquí es donde administra usuarios, licencias, licencias de Microsoft 365, entre otros. También lo incluymos en cualquier URL de sitio interna (SharePoint).
6. En **el paso 3**:
...
Seleccione **Ir a configuración para** completar otros pasos, como agregar más seguridad para proteger su empresa y descargar aplicaciones de Office como Word y Excel.
