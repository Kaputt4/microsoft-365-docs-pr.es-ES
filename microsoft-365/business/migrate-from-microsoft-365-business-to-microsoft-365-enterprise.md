...
| SSO de Azure AD Premium 1: sin límite (aplicaciones locales a través del proxy de aplicación de Azure AD y aplicaciones que no son de galería con Self-Service de integración de aplicaciones)    |     | ![Se incluye con Microsoft 365 E3](../media/check-mark.png) | 
