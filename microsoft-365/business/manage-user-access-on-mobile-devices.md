...
|Requerir una huella digital o un PIN para obtener acceso a las aplicaciones de Office  <br/> |Si esta configuración está **activada**, los usuarios tendrán que proporcionar otra forma de autenticación, además de su nombre de usuario y la contraseña, para usar las aplicaciones de Office en sus dispositivos móviles.  <br/> |
|Restablecer el PIN cuando no se pueda iniciar sesión este número de veces  <br/> |Para impedir que un usuario no autorizado pueda averiguar de forma aleatoria un PIN, este se restablecerá después del número de entradas incorrectas que especifique.  <br/> |
|Exigir a los usuarios que vuelvan a iniciar sesión cuando las aplicaciones de Office estén inactivas durante  <br/> |Esta configuración determina cuánto tiempo puede estar inactivo un usuario antes de que se le pida que vuelva a iniciar sesión.  <br/> |
