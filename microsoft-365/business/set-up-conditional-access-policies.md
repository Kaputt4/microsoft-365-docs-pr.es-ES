...
- **Requerir MFA para los administradores** &ndash; requiere multi-factor Authentication para los roles de administrador con más privilegios, incluido el administrador global.
- La **protección** &ndash; de usuario final requiere autenticación multifactor para los usuarios solo cuando un inicio de sesión es arriesgado. 
...
- **Requerir MFA para la administración** &ndash; de servicios requiere la autenticación multifactor para el acceso a las herramientas de administración, incluido Azure portal (donde se configuran las directivas de línea base). 
