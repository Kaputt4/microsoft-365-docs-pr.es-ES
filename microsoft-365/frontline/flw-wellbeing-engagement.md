---
title: Interactúe con sus empleados de primera línea y céntrese en el bienestar
description: Obtenga información sobre cómo usar Conexiones Viva, SharePoint, Microsoft Teams y la aplicación Elogiar para aumentar el bienestar y la participación del personal de primera línea.
ms.topic: conceptual
author: daisyfell
...
## <a name="connect-frontline-workers-to-your-broader-organization-with-viva-connections"></a>Conectar al personal de primera línea con su organización más amplia con Conexiones Viva
...
### <a name="increase-engagement-with-communications"></a>Aumentar el compromiso con las comunicaciones
...
![Panel, fuente y recursos de Conexiones Viva.](media/viva-connections-mobile-flw.png)
...
#### <a name="empower-your-workers-to-share-feedback"></a>Capacitar a los trabajadores para compartir comentarios
...
### <a name="promote-health-and-wellbeing"></a>Promover la salud y el bienestar
...
### <a name="get-started-planning-building-and-launching-viva-connections"></a>Introducción a la planeación, la creación y el lanzamiento de Conexiones Viva
...
## <a name="create-communities-with-yammer"></a>Crear comunidades con Yammer
...
### <a name="host-live-events"></a>Hospedaje de eventos en directo
...
## <a name="boost-morale-with-praise"></a>Aumentar la motivación con Elogiar
...
## <a name="support-engagement-with-sharepoint-and-microsoft-stream"></a>Apoyar la interacción con SharePoint y Microsoft Stream
...
### <a name="record-teams-meetings-and-store-them-in-sharepoint"></a>Grabar reuniones de Teams y almacenarlas en SharePoint
