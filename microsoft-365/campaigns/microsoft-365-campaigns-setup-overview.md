...
Para las campañas que califican para precios especiales, empieza solicitando una invitación de [Microsoft](https://m365forcampaigns.microsoft.com/)y, a continuación, insccándose en [Microsoft 365 para campañas](m365-campaigns-sign-up.md). Para completar la instalación, [ejecute el Asistente para la](../business/set-up.md?toc=/microsoft-365/campaigns/toc.json) instalación para configurar la configuración principal.

Para todas las demás organizaciones, después de que te hayas registrado [](../business/set-up.md?toc=/microsoft-365/campaigns/toc.json) en [Microsoft 365 Empresa Premium,](../business/sign-up.md)completa la configuración ejecutando el Asistente para la instalación para configurar las opciones principales.
...
Como administrador de Microsoft 365, tiene acceso a nuestro equipo de soporte al cliente, Póngase en contacto con el soporte técnico para productos **[empresariales: Ayuda para administradores](../admin/contact-support-for-business-products.md)**